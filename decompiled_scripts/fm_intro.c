...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_423(false))
			uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/] = 3;
	
		if (func_422(unk_0xAE032CEDCF23C6D5()) > -1)
			unk_0x9C931A1395CC1AE9(unk_0x259BE71D8A81D4FA());
	
		switch (func_421(unk_0xAE032CEDCF23C6D5()))
		{
			case 0:
				if (!IS_BIT_SET(iLocal_718, 10))
					if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
						unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 10);
			
				unk_0xF2CB0224D3BE0B42("FMINT", 0);
			
				if (func_420() && unk_0xCC2EFE4B1D0EE422("FMINT", 0))
				{
					if (func_419() > 0)
					{
						...
						uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/] = 2;
					
						if (bLocal_726)
							uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_2 = -2;
						else
							uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_2 = -1;
					}
				}
			
				if (func_419() == 4)
					uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/] = 4;
			
				if (func_419() == 6 && uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/] < 4)
					uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/] = 6;
				break;
			...
			case 2:
				...
				if (func_419() == 6 && uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/] < 4)
					uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/] = 5;
				break;
...
void func_3() // Position - 0x2EE
{
	if (unk_0x93E08E0F531E2C35())
	{
		if (!IS_BIT_SET(iLocal_535.f_1, 3))
			if (IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_4, 0))
				unk_0x0B0C9A0F9AAEB7F0(&(iLocal_535.f_1), 3);
	
		if (!IS_BIT_SET(iLocal_535.f_1, 4))
			if (IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_4, 2))
				unk_0x0B0C9A0F9AAEB7F0(&(iLocal_535.f_1), 4);
	
		if (!IS_BIT_SET(iLocal_535.f_1, 5))
			if (IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3, 3))
				unk_0x0B0C9A0F9AAEB7F0(&(iLocal_535.f_1), 5);
	
		if (!IS_BIT_SET(iLocal_535.f_1, 6))
			if (IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3, 4))
				unk_0x0B0C9A0F9AAEB7F0(&(iLocal_535.f_1), 6);
	
		if (!IS_BIT_SET(iLocal_535.f_1, 7))
			if (IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3, 5))
				unk_0x0B0C9A0F9AAEB7F0(&(iLocal_535.f_1), 7);
	
		if (!IS_BIT_SET(iLocal_535.f_1, 8))
			if (IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3, 6))
				unk_0x0B0C9A0F9AAEB7F0(&(iLocal_535.f_1), 8);
		...
		switch (iLocal_535.f_2)
		{
			case 0:
				if (IS_BIT_SET(iLocal_535.f_1, 3))
				{
					...
					{
						unk_0xC229299217554C78(unk_0xE38610F405049F71(iLocal_535.f_3), 1, 0, 0);
						iLocal_535.f_2 = 2;
					}
				}
				break;
...
BOOL func_4(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, var uParam6) // Position - 0x4B6
{
	if (func_9(Global_2794162.f_854) && func_9(Global_2794162.f_855))
	{
		if (!unk_0x2FC2FDC413532977(*uParam0))
			if (func_6(uParam0, Global_2794162.f_854, fParam2, fParam5, 1, 1, true, 0, 1, true, false, false, 0, false))
				unk_0x983B8E72C35B01F2(unk_0xE38610F405049F71(*uParam0), 1);
	
		if (!unk_0x2FC2FDC413532977(*uParam1))
		{
			if (func_5(uParam1, *uParam0, 25, Global_2794162.f_855, -1, true, 1, 1))
			{
				unk_0xAAA71DD7E9059338(unk_0xC35A3A4C05A4831B(*uParam1), 1);
				unk_0x55098D9E9AD58806(Global_2794162.f_854);
				unk_0x55098D9E9AD58806(Global_2794162.f_855);
				unk_0x11C125313CB8ADA2(unk_0xE38610F405049F71(*uParam0), 0);
				unk_0x379E96D5D36B27DC(unk_0xC35A3A4C05A4831B(*uParam1), 1);
				func_418(uParam6, 8, unk_0xC35A3A4C05A4831B(*uParam1), "FM_TAXI", 0, 1);
			}
		}
	}
			...
			if (bLocal_724)
				if (!IS_BIT_SET(iLocal_535.f_1, 2))
					if (IS_BIT_SET(uLocal_707[i /*5*/].f_3, 2))
						unk_0x0B0C9A0F9AAEB7F0(&(iLocal_535.f_1), 2);
			else if (!IS_BIT_SET(iLocal_535.f_1, 1))
				if (IS_BIT_SET(uLocal_707[i /*5*/].f_3, 1))
					unk_0x0B0C9A0F9AAEB7F0(&(iLocal_535.f_1), 1);
	}
...
{
	if (func_14(iParam0, false, true))
		return Global_2657704[iParam0 /*463*/].f_1;

	return 0;
}

BOOL func_14(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x990
{
	int num;
...
BOOL func_15(int iParam0, BOOL bParam1) // Position - 0x9F0
{
	...
	return func_16(iParam0, bParam1, false);
}

BOOL func_16(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA17
{
	if (bParam1)
		if (func_17(iParam0))
			return 1;
...
{
	switch (func_422(unk_0xAE032CEDCF23C6D5()))
	{
		case -2:
			func_206();
			break;
...
void func_24() // Position - 0xB61
{
	switch (iLocal_723)
	{
		case 0:
			...
			{
				unk_0x0B0C9A0F9AAEB7F0(&(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3), 2);
				uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_2 = 99;
			}
			break;
	}
...
int func_28(int iParam0, int iParam1) // Position - 0xC40
{
...
void func_32() // Position - 0x103D
{
	...
	if (!IS_BIT_SET(iLocal_718, 21))
		unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 21);
			...
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
				if (unk_0x27E68848F0E5D7D9(unk_0x4A8C381C258A124D()))
					if (func_201(&uLocal_358, 3000, false))
						unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 3);
	...
	else if (!IS_BIT_SET(iLocal_718, 16))
	{
		if (!unk_0x4C705AAF75363287())
		{
			...
			{
				unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 16);
				func_200(&uLocal_358);
			}
		}
	}
	...
	if (IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_4, 2))
	{
		...
		else if (!IS_BIT_SET(iLocal_719, 1))
		{
			...
			{
				unk_0x0B0C9A0F9AAEB7F0(&iLocal_719, 1);
				func_200(&uLocal_364);
			}
		}
		else if (IS_BIT_SET(iLocal_718, 19))
		{
			if (!IS_BIT_SET(iLocal_718, 18))
			{
				...
				{
					func_197(0);
					unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 18);
	...
	if (IS_BIT_SET(iLocal_718, 18))
	{
		if (!IS_BIT_SET(iLocal_718, 2))
		{
			if (unk_0x9390801B06EE998F())
			{
				...
				if (func_101(&uLocal_370, 19, "FM_1AU", "FM_ICALL", num, 0))
				{
					func_100(true);
					unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 2);
				
					if (!IS_BIT_SET(iLocal_718, 20))
					{
						func_85(19, 3, true);
						unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 20);
					}
			...
			if (!func_83())
			{
				if (!func_81())
				{
					if (!IS_BIT_SET(iLocal_718, 12))
					{
						...
						unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 12);
		...
		if (IS_BIT_SET(iLocal_718, 12))
		{
			if (!IS_BIT_SET(iLocal_718, 17))
			{
				...
				{
					func_77();
					unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 17);
					func_200(&uLocal_358);
				}
			}
			else if (!func_198())
			{
				if (!IS_BIT_SET(iLocal_718, 23))
				{
					...
					{
						unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 23);
						unk_0x0B0C9A0F9AAEB7F0(&(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3), 3);
					}
				}
			
				if (func_201(&uLocal_362, 15000, false))
					if (!IS_BIT_SET(iLocal_718, 22))
						unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 22);
			
				if (unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) == 0)
				{
					if (IS_BIT_SET(iLocal_718, 14))
						unk_0x8744D2E3FC95740E(&iLocal_718, 14);
				
					if (!func_25(iLocal_60))
					{
						if (IS_BIT_SET(iLocal_718, 13))
							unk_0x8744D2E3FC95740E(&iLocal_718, 13);
					
						if (IS_BIT_SET(iLocal_718, 25) || !IS_BIT_SET(iLocal_718, 25) && !unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
						{
							if (!IS_BIT_SET(iLocal_718, 0))
							{
								if (IS_BIT_SET(iLocal_718, 15))
									unk_0x8744D2E3FC95740E(&iLocal_718, 15);
							
								if (unk_0xC450B06E5AAA0985(Global_100885.f_267[iLocal_60]))
								{
									func_71("GET_AMMU", false);
									unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 0);
									unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 25);
								
									if (unk_0xC450B06E5AAA0985(Global_100885.f_267[iLocal_60]))
									{
										if (!IS_BIT_SET(Global_2794162.f_853, 2))
											unk_0xBC64B805EE071A37(Global_100885.f_267[iLocal_60], 1);
							...
							else if (IS_BIT_SET(Global_2794162.f_853, 2))
							{
								if (unk_0xC450B06E5AAA0985(Global_100885.f_267[iLocal_60]))
								{
									if (!IS_BIT_SET(iLocal_718, 15))
									{
										unk_0xBC64B805EE071A37(Global_100885.f_267[iLocal_60], 0);
										unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 15);
									}
								}
							}
							else if (unk_0xC450B06E5AAA0985(Global_100885.f_267[iLocal_60]))
							{
								if (IS_BIT_SET(iLocal_718, 15))
								{
									unk_0xBC64B805EE071A37(Global_100885.f_267[iLocal_60], 1);
					...
					{
						if (IS_BIT_SET(iLocal_718, 0))
							unk_0x8744D2E3FC95740E(&iLocal_718, 0);
					
						if (!IS_BIT_SET(iLocal_718, 13))
						{
							func_71("GET_GUN", false);
							func_70(true);
							unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 13);
						}
					}
				}
				else if (!IS_BIT_SET(iLocal_718, 14))
				{
					...
					{
						unk_0xBC64B805EE071A37(Global_100885.f_267[iLocal_60], 0);
						unk_0x861AC9C2D48CEA7F(Global_100885.f_267[iLocal_60], 0);
						func_414(iLocal_60, false);
					}
				
					func_71("LOSE_COP", false);
					unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 14);
				}
			}
		}
	}
	...
	if (!IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3, 0))
	{
		if (unk_0x66B90BA528CFEBCE(unk_0x4A8C381C258A124D(), joaat("WEAPON_PISTOL"), 0) || unk_0x66B90BA528CFEBCE(unk_0x4A8C381C258A124D(), joaat("WEAPON_COMBATPISTOL"), 0) || unk_0x66B90BA528CFEBCE(unk_0x4A8C381C258A124D(), joaat("WEAPON_APPISTOL"), 0) || unk_0x66B90BA528CFEBCE(unk_0x4A8C381C258A124D(), joaat("WEAPON_MICROSMG"), 0))
		{
			...
			{
				func_63(true);
				unk_0x0B0C9A0F9AAEB7F0(&(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3), 0);
				func_25(iLocal_60);
			}
		}
		else
	...
	else if (!IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3, 1))
	{
		if (!func_43())
		{
			unk_0x0B0C9A0F9AAEB7F0(&(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3), 1);
			func_36();
			...
			if (!IS_BIT_SET(iLocal_718, 31))
			{
				func_33(119, 1, -1, 1);
				func_33(115, 1, -1, 1);
				unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 31);
			}
			...
			if (bLocal_724)
				if (bLocal_725)
					uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_2 = 3;
				else
					uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_2 = 1;
			else
				uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_2 = 99;
...
void func_33(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x16A7
{
	int num;
...
int func_34(int iParam0, int iParam1) // Position - 0x16CA
{
	return unk_0xD69CE161FE614531(2, iParam0, func_29(iParam1));
}
...
void func_45(int iParam0) // Position - 0x1B33
{
	...
	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		num = func_60(unk_0x259BE71D8A81D4FA());
	
		if (num < iParam0)
			if (func_59())
				func_46(joaat("SERVICE_EARN_HOLDUPS"), iParam0 - num, &unk, false, false, false);
			else
	...
	switch (iParam0)
	{
		...
		case joaat("SERVICE_SPEND_MAKE_IT_RAIN"):
			if (iParam1 > 0 || Global_262145.f_28582)
				func_47(uParam2, -1135378931, 537254313, joaat("CATEGORY_SERVICE_WITH_THRESHOLD"), iParam0, iParam1, num, 7);
			break;
		...
		case joaat("SERVICE_EARN_SPIN_THE_WHEEL_CASH"):
			func_47(uParam2, -1135378931, 1445302971, joaat("CATEGORY_SERVICE_WITH_THRESHOLD"), iParam0, iParam1, num, 7);
			break;
	}
...
int func_47(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x2443
{
	...
	*uParam0 = 15;
	...
	if (flag || flag2 || unk_0x54BC5E0B6A29AE8A(&num, iParam3, iParam4, iParam2, iParam5, iParam6))
	{
		...
		{
			*uParam0 = func_54(num, iParam1, iParam4, iParam2, iParam3, iParam5, false, iParam6, iParam7, 1, true);
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x280F
{
	int i;
...
int func_57(int iParam0) // Position - 0x29ED
{
	var unk;
...
BOOL func_58(int iParam0) // Position - 0x2A08
{
	int num;
...
int func_60(int iParam0) // Position - 0x2A41
{
	int num;
...
BOOL func_62(int iParam0) // Position - 0x2A96
{
	if (!func_58(iParam0))
		return false;
...
void func_65(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2B50
{
	...
	else if (unk_0x76CD105BCAC6EB9F())
	{
		if (func_19() == 0)
		{
			num = func_27(func_31(iParam0), -1);
			unk_0x8744D2E3FC95740E(&num, iParam1);
			func_66(func_31(iParam0), num, -1, 1);
		}
	}
	else
	{
...
void func_66(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2BC0
{
	int num;
...
void func_70(BOOL bParam0) // Position - 0x2CE9
{
	if (bParam0)
		if (!IS_BIT_SET(Global_1927213, 19))
			unk_0x0B0C9A0F9AAEB7F0(&Global_1927213, 19);
	else if (IS_BIT_SET(Global_1927213, 19))
		unk_0x8744D2E3FC95740E(&Global_1927213, 19);
...
void func_77() // Position - 0x2E61
{
	...
	unk = { func_80(unk_0x259BE71D8A81D4FA()) };
...
BOOL func_79(var uParam0) // Position - 0x2EE6
{
...
void func_85(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2FB8
{
	...
	if (Global_117[iParam0 /*10*/].f_8 != 172)
	{
		...
		else
		{
			...
			num = iParam1;
			func_91(iParam0, num, 1);
			func_90(iParam0, num, 1);
...
void func_94() // Position - 0x335B
{
	...
	{
		if (func_97(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_96(unk_0x4A8C381C258A124D());
		
			if (func_95(num) && !func_99(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != num && func_95(Global_113810.f_2366.f_539.f_4321))
...
int func_96(var uParam0) // Position - 0x3464
{
	int i;
	int num;
...
int func_98(int iParam0) // Position - 0x34C6
{
...
{
	if (bParam0)
		unk_0x0B0C9A0F9AAEB7F0(&Global_8371, 17);
	else
...
BOOL func_101(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x3505
{
	char* str;
	BOOL flag;
	int num;
	...
	flag = false;
	num = -99;
	return func_102(uParam0, iParam1, sParam2, sParam3, 1, iParam5, iParam4, str, flag, num, str, str, -1);
}

BOOL func_102(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, char* sParam7, BOOL bParam8, int iParam9, char* sParam10, char* sParam11, int iParam12) // Position - 0x354A
{
	var unk;
	var unk2;
	int num;
	...
	unk2 = func_193(sParam2, sParam3);
	num = 0;

	if (!unk_0xD6F9DEE4765092A9(sParam7))
		num = unk_0x70E57E9927B6BA58(sParam7);

	if (func_192(unk, unk2, num))
		return true;

	if (!func_188(iParam6))
		return false;

	if (func_185(unk, unk2, num))
	{
		if (func_184())
			return false;
	
		func_183();
		return func_109(uParam0, iParam1, iParam12, sParam2, sParam3, iParam4, iParam5, iParam6, sParam7, bParam8, iParam9, sParam10, sParam11);
	}

	if (!func_108(iParam4))
		return false;

	func_103(unk, unk2, num, sParam3, iParam4, iParam5, iParam6);
	return false;
}

void func_103(var uParam0, var uParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6) // Position - 0x362F
{
...
BOOL func_109(var uParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, char* sParam8, BOOL bParam9, int iParam10, char* sParam11, char* sParam12) // Position - 0x3735
{
	var unk;
	...
	if (iParam5 == 4)
	{
		...
		return func_176(uParam0, iParam1, sParam3, sParam4, &unk);
	}
	...
	if (iParam5 == 1 || iParam5 == 7)
	{
		...
		return func_158(uParam0, iParam1, sParam3, sParam4, iParam7);
	}

	if (iParam5 == 5)
		return func_157(iParam1, iParam2, sParam4, iParam7, sParam8, bParam9, iParam10, sParam11, sParam12);

	if (iParam5 == 2)
		return func_146(iParam1, iParam2, sParam4, iParam7, sParam8, bParam9, iParam10, sParam11, sParam12);

	if (iParam5 == 3)
		return func_145(iParam1, iParam2, sParam4, iParam7, sParam8, bParam9, iParam10, sParam11, sParam12);

	if (iParam5 == 6)
		return func_110(iParam1, iParam2, sParam4, iParam7, sParam8, bParam9, iParam10, sParam11, sParam12);

	return false;
}

BOOL func_110(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0x382E
{
	BOOL flag;
	...
	if (func_112(iParam0, iParam1, sParam2, flag, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8))
	{
		func_111(120000);
		return 1;
	}
...
BOOL func_112(int iParam0, int iParam1, char* sParam2, BOOL bParam3, int iParam4, char* sParam5, BOOL bParam6, int iParam7, char* sParam8, char* sParam9) // Position - 0x3888
{
	int num;
	int num2;
	char* str;
	...
	num3 = 0;
	str2 = func_136(sParam5, bParam6, &num3);
	num4 = func_134(iParam7, &num3);
	num5 = 0;
	...
	if (!(num3 == 0) || !unk_0xD6F9DEE4765092A9(str))
		flag2 = func_133(iParam0, sParam2, num8, str2, num4, str, num3, num9, 1, num7, 0, flag, num6, 0, num5, sParam8, sParam9);
	else
		flag2 = func_116(iParam0, sParam2, num8, num9, 1, num7, 0, flag, num6, 0);
...
BOOL func_116(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x3A08
{
	int num;
	char* str;
	int num2;
	...
	if (func_117(iParam0, sParam1, iParam2, num, str, str2, num2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, num3, str3, str4, num4) == 1)
	{
		if (bParam7 == true)
		{
			Global_9077 = iParam6;
...
int func_117(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x3A74
{
	int num;
	int num2;
	...
	func_118(iParam0, sParam1, num2, func_122(unk_0x259BE71D8A81D4FA()));
	return 1;
}
...
BOOL func_121(int iParam0, int iParam1) // Position - 0x3F6A
{
						...
						if (Global_8939[i] == 0)
						{
							...
							else if (num == 7)
							{
								if (Global_78689)
								{
									...
									func_124(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20500)
...
void func_124(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x4533
{
...
void func_125(int iParam0) // Position - 0x45E6
{
...
void func_126(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x45F8
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	unk_0x330108B080A2132F(SYSTEM::ROUND(fParam2));
...
BOOL func_133(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12, int iParam13, int iParam14, char* sParam15, char* sParam16) // Position - 0x49C6
{
	int num;
	...
	if (func_117(iParam0, sParam1, iParam2, iParam6, sParam3, sParam5, iParam4, iParam7, iParam8, iParam9, bParam11, iParam12, iParam13, iParam14, sParam15, sParam16, num) == 1)
	{
		if (bParam11 == true)
		{
...
char* func_136(char* sParam0, BOOL bParam1, var uParam2) // Position - 0x4B18
{
	if (unk_0xD6F9DEE4765092A9(sParam0))
		return sLocal_16;
...
BOOL func_139(int iParam0) // Position - 0x4BF7
{
	int i;
...
BOOL func_145(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0x4DA5
{
	BOOL flag;

	func_144();
	flag = false;
	return func_112(iParam0, iParam1, sParam2, flag, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8);
}

BOOL func_146(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0x4DCC
{
	BOOL flag;

	flag = false;
	return func_147(iParam0, iParam1, sParam2, flag, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8);
}

BOOL func_147(int iParam0, int iParam1, char* sParam2, BOOL bParam3, int iParam4, char* sParam5, BOOL bParam6, int iParam7, char* sParam8, char* sParam9) // Position - 0x4DEF
{
	int num;
	int num2;
	char* str;
	...
	if (!(num3 == 0) || !unk_0xD6F9DEE4765092A9(str))
		flag2 = func_156(iParam0, sParam2, num8, str2, num4, str, num3, num9, 1, num7, 0, flag, num6, 0, num5, sParam8, sParam9);
	else
		flag2 = func_149(iParam0, sParam2, num8, num9, 1, num7, 0, flag, num6, 0);
...
BOOL func_149(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x4F4D
{
	int num;
	char* str;
	int num2;
	...
	if (func_150(iParam0, sParam1, iParam2, num, str, str2, num2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, num3, str3, str4, num4) == 1)
	{
		if (bParam7 == true)
		{
			Global_9077 = iParam6;
...
int func_150(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x4FDC
{
	int num;
	int num2;
	...
	func_151(iParam0, sParam1, num2, func_122(unk_0x259BE71D8A81D4FA()));
	return 1;
}
...
BOOL func_156(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12, int iParam13, int iParam14, char* sParam15, char* sParam16) // Position - 0x58FD
{
	int num;
	...
	if (func_150(iParam0, sParam1, iParam2, iParam6, sParam3, sParam5, iParam4, iParam7, iParam8, iParam9, bParam11, iParam12, iParam13, iParam14, sParam15, sParam16, num) == 1)
	{
		if (bParam11 == true)
		{
			Global_9077 = iParam10;
...
BOOL func_157(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0x59A9
{
	BOOL flag;
	...
	if (func_147(iParam0, iParam1, sParam2, flag, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8))
	{
		func_111(120000);
		return 1;
	}
...
BOOL func_158(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x59FB
{
	BOOL flag;
	int num;
	...
	if (IS_BIT_SET(iParam4, 4))
		flag = func_175(uParam0, iParam1, sParam2, sParam3, num, 0, 0, true);
	else
		flag = func_164(uParam0, iParam1, sParam2, sParam3, num, 0, 0, true);
...
BOOL func_164(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x5B0C
{
...
BOOL func_175(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x6121
{
	func_174(uParam0, iParam1, sParam2, iParam5, iParam6, 0);
	Global_21893 = 1;
	Global_21852 = true;
...
BOOL func_176(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4) // Position - 0x616F
{
	!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D());
	...
	if (func_178(uParam0, iParam1, sParam2, sParam3, 9, sParam4, 0, 0, true))
	{
		func_177();
		func_161();
		func_114();
...
BOOL func_185(var uParam0, var uParam1, int iParam2) // Position - 0x62F1
{
	if (!func_186(uParam0))
		return 0;
...
BOOL func_186(var uParam0) // Position - 0x6330
{
	if (!func_187())
		return false;
...
BOOL func_192(var uParam0, var uParam1, int iParam2) // Position - 0x6408
{
	if (!func_82())
		return false;

	return func_185(uParam0, uParam1, iParam2);
}

var func_193(char* sParam0, char* sParam1) // Position - 0x6426
{
	var unk;
...
BOOL func_201(var uParam0, int iParam1, BOOL bParam2) // Position - 0x64D7
{
	if (iParam1 == -1)
		return true;
...
{
	if (bParam0)
		if (!IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139, 8))
			unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139), 8);
	else if (IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139, 8))
		unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139), 8);
...
{
	return IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139, 8);
}
...
void func_205() // Position - 0x65B6
{
	...
	if (!bLocal_727)
		uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_2 = 0;
	else
		uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_2 = 3;
...
{
	if (func_212(&uLocal_61, &(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_4)))
		uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_2 = -1;
		...
		case 3:
			if (!flag)
			{
				if (!unk_0x4C705AAF75363287())
				{
					...
					if (unk_0x1226C55CA7D2269A() || func_209())
						func_78("HLP_CASHXBX", 9000);
					else if (unk_0x0BA1A956D36B210F() || func_208())
...
void func_210(int iParam0, BOOL bParam1, int iParam2) // Position - 0x6887
{
	switch (iParam0)
	{
		...
		default:
			if (bParam1)
				unk_0x0B0C9A0F9AAEB7F0(&(Global_1654054.f_1046), iParam0);
			else
				unk_0x8744D2E3FC95740E(&(Global_1654054.f_1046), iParam0);
			break;
	}
...
BOOL func_212(var uParam0, var uParam1) // Position - 0x68E7
{
	float num;
	var unk;
	int i;
	...
	func_385(uParam0);
	func_384(unk_0x259BE71D8A81D4FA());
	...
	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		switch (uParam0->f_6)
		{
			case 0:
				...
				else if (unk_0x486FF5D06E9659F1(func_383()) > 0)
				{
					uParam0->f_295 = 1;
				}
				...
				if (!func_202(&(uParam0->f_15)))
					func_22(&(uParam0->f_15), false, false);
			
				unk_0xD314260005F064BF(&Global_1936380);
				...
				if (unk_0x15CCE8886267624F())
				{
					*uParam0 = 0;
					uParam0->f_4 = 0;
					uParam0->f_5 = 0;
					func_372(false, false, false, true, true, true, 0);
					...
					if (unk_0x486FF5D06E9659F1(joaat("fm_intro")) < 1 || !func_333())
					{
						if (uParam0->f_292)
						{
							if (func_332() == 0)
			...
			case 2:
				if (!unk_0x3555462DB47B7AB1())
				{
					if (!IS_BIT_SET(*uParam0, 4))
					{
						...
						{
							unk_0xE3F88173F42C071B();
							unk_0xAC48F8E2BF2BEBF7(754.2219f, 1226.8309f, 356.5081f, func_313(-14.367f, 0f, 157.3524f), 100f, 0);
							func_200(&(uParam0->f_17));
							func_22(&(uParam0->f_17), false, false);
							unk_0x0B0C9A0F9AAEB7F0(uParam0, 4);
						}
					}
					else if (unk_0x16088CC55E7F218A("FM_INTRO_START") && unk_0x9E2D35FA908F57B4() || func_201(&(uParam0->f_17), 5000, false))
					{
			...
			case 7:
				...
				{
					unk_0x428C32CC68809A35(1);
					func_78("FMIC_INTRO2" /*In GTA Online, you can carry out Jobs with, or compete against, players around the world.*/, -1);
			...
			case 14:
				...
				{
					func_78("FMIC_RACE1" /*Take part in Jobs, including Races, with your friends, Crew members or others and check your position on the global leaderboards in-game or on the Rockstar Social Club.*/, -1);
			...
			case 15:
				...
				if (!IS_BIT_SET(uParam0->f_3, 0))
					func_289(uParam0);
				else if (func_288(uParam0) && func_282(uParam0))
					func_280(uParam0);
			...
			case 17:
				...
				if (!IS_BIT_SET(*uParam0, 6))
				{
					...
					func_78("FMIC_RACE2" /*You can challenge others with Jobs you have created yourself or bet on players to win and earn cash.*/, -1);
				}
			...
			case 19:
				...
				if (func_309(uParam0, 19, 0) && IS_BIT_SET(uParam0->f_3, 0))
				{
				...
				else if (func_309(uParam0, 19, -4968))
				{
					if (!IS_BIT_SET(*uParam0, 12))
					{
						unk_0x428C32CC68809A35(1);
				...
				else if (func_309(uParam0, 19, -5618))
				{
			...
			case 22:
				...
				if (IS_BIT_SET(uParam0->f_3, 0))
				{
					...
					func_275(uParam0);
					func_274();
					func_78("FMIC_GAR" /*You can store your own collection of cars and motorcycles in Garages that you can purchase around the Map.*/, -1);
					uParam0->f_6 = 23;
				}
				break;
			...
			case 27:
				...
				func_272(uParam0, 2);
				func_272(uParam0, 7);
				unk_0x55098D9E9AD58806(func_271());
			...
			case 28:
				...
				if (unk_0x16088CC55E7F218A("FM_INTRO_DRIVE_START") && IS_BIT_SET(uParam0->f_3, 3) && func_309(uParam0, 28, 0))
					uParam0->f_6 = 29;
				break;
			...
			case 29:
				...
				unk_0x216049890A2D1EC6(9, 9, 9, 9);
				func_78("FMIC_TENN" /*~s~Challenge others to Tennis, Golf and many other Activities.*/, -1);
				unk_0xED65412F8B26ED99(4);
				func_258(true, true, true, 0, false, false, false);
				uParam0->f_6 = 30;
				break;
			...
			case 31:
				...
				if (func_255(uParam0) && func_254(uParam0) && !unk_0xFD216000DC314A92())
				{
					if (uParam0->f_293)
					{
					...
					func_253(uParam0);
					func_252(uParam0);
					func_258(false, true, true, 0, false, false, false);
					unk_0x0B0C9A0F9AAEB7F0(uParam0, 15);
			...
			case 48:
				...
				{
					unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139), 3);
			...
			case 49:
				...
				if (unk_0x16088CC55E7F218A("FM_INTRO_DRIVE_END") && func_309(uParam0, 49, 0))
				{
			...
			case 50:
				...
				if (func_309(uParam0, 50, 0) && IS_BIT_SET(*uParam0, 20))
				{
			...
			case 55:
				...
				else if (func_201(&(uParam0->f_17), 10000, false))
				{
					if (func_236(uParam0))
					{
						func_304(uParam0);
			...
			case 56:
				...
				else if (func_201(&(uParam0->f_17), 10000, false))
				{
					if (func_288(uParam0))
					{
						...
						!func_239(unk_0x259BE71D8A81D4FA());
						func_258(false, true, true, 0, false, false, false);
						...
						unk_0xAFD3BC0F6EBB5474(0, 0, 0);
						unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139), 3);
						uParam0->f_13 = unk_0x1DD05E817C89C737() - func_233(uParam0, 48, false);
						uParam0->f_293 = 1;
						func_244(uParam0, 10177.75f);
						unk_0x0B0C9A0F9AAEB7F0(uParam0, 15);
						uParam0->f_6 = 49;
		...
		if (!uParam0->f_291)
		{
			if (uParam0->f_293)
				...
				uParam0->f_289 = SYSTEM::TO_FLOAT(func_241(uParam0));
...
void func_213(var uParam0) // Position - 0xA013
{
	int num;
...
{
	if (bParam0)
		if (!IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139, 18))
			unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139), 18);
	else if (IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139, 18))
		unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139), 18);
...
{
	unk_0xA91A4C18A2DB01BD(Global_1577886, 255, 255, 255, 255, 0);

	if (Global_1577888 == 0)
	{
		unk_0x88F483FBD433696A(Global_1577886, "SET_BIG_LOGO_VISIBLE");
		unk_0x330108B080A2132F(1);
...
void func_216(var uParam0) // Position - 0xA105
{
	var unk;
...
void func_217(var uParam0, int iParam1) // Position - 0xA172
{
	var unk;
	var unk4;
...
float func_219(var uParam0) // Position - 0xA45D
{
	float num;
	float num2;
...
void func_220(var uParam0) // Position - 0xA4DA
{
	if (IS_BIT_SET(*uParam0, 29))
	{
...
void func_221(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA559
{
...
void func_231(var uParam0) // Position - 0xA99F
{
	int i;
...
int func_233(var uParam0, int iParam1, BOOL bParam2) // Position - 0xAA1A
{
	int i;
	int num;
	int num2;
...
BOOL func_236(var uParam0) // Position - 0xAE5B
{
	int num;
	int num2;
...
void func_237(var uParam0, int iParam1) // Position - 0xAF81
{
	if (unk_0xFC8BFE4B41177C22(uParam0->f_58[iParam1]))
...
{
	if (bParam0)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_143), 22);
	else
		unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_143), 22);
...
{
	return IS_BIT_SET(Global_1853988[iParam0 /*867*/].f_143, 22);
}

void func_240(BOOL bParam0) // Position - 0xB00B
{
	if (bParam0)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139), 4);
	else
		unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139), 4);

	return;
}

int func_241(var uParam0) // Position - 0xB03F
{
	if (uParam0->f_6 < 31)
...
void func_242(var uParam0, float fParam1) // Position - 0xB07B
{
	func_243(uParam0->f_34, 7, "FMINTRO", fParam1, true);
	return;
}

void func_243(var uParam0, int iParam1, char* sParam2, float fParam3, BOOL bParam4) // Position - 0xB093
{
	var unk;
...
void func_244(var uParam0, float fParam1) // Position - 0xB113
{
	func_243(uParam0->f_34, 6, "FMINTRO", fParam1, true);
	return;
}

void func_245(var uParam0) // Position - 0xB12B
{
	int num;
	int num2;
...
void func_246(var uParam0) // Position - 0xB160
{
	int i;
...
BOOL func_247(var uParam0) // Position - 0xB1AF
{
	int i;
...
void func_249(var uParam0) // Position - 0xB5D8
{
	int i;
	var unk;
...
BOOL func_250(var uParam0) // Position - 0xB6B3
{
	int i;
	var unk;
	float num;
	...
	num2 = joaat("shamal");
	unk_0xEC9DAA34BBB4658C(num2);
	unk_0xEC9DAA34BBB4658C(func_251());
	...
	if (unk_0x6252BC0DD8A320DB(func_251()))
	{
		for (i = 0; i < 1; i = i + 1)
		{
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_98[i]))
			{
				if (unk_0xFC8BFE4B41177C22(uParam0->f_92[i]))
				{
					...
					{
						uParam0->f_98[i] = unk_0x8728A378EF2B46B2(uParam0->f_92[i], 4, func_251(), -1, 0, 0);
	...
	unk_0x55098D9E9AD58806(func_251());
	unk_0x0B0C9A0F9AAEB7F0(&(uParam0->f_3), 11);
	return true;
}

var func_251() // Position - 0xB85F
{
	return unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D());
}

void func_252(var uParam0) // Position - 0xB86F
{
	int i;
...
void func_253(var uParam0) // Position - 0xB8D0
{
	int i;
...
int func_254(var uParam0) // Position - 0xB96E
{
	if (func_268(uParam0))
	{
...
int func_255(var uParam0) // Position - 0xB9DB
{
	int num;
...
void func_256(var uParam0, float fParam1) // Position - 0xBAA1
{
	func_243(uParam0->f_34, 5, "FMINTRO", fParam1, false);
	return;
}

void func_257(var uParam0) // Position - 0xBAB9
{
	int i;
...
void func_258(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xBAF7
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (unk_0x76CD105BCAC6EB9F())
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && !func_262(unk_0x259BE71D8A81D4FA()) && !func_260(unk_0x259BE71D8A81D4FA(), 0) && !func_259() && !bParam4 && !bParam5 && !unk_0xAD15761928FCF79C())
				unk_0x935364B4448CD584(unk_0x4A8C381C258A124D(), 0);
...
BOOL func_262(int iParam0) // Position - 0xBCF8
{
...
int func_264(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xBD45
{
	int num;
...
void func_266(var uParam0) // Position - 0xBD9B
{
	int i;
	...
	for (i = 0; i < 7; i = i + 1)
	{
		if (!unk_0x1C2F771CDC87A3A5(uParam0->f_104[i], 0))
		{
			...
			unk_0xF293D66D4452C854(uParam0->f_104[i], func_267(i), 0, 0, 64);
		}
	}
...
BOOL func_268(var uParam0) // Position - 0xBE6A
{
	if (uParam0->f_295)
		return func_269();
	else
...
BOOL func_270(var uParam0) // Position - 0xBE99
{
...
void func_272(var uParam0, int iParam1) // Position - 0xBEC5
{
	unk_0x55098D9E9AD58806(func_273(iParam1));
...
void func_274() // Position - 0xBFAA
{
	...
	if (unk_0xA0C7B98BCF1EEF9E(Global_1577886))
	{
		unk_0x88F483FBD433696A(Global_1577886, "SET_BIG_LOGO_VISIBLE");
		unk_0x330108B080A2132F(1);
		unk_0x557F1E2300EF1A3E(0);
		unk_0xE6B753D52F4CA222();
		unk_0xD314260005F064BF(&Global_1577886);
	}

	return;
}

void func_275(var uParam0) // Position - 0xBFE5
{
	var unk;
	int i;
...
void func_276(var uParam0) // Position - 0xC09C
{
...
void func_277(var uParam0) // Position - 0xC0F4
{
	if (unk_0xFC8BFE4B41177C22(uParam0->f_49[2]))
		if (unk_0xD9F5E1FEFD1329E4(uParam0->f_49[2], 0))
...
BOOL func_278() // Position - 0xC127
{
	...
	if (!unk_0xA0C7B98BCF1EEF9E(Global_1577886))
	{
		Global_1577886 = unk_0x8DE4F68A9728925E("GTAV_ONLINE");
		return false;
	}
...
void func_279(var uParam0, char* sParam1, char* sParam2, var uParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9) // Position - 0xC157
{
...
void func_280(var uParam0) // Position - 0xC1D2
{
...
void func_281() // Position - 0xC251
{
	...
	for (i = 0; i < 7; i = i + 1)
	{
		unk_0x7901DE0AC779EB29(func_267(i), 0, 1);
	}

	return;
}

BOOL func_282(var uParam0) // Position - 0xC277
{
	int i;
	var unk;
...
BOOL func_284(var uParam0, int iParam1) // Position - 0xCDB1
{
	if (uParam0->f_295 && uParam0->f_112[iParam1] != -1 && func_14(unk_0xB23E0F9B63D009A8(uParam0->f_112[iParam1]), false, true))
		return true;

	return false;
}

BOOL func_285(var uParam0, int iParam1) // Position - 0xCDEC
{
	if (func_284(uParam0, iParam1))
		return func_270(unk_0xB23E0F9B63D009A8(uParam0->f_112[iParam1]));
...
void func_286(var uParam0) // Position - 0xCE3F
{
	...
	for (i = 0; i < 32; i = i + 1)
	{
		...
		if (func_14(num2, false, true))
		{
			if (unk_0x259BE71D8A81D4FA() != num2)
			{
				if (num < 4)
				{
					uParam0->f_112[func_287(num)] = i;
					num = num + 1;
				}
			}
		}
...
BOOL func_288(var uParam0) // Position - 0xCF19
{
	int num;
	int num2;
...
void func_289(var uParam0) // Position - 0xD0E5
{
	int i;
	...
	if (!IS_BIT_SET(uParam0->f_3, 0))
	{
		...
		if (func_291(uParam0))
		{
			if (func_290(uParam0))
			{
				...
				for (i = 0; i < 8; i = i + 1)
				{
					unk_0x55098D9E9AD58806(func_273(i));
				}
...
BOOL func_290(var uParam0) // Position - 0xD187
{
	int num;
...
BOOL func_291(var uParam0) // Position - 0xD375
{
	int num;
	var unk;
	var unk4;
...
BOOL func_292(var uParam0, int iParam1) // Position - 0xD4D8
{
	switch (iParam1)
	{
		case 0:
...
{
	unk_0xEC9DAA34BBB4658C(func_271());
	unk_0x80813AC549A1E8AE(func_298());
	return;
}
...
void func_299() // Position - 0xDE8B
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		unk_0xEC9DAA34BBB4658C(func_273(i));
	}

	return;
}

void func_300(var uParam0, float fParam1, int iParam2) // Position - 0xDEB0
{
	func_243(uParam0->f_92[0], 100, "FM_Intro_uber", fParam1, false);
	func_243(uParam0->f_92[1], 101, "FM_Intro_uber", fParam1, false);
	func_243(uParam0->f_92[2], 102, "FM_Intro_uber", fParam1 + iParam2, false);
	func_243(uParam0->f_92[3], 103, "FM_Intro_uber", fParam1, false);
	func_243(uParam0->f_92[4], 104, "FM_Intro_uber", fParam1, false);
	return;
}

void func_301(var uParam0, int iParam1) // Position - 0xDF1F
{
	int i;
	int num;
	...
	{
		case 14:
			func_302(uParam0, 0, -2997.1738f, 330.9234f, 14.2341f, -15.97f, &num, true);
			func_302(uParam0, 2, -2983.9001f, 423.7414f, 14.4122f, -5.25f, &num, true);
			break;
	
		case 15:
			func_302(uParam0, 1, -2622.2075f, -109.3386f, 19.2643f, 39.34f, &num, true);
			func_302(uParam0, 3, -2583.9497f, -143.6469f, 20.6224f, 48.89f, &num, true);
			func_302(uParam0, 7, -2552.1448f, -169.0495f, 19.8664f, 60.04f, &num, true);
			func_302(uParam0, 8, -2531.4744f, -174.4581f, 19.2269f, 58.09f, &num, true);
			break;
		...
		case 17:
			func_302(uParam0, 0, -2420.6177f, -232.2668f, 15.3525f, 57.71f, &num, true);
			func_302(uParam0, 2, -2399.7092f, -249.2471f, 14.9551f, 58.19f, &num, true);
			func_302(uParam0, 4, -2568.499f, -153.4655f, 20.4075f, 54.1f, &num, true);
			func_302(uParam0, 5, -2485.392f, -198.0737f, 17.5783f, 63.83f, &num, true);
			func_302(uParam0, 6, -2469.139f, -206.5518f, 17.0201f, 60.64f, &num, true);
			func_302(uParam0, 9, -2408.7327f, -238.8328f, 15.2055f, 59.84f, &num, true);
			break;
	
		case 18:
			func_302(uParam0, 1, -2146.384f, -323.4933f, 12.0429f, 14.8813f, &num, true);
			func_302(uParam0, 3, -2075.444f, -374.131f, 11.556f, 56.66f, &num, true);
			func_302(uParam0, 7, -2160.252f, -294.0829f, 12.5163f, 163.95f, &num, true);
			func_302(uParam0, 8, -2191.4287f, -335.8769f, 12.7225f, 84.71f, &num, true);
			break;
	
		case 19:
			func_302(uParam0, 0, -1833.8702f, -561.7711f, 11.0989f, 48.11f, &num, true);
			func_302(uParam0, 1, -1630.5872f, -685.6821f, 16.5351f, 58.23f, &num, true);
			func_302(uParam0, 2, -1668.738f, -662.7587f, 14.7925f, 60.52f, &num, true);
			func_302(uParam0, 3, -1564.946f, -738.6324f, 10.7672f, 68.32f, &num, true);
			func_302(uParam0, 4, -1706.5074f, -720.8959f, 9.6281f, -132.94f, &num, true);
			func_302(uParam0, 5, -1626.756f, -769.9745f, 10.2367f, -128.8f, &num, true);
			func_302(uParam0, 6, -1782.7637f, -610.5726f, 10.3008f, 52.34f, &num, true);
			func_302(uParam0, 7, -1595.258f, -733.587f, 10.8576f, 68.39f, &num, true);
			func_302(uParam0, 8, -1751.8918f, -682.1017f, 9.6795f, -134.89f, &num, true);
			func_302(uParam0, 9, -1742.0983f, -642.5658f, 9.8169f, 48.19f, &num, true);
			break;
	
		case 33:
			func_302(uParam0, 0, -934.4687f, -2716.0378f, 12.7365f, 309.2312f, &num, false);
			func_302(uParam0, 5, -975.6617f, -2733.5168f, 12.8172f, 267.4944f, &num, false);
			break;
		...
		case 36:
			func_302(uParam0, 6, -850.1183f, -2615.271f, 14.1979f, 327.7461f, &num, false);
			break;
		...
		case 38:
			func_302(uParam0, 0, -712.0925f, -1983.5159f, 25.688f, -167.99f, &num, false);
			func_302(uParam0, 1, -533.9934f, -2004.7274f, 26.9085f, 58.71f, &num, false);
			func_302(uParam0, 2, -653.3551f, -2047.7823f, 27.3566f, -112.14f, &num, false);
			func_302(uParam0, 3, -663.821f, -1934.8499f, 27.1417f, -121.65f, &num, false);
			func_302(uParam0, 4, -656.6017f, -2009.0784f, 30.0188f, -106.53f, &num, false);
			func_302(uParam0, 5, -502.696f, -2023.0684f, 26.2376f, 60.2827f, &num, false);
			func_302(uParam0, 6, -460.1447f, -2044.032f, 26.2371f, 63.9022f, &num, false);
			func_302(uParam0, 7, -624.7944f, -1960.9753f, 26.29f, 237.3848f, &num, false);
			func_302(uParam0, 8, -463.0545f, -1998.2552f, 36.6533f, 27.85f, &num, false);
			func_302(uParam0, 9, -473.4099f, -1950.2133f, 24.7576f, 37.16f, &num, false);
			func_302(uParam0, 10, -574.5834f, -1994.9f, 26.2871f, 236.0571f, &num, false);
			func_302(uParam0, 11, -546.7894f, -2012.7808f, 26.3137f, 235.9205f, &num, false);
			func_302(uParam0, 12, -584.929f, -1970.3323f, 26.2437f, 55.8826f, &num, false);
			func_302(uParam0, 13, -633.4936f, -1937.6824f, 26.2413f, 54.9911f, &num, false);
			func_302(uParam0, 14, -601.2188f, -1941.4187f, 17.4986f, 148.6622f, &num, false);
			break;
	
		case 39:
			func_302(uParam0, 4, -499.2335f, -1906.5316f, 16.3534f, 133.5751f, &num, false);
			func_302(uParam0, 9, -518.8654f, -1918.1439f, 16.3355f, 134.6305f, &num, false);
			break;
	
		case 40:
			func_302(uParam0, 3, -270.2197f, -1499.7521f, 29.4309f, -13.07f, &num, false);
			func_302(uParam0, 7, -313.1461f, -1559.5889f, 24.2966f, 145.66f, &num, false);
			func_302(uParam0, 8, -301.9485f, -1550.0525f, 25.5595f, 146.95f, &num, false);
			break;
		...
		case 43:
			func_302(uParam0, 1, 246.1231f, -238.5137f, 52.9482f, 251.5966f, &num, false);
			func_302(uParam0, 2, 214.2755f, -202.6486f, 53.5033f, 70.72f, &num, false);
			func_302(uParam0, 6, 263.1977f, -115.1292f, 69.0366f, 155.02f, &num, false);
			break;
	
		case 44:
			func_302(uParam0, 0, 392.6941f, 239.868f, 102.5932f, 159.15f, &num, false);
			func_302(uParam0, 7, 375.2224f, 192.316f, 102.0397f, 160.4247f, &num, false);
			func_302(uParam0, 12, 377.4185f, 166.3668f, 102.0407f, 337.9135f, &num, false);
			break;
	
		case 45:
			func_302(uParam0, 1, 267.8363f, 181.3352f, 103.7037f, 71.7724f, &num, false);
			func_302(uParam0, 3, 216.3894f, 211.8832f, 105.2308f, -19.82f, &num, false);
			func_302(uParam0, 4, 290.3365f, 172.6194f, 103.7313f, 67.09f, &num, false);
			func_302(uParam0, 5, 283.6507f, 155.574f, 103.264f, 252.0678f, &num, false);
			func_302(uParam0, 8, 309.5128f, 156.7439f, 103.3183f, -112.52f, &num, false);
			func_302(uParam0, 9, 249.0189f, 168.3015f, 104.5421f, -112.05f, &num, false);
			func_302(uParam0, 11, 313.7221f, 144.8591f, 102.6542f, 249.0527f, &num, false);
			func_302(uParam0, 13, 171.2032f, 216.4137f, 105.2411f, 69.1778f, &num, false);
			break;
		...
		case 47:
			func_302(uParam0, 2, 226.2312f, 176.6035f, 104.3217f, 252.5577f, &num, false);
			func_302(uParam0, 6, 247.4283f, 168.6965f, 103.9378f, 250.2977f, &num, false);
			func_302(uParam0, 7, 211.375f, 181.7446f, 104.561f, 250.2252f, &num, false);
			break;
		...
		case 49:
			func_302(uParam0, 2, -192.4192f, 249.71f, 91.7534f, -99.42f, &num, false);
			func_302(uParam0, 3, -45.3246f, 256.5581f, 105.0516f, 272.9104f, &num, false);
			func_302(uParam0, 4, -24.1551f, 272.3286f, 106.4563f, 96.6005f, &num, false);
			func_302(uParam0, 5, 6.5526f, 270.3987f, 108.268f, 84.5591f, &num, false);
			func_302(uParam0, 6, -124.1576f, 245.0871f, 96.1105f, -89.91f, &num, false);
			func_302(uParam0, 7, -140.9613f, 262.532f, 94.5308f, 87.51f, &num, false);
			func_302(uParam0, 9, -83.4766f, 247.5941f, 99.488f, 275.7796f, &num, false);
			func_302(uParam0, 10, -215.5077f, 252.4543f, 91.0469f, 264.726f, &num, false);
			break;
...
void func_302(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, var uParam6, BOOL bParam7) // Position - 0xE8EB
{
...
void func_303(var uParam0, char* sParam1, char* sParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, int iParam10) // Position - 0xEA0F
{
	if (!unk_0x78411E34CF90EA8C(uParam0->f_8))
		uParam0->f_8 = unk_0x69D23632E4288DBD("DEFAULT_ANIMATED_CAMERA", 0);
...
void func_304(var uParam0) // Position - 0xEA80
{
...
BOOL func_305(var uParam0) // Position - 0xEAAE
{
	BOOL flag;
	int i;
...
BOOL func_308(var uParam0) // Position - 0xEF85
{
	int i;
	int num;
	var unk;
	...
	else
	{
		...
		if (unk_0x6252BC0DD8A320DB(joaat("asterope")) && unk_0x6252BC0DD8A320DB(joaat("sentinel")) && unk_0x6252BC0DD8A320DB(func_251()))
		{
			for (i = 0; i < 15; i = i + 1)
			{
				...
				if (unk_0xFC8BFE4B41177C22(uParam0->f_58[i]))
				{
					...
					{
						uParam0->f_74[i] = unk_0x8728A378EF2B46B2(uParam0->f_58[i], 4, func_251(), -1, 0, 0);
...
BOOL func_309(var uParam0, int iParam1, int iParam2) // Position - 0xF11D
{
	int num;

	num = func_233(uParam0, iParam1, false);

	if (uParam0->f_293)
		if (uParam0->f_13 + num + iParam2 <= unk_0x1DD05E817C89C737())
			return true;
	else if (num + iParam2 <= func_241(uParam0))
		return true;

	return false;
}

BOOL func_310(var uParam0) // Position - 0xF163
{
	int num;
...
void func_311(var uParam0, int iParam1) // Position - 0xF21F
{
	if (func_309(uParam0, iParam1, 0))
		if (uParam0->f_293)
			uParam0->f_13 = unk_0x1DD05E817C89C737() - func_233(uParam0, iParam1, false);
		else
			uParam0->f_291 = 1;
...
void func_312(var uParam0) // Position - 0xF256
{
...
void func_317(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF30D
{
	func_321();
	func_319(1);
	unk_0x428C32CC68809A35(1);
	unk_0x406CBCEA35499884();
	func_258(true, true, true, 0, false, false, bParam2);
	func_318();
	func_210(12, true, -1);
	func_211(0);
...
void func_319(int iParam0) // Position - 0xF3D9
{
	int i;
...
void func_334(BOOL bParam0, BOOL bParam1) // Position - 0x12BF7
{
	if (bParam1)
	{
		unk_0x8744D2E3FC95740E(&(Global_1946161.f_1), 13);
...
void func_335(int iParam0) // Position - 0x12C22
{
	...
	if (Global_1575063)
	{
		str = func_356(iParam0);
		unk = unk_0x70E57E9927B6BA58(str);
		unk2 = func_355(&Global_2697014, true, false);
		func_354(&Global_2697012, true, false);
		unk_0x350F7DB8B2765EC2(unk, 1, num, iParam0, 0);
	}
...
void func_337() // Position - 0x12C9C
{
	if (Global_2694496)
	{
		...
		{
			Global_2694495 = true;
			Global_2694504 = unk_0x1DD05E817C89C737();
			Global_2694503 = true;
		}
	}
...
BOOL func_338() // Position - 0x12CC5
{
	...
	if (Global_2684820.f_6635 && Global_2694496)
	{
		if (func_343(0))
		{
			if (func_341() && !unk_0x15CCE8886267624F())
			{
				...
				if (IS_BIT_SET(Global_2657704[unk_0x259BE71D8A81D4FA() /*463*/].f_73.f_2, 26))
					return true;
			
				if (IS_BIT_SET(Global_2657704[unk_0x259BE71D8A81D4FA() /*463*/].f_73.f_2, 27))
					return true;
				...
				if (IS_BIT_SET(Global_4718592.f_37, 23))
					if (!func_260(unk_0x259BE71D8A81D4FA(), 0) && !func_263())
						return true;
			}
		}
	}
...
{
	if (func_353(unk_0x259BE71D8A81D4FA()) && IS_BIT_SET(Global_1950844.f_4, 22))
		return false;
...
BOOL func_345(int iParam0) // Position - 0x1343B
{
...
BOOL func_347(int iParam0) // Position - 0x13462
{
	...
	unk = { func_348(unk_0x259BE71D8A81D4FA()) };
...
Vector3 func_348(var uParam0) // Position - 0x134B1
{
...
BOOL func_353(int iParam0) // Position - 0x13517
{
	if (iParam0 != func_143())
...
var func_355(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1359B
{
	if (unk_0x76CD105BCAC6EB9F() && !bParam1)
		if (!bParam2)
...
void func_359(BOOL bParam0, BOOL bParam1) // Position - 0x139A2
{
	...
	if (bParam0)
	{
		if (num == 1)
		{
			...
			if (unk_0xFC8BFE4B41177C22(Global_1577845))
			{
				if (unk_0x7C9905528EE2C3AB(Global_1577845, 0))
				{
					if (!unk_0x110821AE6C63DD4F(Global_1577845))
						unk_0xEE0BCDB1B5E36BCB(Global_1577845, 0, 0);
				
					unk_0x734A9F4537A31459(&Global_1577845);
				}
			}
		}
	}
...
void func_364(int iParam0) // Position - 0x13AC4
{
	...
	if (func_366() == 0 || unk_0x4D9174D8796EA622())
	{
		func_365(1);
...
void func_368(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x13B3B
{
	...
	if (func_366() == 1 || unk_0x4D9174D8796EA622() || bParam0)
	{
		func_365(0);
...
void func_372(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, int iParam6) // Position - 0x13C28
{
	int num;
	...
	func_373(unk_0x259BE71D8A81D4FA(), false, num, 0);
	...
	else
	{
		...
		if (unk_0x762604C40829DB72(iParam0) && unk_0x75EAB09F5E974116(iParam0) || iParam3 == 1)
		{
			...
			if (!flag20)
			{
				...
				else if (flag14 || !func_260(unk_0x259BE71D8A81D4FA(), 0) && !func_263() && !func_262(unk_0x259BE71D8A81D4FA()))
			...
			if (bParam1)
			{
				...
				if (!func_377(unk) && !unk_0xB431D60610E7F85F(unk))
					if (!flag22)
...
BOOL func_377(var uParam0) // Position - 0x141EE
{
	int num;
...
void func_378(int iParam0, int iParam1, int iParam2) // Position - 0x1421F
{
	int num;
	int i;
	...
	if (num == 0)
	{
		...
		if (func_260(unk_0x259BE71D8A81D4FA(), 0))
...
void func_379(int iParam0, int iParam1) // Position - 0x142EF
{
	int num;
...
void func_384(var uParam0) // Position - 0x143C6
{
	unk_0x0FB8E752BCC547A9(unk_0x56E414973C2A8C0E(uParam0), 346, 1);
	return;
}

void func_385(var uParam0) // Position - 0x143DC
{
	...
	else
	{
		...
		if (uParam0->f_6 > 31)
		{
			if (unk_0xA0C7B98BCF1EEF9E(Global_1936380))
			{
				if (uParam0->f_5 < 23)
				{
					switch (uParam0->f_5)
					{
						case 0:
							...
							else if (func_309(uParam0, 33, -3390))
							{
						...
						case 1:
							...
							else if (func_309(uParam0, 33, -450))
							{
						...
						case 3:
							...
							else if (func_309(uParam0, 36, -4740))
							{
						...
						case 4:
							...
							else if (func_309(uParam0, 36, -600))
							{
						...
						case 5:
							...
							else if (func_309(uParam0, 37, -1350))
							{
						...
						case 6:
							...
							else if (func_309(uParam0, 38, -4320))
							{
								func_386("prog", 0.16f);
								uParam0->f_5 = uParam0->f_5 + 1;
							}
						...
						case 7:
							...
							else if (func_309(uParam0, 38, -870))
							{
						...
						case 8:
							...
							else if (func_309(uParam0, 39, -1620))
							{
						...
						case 9:
							...
							else if (func_309(uParam0, 40, -1470))
							{
						...
						case 10:
							...
							else if (func_309(uParam0, 41, -1200))
							{
						...
						case 11:
							...
							else if (func_309(uParam0, 42, -1320))
							{
						...
						case 12:
							...
							else if (func_309(uParam0, 43, -1320))
							{
						...
						case 13:
							...
							else if (func_309(uParam0, 45, -1650))
							{
						...
						case 14:
							...
							else if (func_309(uParam0, 46, -1950))
							{
						...
						case 16:
							...
							else if (func_309(uParam0, 48, -1320))
							{
						...
						case 17:
							...
							else if (func_309(uParam0, 49, -5070))
							{
						...
						case 18:
							...
							else if (func_309(uParam0, 49, -720))
							{
				...
				if (Global_1936382)
					unk_0xA91A4C18A2DB01BD(Global_1936380, 255, 255, 255, 255, 0);
			}
		}
	}
...
{
	unk_0x88F483FBD433696A(Global_1936380, "HIDE");
...
{
	unk_0x88F483FBD433696A(Global_1936380, "SHOW_CREDIT_BLOCK");
	unk_0x882AEFD55B8D51FB("STRING");
	unk_0x60D332F23943B34F(sParam0);
	unk_0xCFAD3D478C87321A();
	unk_0x74BF156C860580D4(fParam1);
...
void func_388(char* sParam0, char* sParam1, float fParam2, char* sParam3, int iParam4) // Position - 0x15850
{
	unk_0x88F483FBD433696A(Global_1936380, "ADD_NAMES_TO_CREDIT_BLOCK");
	unk_0x882AEFD55B8D51FB("STRING");
	unk_0x60D332F23943B34F(sParam0);
	unk_0xCFAD3D478C87321A();
	unk_0x882AEFD55B8D51FB("STRING");
...
void func_389(char* sParam0, char* sParam1, float fParam2, char* sParam3, int iParam4) // Position - 0x158AB
{
	unk_0x88F483FBD433696A(Global_1936380, "ADD_ROLE_TO_CREDIT_BLOCK");
	unk_0x882AEFD55B8D51FB("STRING");
	unk_0x60D332F23943B34F(sParam0);
	unk_0xCFAD3D478C87321A();
	unk_0x882AEFD55B8D51FB("STRING");
...
{
	unk_0x88F483FBD433696A(Global_1936380, "SETUP_CREDIT_BLOCK");
	unk_0x882AEFD55B8D51FB("STRING");
	unk_0x60D332F23943B34F(sParam0);
	unk_0xCFAD3D478C87321A();
	unk_0x74BF156C860580D4(fParam1);
...
void func_391(var uParam0) // Position - 0x1595B
{
...
void func_392() // Position - 0x159B5
{
	...
	if (unk_0x93BF17E19A9F0E9B(iLocal_535.f_3))
	{
		switch (iLocal_535.f_2)
		{
			case 2:
				if (IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_4, 1))
				{
					if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
					{
						if (func_412(iLocal_535.f_3))
						{
							if (!unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
							{
								if (unk_0x9B5C1660CCDF7189(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_ENTER_VEHICLE")) != 1 && unk_0x9B5C1660CCDF7189(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_ENTER_VEHICLE")) != 0)
									unk_0xEBA229B2E0BB05E0(unk_0x4A8C381C258A124D(), unk_0xE38610F405049F71(iLocal_535.f_3), 20000, 2, 1f, 1, 0);
							}
							else if (!IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_4, 2))
							{
								if (unk_0xF4244288C3EF3306(unk_0x4A8C381C258A124D(), unk_0xE38610F405049F71(iLocal_535.f_3)))
								{
									unk_0x0B0C9A0F9AAEB7F0(&(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_4), 2);
									func_411(true);
								}
								else
								{
				...
				if (func_412(iLocal_535.f_3))
					if (!func_410(iLocal_535.f_4))
						if (IS_BIT_SET(iLocal_718, 26))
							if (unk_0x9B5C1660CCDF7189(unk_0xC35A3A4C05A4831B(iLocal_535.f_4), joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 1 && unk_0x9B5C1660CCDF7189(unk_0xC35A3A4C05A4831B(iLocal_535.f_4), joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 0)
								unk_0x30CCF17FEE4BDA53(unk_0xC35A3A4C05A4831B(iLocal_535.f_4), unk_0xE38610F405049F71(iLocal_535.f_3), -663.8057f, -952.3882f, 20.2985f, 4, 15f, 802987, 5f, 5f, 0);
				break;
			...
			case 3:
				if (!IS_BIT_SET(iLocal_718, 27))
				{
					if (!unk_0x15CCE8886267624F() && !unk_0x78ABC1D11B34F324())
						...
						unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 27);
				}
				else if (!IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3, 4))
				{
					if (func_399(-649.4202f, -954.0247f, 20.5269f, 90.7653f, true, false, false, false, true, false, 1, false, 0))
					{
						...
						unk_0x64BB72494B9DF6DC(0);
						unk_0xD815D4BD1AE9E85A(0, 1065353216);
						unk_0x0B0C9A0F9AAEB7F0(&(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3), 4);
					}
				}
				break;
			...
			case 4:
				if (!func_410(iLocal_535.f_4))
				{
					if (!IS_BIT_SET(iLocal_718, 29))
					{
						if (func_412(iLocal_535.f_3))
						{
							unk_0x2D864CC37DDFA963(unk_0xC35A3A4C05A4831B(iLocal_535.f_4), unk_0xE38610F405049F71(iLocal_535.f_3), -664.8411f, -952.2484f, 20.283f, 92.0219f, 0, 60f, 1);
							unk_0x10B228D2FDB7AF16(800);
							unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 29);
						}
					}
					else if (!IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3, 5))
					{
						if (unk_0x9B5C1660CCDF7189(unk_0xC35A3A4C05A4831B(iLocal_535.f_4), joaat("SCRIPT_TASK_VEHICLE_PARK")) == 7)
							unk_0x0B0C9A0F9AAEB7F0(&(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3), 5);
					}
				}
				break;
			...
			case 5:
				if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
				{
					...
					else if (!IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3, 6))
					{
						unk_0x0B0C9A0F9AAEB7F0(&(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3), 6);
						unk_0x0B0C9A0F9AAEB7F0(&(Global_2794162.f_853), 4);
						unk_0x8744D2E3FC95740E(&(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_4), 2);
						func_373(unk_0x259BE71D8A81D4FA(), true, 0, 0);
						func_398();
						func_411(false);
						func_35("HLP_TAXI", -1);
						...
						if (func_59())
						{
							func_46(joaat("SERVICE_SPEND_TAXI"), 200, &unk, false, false, false);
						}
						else
						{
							func_395(-200, 0);
			...
			case 6:
				if (!func_410(iLocal_535.f_4))
				{
					if (func_412(iLocal_535.f_3))
					{
						if (unk_0x9B5C1660CCDF7189(unk_0xC35A3A4C05A4831B(iLocal_535.f_4), joaat("SCRIPT_TASK_VEHICLE_DRIVE_WANDER")) != 1 && unk_0x9B5C1660CCDF7189(unk_0xC35A3A4C05A4831B(iLocal_535.f_4), joaat("SCRIPT_TASK_VEHICLE_DRIVE_WANDER")) != 0)
						{
							unk_0x44FB298D6382876D(unk_0xC35A3A4C05A4831B(iLocal_535.f_4), 1);
							unk_0x7C8E9DE09D4AD3FF(unk_0xC35A3A4C05A4831B(iLocal_535.f_4), unk_0xE38610F405049F71(iLocal_535.f_3), 12f, 786599);
		...
		if (IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_4, 1))
		{
			...
			if (!IS_BIT_SET(iLocal_718, 26))
				unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 26);
		}
			...
			if (IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_4, 2))
			{
				...
				else if (func_201(&uLocal_368, 5000, false))
				{
					if (func_181(&uLocal_542, "MPTXIAU", "MPTXI_T1", 12, 0, 0, 1))
						unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 28);
				}
			}
		}
		...
		if (!IS_BIT_SET(iLocal_718, 30))
			if (IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3, 5))
				if (func_181(&uLocal_542, "MPTXIAU", "MPTXI_AR", 12, 0, 0, 1))
					unk_0x0B0C9A0F9AAEB7F0(&iLocal_718, 30);
...
BOOL func_399(float fParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, int iParam10, BOOL bParam11, int iParam12) // Position - 0x160E4
{
	var unk;
	float num;
	float num2;
	...
	if (!func_406(false))
	{
		if (func_405(unk_0x259BE71D8A81D4FA(), true, false) && !(func_404() || func_403()))
		{
			if (bParam9 && func_14(unk_0x259BE71D8A81D4FA(), true, false) && unk_0x3555462DB47B7AB1() && Global_2657704[unk_0x259BE71D8A81D4FA() /*463*/].f_232 == 1)
			{
			}
			else if (func_314() == 28)
			{
	...
	if (!(fParam0 == Global_2672524.f_1026) || !(fParam0.f_1 == Global_2672524.f_1026.f_1) || !(fParam0.f_2 == Global_2672524.f_1026.f_2) || !(fParam3 == Global_2672524.f_1029))
	{
		...
		{
			if (unk_0x775142054EC39277(unk_0x7E3F74F641EE6B27(), Global_2672524.f_1030) < func_402(false))
				return false;
	...
	if (Global_2672524.f_1024)
	{
		...
		if (Global_2672524.f_1031 > -1)
		{
			...
			if (func_400(&(Global_2672524.f_1031), fParam0, fParam3, unk))
			{
				func_407(bParam6, bParam9);
				return true;
			}
...
BOOL func_400(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x165F8
{
...
BOOL func_405(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x16758
{
...
void func_407(BOOL bParam0, BOOL bParam1) // Position - 0x167C0
{
	...
	if (!IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_267.f_31, 14) && !func_409())
		func_408();
...
{
	if (!unk_0x834C960822A4683F() && !func_406(false))
		return false;
...
BOOL func_410(var uParam0) // Position - 0x16876
{
	if (unk_0x2FC2FDC413532977(uParam0))
...
{
	if (bParam0)
		if (!IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139, 15))
			unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139), 15);
	else if (IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139, 15))
		unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139), 15);

	return;
}

BOOL func_412(var uParam0) // Position - 0x168F2
{
	if (unk_0x2FC2FDC413532977(uParam0))
		return !func_413(unk_0xE38610F405049F71(uParam0));

	return false;
}

BOOL func_413(var uParam0) // Position - 0x16912
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
BOOL func_423(BOOL bParam0) // Position - 0x16AD8
{
	if (func_425())
	{
		if (bParam0)
		{
			if (!Global_1836594 && !func_424(unk_0x259BE71D8A81D4FA(), 2))
			{
...
void func_426(BOOL bParam0) // Position - 0x16B3C
{
	...
	if (unk_0x76CD105BCAC6EB9F())
	{
		if (bLocal_724)
		{
			if (IS_BIT_SET(uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/].f_3, 2))
			{
				if (!IS_BIT_SET(iLocal_718, 31))
				{
					func_33(119, 1, -1, 1);
	...
	unk_0xD7B6A43ACC36D868(uLocal_61.f_122, 0);
	...
	unk_0x8744D2E3FC95740E(&(Global_2794162.f_853), 4);
	func_100(false);
	func_63(false);
	func_757();
	...
	unk_0x8744D2E3FC95740E(&(Global_2794162.f_853), 0);
	func_417(false);
	func_416(4, false);
	func_416(1, false);
	func_416(0, false);
	...
	if (unk_0xC450B06E5AAA0985(uLocal_721))
		unk_0xFE54B8568B2ABD12(&uLocal_721);
...
void func_427(var uParam0, var uParam1) // Position - 0x16D5B
{
	if (uParam0.f_1)
		if (unk_0x510D0699BE9C6D06(unk_0x775142054EC39277(unk_0x7E3F74F641EE6B27(), uParam0)) >= 1000)
...
{
	if (bParam0)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139), 5);
	else
		unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139), 5);
...
void func_429(BOOL bParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x16DBA
{
	...
	if (func_734() || !func_733())
	{
		...
		if (num != -1)
		{
			Global_1890739[num /*138*/].f_1 = 0;
			Global_1890739[num /*138*/].f_2 = 0;
			Global_1890739[num /*138*/] = 0;
		}
	}
	...
	if (Global_1927408.f_9 == 4)
		if (func_726(unk_0x259BE71D8A81D4FA()) || func_725(unk_0x259BE71D8A81D4FA()))
			Global_1835476 = 1;
	...
	if (num2 == 0)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_2684820.f_6022), 3);
	else
		unk_0x8744D2E3FC95740E(&(Global_2684820.f_6022), 3);

	if (num != -1 && Global_2683883.f_669.f_10 != 0)
		Global_1890739[unk_0x259BE71D8A81D4FA() /*138*/].f_2 = Global_2683883.f_669.f_10;

	if (func_425() || num != -1 && IS_BIT_SET(Global_1853988[num /*867*/].f_863, 7))
	{
		if (!bParam4)
		{
			Global_4718592 = 2;
	...
	{
		func_700(unk_0x259BE71D8A81D4FA(), 0);
	}
	...
	func_677(false);
	func_676();
	unk_0x8744D2E3FC95740E(&(Global_1853988[num /*867*/].f_863), 7);
	Global_1889942 = 0f;
	Global_1889943 = 0f;
	Global_1836598 = 0;
	Global_1836599 = -1;
	...
	if (func_670())
	{
		...
		else if (Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/] == 0)
		{
			if (Global_1927408.f_9 != -1)
				func_664();
		}
	...
	flag2 = func_18(num);
	Global_1853988[num /*867*/].f_194 = 0;
	...
	if (unk_0x76CD105BCAC6EB9F())
	{
		switch (Global_1927408.f_9)
		{
			...
			case 6:
				...
				unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_863), 1);
				TEXT_LABEL_ASSIGN_STRING(&(Global_2657704[unk_0x259BE71D8A81D4FA() /*463*/].f_226), "", 24);
				Global_2657704[unk_0x259BE71D8A81D4FA() /*463*/].f_223 = { 0f, 0f, 0f };
				func_647(0);
				break;
			...
			case 2:
				...
				if (!func_645() || func_645() && unk_0xD6F9DEE4765092A9(&(Global_2683883.f_33)))
				{
					func_644(Global_1927408.f_17);
					func_643(Global_1927408.f_17);
				}
			
				num3 = Global_1853988[num /*867*/].f_10;
			
				if (num3 != func_143())
					if (unk_0x762604C40829DB72(num3))
						Global_2684820.f_6023 = { func_80(num3) };
					else
						flag3 = true;
				else
					flag3 = true;
			
				if (flag3 && func_645() && unk_0x7F258099B06D4C7C() == 1)
					Global_2684820.f_6023 = { func_642() };
			
				if (Global_4718592.f_1751 > 1 && !func_634() && !func_633(*Global_4718592.f_117591) && !func_632(*Global_4718592.f_117591) && Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_96.f_28 > -1 && Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_96.f_28 < 4)
					func_631(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_96.f_28);
				else
					func_630();
				break;
			...
			case 4:
				...
				if (!IS_BIT_SET(Global_4718592.f_12, 22))
				{
					if (func_614() == -1)
					{
						...
						if (Global_1927408.f_14 > -1)
							unk_0xAFD3BC0F6EBB5474(Global_1927408.f_14, Global_1927408.f_15, 0);
						else if (func_611() > -1)
							func_609(func_611(), false);
					}
					else
					{
						unk_0xAFD3BC0F6EBB5474(func_614(), 0, 0);
					}
				}
				...
				if (func_608())
				{
					...
					if (func_605() != -1)
						Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_96.f_28 = func_605();
			...
			case 9:
				...
				Global_2657704[unk_0x259BE71D8A81D4FA() /*463*/].f_226 = { Global_4718592.f_117878 };
	...
	if (flag || func_725(unk_0x259BE71D8A81D4FA()))
	{
		if (func_578(unk_0x259BE71D8A81D4FA()) || func_726(unk_0x259BE71D8A81D4FA()) || func_725(unk_0x259BE71D8A81D4FA()))
		{
			if (Global_1936361 > 0)
			{
	...
	unk_0x8744D2E3FC95740E(&Global_1836107, 0);
	func_576(false);
	Global_1836376 = 0;
	Global_1836581 = -1;
	Global_1889870 = 0;
	...
	if (func_575() == false)
	{
		...
		{
			if (!func_561(Global_1853988[num /*867*/]) && !func_718() && !flag2 && !func_406(false) && !func_705() && !func_717())
			{
				func_560(true);
				iParam1 == iParam1;
			}
	...
	if (Global_1853988[num /*867*/] != -1)
	{
		iParam2 = iParam2;
	
		if (func_557(Global_1853988[num /*867*/]))
		{
			if (unk_0x261E3728EE56B3AC())
			{
				num5 = func_529(0);
				func_528(1213, -1);
				func_525(joaat("MPPLY_MGAME_CHEAT_END"), num5);
	...
	if (Global_1927408 == 0)
	{
		if (!flag2)
		{
			Global_1853988[num /*867*/].f_10 = -1;
			unk_0x8744D2E3FC95740E(&(Global_1853988[num /*867*/].f_863), 1);
		}
	}
	...
	{
		func_560(false);
		unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[num /*867*/].f_863), 1);
		Global_1853988[num /*867*/].f_10 = func_522(unk_0x259BE71D8A81D4FA());
		unk_0x3D203A4099538B41(0);
		func_378(0, 0, 1);
	...
	if (Global_1853988[num /*867*/] < 10 && Global_1853988[num /*867*/] != -1 && !func_406(false))
		if (!unk_0xD6F9DEE4765092A9(&(Global_1853988[num /*867*/].f_144)) && Global_1853988[num /*867*/] != 5 && Global_1853988[num /*867*/] != 148)
			func_516(&(Global_1853988[num /*867*/].f_144));

	if (Global_1853988[num /*867*/] != 6)
		Global_1927354 = 1;

	Global_1853988[num /*867*/] = -1;
	Global_1853988[num /*867*/].f_36.f_2 = -1;
	Global_1853988[num /*867*/].f_36.f_16 = -1;
	Global_1853988[num /*867*/].f_36.f_1 = -1;
	Global_4718592 = 0;

	if (!flag2)
		func_515(0);

	Global_1853988[num /*867*/].f_36.f_18 = 0;
	unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x383461852896D73D() /*867*/].f_797), 0);
	...
	if (!flag2)
	{
		TEXT_LABEL_ASSIGN_STRING(&(Global_1853988[num /*867*/].f_144), str, 24);
		TEXT_LABEL_ASSIGN_STRING(&(Global_1853988[num /*867*/].f_150), str, 24);
		func_514();
	}

	TEXT_LABEL_ASSIGN_STRING(&Global_1881733[num /*16*/], str, 64);
	TEXT_LABEL_ASSIGN_STRING(&(Global_1853988[num /*867*/].f_164), str, 64);
	Global_1890739[num /*138*/].f_31 = { unk13 };
	Global_1890739[num /*138*/].f_33 = { unk13 };
	Global_1836591 = 0;
	Global_1836592 = 0;
	Global_1836115 = -1;
	flag4 = false;
	...
	if (func_508() && unk_0x834C960822A4683F())
	{
		func_507();
		func_373(unk_0x259BE71D8A81D4FA(), false, 57348, 0);
	}
	...
	else
	{
		...
		if (!IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_863, 1) && !func_745())
		{
			if (unk_0x834C960822A4683F())
			{
				if (func_521())
				...
				else
				{
					if (!IS_BIT_SET(Global_4718592.f_28, 10))
						if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
							Global_2684820.f_2846.f_198 = { unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0) };
	...
	if (func_476(116, &num6))
		func_475(num6);

	if (func_476(123, &num6))
		func_475(num6);
...
void func_430(BOOL bParam0) // Position - 0x180CC
{
	...
	if (!func_455(unk_0x259BE71D8A81D4FA()) && !IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_863, 17))
		func_454();
...
BOOL func_453() // Position - 0x18727
{
	...
	for (i = 0; i < 6; i = i + 1)
	{
		if (!unk_0xD6F9DEE4765092A9(&Global_4718592.f_117906[i /*6*/]))
			num = 0;
	}
...
BOOL func_455(int iParam0) // Position - 0x18775
{
	int num;
...
{
	unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_96.f_32), 5);
	return;
}
...
{
	if (iParam0 == 1)
		Global_2672524.f_3537 = unk_0x7E3F74F641EE6B27();
...
void func_470() // Position - 0x18A82
{
	...
	{
		unk.f_6 = 32;
		Global_2657704[unk_0x259BE71D8A81D4FA() /*463*/].f_126 = { unk };
	}
...
int func_472(BOOL bParam0, BOOL bParam1) // Position - 0x18B01
{
	var unk;
	int i;
	int num;
...
{
	return Global_2656952[unk_0x259BE71D8A81D4FA() /*10*/];
}
...
void func_475(int iParam0) // Position - 0x18BAB
{
	...
	unk_0x2BC0725CAF2E0D6B(Global_2756094[iParam0 /*5*/], Global_2756094[iParam0 /*5*/].f_1, Global_2756094[iParam0 /*5*/].f_2, Global_2756094[iParam0 /*5*/].f_3, Global_2756094[iParam0 /*5*/].f_4);
...
BOOL func_476(int iParam0, var uParam1) // Position - 0x18C78
{
	int i;

	for (i = 0; i < 2; i = i + 1)
	{
		if (Global_2756094[i /*5*/] == iParam0)
		{
			*uParam1 = i;
			return true;
		}
...
{
	return IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139, 18);
}
...
void func_482() // Position - 0x18DF0
{
	...
	if (num >= 0)
		unk_0x8744D2E3FC95740E(&(Global_1853988[num /*867*/].f_96.f_32), 6);
...
{
	unk_0x8744D2E3FC95740E(&Global_2683883, 21);
	return;
}
...
{
	unk_0x0B0C9A0F9AAEB7F0(&Global_2683883, 21);
	return;
}
...
void func_494(int iParam0) // Position - 0x18ED3
{
	...
	Global_2657704[unk_0x259BE71D8A81D4FA() /*463*/].f_222 = iParam0;
	return;
}
...
{
	unk_0x8744D2E3FC95740E(&Global_2683883, 4);
	return;
}

void func_513() // Position - 0x19043
{
	unk_0x8744D2E3FC95740E(&Global_2683883, 28);
	return;
}
...
void func_514() // Position - 0x19055
{
	...
	num = unk_0x259BE71D8A81D4FA();
	unk_0x8744D2E3FC95740E(&(Global_1853988[num /*867*/].f_11.f_1), 4);
	unk_0x8744D2E3FC95740E(&(Global_1853988[num /*867*/].f_11.f_1), 5);
	unk_0x8744D2E3FC95740E(&(Global_1853988[num /*867*/].f_11.f_1), 7);
	unk_0x8744D2E3FC95740E(&(Global_1853988[num /*867*/].f_11.f_1), 8);
	unk_0x8744D2E3FC95740E(&(Global_1853988[num /*867*/].f_11.f_1), 9);
	unk_0x8744D2E3FC95740E(&(Global_1853988[num /*867*/].f_11.f_1), 10);
	unk_0x8744D2E3FC95740E(&(Global_1853988[num /*867*/].f_11.f_1), 11);
	unk_0x8744D2E3FC95740E(&(Global_1853988[num /*867*/].f_11.f_1), 12);
	unk_0x8744D2E3FC95740E(&(Global_1853988[num /*867*/].f_11.f_1), 13);
	return;
}

void func_515(int iParam0) // Position - 0x1910B
{
...
BOOL func_518() // Position - 0x19182
{
	...
	if (Global_1853988[num /*867*/].f_36.f_2 == 63 || Global_1853988[num /*867*/].f_36.f_2 == 62 || Global_1853988[num /*867*/].f_36.f_2 == 61)
		return true;
...
{
	return func_199("FM_RETRY_INV" /*Press ~INPUT_FRONTEND_X~ to replay the Job. Press ~INPUT_FRONTEND_CANCEL~ to start a random Job. More than half the players have to agree.*/);
}
...
void func_525(int iParam0, int iParam1) // Position - 0x19246
{
	...
	num = num + iParam1;
	func_526(iParam0, num);
	return;
}

void func_526(int iParam0, int iParam1) // Position - 0x19265
{
	int num;
...
int func_527(int iParam0) // Position - 0x19281
{
	int num;
	int num2;
...
{
	if (Global_1836618 || Global_1836587 || func_260(unk_0x259BE71D8A81D4FA(), 0) || func_259())
		return true;
...
BOOL func_541(int iParam0, int iParam1) // Position - 0x1955E
{
...
BOOL func_542(int iParam0) // Position - 0x1957E
{
	int num;
...
{
	if (bParam0)
		if (!IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_863, 2))
			unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_863), 2);
	else if (IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_863, 2))
		unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_863), 2);
...
{
	unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_96.f_32), 1);
	return;
}
...
int func_567(int iParam0) // Position - 0x19A31
{
	...
	if (unk_0xD6F9DEE4765092A9(&(Global_4718592.f_117878)))
		return 1;
	...
	if (iParam0 == 0)
	{
		...
		unk_0xCBF0312D1370143F(unk, "quit", Global_1927367);
		unk_0xCBF0312D1370143F(unk, "quitd", 1);
		unk_0xCBF0312D1370143F(unk, "ply", Global_1927367.f_2);
		unk_0xCBF0312D1370143F(unk, "lp", unk_0x39D1D336459711BE());
	}
	else if (iParam0 == 1 || iParam0 == 4)
	{
		Global_1927392.f_1 = Global_1927392.f_1 + 1;
		unk_0xCBF0312D1370143F(unk, "quit", Global_1927392.f_1);
		unk_0xCBF0312D1370143F(unk, "quitd", 1);
		unk_0xCBF0312D1370143F(unk, "ply", Global_1927392.f_4);
		unk_0xCBF0312D1370143F(unk, "lp", unk_0x39D1D336459711BE());
	}

	if (iParam0 == 0)
	{
		if (unk_0x18EEF6291DBCAC51(&(Global_4718592.f_117878), 0f, func_569(iParam0), 0))
		{
		}
	}
	else if (iParam0 == 1 || iParam0 == 4)
	{
		if (unk_0x18EEF6291DBCAC51(&(Global_1048576.f_44), 0f, func_569(iParam0), 0))
		{
		}
	}
...
void func_580(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9) // Position - 0x19D7A
{
	...
	switch (Global_1927408.f_9)
	{
		...
		case 3:
			if (Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/] == 0 || Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/] == 1)
				func_592(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_96.f_28);
		...
		case 4:
			...
			if (func_725(unk_0x259BE71D8A81D4FA()) || func_726(unk_0x259BE71D8A81D4FA()))
				func_588(1);
			...
			unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_863), 1);
			break;
	...
	Global_2657704[unk_0x259BE71D8A81D4FA() /*463*/].f_223 = { Global_1927408.f_23 };
	Global_2657704[unk_0x259BE71D8A81D4FA() /*463*/].f_226 = { uParam4 };
	return;
}

void func_581() // Position - 0x1A08D
{
	unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_36.f_18), 23);
	return;
}

void func_582() // Position - 0x1A0AA
{
	unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_36.f_18), 12);
	return;
}
...
{
	return IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_36.f_18, 24);
}
...
int func_593() // Position - 0x1A1A6
{
	...
	if (!unk_0xA8F635A578C0CE07(&(Global_2684820.f_6641), 13))
		return 0;

	num2 = unk_0x259BE71D8A81D4FA();

	for (i = 0; i < 32; i = i + 1)
	{
		num = unk_0xB23E0F9B63D009A8(i);
	
		if (unk_0x762604C40829DB72(num) && num != num2)
		{
			unk = { func_80(num) };
		
			if (unk_0xD43ED7463CB7671C(&unk, &(Global_2684820.f_6641)) && func_595(num))
			{
				func_594();
				return 1;
			}
...
{
	unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_36.f_18), 9);
	return;
}

BOOL func_595(int iParam0) // Position - 0x1A243
{
	return IS_BIT_SET(Global_1853988[iParam0 /*867*/].f_36.f_18, 9);
}

void func_596() // Position - 0x1A25B
{
	Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_5 = 0;
	return;
}
...
void func_643(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x1A940
{
	...
	Global_4593987 = unk;
	Global_4593988 = unk_0x1DD05E817C89C737() + 60000;
	return;
}
...
void func_655(int iParam0, int iParam1) // Position - 0x1AAAC
{
...
{
	unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_36.f_18), 14);
	return;
}
...
int func_664() // Position - 0x1ABAD
{
	...
	if (unk_0x18EEF6291DBCAC51(&(Global_4718592.f_117878), -1f, func_569(0), 0))
	{
	}
...
BOOL func_668(int iParam0) // Position - 0x1ACAF
{
	switch (func_19())
	{
		case 0:
...
void func_673(int iParam0) // Position - 0x1AD43
{
...
void func_678() // Position - 0x1ADC0
{
	Global_1889949 = -1;
	Global_1889950 = -1;
	Global_2657704[unk_0x259BE71D8A81D4FA() /*463*/].f_461 = -1;
	Global_1889955 = 0;
	return;
}
...
{
	return func_682(unk_0x4A8C381C258A124D());
}

BOOL func_682(var uParam0) // Position - 0x1AE5B
{
	int num;
	int num2;
...
void func_683(int iParam0, int iParam1, int iParam2) // Position - 0x1AF2B
{
	if (iParam2 == -1)
		iParam2 = func_30();
...
void func_687(var uParam0) // Position - 0x1B026
{
	if (uParam0->f_9 != 0)
	{
...
void func_690(BOOL bParam0) // Position - 0x1B0F7
{
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		Global_1927434[i /*42*/].f_1 = func_143();
...
BOOL func_691() // Position - 0x1B1C4
{
	...
	for (i = 0; i < 32; i = i + 1)
	{
		if (Global_1927434[i /*42*/].f_1 != func_143())
...
void func_700(var uParam0, int iParam1) // Position - 0x1B787
{
	int num;
...
{
	if (bParam0)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_11.f_1), 0);
	else
		unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_11.f_1), 0);
...
{
	if (unk_0x76CD105BCAC6EB9F() && !Global_1575038 && !Global_1575039)
		if (Global_2684820.f_3478 != 0 && Global_2684820.f_3478.f_1 != 0 && Global_2684820.f_3478.f_2 != 0 && Global_2684820.f_3478.f_3 != 0)
			unk_0x7B6C12F588333BA9(Global_2684820.f_3478, Global_2684820.f_3478.f_1, Global_2684820.f_3478.f_2, Global_2684820.f_3478.f_3, iParam0);
...
void func_715() // Position - 0x1BBF3
{
	...
	unk_0x41D32B3516729590(Global_4718592, &(Global_4718592.f_117878), unk, unk2, Global_1057161.f_1);
	func_716();
	return;
}
...
{
	if (func_351() && unk_0x834C960822A4683F())
		return true;
...
void func_731(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1BEE5
{
	...
	if (bParam0)
	{
		...
		{
			Global_1890739[unk_0x259BE71D8A81D4FA() /*138*/].f_2 = 0;
			Global_1890739[unk_0x259BE71D8A81D4FA() /*138*/] = 0;
		}
	}
...
{
	unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_96.f_32), 11);
	return;
}

void func_736() // Position - 0x1BFFF
{
	unk_0x8744D2E3FC95740E(&(Global_1890739[unk_0x259BE71D8A81D4FA() /*138*/].f_29), 3);
	return;
}
...
{
	if (unk_0xBCF87EE3DC296C2A(unk_0xBF03D0685ADC793B()) != Global_1665570)
	{
		if (unk_0xBF03D0685ADC793B() == 0 && Global_1665570 == 3)
			Global_1665570 = unk_0xBCF87EE3DC296C2A(0);
	
		unk_0x07938654FF332D78(unk_0xBF03D0685ADC793B(), Global_1665570);
	}
	...
	if (num != -1)
		if (bParam0)
			if (!IS_BIT_SET(Global_1853988[num /*867*/].f_199, 0))
				unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[num /*867*/].f_199), 0);
		else if (IS_BIT_SET(Global_1853988[num /*867*/].f_199, 0))
			unk_0x8744D2E3FC95740E(&(Global_1853988[num /*867*/].f_199), 0);
...
{
	unk_0x8744D2E3FC95740E(&(Global_2683883.f_2), 31);
	return;
}
...
{
	unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_36.f_18), 20);
	return;
}
...
{
	unk_0x8744D2E3FC95740E(&(Global_2794162.f_853), 3);
	return;
}
...
void func_758(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1C2F6
{
	...
	func_258(false, true, true, 0, false, bParam2, false);
	func_764();
	func_210(12, false, -1);
	func_211(1);
	unk_0xD7C0EA10993D3214(0, -1);
	...
	if (func_127() == false && func_762() == false && bParam1 && !func_262(unk_0x259BE71D8A81D4FA()) && !unk_0x787F8EE1F6FBDC6D() && func_341())
		func_373(unk_0x259BE71D8A81D4FA(), true, 0, 0);
...
void func_759() // Position - 0x1C3C8
{
	...
	if (unk_0x76CD105BCAC6EB9F() && func_202(&Global_2803710))
	{
		if (!func_201(&Global_2803710, 3500, true) || unk_0xCF580EB76CEC15FD(unk_0x259BE71D8A81D4FA()))
		{
			if (!func_761())
			{
				if (unk_0x15CCE8886267624F())
				{
					func_354(&Global_2803710, true, false);
				}
				else if (!func_260(unk_0x259BE71D8A81D4FA(), 0))
				{
					if (unk_0x9B5C1660CCDF7189(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_PARACHUTE")) != 1 && unk_0x9B5C1660CCDF7189(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_PARACHUTE")) != 0 && unk_0x57E7FD3BD6BB28C0(unk_0x4A8C381C258A124D()) == -1 || Global_2803780)
					{
...
{
	if (IS_BIT_SET(Global_2803714, iParam0) && unk_0x76CD105BCAC6EB9F())
	{
		if (!func_201(&Global_2803715[iParam0 /*2*/], 3500, true) || unk_0xCF580EB76CEC15FD(iParam0))
		{
			if (!func_761())
			{
				if (unk_0x15CCE8886267624F())
				{
					func_354(&Global_2803715[iParam0 /*2*/], true, false);
				}
		...
		else
		{
			...
			unk_0x8744D2E3FC95740E(&Global_2803714, iParam0);
		}
	}
...
void func_765(BOOL bParam0) // Position - 0x1C64B
{
	...
	num = func_802(unk_0x259BE71D8A81D4FA(), bParam0);
...
void func_775(BOOL bParam0, BOOL bParam1) // Position - 0x1CE0F
{
	...
	if (bParam0)
		if (func_651(0) > 1)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_2794162.f_1835), 10);
...
BOOL func_778(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1CFA0
{
	...
	if (Global_262145.f_8317 == 1)
	{
		...
		if (func_780(unk_0x259BE71D8A81D4FA(), 85))
...
BOOL func_780(int iParam0, int iParam1) // Position - 0x1D168
{
	if (!func_773())
		return false;
...
void func_785(int iParam0, BOOL bParam1) // Position - 0x1D3C1
{
	...
	if (iParam0 != -1)
	{
		...
		num2 = num / 32;
		num = num % 32;
		unk_0x0B0C9A0F9AAEB7F0(&Global_1836851[num2], num);
	}
...
BOOL func_786() // Position - 0x1D45A
{
	...
	if (func_790(unk_0x259BE71D8A81D4FA()))
		return true;
...
void func_787(BOOL bParam0) // Position - 0x1D48C
{
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139, 25))
		{
			func_788(unk_0x259BE71D8A81D4FA(), 12);
			unk_0x0B0C9A0F9AAEB7F0(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139), 25);
		}
	}
	else if (IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139, 25))
	{
		unk_0x8744D2E3FC95740E(&(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_139), 25);
	}
...
BOOL func_790(int iParam0) // Position - 0x1D54A
{
	if (func_770())
		return true;
	...
	return IS_BIT_SET(Global_1853988[iParam0 /*867*/].f_139, 25);
}
...
BOOL func_791() // Position - 0x1D576
{
	...
	{
		if (!IS_BIT_SET(Global_2794162.f_1831, 6))
			unk_0x0B0C9A0F9AAEB7F0(&(Global_2794162.f_1831), 6);
...
{
	return IS_BIT_SET(Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_143, 7);
}
...
BOOL func_805() // Position - 0x1E2A4
{
	...
	if (func_806() != 0)
		if (unk_0x486FF5D06E9659F1(func_806()) == 0)
			return true;
...
BOOL func_808(int iParam0) // Position - 0x1E36A
{
...
void func_811(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x1E39A
{
	...
	func_816(0, -1, false);
	unk_0x6F4A865F87C7A3AD(&iLocal_535, 7, 0);
	unk_0x7B13DC83218D9AF5(&uLocal_707, 11, 0);
	Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/] = 16;
	...
	func_814();
	func_812();
	uLocal_707[unk_0xAE032CEDCF23C6D5() /*5*/] = 0;
	return;
}
...
{
	unk_0xB5396F1FB088FE38(&uLocal_720);
	unk_0x092B9247AF00F5CF(0, 0, 0);
	unk_0xCD76801E1106CABE(0, 17.0693f, -1115.9354f, 28.7968f, 0);
	unk_0x93C0674FC00824D0(uLocal_720);
	return;
}

BOOL func_815() // Position - 0x1E597
{
	int num;

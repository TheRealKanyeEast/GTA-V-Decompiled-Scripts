...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (unk_0xFC8BFE4B41177C22(uLocal_83) && !unk_0x1C2F771CDC87A3A5(uLocal_83, 0))
		{
			...
			{
				case 0:
					if (func_160(iLocal_98) || func_162(iLocal_92, 16) && !func_162(iLocal_92, 524288))
					{
						iLocal_96 = -1;
						func_148();
						func_155(1);
				...
				case 3:
					...
					if (!func_160(iLocal_98))
					{
						if (!func_162(iLocal_92, 8))
						{
							...
							if (unk_0x1B79E937E91F40C3(&(Global_100833.f_3), &uLocal_67))
							{
								uLocal_67 = { uLocal_51 };
								flag2 = false;
							}
					...
					else
					{
						...
						if (!func_140(3) && !Global_100867)
						{
							...
							{
								if (!func_162(iLocal_92, 1) || !unk_0xFC8BFE4B41177C22(func_139()) && !Global_100867)
								{
									func_155(10);
									break;
								}
				...
				case 6:
					...
					if (!unk_0xF40767E41852FB72(iLocal_50))
					{
						...
						if (iLocal_97 != -1)
						{
							if (func_162(Global_112460, 0))
							{
								unk_0x375B1B37EF136A49(func_22(iLocal_97), 0, Global_100870, 0);
...
void func_6(char* sParam0, int iParam1, var uParam2, int iParam3, int iParam4) // Position - 0xAB8
{
	...
	if (unk_0xDCE96FB47C1D0314(sParam0, &Global_97883, 0, -1) != 0)
		return;

	unk_0x1A6EB10909EB6840(sParam0, iParam1, uParam2, iParam3, iParam4, Global_94990);
...
void func_20(char* sParam0, int iParam1, int iParam2) // Position - 0xD24
{
	...
	unk_0x048963DA591ECAAF(sParam0, iParam1, iParam2, func_21(false));
	return;
}

BOOL func_21(BOOL bParam0) // Position - 0xD65
{
...
void func_53() // Position - 0x57F3
{
	...
	if (func_110(iLocal_285.f_3, iLocal_285, true, true, true, true, false) || unk_0x3555462DB47B7AB1())
	{
		...
		if (func_1("PLAY_BASEJUMP_S" /*Approach the helicopter and press ~INPUT_ENTER~ to start parachuting.*/))
			unk_0x428C32CC68809A35(1);
		...
		if (!unk_0xFC8BFE4B41177C22(iLocal_285.f_3))
		{
			if (unk_0x6252BC0DD8A320DB(func_108(iLocal_119)) && unk_0xFC8BFE4B41177C22(iLocal_285) && unk_0xD9F5E1FEFD1329E4(iLocal_285, 0))
			{
				...
				if (!unk_0x4FAFF4BCB7633475(iLocal_285.f_3))
				{
					...
					func_106();
					unk_0x397CF4F4C8B17365(iLocal_285.f_3, func_105(iLocal_119));
					func_103(&uLocal_120, 0, iLocal_285.f_3, func_104(iLocal_119), 1, 1);
	...
	if (unk_0xCECDBB848D53DEB2(unk_0x4A8C381C258A124D(), iLocal_285, 1) && !unk_0x49CB27F641DC1328(unk_0x4A8C381C258A124D()) && func_79(iLocal_285.f_3, iLocal_285))
	{
		...
		if (num2 < 0f || num2.f_1 < 1f)
		{
			...
			if (bLocal_457)
			{
				if (func_1("PLAY_BASEJUMP_B" /*Approach the helicopter and press ~INPUT_ENTER~ to start parachuting.*/) || func_1("PLAY_BASEJUMP_S" /*Approach the helicopter and press ~INPUT_ENTER~ to start parachuting.*/))
					unk_0x428C32CC68809A35(1);
	...
	if (!flag)
	{
		...
		{
			if (!bLocal_457 || iLocal_119 == 3 && !func_1("PLAY_BASEJUMP_B" /*Approach the helicopter and press ~INPUT_ENTER~ to start parachuting.*/) || iLocal_119 != 3 && !func_1("PLAY_BASEJUMP_S" /*Approach the helicopter and press ~INPUT_ENTER~ to start parachuting.*/))
			{
				if (iLocal_119 == 3)
					if (!Global_75816)
...
BOOL func_74(int iParam0) // Position - 0x672C
{
	int num;
...
BOOL func_75(int iParam0) // Position - 0x674E
{
...
int func_77(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x679B
{
	int num;
...
BOOL func_79(var uParam0, int iParam1) // Position - 0x67F1
{
...
int func_80(var uParam0, int iParam1) // Position - 0x684E
{
...
BOOL func_86(int iParam0, int iParam1) // Position - 0x6C86
{
...
void func_93() // Position - 0x6EC1
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_96(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_94(num) && !func_142(14) || Global_112760)
			{
...
int func_95(var uParam0) // Position - 0x6FCA
{
	int i;
	int num;
...
int func_97(int iParam0) // Position - 0x702C
{
...
char* func_101(int iParam0) // Position - 0x713F
{
	...
	flag = func_95(unk_0x4A8C381C258A124D()) == 1;
...
void func_103(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x7218
{
...
void func_107(var uParam0, int iParam1) // Position - 0x7348
{
...
int func_110(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x75BC
{
	var unk;
	float num;
...
float func_111(var uParam0, int iParam1) // Position - 0x77AB
{
	return func_112(unk_0x56E414973C2A8C0E(unk_0xB6B621402486C3E4()), uParam0, iParam1);
}

float func_112(var uParam0, var uParam1, int iParam2) // Position - 0x77C3
{
	var unk;
	var unk4;
...
void func_117(var uParam0) // Position - 0x7981
{
	int num;
...
void func_118(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x79D8
{
	int i;
...
BOOL func_119(int iParam0) // Position - 0x7B03
{
	return false;
}
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_137() || Global_112857 || Global_32286 || func_136() || func_122(8, -1) || func_135() || func_134() || func_133() || func_124() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_137() || Global_32286 || func_136() || func_122(8, -1) || func_133() || func_135() || func_134() || func_124() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_137() || Global_112857 || Global_32286 || func_136() || func_122(8, -1) || func_133() || func_135() || func_134() || func_124() || Global_113810.f_7691.f_919[num] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_137() || Global_112857 || Global_32286 || func_136() || func_122(8, -1) || func_135() || func_134() || func_124() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
				
					case 4:
						if (func_137() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_122(8, -1) || func_124() || func_132() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;

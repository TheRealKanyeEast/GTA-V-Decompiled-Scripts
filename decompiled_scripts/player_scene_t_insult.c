	...
	if (unk_0x5266F1D2AEF6F73A(Global_98143))
	{
		...
		if (!unk_0xD6F9DEE4765092A9(&uLocal_724))
		{
			if (!bLocal_729)
			{
				...
				else if (func_3(&uLocal_70, "PRSAUD", &uLocal_724, 3, 0, 0, 0))
				{
					bLocal_729 = true;
				}
			}
...
int func_18(var uParam0) // Position - 0x93F
{
	int i;
	int num;
...
int func_20(int iParam0) // Position - 0x9A1
{
		...
		switch (iLocal_239[iParam1])
		{
			case 0:
				if (unk_0x13CCB1AD131C1082(uParam0, &uLocal_344, &uLocal_393[iParam1 /*16*/], 2))
				{
					...
					{
						num3 = unk_0xBD3B265153D3BA2D(Global_98143);
				...
				else
				{
					...
					else
					{
						...
						if (iLocal_255[0] == joaat("p_trev_rope_01_s") || iLocal_255[1] == joaat("p_trev_rope_01_s"))
						{
							...
							unk_0xD25E9BDC14A0B649(iLocal_236[iParam1], unk_0xF8A78594664D23A6(iLocal_236[iParam1]), 0);
							...
							for (i = 0; i < iLocal_252; i = i + 1)
							{
								...
								unk_0x918FE23DCE5B8322(iLocal_252[i], 0);
							}
						}
...
void func_27(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x15E2
{
...
BOOL func_28(var uParam0) // Position - 0x167D
{
	int i;
...
BOOL func_29(var uParam0) // Position - 0x1719
{
	int i;
	float num;
...
void func_33(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x182B
{
...
int func_35(var uParam0, var uParam1, char* sParam2, var uParam3, var uParam4) // Position - 0x1A33
{
		...
		if (unk_0x5266F1D2AEF6F73A(Global_98143))
		{
			for (i = 0; i < iLocal_236; i = i + 1)
			{
				if (!unk_0x4FAFF4BCB7633475(iLocal_236[i]))
				{
					...
					unk_0x3DA436E63AB0F541(iLocal_236[i], Global_98143, &uLocal_344, &uLocal_393[i /*16*/], 1000f, num, num2, num3, num4, num5);
					iLocal_239[i] = 0;
				}
			}
			...
			for (i = 0; i < iLocal_252; i = i + 1)
			{
				if (unk_0xFC8BFE4B41177C22(iLocal_252[i]))
					if (!unk_0xD6F9DEE4765092A9(&uLocal_558[i /*16*/]))
						unk_0x381D671BCFC294D9(iLocal_252[i], Global_98143, &uLocal_558[i /*16*/], &uLocal_344, 8f, -1000f, 0, 1148846080);
			}
...
BOOL func_38() // Position - 0x1C61
{
	...
	if (unk_0x5266F1D2AEF6F73A(Global_98142))
	{
		...
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_236[i]))
				unk_0x3DA436E63AB0F541(iLocal_236[i], Global_98142, &uLocal_344, &uLocal_360[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
		}
		...
		for (i = 0; i < iLocal_252; i = i + 1)
		{
			if (unk_0xFC8BFE4B41177C22(iLocal_252[i]))
				if (!unk_0xD6F9DEE4765092A9(&uLocal_525[i /*16*/]))
					unk_0x381D671BCFC294D9(iLocal_252[i], Global_98142, &uLocal_525[i /*16*/], &uLocal_344, 8f, -1000f, 0, 1148846080);
		}
	
		if (!unk_0xD6F9DEE4765092A9(&uLocal_724))
		{
			func_27(&uLocal_70, 2, unk_0x4A8C381C258A124D(), "TREVOR", 0, 1);

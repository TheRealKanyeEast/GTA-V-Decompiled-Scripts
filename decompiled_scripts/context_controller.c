...
void func_1() // Position - 0x457
{
	...
	if (bLocal_95)
	{
		...
		unk_0xAC98CA65AD9A3215(&uLocal_97);
	
		if (bLocal_96)
		{
			unk_0x60D332F23943B34F(&uLocal_101);
		}
		else
		{
			unk_0xACF853FB3F6EA7D4(&Global_44318);
			unk_0xACF853FB3F6EA7D4(&uLocal_101);
		}
...
int func_6(int iParam0, BOOL bParam1, int iParam2) // Position - 0x561
{
	...
	if (num != func_7() && Global_1895156[num /*609*/].f_10.f_429 == iParam2)
		return 1;
...
BOOL func_8(int iParam0, int iParam1) // Position - 0x5C7
{
	if (func_9(iParam0))
...
void func_11(var uParam0) // Position - 0x665
{
	...
	for (i = 0; i < 6; i = i + 1)
	{
		if (Global_44123[i /*32*/] && Global_44123[i /*32*/].f_4)
		{
			...
			{
				if (!unk_0xF40767E41852FB72(Global_44123[i /*32*/].f_31))
				{
					if (*uParam0 > -1)
						func_12();
...
void func_27() // Position - 0xB61
{
	if (!unk_0x3555462DB47B7AB1() && !func_33())
	{
		if (func_32(false))
		{
			if (!unk_0xD6F9DEE4765092A9(&(Global_2683883.f_785.f_12)))
			{
				func_31();
				func_28(6, false, 0);
			}
	...
	if (Global_1835457 != -1)
	{
			...
			if (bLocal_118)
			{
				...
				else
				{
					if (unk_0xA44A2B8A83947D02())
						TEXT_LABEL_ASSIGN_STRING(&Global_2359296[func_40() /*5568*/].f_5391.f_18[Global_1835457 /*6*/], unk_0x6E4BB594E2A075CC(&unk[0 /*13*/]), 24);
		...
		else if (unk_0x0BA1A956D36B210F() || func_38())
		{
			if (func_37(unk[0 /*13*/]))
			{
				...
				{
					case 0:
						iLocal_120 = unk_0x310461CE0659232F(&unk, 1);
					...
					case 1:
						num = unk_0xD61DBE5217500D72(iLocal_120, &unk15, 1);
		...
		{
			if (func_37(unk[0 /*13*/]))
				TEXT_LABEL_ASSIGN_STRING(&Global_2359296[func_40() /*5568*/].f_5391.f_18[Global_1835457 /*6*/], unk_0x0CA8AE01D86E1FDC(&unk[0 /*13*/]), 24);

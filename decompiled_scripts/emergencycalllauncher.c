...
int func_23(var uParam0) // Position - 0xA5C
{
	int i;
	int num;
...
int func_25(int iParam0) // Position - 0xABE
{
...
BOOL func_32(BOOL bParam0) // Position - 0xC6A
{
...
{
	Global_32509 = true;
	TEXT_LABEL_ASSIGN_STRING(&Global_32510, unk_0x1AF90EB93E0012D6(), 32);
	return;
}

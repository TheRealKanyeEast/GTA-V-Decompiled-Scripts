...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (unk_0x76CD105BCAC6EB9F() && func_1(unk_0x259BE71D8A81D4FA(), true, true) && !Global_1836387 && Global_32283 == 0)
			func_113();
...
void func_5(int iParam0) // Position - 0x339
{
	...
	{
		unk_0x0B0C9A0F9AAEB7F0(&Global_32534, iParam0);
		Global_32537 = 1;
		func_6();
	}
...
void func_9() // Position - 0x3F6
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_12(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_10(num) && !func_15(14) || Global_112760)
			{
...
BOOL func_18(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x63A
{
	...
	unk48 = unk_0x14C30F326F5883DA(func_19(unk_0x259BE71D8A81D4FA()) + { 1f, 0f, 0f }, uParam1, 87, unk_0x4A8C381C258A124D(), 0);
...
void func_31(int iParam0, BOOL bParam1) // Position - 0xBD2
{
	if (bParam1)
	{
		unk_0x0B0C9A0F9AAEB7F0(&Global_32533, iParam0);
		func_5(iParam0);
	}
	else
	{
		unk_0x8744D2E3FC95740E(&Global_32533, iParam0);
	}
...
void func_39() // Position - 0xFFF
{
	...
	switch (iLocal_60)
	{
		...
		case 5:
			...
			unk = { func_19(unk_0x259BE71D8A81D4FA()) };
...
BOOL func_83(var uParam0, int iParam1, BOOL bParam2) // Position - 0x27DA
{
	int i;
	var unk;
	int num;
	...
	for (i = 0; func_84(iParam1, i, &unk, &num); i = i + 1)
	{
...
BOOL func_84(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x2848
{
...
BOOL func_106(int iParam0, int iParam1) // Position - 0x3BC7
{
	if (IS_BIT_SET(Global_32535, iParam0))
	{
		if (iParam1 != 0)
		{
			...
			{
				unk_0x8744D2E3FC95740E(&Global_32535, iParam0);
				bLocal_91 = true;
				return true;
			}
			else

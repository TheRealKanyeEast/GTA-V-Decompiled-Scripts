...
void func_1() // Position - 0x122B
{
	...
	if (unk_0xBD3B265153D3BA2D(uLocal_214) > fLocal_215 && bLocal_181)
	{
		...
		if (iLocal_47 == 1)
		{
			...
			func_2(0, func_43(), true);
		}
		else if (iLocal_47 == 2)
		{
			func_13(func_43(), 1, iLocal_187);
			func_2(14, func_43(), true);
		}
...
void func_2(int iParam0, int iParam1, BOOL bParam2) // Position - 0x160E
{
	int num;
...
int func_5(int iParam0, int iParam1) // Position - 0x170D
{
...
int func_13(int iParam0, int iParam1, int iParam2) // Position - 0x1C14
{
	...
	return func_14(func_42(iParam0), 0, iParam1, iParam2, false);
}
...
char* func_18(int iParam0) // Position - 0x269D
{
	switch (iParam0)
	{
		case 0:
...
void func_20(int iParam0, int iParam1, int iParam2) // Position - 0x27AD
{
	if (iParam2 == -1)
		iParam2 = func_7();
...
void func_44() // Position - 0x2EB8
{
	...
	{
		if (func_47(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_46(unk_0x4A8C381C258A124D());
		
			if (func_45(num) && !func_38(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != num && func_45(Global_113810.f_2366.f_539.f_4321))
...
BOOL func_45(int iParam0) // Position - 0x2FB5
{
	return iParam0 < 3;
}

int func_46(var uParam0) // Position - 0x2FC1
{
	int i;
	int num;
...
int func_48(int iParam0) // Position - 0x3023
{
...
BOOL func_57(BOOL bParam0) // Position - 0x3382
{
...
var func_81(var uParam0) // Position - 0x4DB5
{
	return uParam0;
}
...
void func_82(int iParam0, var uParam1) // Position - 0x4DBF
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_83(iParam0) && unk_0x486FF5D06E9659F1(Global_91601[26 /*34*/].f_6) == 0)
			{
				Global_113810.f_7264[iParam0] = 1;
				unk_0xEBB2809684978887(uParam1->f_5, Global_113810.f_7264[iParam0], 1, 1);
			}
...
int func_107(var uParam0) // Position - 0x8AEA
{
	int num;
...
int func_112(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8DFD
{
	return func_113(uParam0, !bParam1, bParam2);
}

int func_113(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8E10
{
	int num;
...
BOOL func_122(int iParam0, int iParam1) // Position - 0x9399
{
...
void func_141(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x9940
{
	if (bParam0)
	{
...
BOOL func_145(int iParam0) // Position - 0x9B41
{
	int num;
...
BOOL func_146(int iParam0) // Position - 0x9B63
{
...
int func_148(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x9BB0
{
	int num;
...
void func_153() // Position - 0x9F70
{
	if (!unk_0x1C2F771CDC87A3A5(uLocal_173, 0))
	{
		...
		{
			unk_0xD25E9BDC14A0B649(uLocal_173, 0, 0);
				...
				if (SYSTEM::TIMERA() > 14100)
				{
					...
					if (unk_0xD9F5E1FEFD1329E4(uLocal_173, 0))
					{
						if (!unk_0x4FAFF4BCB7633475(iLocal_112[0]))
						{
							...
							unk_0xEBA229B2E0BB05E0(0, uLocal_173, -1, 0, 2f, 1, 0);
							unk_0x93C0674FC00824D0(uLocal_150);
						...
						if (!unk_0x4FAFF4BCB7633475(iLocal_112[1]))
						{
							...
							unk_0xB5396F1FB088FE38(&uLocal_150);
							unk_0x84B06A81C98DA4B8(0);
							unk_0xEBA229B2E0BB05E0(0, uLocal_173, -1, 1, 2f, 1, 0);
							unk_0x93C0674FC00824D0(uLocal_150);
...
Vector3 func_157(var uParam0) // Position - 0xA6B8
{
...
{
	switch (func_165(&Global_32343, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
int func_171(var uParam0, BOOL bParam1, int iParam2) // Position - 0xB30B
{
	int num;
...
void func_176(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xB763
{
	unk_0x4CAD907F190E6F10(uParam0, sParam1, sParam2, func_177(iParam3), 0);
	return;
}

char* func_177(int iParam0) // Position - 0xB77C
{
	char* str;
...
void func_178() // Position - 0xB971
{
	...
	if (func_43() == 0)
		func_183(&uLocal_230, 0, unk_0x4A8C381C258A124D(), "MICHAEL", 0, 1);
	else if (func_43() == 1)
		func_183(&uLocal_230, 0, unk_0x4A8C381C258A124D(), "FRANKLIN", 0, 1);
	else if (func_43() == 2)
		func_183(&uLocal_230, 0, unk_0x4A8C381C258A124D(), "TREVOR", 0, 1);

	uLocal_165 = unk_0x4E55EAB577C13329(iLocal_186, uLocal_95, 1, 1, 0);

	if (iLocal_47 == 1)
	{
		unk_0xA7B0B03284E7503C(uLocal_126 - { 20f, 20f, 20f }, uLocal_126 + { 20f, 20f, 20f }, 0, 1, 1, 1);
	...
	{
		unk_0xA7B0B03284E7503C(uLocal_129 - { 20f, 20f, 20f }, uLocal_129 + { 20f, 20f, 20f }, 0, 1, 1, 1);
...
void func_183(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xC902
{
...
{
	if (Global_113799 == func_71() && unk_0x9FA91AA1AC724CD0() && Global_113800)
		return true;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_226() || Global_112857 || Global_32286 || func_225() || func_130(8, -1) || func_224() || func_223() || func_222() || func_221() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_226() || Global_32286 || func_225() || func_130(8, -1) || func_222() || func_224() || func_223() || func_221() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_226() || Global_112857 || Global_32286 || func_225() || func_130(8, -1) || func_222() || func_224() || func_223() || func_221() || Global_113810.f_7691.f_919[num] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_226() || Global_112857 || Global_32286 || func_225() || func_130(8, -1) || func_224() || func_223() || func_221() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
				
					case 4:
						if (func_226() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_130(8, -1) || func_221() || func_220() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
...
BOOL func_229(int iParam0, int iParam1, int iParam2) // Position - 0xFC5D
{
	BOOL num;
	int num2;
...
int func_230(int iParam0) // Position - 0xFD41
{
	if (!func_45(iParam0))
		return 7;
...
void func_237(int iParam0) // Position - 0x1022E
{
	...
	if (func_200())
	{
		...
		func_240(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_239(Global_113799, true), 64);

...
void main() // Position - 0x0
{
	...
	uLocal_160 = func_410();
	uLocal_161 = func_409(1855.08f, 4755.85f, 36.81f, 25f);
	...
	if (func_420())
	{
		if (func_382() == 0)
		{
			...
			func_380(1);
			func_379(&uLocal_81, 0, true);
			func_378();
			func_408("Done replay setup");
		}
	}
	else if (func_419(false))
	{
		func_381(uLocal_145, fLocal_148, 1, 0);
		func_380(0);
		func_379(&uLocal_81, 1, true);
		func_378();
	}
	...
	while (true)
	{
		...
		{
			if (func_352(unk_0x4A8C381C258A124D()) == iLocal_157)
			{
...
void func_11() // Position - 0x651
{
	...
	while (func_352(unk_0x4A8C381C258A124D()) == iLocal_157)
	{
		SYSTEM::WAIT(0);
		unk_0x4EB223432F8FA0A0(2);
...
void func_86(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6268
{
	int num;
...
int func_87(int iParam0, int iParam1) // Position - 0x628B
{
...
BOOL func_93(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x9BED
{
	int num;
...
void func_96(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA677
{
	int num;
	var unk;
	int num2;
...
BOOL func_109(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xEC57
{
	int num;
	int num2;
	int num3;
...
BOOL func_167(int iParam0, int iParam1, int iParam2) // Position - 0x1FFF2
{
	int num;
	int num2;
	int i;
...
int func_170(int iParam0) // Position - 0x202AD
{
...
void func_172(var uParam0, int iParam1) // Position - 0x202C8
{
...
void func_178(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x20929
{
...
void func_179(int iParam0, int iParam1, int iParam2) // Position - 0x209C6
{
	var unk;
	var unk33;
...
void func_180(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x20A05
{
...
char* func_186(int iParam0) // Position - 0x22019
{
	iParam0 = iParam0;
	return "";
}
...
int func_222(var uParam0, int iParam1) // Position - 0x274CC
{
	int num;
	var unk;
	var unk33;
...
void func_233() // Position - 0x277E3
{
	switch (iLocal_770.f_1)
	{
		...
		case 1:
			...
			else if (func_235(uLocal_604[0 /*8*/]))
			{
...
float func_234(var uParam0, var uParam1, int iParam2) // Position - 0x27A06
{
	var unk;
	var unk4;
...
BOOL func_235(int iParam0) // Position - 0x27A64
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_237(int iParam0, int iParam1, int iParam2) // Position - 0x27AA6
{
	if (func_235(iParam0))
	{
...
BOOL func_238(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x27ADE
{
	float num;
	float num2;
...
BOOL func_239(int iParam0, int iParam1) // Position - 0x27BEA
{
	var unk;
	var unk2;
...
BOOL func_240(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x27C7F
{
	var unk;
	var unk4;
	float num;
	...
	if (iLocal_770.f_3 == 1)
	{
		...
		if (unk_0xB3FA103AA6383C28())
		{
			...
			if (func_235(unk_0x4A8C381C258A124D()))
				func_299("Michael", unk_0x4A8C381C258A124D(), 0, 2);
	...
	if (iLocal_770.f_1 == 0)
	{
		...
		if (func_353(unk_0x4A8C381C258A124D()))
		{
			...
			if (iLocal_351 == 0)
			{
				...
				if (func_235(uLocal_361[iLocal_351 /*43*/].f_1))
...
void func_245(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x284B8
{
	var unk;
...
void func_246(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x28562
{
	if (bParam0)
	{
...
BOOL func_250(int iParam0) // Position - 0x28763
{
	int num;
...
BOOL func_251(int iParam0) // Position - 0x28785
{
...
int func_253(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x287D2
{
	int num;
...
void func_257() // Position - 0x28932
{
	if (func_235(uLocal_604[1 /*8*/]))
	{
		if (unk_0xD8FC13DA1BA1DBA2("Jimmy_Boston", 0))
		{
			if (iLocal_351 >= 2)
			{
				if (func_235(uLocal_81.f_28[1]) && func_293(iLocal_360))
				{
...
void func_258() // Position - 0x289EE
{
	if (func_235(uLocal_604[0 /*8*/]))
	{
		if (unk_0xD8FC13DA1BA1DBA2("Marnie", 0))
		{
			if (iLocal_351 >= 2)
			{
				if (func_235(uLocal_81.f_28[0]) && func_293(iLocal_360))
				{
					unk_0xB5396F1FB088FE38(&uLocal_780);
...
Vector3 func_264(var uParam0) // Position - 0x28E7D
{
...
void func_268(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x28F12
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
BOOL func_269(float fParam0, var uParam1, var uParam2) // Position - 0x29308
{
...
BOOL func_270(var uParam0, int iParam1, BOOL bParam2) // Position - 0x29332
{
	int i;
	var unk;
	int num;
	...
	for (i = 0; func_271(iParam1, i, &unk, &num); i = i + 1)
	{
...
BOOL func_271(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x293A0
{
...
BOOL func_272(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x29478
{
	float num;
	var unk3;
	var unk6;
...
void func_274(var uParam0) // Position - 0x29822
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
int func_276(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x2989E
{
	int num;
	int num2;
	int num3;
...
void func_277(var uParam0, int iParam1) // Position - 0x29A12
{
	int num;
...
BOOL func_279(int iParam0) // Position - 0x29BC7
{
...
BOOL func_287() // Position - 0x2ACC2
{
...
BOOL func_289(var uParam0, int iParam1) // Position - 0x2AD35
{
	if (func_353(uParam0))
...
BOOL func_290(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2AD68
{
...
void func_291(var uParam0) // Position - 0x2AF00
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_293(int iParam0) // Position - 0x2AF95
{
	if (func_235(iParam0))
...
void func_301(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2B4E8
{
	...
	if (!unk_0x4FAFF4BCB7633475(iParam0))
	{
		...
		for (i = 0; i < 12; i = i + 1)
		{
			func_305(iParam0, i, &uParam1->f_13[i], &uParam1->[i], &uParam1->f_26[i], iParam2, 145);
		}
	
		for (i = 0; i < 9; i = i + 1)
		{
			func_304(iParam0, i, &uParam1->f_39[i], &uParam1->f_49[i], iParam2, 145);
		}
...
var func_303(int iParam0, int iParam1) // Position - 0x2B6A6
{
...
void func_309() // Position - 0x2BEF2
{
	...
	if (iLocal_770.f_1 == 0)
	{
		...
		func_336(&uLocal_166, 0, unk_0x4A8C381C258A124D(), "MICHAEL", 0, 1);
		func_336(&uLocal_166, 5, uLocal_604[1 /*8*/], "JIMMYBOSTON", 0, 1);
		func_336(&uLocal_166, 4, uLocal_604[0 /*8*/], "MARNIE", 0, 1);
	...
	if (iLocal_770.f_1 == 1)
	{
		...
		else if (!func_334(&uLocal_692, unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1)))
		{
			func_243(6);
			iLocal_770.f_9 = 8;
			iLocal_770.f_1 = 3;
		...
		else
		{
			...
			func_295(iLocal_623.f_1);
		
			if (iLocal_337 == 1)
			{
				func_328(&iLocal_162);
			
				if (!func_334(&uLocal_640, unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1)))
				{
					iLocal_337 = 0;
					unk_0x0F15249D24BC5ADA(0);
					unk_0x406CBCEA35499884();
				...
				{
					if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_36, sLocal_159) || func_314(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_36, 7, 0, 0, 0))
					{
				...
				{
					if (!func_287() && unk_0x1DD05E817C89C737() - uLocal_356 >= 7500)
					{
						if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_37, sLocal_159) || !unk_0xFAA48325A90263BE(unk_0x4A8C381C258A124D(), iLocal_359, 30f, 30f, 30f, 0, 1, 0) || func_314(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_37, 7, 0, 0, 0))
						{
				...
				else if (bLocal_336 == false && !func_312(unk_0x4A8C381C258A124D(), uLocal_361[iLocal_351 /*43*/].f_2, 9f, 1))
				{
					if (func_312(unk_0x4A8C381C258A124D(), uLocal_361[iLocal_351 /*43*/].f_2, 20f, 1))
					{
						if (!bLocal_341)
						{
							if (!func_287())
							{
								if (func_314(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_42, 7, 0, 0, 0))
								{
									if (func_235(iLocal_359))
										unk_0xE67051907958B5EB(iLocal_359, unk_0x4A8C381C258A124D(), 5000, 0, 2);
					...
					{
						if (func_311(unk_0x4A8C381C258A124D(), iLocal_359, 30f, 1) || iLocal_351 == 2)
						{
							if (!func_287() && unk_0x1DD05E817C89C737() - iLocal_354 > 15000)
							{
								if (bLocal_334)
								{
									if (iLocal_350 == 0)
									{
										...
										{
											if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_40, sLocal_159) || func_314(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_40, 7, 0, 0, 0))
											{
									...
									{
										if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_40, sLocal_159) || func_314(&uLocal_166, "EPS4AUD", "EPS4_HASSIG", 7, 0, 0, 0))
										{
											iLocal_354 = unk_0x1DD05E817C89C737();
								...
								{
									if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_41, sLocal_159) || func_314(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_41, 7, 0, 0, 0))
									{
										if (func_353(iLocal_359))
											unk_0xE67051907958B5EB(iLocal_359, unk_0x4A8C381C258A124D(), 3000, 0, 2);
				...
				if (iLocal_351 == 0)
				{
					if (iLocal_751 < 5)
					{
						if (unk_0x1DD05E817C89C737() - uLocal_753 > 7500 && !func_287() && !unk_0xFBA523E6F8ACE541())
						{
							if (func_235(uLocal_604[0 /*8*/]))
							{
				...
				else if (!func_312(unk_0x4A8C381C258A124D(), uLocal_361[iLocal_351 /*43*/].f_2, 9f + 2f, 1))
				{
					bLocal_335 = false;
				}
			}
			else
			{
				if (!unk_0xC450B06E5AAA0985(iLocal_162))
					iLocal_162 = func_310(uLocal_142, 5, 0);
					...
					if (iLocal_351 < 2)
						if (unk_0xFAA48325A90263BE(unk_0x4A8C381C258A124D(), iLocal_359, 30f, 30f, 30f, 0, 1, 0))
							if (!func_287() && !unk_0xFBA523E6F8ACE541())
								if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_38, sLocal_159) || func_314(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_38, 7, 0, 0, 0))
									iLocal_342 = 1;
				...
				else if (iLocal_343 == 0)
				{
					if (iLocal_351 < 2)
						if (unk_0xFAA48325A90263BE(unk_0x4A8C381C258A124D(), iLocal_359, 30f, 30f, 30f, 0, 1, 0))
							if (!func_287() && unk_0x1DD05E817C89C737() - uLocal_356 >= 7500 && !unk_0xFBA523E6F8ACE541())
								if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_39, sLocal_159) || func_314(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_39, 7, 0, 0, 0))
									iLocal_343 = 1;
					else if (!func_287() && unk_0x1DD05E817C89C737() - uLocal_356 >= 7500 && !unk_0xFBA523E6F8ACE541())
						if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_39, sLocal_159) || func_314(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_39, 7, 0, 0, 0))
							iLocal_343 = 1;
				}
			}
...
int func_310(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x2D280
{
	int num;
...
BOOL func_311(var uParam0, int iParam1, float fParam2, int iParam3) // Position - 0x2D2AE
{
	return SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(uParam0, iParam3), unk_0xD1A6A821F5AC81DB(iParam1, iParam3)) <= fParam2 * fParam2;
}

BOOL func_312(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x2D2D0
{
...
BOOL func_317() // Position - 0x2D65A
{
	...
	if (unk_0x259BE71D8A81D4FA() == func_320())
		return false;
...
BOOL func_319(int iParam0, int iParam1) // Position - 0x2D6CD
{
...
void func_328(var uParam0) // Position - 0x2D9D4
{
...
void func_331(var uParam0) // Position - 0x2DF2A
{
	...
	if (func_353(*uParam0) && unk_0x133460AD0F183CC9(*uParam0))
		...
		case 4:
			...
			else if (uParam0->f_2 == 0)
			{
				if (!unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), uParam0->f_4, 1f, 1f, 1f, 0, 1, 0) || iLocal_351 > 0)
				{
					...
					{
						unk_0x974022927CB47E68(*uParam0);
						unk_0x03AB73582A77DBD3(*uParam0, func_332());
					...
					if (iLocal_351 == 0)
						unk_0xDC80C872B18711B5(func_332(), 0);
					else
						unk_0xDC80C872B18711B5(func_332(), 0);
				
					unk_0x47F8464BB13E408D(func_332(), 4f, -1082130432, -1082130432);
					uParam0->f_2 = 1;
				}
			}
			else if (uParam0->f_2 == 1)
			{
				...
				if (unk_0x6F21822F60DC0945(unk_0x4A8C381C258A124D()) || unk_0x2C807E70DCB4BB36(unk_0x4A8C381C258A124D()))
					if (unk_0x1DD05E817C89C737() - uLocal_755 > 7500 && !func_287() && !unk_0xFBA523E6F8ACE541() && !bLocal_335)
						if (*uParam0 == uLocal_604[1 /*8*/])
				...
				{
					if (iLocal_756 < 4 && !func_287() && !unk_0xFBA523E6F8ACE541() && !bLocal_335 && !func_354())
					{
						if (*uParam0 == uLocal_604[1 /*8*/])
						{
...
{
	if (func_353(iParam0) && func_235(unk_0x4A8C381C258A124D()))
	{
		if (iLocal_621 == 0)
		{
...
void func_336(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2E883
{
...
{
	if (func_353(*uParam0) && func_353(unk_0x4A8C381C258A124D()))
	{
		uParam0->f_1 = 4;
		uParam0->f_2 = 0;
...
void func_346() // Position - 0x2EC18
{
	...
	if (iLocal_770.f_1 == 0)
	{
		...
		if (func_283(1, 1093140480, 0))
		{
			...
			if (func_353(uLocal_81.f_28[1]))
			{
				...
				if (func_235(unk_0x484426882F80CACE(uLocal_81.f_28[1], 1)))
				{
	...
	if (iLocal_770.f_1 == 1)
	{
		...
		if (func_235(unk_0x4A8C381C258A124D()))
		{
			...
			{
				func_408("*** Forcing Michael's move state");
				func_349(unk_0x4A8C381C258A124D(), 1827.1611f, 4698.6445f, 38.094f, 184.1384f, false, 1);
				unk_0xB41DEC3AAC1AA107(unk_0x4A8C381C258A124D(), iLocal_157, -1, 1, 1);
			}
		}
...
BOOL func_349(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, int iParam6) // Position - 0x2F091
{
	BOOL flag;
	float num;
...
void func_351() // Position - 0x2F10D
{
	...
	if (iLocal_770.f_1 == 0)
	{
		...
		if (!func_419(false) && unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), 1826.6212f, 4698.7344f, 41.36862f, 1831.1576f, 4680.1914f, 32.426258f, 16.5f, 0, 1, 0))
		{
			func_408("Doing setup for leadin");
			func_336(&uLocal_166, 4, uLocal_81.f_28[0], "MARNIE", 0, 1);
	...
	if (iLocal_770.f_1 == 1)
	{
		...
		if (!func_419(false) && unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), 1826.6212f, 4698.7344f, 41.36862f, 1831.1576f, 4680.1914f, 32.426258f, 16.5f, 0, 1, 0))
		{
			...
			if (!bLocal_332)
			{
				if (func_353(uLocal_81.f_28[0]) && !func_287())
				{
...
int func_352(var uParam0) // Position - 0x2F4AD
{
	int unk;
...
BOOL func_353(int iParam0) // Position - 0x2F4C1
{
	if (func_235(iParam0))
		if (!unk_0x4FAFF4BCB7633475(iParam0))
			return true;
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_357(Global_78945, Global_78947, iParam10) };
				num4 == -0.014f;
...
float func_356(var uParam0) // Position - 0x2F7DF
{
...
{
	if (!func_368(0) || Global_78960 || Global_78948 == 1 || !unk_0x9390801B06EE998F())
		return false;
	...
	switch (Global_78944)
	{
		...
		case 5:
			if (unk_0xFD216000DC314A92() || func_229(0) || func_367(true))
			{
			}
			else
			{
...
void func_371(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2FF35
{
	...
	if (Global_117[iParam0 /*10*/].f_8 != 172)
	{
		...
		else
		{
			...
			num = iParam1;
			func_377(iParam0, num, 1);
			func_376(iParam0, num, 1);
...
int func_383(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x304EE
{
	if (iParam5 != 0)
	{
		*uParam0 = iParam5;
...
void func_384(var uParam0) // Position - 0x30584
{
	...
	if (unk_0xFC8BFE4B41177C22(uParam0->f_1))
	{
		...
		func_385("Rock rot vector: ", unk_0x88124E0D60FB8D11(uParam0->f_1, 0));
		func_385("Rock actual position: ", unk_0xD1A6A821F5AC81DB(uParam0->f_1, 0));
...
var func_409(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x31129
{
	var unk;
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[1]))
			{
				if (func_412(&uParam0->f_28[1], 55, 1827.24f, 4699.76f, 39.09f, 57.09f, "EPSILON LAUNCHER RC - JIMMY", 1))
				{
					...
					func_349(uParam0->f_28[1], 1827.24f, 4699.76f, 39.09f, 57.09f, true, 1);
				}
				else
				{
					flag = false;
...
BOOL func_412(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x313B6
{
	if (func_413(uParam0, iParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_413(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x31412
{
	int num;

	if (!func_171(iParam1))
	{
		num = func_444(iParam1);
...
BOOL func_419(BOOL bParam0) // Position - 0x315A2
{
...
BOOL func_420() // Position - 0x315CA
{
	if (Global_100833 == 10 || Global_100833 == 9)
		return true;
...
void func_421() // Position - 0x315EE
{
	...
	if (func_235(uLocal_604[0 /*8*/]) && func_235(uLocal_604[1 /*8*/]))
	...
	func_422(&uLocal_604[0 /*8*/], 1, 1, 1);
	func_422(&uLocal_604[1 /*8*/], 1, 1, 1);
...
void func_422(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x31702
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_424(BOOL bParam0) // Position - 0x317F3
{
	...
	if (!func_439())
	{
		...
		{
			func_179(num, 1, 0);
			func_425(unk_0x1AF90EB93E0012D6(), num);
		}
		else
		{
			if (Global_112897[num /*10*/].f_9 == -1)
...
BOOL func_426(char* sParam0, int iParam1, int iParam2) // Position - 0x318EB
{
	var unk;
	var unk2;
	int num;
	...
	if (func_432())
	{
		...
		{
			num = func_427(unk_0x1AF90EB93E0012D6());
...
int func_429(char* sParam0, BOOL bParam1) // Position - 0x31AF8
{
	...
	num = func_430(unk, true);
	num == -1 && !bParam1;
	return num;
}

int func_430(var uParam0, BOOL bParam1) // Position - 0x31B22
{
	int i;
...
void func_433(int iParam0) // Position - 0x31C14
{

...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		func_208(num);
		func_201(&iLocal_91, &uLocal_92, &(num.f_9), unk61, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_194(&num, unk61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
...
int func_32(var uParam0) // Position - 0x2A4E
{
	int i;
...
int func_33(var uParam0, int iParam1, int iParam2) // Position - 0x2AB1
{
	int i;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5CDC
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6974
{
	int i;
	float num;
	float num2;
...
BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x748B
{
...
BOOL func_85(int iParam0) // Position - 0x74E1
{
	if (iParam0 != func_94())
...
BOOL func_93(int iParam0) // Position - 0x8398
{
	if (iParam0 != func_94())
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8D70
{
...
BOOL func_117(BOOL bParam0) // Position - 0x8DB2
{
...
BOOL func_135(var uParam0) // Position - 0xAC68
{
	if (func_136(uParam0))
...
BOOL func_136(int iParam0) // Position - 0xAC88
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xADCC
{
	int i;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF6B
{
	if (bParam0)
	{
...
BOOL func_147(int iParam0) // Position - 0xB16C
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB18E
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB1DB
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB258
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB38B
{
...
void func_160(var uParam0) // Position - 0xB523
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_177(var uParam0, int iParam1) // Position - 0xBBA8
{
	int num;
	var unk;
	var unk33;
...
BOOL func_184(var uParam0) // Position - 0xC59C
{
	if (func_136(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
int func_194(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xCDC9
{
	...
	if (func_185(2))
	{
		if (!func_156())
		{
			if (func_136(unk_0x4A8C381C258A124D()) && func_136(uParam0->f_28[0]) && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_200(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
			{
				unk = 16;
		...
		else if (func_195(sParam5))
		{
			if (func_136(unk_0x4A8C381C258A124D()))
				if (func_200(unk_0x4A8C381C258A124D(), uParam1, 1) >= 20f)
					func_154();
		}
	}
...
void func_199(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xCF60
{
...
float func_200(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xCFFB
{
	var unk;
...
void func_201(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11) // Position - 0xD035
{
	float num;
	float num2;
	float num3;
	...
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam2))
		{
			...
			{
				if (func_200(unk_0x4A8C381C258A124D(), uParam3, 1) <= 100f)
					func_204(uParam0, 1);
			}
			else
			{
				...
				{
					num = func_200(unk_0x4A8C381C258A124D(), fParam6, 1);
					num2 = func_200(unk_0x4A8C381C258A124D(), fParam9, 1);
					num3 = num - num2;
				...
				if (func_200(unk_0x4A8C381C258A124D(), uParam3, 1) > 120f)
					func_205(uParam0);
			}
		}
	}
...
BOOL func_209(Any* panParam0, BOOL bParam1) // Position - 0xD399
{
	var unk;
...
void func_215(var uParam0) // Position - 0xDCC2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_217(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDD6D
{
	int i;
	int num;
	var unk;
...
BOOL func_218(var uParam0, var uParam1) // Position - 0xDF2B
{
	var unk;
...
BOOL func_221(var uParam0, int iParam1) // Position - 0xE24B
{
	float num;
...
BOOL func_222(var uParam0, int iParam1) // Position - 0xE2C1
{
	return func_223(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_223(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE2D9
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_224(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE39A
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_225(var uParam0, int iParam1) // Position - 0xE4C6
{
	int num;
...
BOOL func_227(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE5D5
{
	var unk;
	var unk4;
	float num;
...
int func_231(var uParam0, var uParam1) // Position - 0xE6E1
{
	int i;
...
int func_232(var uParam0) // Position - 0xE720
{
...
BOOL func_233(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE748
{
	float num;
	float num2;
	int num3;
...
BOOL func_234(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE843
{
	float num;
	float num2;
...
BOOL func_235(var uParam0, float fParam1) // Position - 0xE94F
{
	var unk;
	var unk2;
...
BOOL func_236(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE9E4
{
	var unk;
	var unk4;
	float num;
...
BOOL func_237(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEA72
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_239(var uParam0) // Position - 0xEB04
{
	var unk;
...
BOOL func_248(var uParam0) // Position - 0xED6E
{
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_251(&num) || !unk_0xE100DD4F82A51BDE("rcmlastone1") || !unk_0x92A65766A892EFC6(joaat("WEAPON_PUMPSHOTGUN")) || !unk_0x92A65766A892EFC6(joaat("WEAPON_SNIPERRIFLE")))
				return false;
...
void func_249(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xEF5A
{
	func_250(uParam0);
...
void func_250(var uParam0) // Position - 0xEF9C
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_270(var uParam0, BOOL bParam1) // Position - 0xF6BF
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_273(var uParam0) // Position - 0xF749
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_275(var uParam0, int iParam1) // Position - 0xF793
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_276(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_276(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF7D4
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_277(var uParam0) // Position - 0xF824
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))

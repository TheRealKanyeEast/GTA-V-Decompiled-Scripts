...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (!func_303(unk_0x4A8C381C258A124D()) || Global_32287 == 1)
		{
			func_308(1, 1, 1, 1);
			Global_32289 = 0;
...
void func_5() // Position - 0x520
{
	...
	if (num == 2)
	{
		func_6("WAIT_CABLE" /*If you wish to wait, a cable car will arrive shortly.*/, -1);
		iLocal_428 = 1;
	}
...
BOOL func_16(var uParam0) // Position - 0xFF0
{
		...
		case 2:
			...
			if (uParam0->f_31 <= 0f)
			{
				...
				*uParam0 = 3;
				...
				if (uParam0->f_11 == 1)
					func_6("FGND_SWTCHCAM" /*Press ~INPUT_SCRIPT_SELECT~ to change view.~n~Press ~INPUT_CONTEXT~ or ~INPUT_SKIP_CUTSCENE~ to skip the ride.*/, -1);
			}
...
void func_42(var uParam0, BOOL bParam1) // Position - 0x220B
{
	...
	if (uParam0->f_11 == 1 || uParam0->f_34 == 1)
	{
		...
		unk_0x8744D2E3FC95740E(&Global_78938, 4);
		unk_0x8744D2E3FC95740E(&Global_78938, 5);
...
BOOL func_49(BOOL bParam0) // Position - 0x2B39
{
...
void func_52(int iParam0, int iParam1, int iParam2) // Position - 0x2BBD
{
	if (iParam2 == -1)
		iParam2 = func_53();
...
int func_56(int iParam0, int iParam1, int iParam2) // Position - 0x2C37
{
	...
	return func_57(func_87(iParam0), 0, iParam1, iParam2, false);
}
...
char* func_61(int iParam0) // Position - 0x36C0
{
	switch (iParam0)
	{
		case 0:
...
int func_64(int iParam0, int iParam1) // Position - 0x37F3
{
...
int func_88(var uParam0) // Position - 0x3F03
{
	int i;
	int num;
	int num2;
...
int func_90(int iParam0) // Position - 0x3F6F
{
...
int func_93(var uParam0) // Position - 0x3FAC
{
	int i;
	int num;
...
void func_98() // Position - 0x4080
{
	...
	{
		if (func_94(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_93(unk_0x4A8C381C258A124D());
		
			if (func_91(num) && !func_45(14) || Global_112760)
			{
...
int func_101(int iParam0) // Position - 0x4211
{
	int num;
...
BOOL func_103(int iParam0) // Position - 0x4266
{
	if (!func_104(iParam0))
		return false;
...
BOOL func_104(int iParam0) // Position - 0x4285
{
	int num;
...
void func_105(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x42A7
{
	var unk;
	int num;
...
Vector3 func_116(var uParam0) // Position - 0x49A6
{
	return unk_0xD1A6A821F5AC81DB(unk_0x56E414973C2A8C0E(uParam0), 0);
}

int func_117(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x49B9
{
	int i;
	int j;
	int k;
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				...
				if (IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0))
				{
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_127(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_127(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_127(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
			...
			{
				Global_78472[1 /*14*/] = { func_165(num8, i, func_126(uParam0, i, -1), -1) };
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_127(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_127(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_127(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
...
BOOL func_118(var uParam0, int iParam1, var uParam2) // Position - 0x51CA
{
	int num;
	...
	{
		if (!func_229(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_64, Global_113810.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_121(int iParam0, int iParam1, int iParam2) // Position - 0x531B
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_123(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x5421
{
	var unk;
	int i;
...
BOOL func_124(int iParam0, int iParam1, int iParam2) // Position - 0x5A25
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_125(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x5ABE
{
	int num;
	...
	{
		if (!func_229(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_61, Global_113810.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
int func_126(var uParam0, int iParam1, int iParam2) // Position - 0x5B69
{
	int i;
	int j;
...
int func_128(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x5CBA
{
	int num;
...
int func_129(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x5FC1
{
	int num;
	int num2;
	int num3;
...
BOOL func_133(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7156
{
	int num;
...
BOOL func_134(int iParam0, int iParam1, var uParam2) // Position - 0x717F
{
	*uParam2 = -99;
...
int func_135(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x7449
{
	int num;
...
void func_137(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x782A
{
	int num;
...
BOOL func_138(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x78C4
{
	switch (iParam0)
	{
...
int func_142(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7EB4
{
	int num;
	int num2;
	int num3;
...
int func_143(var uParam0, int iParam1) // Position - 0x7FB0
{
	int num;
...
void func_148(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8BBD
{
	int num;
	var unk;
	int num2;
...
BOOL func_154(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xAE82
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_155(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB0FF
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_156(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB524
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_157(var uParam0, int iParam1) // Position - 0xB817
{
	int num;
	var unk;
...
int func_158(var uParam0, int iParam1) // Position - 0xB85E
{
	int num;
	var unk;
	var unk2;
...
int func_159(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0xB8BE
{
	int num;
	int num2;
	int num3;
...
BOOL func_172(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1165F
{
	int num;
	int num2;
	int num3;
...
BOOL func_229(var uParam0, int iParam1, int iParam2) // Position - 0x22E36
{
	int num;
	int num2;
	int i;
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_229(uParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_78472[2 /*14*/].f_12 == j)
										if (func_229(uParam0, 14, k))
											if (!func_123(num, iParam2, 14, k, &unk, &Global_78472[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						if (!func_123(num, iParam2, i, num2, &unk, &Global_78472[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_78472[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_127(iParam1)) && Global_78472[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_127(iParam1)))
	{
		return true;
	}
...
void func_231(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x230CE
{
	if (bParam0)
	{
...
BOOL func_235(int iParam0) // Position - 0x232CF
{
...
int func_237(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x2331C
{
	int num;
...
BOOL func_239(var uParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x23372
{
	var unk;
	var unk9;
...
void func_269(var uParam0, var uParam1, int iParam2) // Position - 0x252A9
{
	var unk;
...
BOOL func_270(var uParam0) // Position - 0x2534E
{
	int num;
...
int func_273(var uParam0) // Position - 0x253F3
{
	...
	switch (uParam0->f_1)
	{
		...
		case 4:
			...
			if (func_252(uParam0) == 0)
				unk_0x0B0C9A0F9AAEB7F0(&Global_78938, 4);
			else
				unk_0x0B0C9A0F9AAEB7F0(&Global_78938, 5);
...
int func_281(var uParam0, var uParam1, float fParam2, BOOL bParam3) // Position - 0x257AD
{
	var unk;
	var unk9;
...
void func_282(var uParam0, int iParam1, BOOL bParam2) // Position - 0x2586B
{
	if (unk_0x78411E34CF90EA8C(*uParam0))
	{
		if (bParam2)
...
void func_283(var uParam0, int iParam1) // Position - 0x25905
{
	if (unk_0x78411E34CF90EA8C(*uParam0))
	{
...
BOOL func_285(float fParam0, var uParam1, var uParam2) // Position - 0x25957
{
...
BOOL func_303(var uParam0) // Position - 0x264FA
{
	if (!unk_0xFC8BFE4B41177C22(uParam0))
		return false;
...
float func_307(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x266E6
{
	var unk;
...
void func_308(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x26720
{
	var unk;
...
BOOL func_309(var uParam0) // Position - 0x267CA
{
	if (func_16(uParam0))
		if (!unk_0x4FAFF4BCB7633475(uParam0))
			return true;

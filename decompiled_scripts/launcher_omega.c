...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		func_212(num);
		func_205(&iLocal_91, &(num.f_9), unk61);
	
		if (num == 44)
		{
			func_197(&num, unk61, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_92);
			func_196();
		}
		else if (num == 45)
		{
			func_197(&num, unk61, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_93);
			func_194(&num);
		}
...
int func_32(var uParam0) // Position - 0x2A80
{
	int i;
...
int func_33(var uParam0, int iParam1, int iParam2) // Position - 0x2AE3
{
	int i;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D0F
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x69A7
{
	int i;
	float num;
	float num2;
...
BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x74BE
{
...
BOOL func_85(int iParam0) // Position - 0x7514
{
	if (iParam0 != func_94())
...
BOOL func_93(int iParam0) // Position - 0x83CB
{
	if (iParam0 != func_94())
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8DA3
{
...
BOOL func_117(BOOL bParam0) // Position - 0x8DE5
{
...
BOOL func_135(var uParam0) // Position - 0xAC9B
{
	if (func_136(uParam0))
...
BOOL func_136(int iParam0) // Position - 0xACBB
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xADFF
{
	int i;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF9E
{
	if (bParam0)
	{
...
BOOL func_147(int iParam0) // Position - 0xB19F
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB1C1
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB20E
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB28B
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB3BE
{
...
void func_160(var uParam0) // Position - 0xB556
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_177(var uParam0, int iParam1) // Position - 0xBBDB
{
	int num;
	var unk;
	var unk33;
...
BOOL func_184(var uParam0) // Position - 0xC5D0
{
	if (func_136(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_194(var uParam0) // Position - 0xCDFD
{
	...
	{
		if (func_136(uParam0->f_28[0]) && !unk_0xCB5CAFF0A4A8B74B(uParam0->f_28[0]))
		{
			if (func_136(unk_0x4A8C381C258A124D()) && !func_195(unk_0x4A8C381C258A124D(), uParam0->f_28[0], 50f, 1))
			{
...
BOOL func_195(var uParam0, var uParam1, float fParam2, int iParam3) // Position - 0xCEE6
{
...
int func_197(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, var uParam8) // Position - 0xCFFA
{
	...
	if (!(*uParam8 == 3))
	{
		if (func_185(2))
		{
			if (!func_156())
			{
				if (func_136(unk_0x4A8C381C258A124D()) && func_136(uParam0->f_28[0]) && func_204(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
				{
			...
			if (func_204(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f && *uParam8 == 1)
			{
...
void func_203(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD1FE
{
...
float func_204(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD299
{
	var unk;
...
void func_205(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD2D3
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
BOOL func_213(Any* panParam0, BOOL bParam1) // Position - 0xD60A
{
	var unk;
...
void func_219(var uParam0) // Position - 0xDF33
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_221(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDFDE
{
	int i;
	int num;
	var unk;
...
BOOL func_222(var uParam0, var uParam1) // Position - 0xE19C
{
	var unk;
...
BOOL func_225(var uParam0, int iParam1) // Position - 0xE4BC
{
	float num;
...
BOOL func_226(var uParam0, int iParam1) // Position - 0xE532
{
	return func_227(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_227(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE54A
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_228(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE60B
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_229(var uParam0, int iParam1) // Position - 0xE737
{
	int num;
...
BOOL func_231(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE846
{
	var unk;
	var unk4;
	float num;
...
int func_235(var uParam0, var uParam1) // Position - 0xE952
{
	int i;
...
int func_236(var uParam0) // Position - 0xE991
{
...
BOOL func_237(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE9B9
{
	float num;
	float num2;
	int num3;
...
BOOL func_238(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEAB4
{
	float num;
	float num2;
...
BOOL func_239(var uParam0, float fParam1) // Position - 0xEBC0
{
	var unk;
	var unk2;
...
BOOL func_240(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEC55
{
	var unk;
	var unk4;
	float num;
...
BOOL func_241(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xECE3
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_243(var uParam0) // Position - 0xED75
{
	var unk;
...
void func_255(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF24C
{
	func_256(uParam0);
...
void func_256(var uParam0) // Position - 0xF28E
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_257(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF32A
{
...
BOOL func_258(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF386
{
	int num;
...
BOOL func_263(var uParam0) // Position - 0xF4F1
{
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (func_136(uParam0->f_28[0]) && unk_0xFC8BFE4B41177C22(uParam0->f_41[0]) && unk_0xFC8BFE4B41177C22(uParam0->f_41[1]))
			{
...
void func_285(var uParam0, BOOL bParam1) // Position - 0xFE95
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_288(var uParam0) // Position - 0xFF1F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_291(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFFAA
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_292(var uParam0) // Position - 0xFFFA
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))

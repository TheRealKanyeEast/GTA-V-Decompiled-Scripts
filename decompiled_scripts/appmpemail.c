...
void main() // Position - 0x0
{
	...
	Global_20504 = 0;
	unk_0x78C4EBB0251847E2(&uLocal_1364);
	...
	while (true)
	{
		...
		if (Global_20500.f_1 != 9 && Global_22879 == 0 && Global_22878 == 0)
		{
			...
			else if (func_3(2, Global_20468, 0) || IS_BIT_SET(Global_8371, 12))
			{
				if (unk_0x1B79E937E91F40C3(&Global_4541037[iLocal_34 /*104*/], "CELL_FINV"))
				{
				}
				else
				{
					SYSTEM::WAIT(0);
					unk_0x8744D2E3FC95740E(&Global_8371, 12);
					func_2();
					Global_20478 = 1;
					Global_22911 = 0;
...
void func_12() // Position - 0x51C
{
	if (Global_4541037[iLocal_34 /*104*/].f_24 == 1)
	{
		if (Global_20478 == 0)
		{
			if (unk_0x6D05C5731A838CB3(2, Global_20471))
			{
				func_2();
				Global_20478 = 1;
				func_30();
				...
				unk_0xFE3A52C5B7AE3101(Global_4541037[iLocal_34 /*104*/].f_16);
				func_57(Global_20481, "SET_DATA_SLOT_EMPTY", 8f, -1082130432, -1082130432, -1082130432, -1082130432);
				func_54();
	...
	{
		if (unk_0x6D05C5731A838CB3(2, Global_20472))
		{
			if (iLocal_36 == 1)
			{
				if (Global_20500.f_1 > 3)
				{
					TEXT_LABEL_ASSIGN_STRING(&Global_75799, unk_0xFACCDE46E24AD056(&Global_22886), 64);
				
					if (unk_0x1B79E937E91F40C3(&Global_75799, "HARDCODED_4207156"))
					{
						Global_20500.f_1 = 3;
						Global_1969138 = 1;
					}
					...
					{
						Global_75929 = 7;
						unk_0x0B0C9A0F9AAEB7F0(&Global_8371, 10);
						Global_20500.f_1 = 6;
					}
				}
						...
						if (Global_8939[i] == 0)
						{
							...
							else if (num == 7)
							{
								if (Global_78689)
								{
									...
									func_22(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20500)
...
void func_32() // Position - 0x1BC4
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_35(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_33(num) && !func_21(14) || Global_112760)
			{
...
int func_34(var uParam0) // Position - 0x1CCD
{
	int i;
	int num;
...
int func_36(int iParam0) // Position - 0x1D2F
{
		...
		if (func_3(2, Global_20469, 0) || Global_4542287 == 1 || Global_22905 == 1)
		{
			...
			if (iLocal_32 == iLocal_31 || iLocal_32 > iLocal_31)
			{
				if (Global_20500.f_1 > 3)
				{
					...
					Global_22911 = 1;
					iLocal_33 = iLocal_32;
					unk_0xEC552A25287441B8(uLocal_17[iLocal_32], &uLocal_1372);
				}
				...
				unk_0x60D332F23943B34F(&(uLocal_1372.f_2));
				unk_0xCFAD3D478C87321A();
				unk_0x882AEFD55B8D51FB("CELL_EMAIL_BCON" /*~a~~a~~a~~a~~a~~a~~a~~a~~a~~a~*/);
				unk_0x60D332F23943B34F(&uLocal_1372.f_56[0 /*16*/]);
				unk_0x60D332F23943B34F(&uLocal_1372.f_56[1 /*16*/]);
				unk_0x60D332F23943B34F(&uLocal_1372.f_56[2 /*16*/]);
				unk_0x60D332F23943B34F(&uLocal_1372.f_56[3 /*16*/]);
				unk_0x60D332F23943B34F(&uLocal_1372.f_56[4 /*16*/]);
				unk_0x60D332F23943B34F(&uLocal_1372.f_56[5 /*16*/]);
				unk_0x60D332F23943B34F(&uLocal_1372.f_56[6 /*16*/]);
				unk_0x60D332F23943B34F(&uLocal_1372.f_56[7 /*16*/]);
				unk_0x60D332F23943B34F(&uLocal_1372.f_56[8 /*16*/]);
				unk_0x60D332F23943B34F(&uLocal_1372.f_56[9 /*16*/]);
				unk_0xCFAD3D478C87321A();
				...
				if (iLocal_32 == iLocal_31)
				{
					if (IS_BIT_SET(Global_4542302, 25))
						unk_0x8744D2E3FC95740E(&Global_4542302, 25);
				
					if (Global_4541036 > 0)
					{
						func_39(12517, uLocal_1367, -1, 1);
			...
			if (Global_4541037[iLocal_34 /*104*/].f_24 != 0)
			{
				...
				unk = { Global_4541037[iLocal_34 /*104*/] };
				...
				{
					unk_0x882AEFD55B8D51FB("CELL_FROM_FIELD" /*From: ~a~*/);
					unk_0x60D332F23943B34F(&(Global_4541037[iLocal_34 /*104*/].f_50));
					unk_0xCFAD3D478C87321A();
				}
				else
				{
					unk_0x882AEFD55B8D51FB("CELL_FROM_FIELD" /*From: ~a~*/);
					unk_0xACF853FB3F6EA7D4(&(Global_2058[Global_4541037[iLocal_34 /*104*/].f_17 /*29*/].f_3));
					unk_0xCFAD3D478C87321A();
				}
				...
				switch (Global_4541037[iLocal_34 /*104*/].f_32)
				{
					...
					case 1:
						unk_0x882AEFD55B8D51FB(&Global_4541037[iLocal_34 /*104*/]);
						unk_0x60D332F23943B34F(&(Global_4541037[iLocal_34 /*104*/].f_33));
					
						if (Global_4541037[iLocal_34 /*104*/].f_66 == 1 && !unk_0x1B79E937E91F40C3(&(Global_4541037[iLocal_34 /*104*/].f_67), "NULL"))
							unk_0x60D332F23943B34F(&(Global_4541037[iLocal_34 /*104*/].f_67));
					
						if (Global_4541037[iLocal_34 /*104*/].f_66 == 2 && !unk_0x1B79E937E91F40C3(&(Global_4541037[iLocal_34 /*104*/].f_67), "NULL") && !unk_0x1B79E937E91F40C3(&(Global_4541037[iLocal_34 /*104*/].f_83), "NULL"))
						{
							if (unk_0x6BA487C862DB8DDF(&(Global_4541037[iLocal_34 /*104*/].f_67)))
								unk_0xACF853FB3F6EA7D4(&(Global_4541037[iLocal_34 /*104*/].f_67));
							else
								unk_0x60D332F23943B34F(&(Global_4541037[iLocal_34 /*104*/].f_67));
						
							if (unk_0x6BA487C862DB8DDF(&(Global_4541037[iLocal_34 /*104*/].f_83)))
								unk_0xACF853FB3F6EA7D4(&(Global_4541037[iLocal_34 /*104*/].f_83));
							else
								unk_0x60D332F23943B34F(&(Global_4541037[iLocal_34 /*104*/].f_83));
						}
					...
					case 2:
						unk_0x882AEFD55B8D51FB(&Global_4541037[iLocal_34 /*104*/]);
						unk_0x511D14ED2DA887E1(Global_4541037[iLocal_34 /*104*/].f_49);
						unk_0xCFAD3D478C87321A();
						break;
...
void func_38(int iParam0) // Position - 0x296C
{
	...
	unk_0xACF853FB3F6EA7D4(&Global_113810.f_14144[iParam0 /*104*/]);
...
void func_39(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2B0D
{
	int num;

	num = func_40(iParam0, iParam2);
...
int func_40(int iParam0, int iParam1) // Position - 0x2B30
{
...
void func_43() // Position - 0x2B85
{
	...
	if (Global_4541037[iLocal_34 /*104*/].f_24 != 0)
	{
		for (i = 0; i < 59; i = i + 1)
		{
			if (unk_0x1B79E937E91F40C3(&Global_4541037[iLocal_34 /*104*/], &uLocal_60[i /*6*/]))
			{
...
BOOL func_44(var uParam0) // Position - 0x2C20
{
...
float func_47(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11, float fParam12, BOOL bParam13) // Position - 0x2DAB
{
	...
	num = func_49(SYSTEM::TO_FLOAT(unk_0x1DD05E817C89C737() - iLocal_16) / fParam12, 0f, 1f);
...
void func_53(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6) // Position - 0x32CA
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	func_16(sParam2);
...
void func_54() // Position - 0x3325
{
	...
	while (num < 11)
	{
		...
		num3 = 0;
		num4 = 11;
		Global_4541037[num4 /*104*/].f_18 = -1;
		Global_4541037[num4 /*104*/].f_18.f_1 = 0;
		Global_4541037[num4 /*104*/].f_18.f_2 = 0;
		Global_4541037[num4 /*104*/].f_18.f_3 = 0;
		Global_4541037[num4 /*104*/].f_18.f_5 = 0;
		...
		while (num3 < 12)
		{
			...
			if (unk[num3] == 0)
			{
				if (Global_4541037[num3 /*104*/].f_24 != 0)
				{
					...
					{
						if (func_56(Global_4541037[num3 /*104*/].f_18, Global_4541037[num4 /*104*/].f_18))
						{
							num4 = num3;
						
							if (Global_4541037[num4 /*104*/].f_28 == 0)
								iLocal_35 = 0;
							else
								iLocal_35 = 1;
						}
		...
		if (Global_4541037[num4 /*104*/].f_24 != 0)
		{
			if (Global_4541037[num4 /*104*/].f_99[Global_20500] == 1)
			{
				unk_0x88F483FBD433696A(Global_20481, "SET_DATA_SLOT");
				...
				if (Global_4541037[num4 /*104*/].f_17 == 145)
				{
					unk_0x882AEFD55B8D51FB("CELL_2000" /*~a~*/);
					unk_0x60D332F23943B34F(&(Global_4541037[num4 /*104*/].f_50));
					unk_0xCFAD3D478C87321A();
				}
				else
				{
					func_16(&(Global_2058[Global_4541037[num4 /*104*/].f_17 /*29*/].f_3));
				}
			
				unk14 = { Global_4541037[num4 /*104*/] };
			
				if (func_44(&Global_4541037[num4 /*104*/]))
				{
					num5 = func_55(7315, -1);
	...
	while (num < iLocal_1371 + iLocal_30)
	{
		num2 = 0;
		num6 = 0;
	
		while (num2 < iLocal_1371 && num6 == 0)
		{
			unk_0xEC552A25287441B8(num2, &uLocal_1372);
			...
			if (unk30[num2] == 0)
			{
				...
				unk_0x60D332F23943B34F(&uLocal_1372.f_23[0 /*16*/]);
				unk_0x60D332F23943B34F(&uLocal_1372.f_23[1 /*16*/]);
				unk_0xCFAD3D478C87321A();
				unk_0xE6B753D52F4CA222();
				unk30[num2] = 1;
				uLocal_17[num] = num2;
...
var func_55(int iParam0, int iParam1) // Position - 0x3661
{
	if (iParam1 == -1)
		iParam1 = func_42();
...
void func_57(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3768
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	unk_0x330108B080A2132F(SYSTEM::ROUND(fParam2));
...
void func_58() // Position - 0x37CB
{
	...
	{
		SYSTEM::WAIT(0);
		iLocal_1370 = unk_0x80CA040BF6D2FA31();
	...
	if (bLocal_1369)
		iLocal_1371 = unk_0x6109CAB6F2F7BB46();
	else
		iLocal_1371 = 0;

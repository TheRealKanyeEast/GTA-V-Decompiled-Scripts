...
BOOL func_4() // Position - 0x1B6
{
	...
	if (!func_3(&unk))
	{
		...
		else if (unk_0x5266F1D2AEF6F73A(Global_98143))
		{
			...
			if (!func_5(Global_100554, uLocal_73, 2))
				if (num >= 0.9f)
					unk_0x73CAFD2038E812B3(Global_100554, uLocal_73, 2);
...
void func_12() // Position - 0x4B0
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_15(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_13(num) && !func_17(14) || Global_112760)
			{
...
void func_22() // Position - 0x6A5
{
	...
	while (!unk_0xFC8BFE4B41177C22(Global_100554) || !unk_0xFC8BFE4B41177C22(uLocal_73) || !unk_0x6252BC0DD8A320DB(iLocal_72) && num < 400)
	{
	...
	{
		unk_0x3CEA1FD137ACE2D9(Global_100554, Global_95817);
		unk_0x397CF4F4C8B17365(Global_100554, "A_F_Y_BevHills_01_White_FULL_01");
	}
...
BOOL func_32(int iParam0, BOOL bParam1, int iParam2) // Position - 0x7C97
{
	...
	{
		if (func_38() || unk_0x761778199FE1211C() || func_37())
		{
		}
		else if (!func_40())
		{
...
BOOL func_46(var uParam0) // Position - 0xD683
{
	...
	if (func_47(vector, 0f, 0f, 0f, false))

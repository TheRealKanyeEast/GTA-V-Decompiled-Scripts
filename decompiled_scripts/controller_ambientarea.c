		...
		while (num2 != 2)
		{
			if (func_13(&Global_32624[num /*7*/]))
			{
				if (func_12(num, unk))
				{
					...
					{
						if (unk_0xF40767E41852FB72(Global_32624[num /*7*/].f_5))
							unk_0xE1440F5C29913E5D(Global_32624[num /*7*/].f_5, 1);
			...
			{
				if (func_5(&Global_32624[num /*7*/], unk))
					func_1(num);
			}
...
BOOL func_12(int iParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x553
{
	...
	if (!unk_0xF40767E41852FB72(Global_32624[iParam0 /*7*/].f_5))
		return true;

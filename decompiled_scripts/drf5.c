...
void main() // Position - 0x0
{
	...
	iLocal_430 = func_276() ? 0 : 1;
	iLocal_431 = func_276() ? 0 : 1;
	iLocal_432 = func_276() ? 0 : 1;
	...
	if (unk_0x96CFB880BAC634CE(67))
	{
		...
		func_256(&iLocal_397, &uLocal_400, uLocal_402, iLocal_58);
	}

	iLocal_80 = func_255();
	func_254(&uLocal_59, iLocal_80);
	unk_0xD7ABE01242C5B8E3(-1899.7563f, -561.3688f, 10.78784f, 100f);
	unk_0x0B0C9A0F9AAEB7F0(&(Global_113810.f_10019.f_25), 6);
			...
			case 3:
				...
				if (!flag3)
				{
					...
					else if (!flag4 && func_137(&uLocal_249) >= 7f)
					{
						...
						func_98(&uLocal_81, &unk9, &unk13, 9, 0, 0, 0);
						flag4 = true;
					}
				}
					...
					if (!bLocal_437)
					{
						...
						if (func_137(&uLocal_261) > 2f)
						{
							...
							if (unk_0xFC8BFE4B41177C22(uLocal_400) && !unk_0x1C2F771CDC87A3A5(uLocal_400, 0))
							{
								...
								unk_0x935364B4448CD584(uLocal_400, 0);
...
int func_2(int iParam0, int iParam1, int iParam2) // Position - 0x1126
{
	...
	return func_3(func_37(iParam0), 0, iParam1, iParam2, false);
}
...
void func_9(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1CB2
{
	int num;
...
int func_10(int iParam0, int iParam1) // Position - 0x1CD5
{
...
void func_13(int iParam0, int iParam1, int iParam2) // Position - 0x1D2A
{
	if (iParam2 == -1)
		iParam2 = func_12();
...
void func_40() // Position - 0x24E2
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_43(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_41(num) && !func_32(14) || Global_112760)
			{
...
int func_44(int iParam0) // Position - 0x264D
{
	return Global_2058[iParam0 /*29*/];
}

BOOL func_45(var uParam0) // Position - 0x265C
{
	var unk;
	int num;
...
BOOL func_46(var uParam0) // Position - 0x26DF
{
	if (func_47(uParam0))
...
BOOL func_47(var uParam0) // Position - 0x2709
{
...
int func_48(var uParam0) // Position - 0x272A
{
	if (func_47(uParam0))
...
BOOL func_49(var uParam0) // Position - 0x274A
{
	var unk;
	int num;
...
void func_50(var uParam0, float fParam1) // Position - 0x27B6
{
...
BOOL func_53(var uParam0, float fParam1) // Position - 0x2852
{
...
BOOL func_54(var uParam0, float fParam1) // Position - 0x2870
{
	if (func_76(uParam0))
...
BOOL func_62(int iParam0, int iParam1) // Position - 0x2F40
{
...
float func_73(int iParam0, var uParam1, int iParam2) // Position - 0x32C5
{
	var unk;
	var unk4;
...
BOOL func_76(var uParam0) // Position - 0x33F8
{
...
Vector3 func_78(var uParam0) // Position - 0x3444
{
	var unk;
	var unk4;
	var unk7;
...
void func_79(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x34A9
{
	if (bParam0)
	{
...
BOOL func_83(int iParam0) // Position - 0x36AA
{
	int num;
...
BOOL func_84(int iParam0) // Position - 0x36CC
{
...
int func_86(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x3719
{
	int num;
...
Vector3 func_88(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x376F
{
	var unk;
...
BOOL func_89(var uParam0) // Position - 0x37B5
{
	if (!unk_0xFC8BFE4B41177C22(uParam0))
		return false;
...
void func_90() // Position - 0x37D3
{
	...
	if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0) && !unk_0x1C2F771CDC87A3A5(uLocal_399, 0) && unk_0xD9F5E1FEFD1329E4(uLocal_399, 0))
	{
		...
		if (unk_0xFC8BFE4B41177C22(uLocal_400))
		{
			...
			{
				unk_0xF698038C13845696(uLocal_400);
				unk_0x935364B4448CD584(uLocal_400, 1);
		...
		if (!unk_0x4FAFF4BCB7633475(iLocal_398) && !unk_0x1C2F771CDC87A3A5(uLocal_399, 0))
		{
			...
			unk_0xEBA229B2E0BB05E0(0, uLocal_399, -1, -1, num, 1, 0);
...
BOOL func_95(int iParam0, int iParam1, var uParam2) // Position - 0x3BF3
{
	int num;
	var unk;
	var unk9;
...
BOOL func_99(var uParam0, var uParam1, var uParam2) // Position - 0x3E2C
{
	BOOL flag;
	BOOL flag2;
...
void func_100(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x3EAA
{
	var unk;
	var unk2;
	BOOL flag;
...
void func_103(var uParam0) // Position - 0x418B
{
...
void func_104(var uParam0) // Position - 0x419D
{
...
BOOL func_106(var uParam0) // Position - 0x41BA
{
	if (*uParam0 != 0)
	{
...
void func_107(var uParam0) // Position - 0x41E1
{
	if (*uParam0 != 0)
	{
...
void func_109(var uParam0, var uParam1, int iParam2) // Position - 0x4217
{
	BOOL flag;
...
void func_121(var uParam0) // Position - 0x478F
{
	func_50(uParam0, 0f);
	return;
}
...
void func_133(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, float fParam8, int iParam9) // Position - 0x4B31
{
	var unk;
	int num;
...
void func_134(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4CCB
{
	int num;
	var unk;
	var unk9;
...
void func_135(var uParam0) // Position - 0x4E00
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
float func_137(var uParam0) // Position - 0x4E39
{
	if (func_76(uParam0))
		if (func_138(uParam0))
			return uParam0->f_2;
...
void func_139(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4E82
{
	var unk;
	int i;
...
int func_144(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5543
{
	var unk;
	int i;
	int num;
...
BOOL func_150(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x5B9B
{
	int num;
...
BOOL func_160(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x905A
{
	int num;
	int num2;
	int num3;
...
void func_163(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xBB6A
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_155(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_155(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78670)
		{
			...
			func_155(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_218(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x1D0AB
{
	int num;
...
int func_219(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x1D3B2
{
	int num;
	int num2;
	int num3;
...
var func_223(int iParam0, int iParam1) // Position - 0x1D677
{
...
void func_226(var uParam0, int iParam1) // Position - 0x1DE16
{
	int bitShift;
	BOOL flag;
...
struct<4> func_228(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3) // Position - 0x1DF76
{
	...
	if (!func_233(&(Global_113810.f_19964), 8) && bParam1 && iParam0 != 4 && func_231(3) > 0 && unk_0xD2AA6F822D3A55D2(0, 1065353216) < 0.75f)
	{
		num = 8;
		*uParam3 = 4;
	}
...
void func_236(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1E754
{
	if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
...
void func_246(var uParam0) // Position - 0x21EF0
{
	if (!func_76(uParam0))
		func_121(uParam0);
...
void func_256(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x221BA
{
	unk_0x747786364137DC63(1);
	unk_0x37B894853929BF1A(1);
	func_260();
...
void func_261() // Position - 0x223DE
{
	...
	if (Global_113810.f_9088 || func_270(false))
	{
		if (!func_269())
		{
			num = func_268();
...
BOOL func_270(BOOL bParam0) // Position - 0x2323D
{
...
void func_271(BOOL bParam0, BOOL bParam1) // Position - 0x23265
{
	...
	if (bParam0)
	{
		if (func_270(false) && Global_78936.f_1 == 1 && func_272(Global_78936))
		{
		}
		else
		{
...
BOOL func_276() // Position - 0x233DD
{

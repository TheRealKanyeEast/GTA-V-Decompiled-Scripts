...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_66(unk_0x4A8C381C258A124D(), unk, 0) > 100f + 20f)
			func_76();
...
int func_4(var uParam0, int iParam1) // Position - 0xBA6
{
	var unk;
	int num;
	int i;
...
BOOL func_6() // Position - 0xC51
{
	...
	if (!func_65(14) && unk_0x486FF5D06E9659F1(joaat("director_mode")) > 0)
		return true;
...
BOOL func_14(var uParam0) // Position - 0xE4D
{
...
BOOL func_26(var uParam0) // Position - 0x1182
{
...
void func_31() // Position - 0x125C
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_34(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_32(num) && !func_65(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != num && func_32(Global_113810.f_2366.f_539.f_4321))
...
int func_33(var uParam0) // Position - 0x1365
{
	int i;
	int num;
...
int func_35(int iParam0) // Position - 0x13C7
{
...
BOOL func_39(int iParam0) // Position - 0x144A
{
	int num;
...
BOOL func_44(int iParam0) // Position - 0x1577
{
	...
	if (func_45(unk_0x259BE71D8A81D4FA()))
		return false;

	return true;
}

BOOL func_45(var uParam0) // Position - 0x15E3
{
	if (func_48(uParam0))
		return true;
...
BOOL func_46(int iParam0) // Position - 0x1606
{
	int num;
...
BOOL func_47(int iParam0, int iParam1) // Position - 0x1624
{
	return IS_BIT_SET(Global_1895156[iParam0 /*609*/].f_10.f_4, iParam1);
}

BOOL func_48(int iParam0) // Position - 0x163C
{
	int num;
...
float func_66(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x5DAF
{
	var unk;
...
BOOL func_67(var uParam0) // Position - 0x5DE9
{
	if (!unk_0xFC8BFE4B41177C22(uParam0))
		return false;
...
BOOL func_78(float fParam0, var uParam1, var uParam2) // Position - 0x60D9
{

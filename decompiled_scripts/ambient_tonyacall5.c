...
int func_19(var uParam0) // Position - 0xC22
{
	int i;
	int num;
...
int func_21(int iParam0) // Position - 0xC84
{
...
BOOL func_29(float fParam0, var uParam1, var uParam2) // Position - 0xF35
{
...
void func_31(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1018
{

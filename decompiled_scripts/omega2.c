...
void func_5() // Position - 0x280
{
	...
	{
		case 0:
			func_45(&uLocal_170, 1, unk_0x4A8C381C258A124D(), "FRANKLIN", 0, 1);
		...
		case 1:
			if (func_29(unk_0x4A8C381C258A124D()))
			{
				...
				{
					if (func_29(iLocal_169) && unk_0xCECDBB848D53DEB2(unk_0x4A8C381C258A124D(), iLocal_169, 1))
...
int func_21(var uParam0) // Position - 0xA86
{
	int i;
	int num;
...
BOOL func_29(int iParam0) // Position - 0xC41
{
...
void func_45(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xF7B
{
	...
	switch (iLocal_141)
	{
		...
		case 1:
			...
			if (unk_0xC9BA6D804FA4FAAA())
			{
				...
				{
					uLocal_157 = unk_0x43AFC452F25F3A2F(iLocal_164, uLocal_158, 1, 1, 0);
...
Vector3 func_64(var uParam0) // Position - 0x17CE
{
...
int func_65(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17E1
{
	...
	if (iParam5 == 0)
	{
		Global_78472[1 /*14*/] = { func_118(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78472[1 /*14*/] = { func_118(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78472[1 /*14*/] = { func_118(num8, 14, unk18[j], -1) };
							func_85(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
							func_108(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_75(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_75(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_75(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
			...
			{
				Global_78472[1 /*14*/] = { func_118(num8, i, func_74(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78472[1 /*14*/] = { func_118(num8, 14, unk59[j], -1) };
			func_85(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
			func_108(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_75(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_75(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_75(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
...
BOOL func_66(var uParam0, int iParam1, var uParam2) // Position - 0x1FF2
{
	...
	{
		if (!func_182(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_64, Global_113810.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_73(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x28E6
{
	...
	{
		if (!func_182(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_61, Global_113810.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
void func_110(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8833
{
	int num;
...
int func_111(int iParam0, int iParam1) // Position - 0x8856
{
...
BOOL func_125(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE4D8
{
	int num;
	int num2;
	int num3;
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xE5EA
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_121(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_121(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78670)
		{
			...
			func_121(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_182(var uParam0, int iParam1, int iParam2) // Position - 0x1F975
{
	int num;
	int num2;
	int i;
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_78472[1 /*14*/] = { func_118(num, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_182(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_182(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78472[2 /*14*/] = { func_118(num, 14, k, -1) };
								
									if (Global_78472[2 /*14*/].f_12 == j)
										if (func_182(uParam0, 14, k))
											if (!func_71(num, iParam2, 14, k, &unk, &Global_78472[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_78472[2 /*14*/] = { func_118(num, i, num2, -1) };
					
						if (!func_71(num, iParam2, i, num2, &unk, &Global_78472[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_78472[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_75(iParam1)) && Global_78472[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_75(iParam1)))
	{
		return true;
	}
...
void func_184(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1FC0D
{
	if (bParam0)
	{
...
BOOL func_188(int iParam0) // Position - 0x1FE0E
{
	int num;
...
BOOL func_189(int iParam0) // Position - 0x1FE30
{
...
int func_191(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x1FE7D
{
	int num;
...
void func_194(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x1FEFC
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
BOOL func_195(float fParam0, var uParam1, var uParam2) // Position - 0x202F3
{
...
BOOL func_196(var uParam0, int iParam1, BOOL bParam2) // Position - 0x2031D
{
	int i;
	var unk;
	int num;
	...
	for (i = 0; func_197(iParam1, i, &unk, &num); i = i + 1)
	{
...
BOOL func_197(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x2038B
{
...
BOOL func_198(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x20463
{
	float num;
	var unk3;
	var unk6;
...
void func_201(var uParam0) // Position - 0x2084C
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
int func_204(var uParam0, int iParam1) // Position - 0x208E2
{
	int num;
	var unk;
	var unk33;
...
BOOL func_213() // Position - 0x22441
{
...
BOOL func_215(var uParam0, int iParam1) // Position - 0x224B4
{
	if (func_216(uParam0))
...
BOOL func_216(var uParam0) // Position - 0x224E7
{
	if (func_29(uParam0))
		if (!unk_0x4FAFF4BCB7633475(uParam0))
			return true;
...
BOOL func_217(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x22507
{
...
void func_218(var uParam0) // Position - 0x2269F
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_221() // Position - 0x22703
{
	...
	if (func_223())
	{
		if (unk_0x1DD05E817C89C737() < iLocal_144 && !func_222(unk_0x4A8C381C258A124D(), uLocal_79.f_28[0], 5f, 1))
		{
...
BOOL func_222(var uParam0, var uParam1, float fParam2, int iParam3) // Position - 0x2279E
{
...
BOOL func_223() // Position - 0x227C0
{
	...
	{
		if (func_225(uLocal_79.f_28[0], true, 1116471296, 1126825984, false, false, false, false) || func_224(unk_0x4A8C381C258A124D(), uLocal_79.f_28[0], true))
		{
...
BOOL func_224(var uParam0, var uParam1, BOOL bParam2) // Position - 0x22876
{
...
BOOL func_225(var uParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x228C1
{
	float num;
	...
	if (func_29(unk_0x4A8C381C258A124D()) && func_29(uParam0))
	{
		...
		if (func_238(uParam0, bParam1, bParam5, bParam6, bParam7))
			return true;
		...
		if (!unk_0x11552FA9DCB8E126(unk_0x4A8C381C258A124D(), 6))
		{
			if (unk_0xFFAC548682B3D56E(unk_0x4A8C381C258A124D()))
			{
				...
				if ((num * num) + (num.f_1 * num.f_1) + (num.f_2 * num.f_2) <= 5f)
					return func_237(unk_0x4A8C381C258A124D(), uParam0, iParam2);
			}
		}
	
		if (bParam4)
			return false;
		else if (func_226(uParam0, iParam3))
			return true;
	}
...
BOOL func_226(var uParam0, int iParam1) // Position - 0x2297C
{
	float num;
...
BOOL func_227(var uParam0, int iParam1) // Position - 0x229F2
{
	return func_228(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_228(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x22A0A
{
	BOOL flag;
	var unk;
	int num;
	...
	if (!func_29(uParam0) || !func_29(uParam1))
	{
		if (num != -1)
	...
	flag = func_229(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_229(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0x22ACB
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_230(var uParam0, int iParam1) // Position - 0x22BF7
{
	int num;
...
BOOL func_232(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0x22D06
{
	var unk;
	var unk4;
	float num;
...
int func_235(var uParam0, var uParam1) // Position - 0x22DD3
{
	int i;
...
int func_236(var uParam0) // Position - 0x22E12
{
...
BOOL func_237(var uParam0, var uParam1, int iParam2) // Position - 0x22E3A
{
	float num;
	Vector3 vector;
...
BOOL func_238(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x22E81
{
	float num;
	float num2;
	int num3;
	...
	if (func_29(unk_0x4A8C381C258A124D()) && func_29(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_242(uParam0, bParam1, num, num2))
				return true;
		
			if (func_239(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_239(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x22F7C
{
	float num;
	float num2;
...
BOOL func_240(var uParam0, float fParam1) // Position - 0x23088
{
	var unk;
	var unk2;
	...
	if (unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_241(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_241(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x2311D
{
	var unk;
	var unk4;
	float num;
...
BOOL func_242(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0x231AB
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_257(Global_78945, Global_78947, iParam10) };
				num4 == -0.014f;
...
float func_256(var uParam0) // Position - 0x238D5
{
...
{
	if (!func_268(0) || Global_78960 || Global_78948 == 1 || !unk_0x9390801B06EE998F())
		return false;
	...
	switch (Global_78944)
	{
		...
		case 5:
			if (unk_0xFD216000DC314A92() || func_250(0) || func_267(true))
			{
			}
			else
			{
...
void func_271(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2400D
{
	var unk;
...
void func_272(var uParam0, int iParam1, BOOL bParam2) // Position - 0x240B7
{
	int i;
...
void func_274(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x2437A
{
	func_38(uParam0);
...
BOOL func_275(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x243BC
{
	if (func_276(uParam0, iParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_276(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x24418
{
	int num;
...
BOOL func_282() // Position - 0x245A8
{
...
BOOL func_285(BOOL bParam0) // Position - 0x246E2
{
...
void func_290() // Position - 0x2497E
{
	...
	if (!unk_0xB00920C3C99A34C5())
	{
		if (!Global_78689)
		{
			if (func_291() == 2 == false && !unk_0x76CD105BCAC6EB9F())
			{
...
void func_293(int iParam0, int iParam1, int iParam2) // Position - 0x24E98
{
	if (iParam2 == -1)
		iParam2 = func_113();
...
BOOL func_314(var uParam0, int iParam1, int iParam2) // Position - 0x25958
{
	int num;
	int i;
	var unk;
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			if (!func_314(uParam0, 14, unk18[j]))
				flag = 0;
		}
	...
	{
		unk28 = { func_98(num, 0) };
		Global_78472[1 /*14*/] = { func_118(num, iParam1, unk28[iParam1], -1) };
	
		if (unk_0x1A4EFE92822E3123(uParam0, func_75(iParam1)) > 0 && unk_0x8401C77F508D70FD(uParam0, func_75(iParam1), Global_78472[1 /*14*/].f_3) > 0)
			unk_0xD1C578C204015E1F(uParam0, func_75(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, 0);
	}
...
void func_315(var uParam0, int iParam1) // Position - 0x25B15
{
...
void func_318(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x25BF6
{
...
void func_319(int iParam0, int iParam1, int iParam2) // Position - 0x25C93
{
	var unk;
	var unk33;
	...
	if (iParam0 != -1)
	{
		...
		func_320(&unk33, unk.f_3, Global_100870, iParam1, iParam2);
	}

	return;
}

void func_320(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x25CD2
{
...
void func_322() // Position - 0x25D28
{
	...
	{
		func_19();
		unk_0xAFB25B9F2232474E(func_323(Global_113810.f_2366.f_539.f_4321));
	}
	else
	{
...
char* func_323(int iParam0) // Position - 0x25D5A
{
	iParam0 = iParam0;
	return "";
}
...
void func_324() // Position - 0x25D69
{
	...
	if (unk_0x1226C55CA7D2269A() || func_326())
	{
		unk_0x012C74D626CB4559(StackVal, 0, 0, 0);
	}
	else if (unk_0x0BA1A956D36B210F() || func_325())
	{
...
void func_358(BOOL bParam0) // Position - 0x2B205
{
	...
	if (!func_375())
	{
		...
		{
			func_319(num, 1, 0);
			func_359(unk_0x1AF90EB93E0012D6(), num);
		}
		else
		{
			if (Global_112897[num /*10*/].f_9 == -1)
...
BOOL func_360(char* sParam0, int iParam1, int iParam2) // Position - 0x2B2FD
{
	var unk;
	var unk2;
	int num;
	...
	if (func_366())
	{
		...
		{
			num = func_361(unk_0x1AF90EB93E0012D6());
...
int func_364(var uParam0, BOOL bParam1) // Position - 0x2B530
{
	int i;
...
void func_367(int iParam0) // Position - 0x2B622
{

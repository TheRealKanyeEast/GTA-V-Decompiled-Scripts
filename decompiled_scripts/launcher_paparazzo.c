...
void main() // Position - 0x0
{
	...
	if (!func_277(&unk64, &num, unk61, 5f))
	{
		func_276();
	...
	while (true)
	{
		...
		if (num == 47)
			func_207(&num, unk61, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		else if (num == 51)
			func_207(&num, unk61, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
	
		func_206(num);
		func_198(&iLocal_93, &(num.f_9), unk61);
	
		if (func_183(&num, 0))
		{
			if (func_182(num))
				func_179(num, &uLocal_95);
...
int func_32(var uParam0) // Position - 0x2ABC
{
	int i;
...
int func_33(var uParam0, int iParam1, int iParam2) // Position - 0x2B1F
{
	int i;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D4A
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x69E2
{
	int i;
	float num;
	float num2;
...
BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x74F9
{
...
BOOL func_85(int iParam0) // Position - 0x754F
{
	if (iParam0 != func_94())
...
BOOL func_93(int iParam0) // Position - 0x8406
{
	if (iParam0 != func_94())
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8DDE
{
...
BOOL func_117(BOOL bParam0) // Position - 0x8E20
{
...
BOOL func_135(var uParam0) // Position - 0xACD6
{
	if (func_136(uParam0))
...
BOOL func_136(int iParam0) // Position - 0xACF6
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAE3A
{
	int i;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAFD9
{
	if (bParam0)
	{
...
BOOL func_147(int iParam0) // Position - 0xB1DA
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB1FC
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB249
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB2C6
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB3F9
{
...
void func_160(var uParam0) // Position - 0xB591
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_177(var uParam0, int iParam1) // Position - 0xBC16
{
	int num;
	var unk;
	var unk33;
...
var func_180(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC0F3
{
	var unk;
...
BOOL func_188(var uParam0) // Position - 0xCB4C
{
	if (func_136(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_198(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD379
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
float func_202(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD57D
{
	var unk;
...
int func_207(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD6EA
{
	...
	if (func_136(unk_0x4A8C381C258A124D()) && func_136(uParam0->f_28[0]) && !func_156() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_202(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
		func_210(&unk, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		func_208(&unk, sParam4, sParam5, 7, 0, 0);
...
void func_210(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD803
{
...
BOOL func_211(Any* panParam0, BOOL bParam1) // Position - 0xD89E
{
	var unk;
	...
	{
		if (!func_219(panParam0, true, true))
		{
			if (*panParam0 == 16)
				func_218(panParam0);
			else
	...
	{
		if (!func_219(panParam0, false, true))
		{
			func_216(panParam0);
			return false;
		}
	...
	{
		if (!func_219(panParam0, true, false))
		{
			func_216(panParam0);
			return false;
		}
	...
	{
		if (!func_219(panParam0, false, false))
		{
			func_216(panParam0);
			return false;
		}
...
void func_217(var uParam0) // Position - 0xE1C7
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_219(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE272
{
	int i;
	int num;
	var unk;
...
BOOL func_220(var uParam0, var uParam1) // Position - 0xE430
{
	var unk;
...
BOOL func_223(var uParam0, int iParam1) // Position - 0xE750
{
	float num;
...
BOOL func_224(var uParam0, int iParam1) // Position - 0xE7C6
{
	return func_225(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_225(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE7DE
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_226(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE89F
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_227(var uParam0, int iParam1) // Position - 0xE9CB
{
	int num;
...
BOOL func_229(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xEADA
{
	var unk;
	var unk4;
	float num;
...
int func_233(var uParam0, var uParam1) // Position - 0xEBE6
{
	int i;
...
int func_234(var uParam0) // Position - 0xEC25
{
...
BOOL func_235(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEC4D
{
	float num;
	float num2;
	int num3;
...
BOOL func_236(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xED48
{
	float num;
	float num2;
...
BOOL func_237(var uParam0, float fParam1) // Position - 0xEE54
{
	var unk;
	var unk2;
...
BOOL func_238(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEEE9
{
	var unk;
	var unk4;
	float num;
...
BOOL func_239(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEF77
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_241(var uParam0) // Position - 0xF009
{
	var unk;
...
BOOL func_251(var uParam0) // Position - 0xF325
{
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_260(&num) || !unk_0xE100DD4F82A51BDE(str))
				return false;
		...
		case 2:
			...
			{
				func_255(&uParam0->f_28[1], num[3], -498.16565f, 228.62839f, 82.09948f, 292.9763f, 26);
			...
			{
				func_255(&uParam0->f_28[2], num[4], -498.30902f, 227.91116f, 82.105995f, 296.4216f, 26);
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_41[0]))
			{
				...
				if (func_136(uParam0->f_28[0]) && unk_0xFC8BFE4B41177C22(uParam0->f_41[0]))
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_41[1]))
			{
				...
				if (func_136(uParam0->f_28[1]) && unk_0xFC8BFE4B41177C22(uParam0->f_41[1]))
...
void func_252(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF8EA
{
	func_217(uParam0);
...
void func_253(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF911
{
	func_254(uParam0);
...
void func_254(var uParam0) // Position - 0xF953
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_255(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0xF9EF
{
	func_256(uParam0);
...
void func_256(var uParam0) // Position - 0xFA10
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_257(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFA51
{
	if (func_258(uParam0, iParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_258(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFAAD
{
	int num;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (func_135(uParam0->f_28[0]))
			{
				...
				{
					func_252(&uParam0->f_41[3], num[1], unk_0x0D1381B6E0F3987D(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
...
BOOL func_264(var uParam0) // Position - 0x10213
{
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_260(&num) || !unk_0xE100DD4F82A51BDE("rcmpaparazzo_2"))
				return false;
		...
		case 2:
			...
			if (func_135(uParam0->f_28[0]))
			{
				if (!unk_0xFC8BFE4B41177C22(uParam0->f_41[0]))
				{
					func_252(&uParam0->f_41[0], num[2], unk_0x0D1381B6E0F3987D(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
		...
		case 3:
			if (func_136(uParam0->f_28[0]) && func_136(unk_0x4A8C381C258A124D()))
			{
...
void func_285(var uParam0, BOOL bParam1) // Position - 0x11072
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_288(var uParam0) // Position - 0x110FC
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_291(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x11187
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))

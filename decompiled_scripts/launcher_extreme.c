...
void main() // Position - 0x0
{
	...
	if (!func_279(&unk64, &num, unk61, 1f))
	{
		func_278();
	...
	if (num == 17)
	{
		uLocal_95 = unk_0xA7B0B03284E7503C(unk61 - { 40f, 40f, 40f }, unk61 + { 40f, 40f, 40f }, 0, 1, 1, 1);
		unk_0x470041F66BF345BA("WORLD_VEHICLE_SALTON_DIRT_BIKE", 0);
	}
	else if (num == 18)
	{
		uLocal_95 = unk_0xA7B0B03284E7503C(-1040f, -2870f, 0f, -910f, -2740f, 50f, 0, 0, 1, 1);
	}
	...
	while (true)
	{
		...
		func_214(num);
		func_207(&iLocal_92, &(num.f_9), unk61);
	
		if (num == 18)
		{
			func_206(&num);
			func_201(&num, unk61, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (num == 19)
		{
			func_206(&num);
			...
			if (unk_0x9F0C06CFBACDD6A1(uLocal_94))
				func_201(&num, unk61, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
		
			if (!func_200() && func_199(num.f_28[0]) && !unk_0x75E315E7679F4F24(num.f_28[0]) && unk_0x9F0C06CFBACDD6A1(uLocal_94) && unk_0xD7E1DF759CD0FFF2("EXTREME_04_DOM_A", 0, -1) && unk_0xD7E1DF759CD0FFF2("EXTREME_04_DOM_B", 0, -1) && unk_0xD7E1DF759CD0FFF2("EXTREME_04_DOM_C", 0, -1))
				unk_0xBD618A73193F9982(uLocal_94, "DOM_BREATHING", num.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
		
			if (iLocal_93 == 0 && func_199(unk_0x4A8C381C258A124D()) && unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), unk61, num.f_15, num.f_15, num.f_15, 0, 0, 0))
			{
				...
				{
					iLocal_93 = 1;
					func_198("TOPMAZE_HELP" /*Get to the top of the Maze Tower to start this mission.*/, -1);
...
int func_32(var uParam0) // Position - 0x2C0C
{
	int i;
...
int func_33(var uParam0, int iParam1, int iParam2) // Position - 0x2C6F
{
	int i;
...
int func_34(int iParam0, int iParam1) // Position - 0x2CFD
{
	int num;
...
void func_35(int iParam0, var uParam1, int iParam2) // Position - 0x2D3F
{
	int num;
...
BOOL func_36(int iParam0) // Position - 0x2F9B
{
	return iParam0 < 3;
}
...
BOOL func_43(var uParam0, int iParam1, BOOL bParam2) // Position - 0x36F5
{
	int i;
	var unk;
	int num;
...
BOOL func_44(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x3763
{
...
int func_47(int iParam0) // Position - 0x389E
{
...
var func_50(int iParam0, int iParam1) // Position - 0x3A76
{
...
var func_54(int iParam0, int iParam1) // Position - 0x3AEF
{
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E99
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B31
{
	int i;
	float num;
	float num2;
...
BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x7648
{
...
BOOL func_85(int iParam0) // Position - 0x769E
{
	if (iParam0 != func_94())
...
BOOL func_93(int iParam0) // Position - 0x8557
{
	if (iParam0 != func_94())
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8F2F
{
...
BOOL func_117(BOOL bParam0) // Position - 0x8F71
{
...
BOOL func_135(var uParam0) // Position - 0xAE27
{
	if (func_199(uParam0))
...
void func_142(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB109
{
	if (bParam0)
	{
...
BOOL func_146(int iParam0) // Position - 0xB30A
{
	int num;
...
BOOL func_147(int iParam0) // Position - 0xB32C
{
...
int func_149(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB379
{
	int num;
...
BOOL func_152(var uParam0) // Position - 0xB3F6
{
...
void func_156() // Position - 0xB4AF
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
		if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
			if (func_157(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 10.5f, 1, 1056964608, 0, true, false))
...
BOOL func_157(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB507
{
...
void func_158(var uParam0) // Position - 0xB69F
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_175(var uParam0, int iParam1) // Position - 0xBD24
{
	int num;
	var unk;
	var unk33;
...
var func_178(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC202
{
	var unk;
...
int func_181(var uParam0) // Position - 0xC2D4
{
	if (*uParam0 == 18)
	{
		if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), -954.5357f, -2760.5532f, 11.916363f, -947.6847f, -2749.719f, 15.631608f, 26f, 0, 1, 0))
		{
			...
			else if (!func_182(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && func_199(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)) && func_157(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 3f, 1, 1056964608, 0, true, false))
			{
				unk_0x092B9247AF00F5CF(unk_0x4A8C381C258A124D(), 0, 0);
			}
		}
...
BOOL func_182(var uParam0, int iParam1) // Position - 0xC37B
{
	if (func_135(uParam0))
...
int func_183(var uParam0, int iParam1) // Position - 0xC3AE
{
	switch (uParam0->f_16)
	{
		...
		case 5:
			...
			{
				if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
					if (func_199(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)))
...
BOOL func_188(var uParam0) // Position - 0xCD35
{
	if (func_199(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_199(int iParam0) // Position - 0xD579
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
int func_201(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD5BC
{
	...
	if (func_199(unk_0x4A8C381C258A124D()) && func_199(uParam0->f_28[0]) && !func_200() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_205(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
		func_204(&unk, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		func_202(&unk, sParam4, sParam5, 7, 0, 0);
...
void func_204(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD6D5
{
...
float func_205(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD770
{
	var unk;
...
void func_207(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD7D7
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_205(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_210(uParam0, 1);
			}
			else
			{
				...
				if (func_205(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_212(uParam0);
			}
		}
	}
...
BOOL func_215(Any* panParam0, BOOL bParam1) // Position - 0xDB0E
{
	var unk;
	...
	{
		if (!func_223(panParam0, true, true))
		{
			if (*panParam0 == 16)
				func_222(panParam0);
			else
	...
	{
		if (!func_223(panParam0, false, true))
		{
			func_220(panParam0);
			return false;
		}
	...
	{
		if (!func_223(panParam0, true, false))
		{
			func_220(panParam0);
			return false;
		}
	...
	{
		if (!func_223(panParam0, false, false))
		{
			func_220(panParam0);
			return false;
		}
...
void func_221(var uParam0) // Position - 0xE437
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_223(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE4E2
{
	int i;
	int num;
	var unk;
...
BOOL func_224(var uParam0, var uParam1) // Position - 0xE6A0
{
	var unk;
...
BOOL func_227(var uParam0, int iParam1) // Position - 0xE9C0
{
	float num;

	if (func_199(unk_0x4A8C381C258A124D()) && func_199(uParam0))
	{
...
BOOL func_228(var uParam0, int iParam1) // Position - 0xEA36
{
	return func_229(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_229(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEA4E
{
	BOOL flag;
	var unk;
	int num;
	...
	if (!func_199(uParam0) || !func_199(uParam1))
	{
		if (num != -1)
...
BOOL func_230(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xEB0F
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_231(var uParam0, int iParam1) // Position - 0xEC3B
{
	int num;
...
BOOL func_233(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xED4A
{
	var unk;
	var unk4;
	float num;
...
int func_237(var uParam0, var uParam1) // Position - 0xEE56
{
	int i;
...
int func_238(var uParam0) // Position - 0xEE95
{
...
BOOL func_239(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEEBD
{
	float num;
	float num2;
	int num3;
...
BOOL func_240(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEFB8
{
	float num;
	float num2;
...
BOOL func_241(var uParam0, float fParam1) // Position - 0xF0C4
{
	var unk;
	var unk2;
...
BOOL func_242(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF159
{
	var unk;
	var unk4;
	float num;
...
BOOL func_243(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF1E7
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_245(var uParam0) // Position - 0xF279
{
	var unk;
...
void func_255(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0xF63D
{
	func_256(uParam0, iLocal_91, fParam1, fParam4, 26);
...
void func_256(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0xF66F
{
	func_257(uParam0);
...
void func_257(var uParam0) // Position - 0xF690
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_262(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF8FB
{
	if (func_263(uParam0, iParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_263(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF957
{
	int num;
...
void func_266(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFD2F
{
	func_267(uParam0);
...
void func_267(var uParam0) // Position - 0xFD71
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x110821AE6C63DD4F(*uParam0))
...
void func_287(var uParam0, BOOL bParam1) // Position - 0x105DB
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_290(var uParam0) // Position - 0x10665
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_293(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x106F0
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))

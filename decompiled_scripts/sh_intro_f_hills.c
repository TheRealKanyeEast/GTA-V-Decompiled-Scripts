			...
			case 0:
				if (func_150(0, 1093140480, 0))
				{
					if (unk_0x787F8EE1F6FBDC6D() && unk_0x9E2D35FA908F57B4() || unk_0x1DD05E817C89C737() - uLocal_51 > 9000)
					{
						...
						func_8("SHI_F_HILLS_1" /*This is Franklin's new safehouse. You can save vehicles by parking them in the Garage.*/, -1);
						bLocal_44 = true;
						iLocal_43 = 1;
					}
				}
...
int func_12(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x9AF
{
	...
	if (iParam5 == 0)
	{
		Global_78472[1 /*14*/] = { func_65(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78472[1 /*14*/] = { func_65(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78472[1 /*14*/] = { func_65(num8, 14, unk18[j], -1) };
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_22(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_22(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_22(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
			...
			{
				Global_78472[1 /*14*/] = { func_65(num8, i, func_21(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78472[1 /*14*/] = { func_65(num8, 14, unk59[j], -1) };
			func_32(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
			func_55(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_22(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_22(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_22(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
...
BOOL func_13(var uParam0, int iParam1, var uParam2) // Position - 0x11C0
{
	...
	{
		if (!func_130(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_64, Global_113810.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_20(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x1AB4
{
	...
	{
		if (!func_130(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_61, Global_113810.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
void func_57(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7A01
{
	int num;
...
int func_58(int iParam0, int iParam1) // Position - 0x7A24
{
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xD6A3
{
	int num;
	int num2;
	int num3;
...
void func_75(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xD7C3
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_68(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_68(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78670)
		{
			...
			func_68(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_130(var uParam0, int iParam1, int iParam2) // Position - 0x1EA3F
{
	int num;
	int num2;
	int i;
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_78472[1 /*14*/] = { func_65(num, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_130(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_130(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78472[2 /*14*/] = { func_65(num, 14, k, -1) };
								
									if (Global_78472[2 /*14*/].f_12 == j)
										if (func_130(uParam0, 14, k))
											if (!func_18(num, iParam2, 14, k, &unk, &Global_78472[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_78472[2 /*14*/] = { func_65(num, i, num2, -1) };
					
						if (!func_18(num, iParam2, i, num2, &unk, &Global_78472[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_78472[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_22(iParam1)) && Global_78472[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_22(iParam1)))
	{
		return true;
	}
...
void func_132() // Position - 0x1ECB1
{
	...
	{
		if (func_135(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_134(unk_0x4A8C381C258A124D());
		
			if (func_133(num) && !func_73(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != num && func_133(Global_113810.f_2366.f_539.f_4321))
...
int func_134(var uParam0) // Position - 0x1EDBA
{
	int i;
	int num;
...
int func_136(int iParam0) // Position - 0x1EE1C
{
...
void func_138(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1EE6A
{
	if (bParam0)
	{
...
BOOL func_142(int iParam0) // Position - 0x1F06B
{
	int num;
...
BOOL func_143(int iParam0) // Position - 0x1F08D
{
...
int func_145(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x1F0DA
{
	int num;
...
BOOL func_154() // Position - 0x1F2E6
{
...
BOOL func_156(var uParam0, int iParam1) // Position - 0x1F359
{
	if (func_6(uParam0))
...
BOOL func_157(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1F38C
{
...
void func_158(var uParam0) // Position - 0x1F524
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_174() // Position - 0x1FBDE
{
	...
	if (func_175(197, &num))
		if (!IS_BIT_SET(Global_113810.f_18536.f_23, num))
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113810.f_18536.f_23), num);

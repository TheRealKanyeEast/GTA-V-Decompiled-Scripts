...
BOOL func_33(var uParam0, int iParam1) // Position - 0xD4E
{
	...
	if (func_8(unk_0x4A8C381C258A124D()) && func_8(uParam0))
	{
	...
	if (iLocal_82 < iLocal_83)
	{
		if (!func_23())
		{
			if (SYSTEM::VDIST2(vParam3, vParam0) < iParam7 * iParam7)
			{
				...
				{
					unk = 16;
					func_47(&unk, 3, uLocal_80, "MAUDE", 0, 1);
					str = func_46();
					str2 = func_21();
...
void func_47(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1367
{

...
void func_5() // Position - 0x451
{
	...
	{
		if (func_9(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_8(unk_0x4A8C381C258A124D());
		
			if (func_7(num) && !func_6(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != num && func_7(Global_113810.f_2366.f_539.f_4321))
...
int func_8(var uParam0) // Position - 0x568
{
	int i;
	int num;
...
int func_10(int iParam0) // Position - 0x5CA
{
...
BOOL func_14(BOOL bParam0) // Position - 0x819
{
...
void func_36(int iParam0, int iParam1, int iParam2) // Position - 0x1184
{
	if (iParam2 == -1)
		iParam2 = func_21();
...
BOOL func_42(var uParam0) // Position - 0x140D
{
	if (unk_0xFC8BFE4B41177C22(uParam0))

...
int func_3(int iParam0) // Position - 0x12C
{
	...
	if (!unk_0x4FAFF4BCB7633475(*iParam0))
	{
		...
		{
			case 0:
				if (unk_0x5266F1D2AEF6F73A(Global_98142) || unk_0x5266F1D2AEF6F73A(Global_98143))
				{
			...
			case 1:
				if (unk_0x5266F1D2AEF6F73A(Global_98142))
				{
				}
				else if (unk_0x5266F1D2AEF6F73A(Global_98143))
				{
					unk_0x007DF2AFED58568A(Global_98143);
					...
					{
						num = unk_0xBD3B265153D3BA2D(Global_98143);
				...
				else
				{
					...
					if (unk_0xC0EEE6A2207F3CB8(unk5, 0, &vector, 14))
					{
						if (SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(*iParam0, 1), vector) > 100f)
						{
							...
							uLocal_348 = unk_0xA7B0B03284E7503C(unk10, unk13, 0, 0, 1, 1);
...
void func_7(int iParam0) // Position - 0x96A
{
	...
	if (unk_0x4FAFF4BCB7633475(iParam0))
	{
		if (!bLocal_351 && unk_0x9B3D4335E0EDB0BE(iParam0, unk_0x4A8C381C258A124D(), 1))
		{
			...
			if (num3 != -1)
			{
				num4 = func_124(iParam0);
			
				if (num4 != 0)
				{
					if (!func_123(num3) || func_115(num3) == 6)
					{
						func_114(75, unk_0xD1A6A821F5AC81DB(iParam0, 0), 250f, -1);
					
						if (func_46(Global_96547, num, 2, 0, num4, num3, 75))
							bLocal_351 = true;
					}
				}
			}
	...
	num5 = SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(iParam0, 1), unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1));
...
{
	unk_0x04C016145CE6A18B(iParam0, sParam1, func_9(iParam2), 1);
	return;
}

char* func_9(int iParam0) // Position - 0xAD8
{
	char* str;
...
BOOL func_14(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, int iParam5) // Position - 0x1105
{
	...
	if (func_33(sParam0, 7))
	{
		...
		{
			func_35(uParam2, 0, unk_0x4A8C381C258A124D(), str, 0, 1);
...
int func_40(int iParam0) // Position - 0x2293
{
...
void func_44() // Position - 0x22ED
{
	...
	{
		if (func_39(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_45(unk_0x4A8C381C258A124D());
		
			if (func_41(num) && !func_28(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != num && func_41(Global_113810.f_2366.f_539.f_4321))
...
int func_45(var uParam0) // Position - 0x23EA
{
	int i;
	int num;
...
BOOL func_46(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2427
{
	int num;
	int num2;
	int num3;
	...
	if (iParam3 == 0)
	{
		if (func_111(num2, iParam2, -1, &num5, &num6))
		{
			...
			if (func_107(iParam5, num5, num6, num, num3, iParam1, num4, 10000, iParam6, iParam4, num8, num7, 1))
				return true;
			else
				return false;
		}
	...
	{
		if (func_88(iParam1, &unk, 1, 0, 0, 0, 0, true, 0, 1))
		{
			if (iParam4 != 0)
			{
				switch (iParam4)
...
int func_48(int iParam0, int iParam1, int iParam2) // Position - 0x2613
{
	...
	return func_49(func_82(iParam0), 0, iParam1, iParam2, false);
}
...
void func_52(int iParam0) // Position - 0x2F22
{
	...
	if (flag)
	{
		...
		unk_0xACF853FB3F6EA7D4(func_53(iParam0));
...
char* func_53(int iParam0) // Position - 0x309A
{
	switch (iParam0)
	{
		case 0:
...
void func_55(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x31A8
{
	int num;
...
int func_56(int iParam0, int iParam1) // Position - 0x31CB
{
...
void func_59(int iParam0, int iParam1, int iParam2) // Position - 0x3220
{
	if (iParam2 == -1)
		iParam2 = func_58();
...
BOOL func_88(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x3AB6
{
	int num;
	char* str;
	int num2;
	...
	if (func_90(iParam0, sParam1, iParam2, num, str, str2, num2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, num3, str3, str4, num4) == 1)
	{
		if (bParam7 == true)
		{
			Global_9077 = iParam6;
			Global_8980[3 /*6*/] = { func_89(iParam0) };
			Global_9057 = iParam0;
...
int func_90(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x3B58
{
	int num;
	int num2;
	...
	func_91(iParam0, sParam1, num2, func_92(unk_0x259BE71D8A81D4FA()));
	return 1;
}
						...
						if (Global_8939[i] == 0)
						{
							...
							else if (num == 7)
							{
								if (Global_78689)
								{
									...
									func_94(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20500)
...
void func_94(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x4681
{
...
void func_95(int iParam0) // Position - 0x4734
{
...
void func_96(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4746
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	unk_0x330108B080A2132F(SYSTEM::ROUND(fParam2));
...
BOOL func_104(var uParam0, int iParam1) // Position - 0x4CBC
{
	int num;
	int num2;
...
BOOL func_107(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12) // Position - 0x4E05
{
	int num;
...
void func_108(int iParam0) // Position - 0x4F40
{
	int i;
	int num;
	int j;
...
BOOL func_110(BOOL bParam0) // Position - 0x5068
{
...
int func_116(int iParam0, var uParam1) // Position - 0x5376
{
	...
	if (IS_BIT_SET(num.f_2, func_117()))
		flag = true;
	...
	if (flag)
		if (num.f_3 < Global_113810.f_7691.f_919[func_117()])
			return 5;
...
int func_119(int iParam0, var uParam1) // Position - 0x5473
{
	int num;
	BOOL flag;
...
int func_121(int iParam0, var uParam1) // Position - 0x554E
{
	int num;
	BOOL flag;
...
int func_125(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x57CD
{
	int i;
	float num;
	float num2;
...
int func_128(int iParam0) // Position - 0x590B
{
...
BOOL func_131(int iParam0) // Position - 0x5984
{
	Vector3 vector;
	Vector3 vector2;
...
BOOL func_132(var uParam0, BOOL bParam1) // Position - 0x59E2
{
...
void func_134(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x5A79
{
...
BOOL func_136() // Position - 0x5AA3
{
	if (!func_138())
	{
		func_35(&uLocal_71, 0, unk_0x4A8C381C258A124D(), "MICHAEL", 0, 1);
...
BOOL func_139(int iParam0, int iParam1) // Position - 0x5CF9
{
	Vector3 vector;
	float num;
...
void func_147() // Position - 0x5EA9
{
	...
	while (!flag && num < 400)
	{
		...
		if (!unk_0xFC8BFE4B41177C22(Global_100554))
			flag = false;
	...
	unk_0xEE0BCDB1B5E36BCB(Global_100554, 1, 1);
	func_148(&Global_100554, Global_95816);
	unk_0x0428AFDCAA63B06E(Global_100554, 132, 1);
	unk_0x0428AFDCAA63B06E(Global_100554, 317, 1);
	return;
}

void func_148(int iParam0, int iParam1) // Position - 0x5F3F
{
...
BOOL func_155(int iParam0, BOOL bParam1, int iParam2) // Position - 0xA2EC
{
	int i;
	var unk;
...
BOOL func_156(int iParam0) // Position - 0xA46E
{
	int num;
	var unk;
	var unk2;
...
BOOL func_158(int iParam0, int iParam1) // Position - 0xA551
{
	BOOL num;
	var unk;
...
BOOL func_172() // Position - 0x14353
{

...
BOOL func_4(var uParam0, int iParam1, BOOL bParam2) // Position - 0x531
{
	...
	for (i = 0; func_5(iParam1, i, &unk, &num); i = i + 1)
	{
...
void func_21(BOOL bParam0, BOOL bParam1) // Position - 0xCF5
{
	...
	if (bParam0)
	{
		if (func_24(false) && Global_78936.f_1 == 1 && func_23(Global_78936))
		{
		}
		else
		{
	...
	if (Global_113810.f_9088 || func_24(false))
	{
		num = func_22();

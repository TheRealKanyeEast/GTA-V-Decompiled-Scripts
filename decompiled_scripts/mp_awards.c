...
void main() // Position - 0x0
{
	...
	if (unk_0x96CFB880BAC634CE(4))
	{
		...
		Global_1574599 = 0;
		unk_0xA6B31A9A2BC308B5(Global_1652690.f_471, Global_1652690.f_472, Global_1652690.f_499, Global_1652690.f_500);
...
void func_2(var uParam0, var uParam1, var uParam2) // Position - 0x552
{
	...
	if (unk_0x6D05C5731A838CB3(2, 187) || func_12(187, &(Global_1654054.f_1060), 1) && flag)
	{
		func_11(uParam2);
	...
	if (unk_0x6D05C5731A838CB3(2, 188) || func_12(188, &(Global_1654054.f_1060), 1) && flag)
	{
		func_11(uParam2);
		func_10(uParam2, false, false);
	...
	if (unk_0x6D05C5731A838CB3(2, 189) || unk_0x6D05C5731A838CB3(2, 241) || func_12(189, &(Global_1654054.f_1060), 1) && flag)
	{
		func_11(uParam2);
		func_10(uParam2, false, false);
	...
	if (unk_0x6D05C5731A838CB3(2, 190) || unk_0x6D05C5731A838CB3(2, 242) || func_12(190, &(Global_1654054.f_1060), 1) && flag)
	{
		func_11(uParam2);
		func_10(uParam2, false, false);
		...
		switch (uParam1->f_7)
		{
			case 0:
				if (num3 == 0 || num3 == 1)
				{
					...
					{
						Global_1652106.f_1 = num4 % 4;
						Global_1652106.f_3 = num4 / 4;
					}
				}
				break;
		}
...
BOOL func_13(var uParam0, int iParam1, BOOL bParam2) // Position - 0xE6C
{
	if (iParam1 == -1)
		return 1;
...
void func_45(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x49E0
{
	int num;
...
int func_46(int iParam0, int iParam1) // Position - 0x4A03
{
...
var func_51(int iParam0, int iParam1) // Position - 0x4ABD
{
...
var func_109(int iParam0, int iParam1) // Position - 0xB430
{
...
void func_129(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4) // Position - 0x1033D
{
...
void func_130(int iParam0) // Position - 0x1039A
{
	...
	if (func_137(iParam0))
	{
		...
		if (!IS_BIT_SET(Global_1652690.f_471, num))
			unk_0x0B0C9A0F9AAEB7F0(&(Global_1652690.f_471), num);
	
		if (flag)
			if (!IS_BIT_SET(Global_1652690.f_472, num))
				unk_0x0B0C9A0F9AAEB7F0(&(Global_1652690.f_472), num);
	}
	...
	if (func_132(iParam0))
	{
		...
		if (!IS_BIT_SET(Global_1652690.f_499, num2))
			unk_0x0B0C9A0F9AAEB7F0(&(Global_1652690.f_499), num2);
	
		if (flag2)
			if (!IS_BIT_SET(Global_1652690.f_500, num2))
				unk_0x0B0C9A0F9AAEB7F0(&(Global_1652690.f_500), num2);
	}
...
void func_149(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x10BF9
{

...
void main() // Position - 0x0
{
	...
	uLocal_116 = unk_0xA7B0B03284E7503C(unk, unk4, 0, 1, 1, 1);
	...
	while (true)
	{
		...
		if (func_48(&uLocal_41))
		{
			...
			{
				if (unk_0x1D25F777D0165BF3() == Global_78384)
				{
					Global_78384 = 0;
				...
				func_40();
				func_39(&uLocal_117, 0, unk_0x4A8C381C258A124D(), "MICHAEL", 0, 1);
				func_22(&uLocal_117, "EPS3AUD", "EP3_MCS1", 6, 0, 0, 0);
			
				if (func_21("EPS_DROP_HELP" /*This vehicle is wanted by the Epsilon Program. Deliver it to the location marked ~HUD_COLOUR_MICHAEL~~BLIP_EPSILON~~s~*/))
		...
		if (Global_113810.f_10052.f_104 != 0)
		{
			iLocal_95 = (Global_113810.f_10052.f_104 + 14) % func_18(unk_0x8825A6E0A30BDCB8(), unk_0x7598FE4545010A75());
...
void func_39(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1DC1
{
...
BOOL func_41(BOOL bParam0) // Position - 0x1EA7
{
...
void func_57(var uParam0) // Position - 0x2C3B
{
	...
	switch (*uParam0)
	{
		case 1:
			func_60(&iLocal_90);
			func_59("EPS_DROP_PERSON" /*This vehicle can't be delivered while there are passengers in it.*/, -1);
			*uParam0 = 2;
			break;
		...
		case 4:
			...
			{
				func_59("EPS_DROP_ESCAPE" /*Deliver the vehicle to the location marked ~HUD_COLOUR_MICHAEL~~BLIP_EPSILON~~s~*/, -1);
				func_82(2);
			}
			break;
	}
		...
		if (!func_14(i))
		{
			if (func_46(unk_0x4B423FAA24E8ABF0(unk), i))
			{
				if (func_47(unk))
				{
					if (!bLocal_100)
					{
						func_59("EPS_DROP_FAIL" /*The vehicle is too damaged for the Epsilon Program. Find another one or repair it.*/, -1);
						bLocal_100 = true;
					}
			...
			switch (iLocal_96)
			{
				case 0:
					if (iLocal_101 == 1 && !uLocal_41.f_26)
						if (func_21("EPS_DROP_MESS" /*Clear obstructions away from the garage or park closer to the wall.*/))
							unk_0x428C32CC68809A35(1);
					...
					if (!uLocal_41.f_26)
					{
						if (iLocal_102 == 0)
						{
							if (func_65(unk))
							{
								...
								{
									func_64("EPS_DROP_EXIT" /*Exit the vehicle.*/, 7500, 1);
									iLocal_104 = 0;
									iLocal_102 = 1;
									iLocal_101 = 0;
								}
					...
					if (uLocal_41.f_26 && !unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) && unk_0x5B3431FA66D59A4C(unk_0x4A8C381C258A124D()))
					{
						...
						else if (unk_0x1DD05E817C89C737() - iLocal_104 > 500)
						{
							if (iLocal_101 == 0)
							{
								...
								func_59("EPS_DROP_MESS" /*Clear obstructions away from the garage or park closer to the wall.*/, -1);
								iLocal_101 = 1;
								iLocal_102 = 0;
							}
						}
...
BOOL func_66(var uParam0) // Position - 0x305D
{
...
void func_68(var uParam0) // Position - 0x3176
{
	switch (*uParam0)
	{
		case 1:
			...
			if (iLocal_103 == 0)
				func_59("EPS_DROP_WANTED" /*This vehicle can't be delivered while wanted. Lose your wanted rating.*/, -1);
...
void func_69(var uParam0) // Position - 0x31F1
{
	switch (*uParam0)
	{
		...
		case 4:
			if (iLocal_99 == 0 && func_66(unk_0x4A8C381C258A124D()))
			{
				if (uLocal_115 != unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 1))
				{
					uLocal_115 = unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 1);
					func_59("EPS_DROP_HELP" /*This vehicle is wanted by the Epsilon Program. Deliver it to the location marked ~HUD_COLOUR_MICHAEL~~BLIP_EPSILON~~s~*/, -1);
					iLocal_99 = 1;
				}
			}
...
void func_76() // Position - 0x34DA
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_79(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_77(num) && !func_34(14) || Global_112760)
			{
...
int func_78(var uParam0) // Position - 0x35E3
{
	int i;
	int num;
...
int func_80(int iParam0) // Position - 0x3645
{

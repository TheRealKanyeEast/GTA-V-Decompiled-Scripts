...
void func_9(var uParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2F9
{
	...
	unk_0x8744D2E3FC95740E(&Global_8371, 30);

	if (bParam3)
		unk_0x0B0C9A0F9AAEB7F0(&Global_8371, 29);
	else
		unk_0x8744D2E3FC95740E(&Global_8371, 29);

	if (bParam4)
		unk_0x0B0C9A0F9AAEB7F0(&Global_8372, 1);
	else
		unk_0x8744D2E3FC95740E(&Global_8372, 1);
...
int func_13(int iParam0) // Position - 0x720
{
	...
	{
		if (iParam0 == 1)
			unk_0x0B0C9A0F9AAEB7F0(&Global_8371, 22);
		else
			unk_0x8744D2E3FC95740E(&Global_8371, 22);
...
void func_22() // Position - 0xC0C
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_25(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_23(num) && !func_17(14) || Global_112760)
			{
...
int func_24(var uParam0) // Position - 0xD15
{
	int i;
	int num;
...
int func_26(int iParam0) // Position - 0xD77
{
...
void func_27() // Position - 0xD86
{
	...
	if (Global_78689 == false)
	{
		...
		if (Global_43377 == 15 && func_29(false) == false && Global_8375 == 0)
		{
...
BOOL func_29(BOOL bParam0) // Position - 0x12DF
{
...
void func_52(int iParam0, int iParam1, int iParam2) // Position - 0x1D20
{
	if (iParam2 == -1)
		iParam2 = func_53();
...
char* func_61(int iParam0) // Position - 0x2CF6
{
	switch (iParam0)
	{
		case 0:
...
void func_63(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2E06
{
	int num;
...
int func_64(int iParam0, int iParam1) // Position - 0x2E29
{
...
BOOL func_76(var uParam0, var uParam1) // Position - 0x332A
{
	...
	for (i = 0; i < iLocal_390; i = i + 1)
	{
		...
		{
			if (func_93(uParam0, uParam1, unk))
			{
...
{
	unk_0x0B0C9A0F9AAEB7F0(&Global_8371, 30);
	return;
}

void func_83(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, char* sParam6, char* sParam7) // Position - 0x35DF
{
	var unk;
...
BOOL func_93(var uParam0, var uParam1, Vector3 vParam2, var uParam3, var uParam4) // Position - 0x3A55
{
	...
	if (uParam1->[num /*11*/].f_10)
	{
		...
		{
			if (unk_0x1D56B24774D5E23C(uParam1->[num /*11*/].f_1) || func_105(uParam1->[num /*11*/].f_1))
			{
...
void func_97() // Position - 0x3BEE
{
	...
	num4 = 0;
	unk_0xDF7F16323520B858(func_98(0), &num, -1);
	num2 = num2 + num;

	if (num > 0)
		func_51(18, num);

	unk_0xDF7F16323520B858(func_98(1), &num, -1);
	num2 = num2 + num;

	if (num > 0)
		func_51(19, num);

	unk_0xDF7F16323520B858(func_98(3), &num, -1);
	num2 = num2 + num;

	if (num > 0)
		func_51(20, num);

	num3 = func_88(0) + func_88(1) + func_88(3);
...
void func_102(int iParam0, int iParam1, BOOL bParam2) // Position - 0x3E12
{
	...
	if (iParam0 == 1)
	{
		...
		{
			if (bParam2)
				unk_0x0B0C9A0F9AAEB7F0(&(Global_113810.f_10052.f_122), iParam1);
			else
				unk_0x8744D2E3FC95740E(&(Global_113810.f_10052.f_122), iParam1);
		
			return;
		}
	
		if (bParam2)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113810.f_10052.f_122.f_1), iParam1 - 32);
		else
			unk_0x8744D2E3FC95740E(&(Global_113810.f_10052.f_122.f_1), iParam1 - 32);
	}
	else if (iParam0 == 0)
	{
		if (iParam1 <= 31)
		{
			if (bParam2)
				unk_0x0B0C9A0F9AAEB7F0(&(Global_113810.f_10052.f_125), iParam1);
			else
				unk_0x8744D2E3FC95740E(&(Global_113810.f_10052.f_125), iParam1);
		
			return;
		}
	
		if (bParam2)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113810.f_10052.f_125.f_1), iParam1 - 32);
		else
			unk_0x8744D2E3FC95740E(&(Global_113810.f_10052.f_125.f_1), iParam1 - 32);
	}

	return;
}

void func_103(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3EFE
{
	if (iParam1 < 0 || iParam1 >= 64)
		return;
...
void func_104(var uParam0) // Position - 0x3F5F
{
...
int func_105(var uParam0) // Position - 0x3F7F
{
	var unk;
	int num;
...
void func_106(var uParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x400C
{
	var unk;
...
void func_107(var uParam0, var uParam1, var uParam2) // Position - 0x4125
{
	var unk;
...
BOOL func_109(var uParam0) // Position - 0x41AA
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
void func_120(var uParam0, int iParam1, int iParam2) // Position - 0x46D7
{
	int i;
	int num;
	...
	*uParam0 = 0;
	...
	for (i = 0; i < uParam0->f_3; i = i + 1)
	{
		if (func_69(uParam0->f_2 + i, -1))
		{
			num = num + 1;
			func_103(uParam0, i, true);
			bLocal_38;
		}
	}
...
BOOL func_124(var uParam0) // Position - 0x4B05
{
	if (!unk_0xFC8BFE4B41177C22(uParam0))
		return false;

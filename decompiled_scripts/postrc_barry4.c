...
int func_17(var uParam0) // Position - 0x808
{
	int i;
	int num;
...
int func_19(int iParam0) // Position - 0x86A
{
...
void func_25() // Position - 0x9C3
{
	...
	func_26(&uLocal_35, 1, unk_0x4A8C381C258A124D(), "FRANKLIN", 0, 1);
	iLocal_34 = 1;
	return;
}

void func_26(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x9E4
{

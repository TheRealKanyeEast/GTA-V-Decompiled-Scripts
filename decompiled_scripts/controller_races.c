	...
	if (func_11(8))
	{
		for (i = 0; i <= 5 - 1; i = i + 1)
		{
			...
			if (IS_BIT_SET(Global_113810.f_24982.f_1, i))
			{
				...
				{
					num2 = SYSTEM::VDIST2(func_9(unk_0x259BE71D8A81D4FA()), func_8(num, 0));
					...
					if (num2 > 43681f)
					{
						if (!func_7(num))
						{
							if (!Global_113784[i])
							{
								...
								unk_0x8744D2E3FC95740E(&(Global_113810.f_24982.f_3), i);
							}
							else if (unk_0x1DD05E817C89C737() - Global_113790[i] > 60000)
							{
								Global_113784[i] = false;
								Global_113790[i] = unk_0x1DD05E817C89C737();
								func_3(num);
								func_2(num, true, true);
								unk_0x8744D2E3FC95740E(&(Global_113810.f_24982.f_3), i);
							}
...
void func_13() // Position - 0x636
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_17(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_15(num) && !func_14(14) || Global_112760)
			{
				...
				if (num2 > 43681f)
				{
					if (!func_7(num))
					{
						if (!Global_113774[i])
						{
							func_3(num);
							func_2(num, true, true);
							unk_0x8744D2E3FC95740E(&(Global_113810.f_24979.f_2), i);
						}
						else if (unk_0x1DD05E817C89C737() - Global_113779[i] > 60000)
						{
							Global_113774[i] = false;
							Global_113779[i] = unk_0x1DD05E817C89C737();
							func_3(num);
							func_2(num, true, true);
							unk_0x8744D2E3FC95740E(&(Global_113810.f_24979.f_2), i);
						}

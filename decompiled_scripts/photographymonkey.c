...
void func_2(int iParam0, BOOL bParam1) // Position - 0x3AD
{
	...
	{
		if (bParam1)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113810.f_24998), num);
		else
			unk_0x8744D2E3FC95740E(&(Global_113810.f_24998), num);
	}
	else
	{
		num = num - 31;
		...
		if (bParam1)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113810.f_24998.f_1), num);
		else
			unk_0x8744D2E3FC95740E(&(Global_113810.f_24998.f_1), num);
	}
...
{
	if (bParam0 == 1)
		unk_0x0B0C9A0F9AAEB7F0(&Global_8371, 28);
	else
		unk_0x8744D2E3FC95740E(&Global_8371, 28);
...
void func_24(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x64F1
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_13(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_13(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78670)
		{
			...
			func_13(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			if (!bParam3 || IS_BIT_SET(Global_113810.f_7232[1], 0))
				unk_0x0B0C9A0F9AAEB7F0(&Global_113810.f_2366.f_539.f_3816[0 /*166*/][iParam1 /*11*/][iParam2 / 32], iParam2 % 32);
			break;
	
		case joaat("Player_Two"):
			if (!bParam3 || IS_BIT_SET(Global_113810.f_7232[3], 0))
				unk_0x0B0C9A0F9AAEB7F0(&Global_113810.f_2366.f_539.f_3816[1 /*166*/][iParam1 /*11*/][iParam2 / 32], iParam2 % 32);
		
			if (!bParam3 || IS_BIT_SET(Global_113810.f_7232[4], 0))
				unk_0x0B0C9A0F9AAEB7F0(&Global_113810.f_2366.f_539.f_3816[2 /*166*/][iParam1 /*11*/][iParam2 / 32], iParam2 % 32);
			break;
	}
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x1ACD5
{
	...
	if (bParam1)
		unk_0x0B0C9A0F9AAEB7F0(&Global_113810.f_10052.f_135[num], unk);
	else
		unk_0x8744D2E3FC95740E(&Global_113810.f_10052.f_135[num], unk);

	return;
}

void func_98(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x1AD15
{
...
BOOL func_99(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0x1AD3B
{
	float num;
	float num2;
...
void func_100(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10) // Position - 0x1AD7B
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
...
BOOL func_106(BOOL bParam0) // Position - 0x1B035
{
			...
			case 7:
				if (iLocal_460 < unk_0x1DD05E817C89C737())
				{
					if (func_110(62) && !func_110(24))
						func_109("PM_CLOTHES" /*New clothes have been added to Trevor's wardrobe.*/, 10000);

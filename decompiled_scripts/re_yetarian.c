...
BOOL func_2(var uParam0) // Position - 0x2A0
{
...
void func_14(int iParam0, int iParam1, int iParam2) // Position - 0xD95
{
	if (iParam2 == -1)
		iParam2 = func_15();
...
BOOL func_25(int iParam0) // Position - 0x1600
{
	return iParam0 < 3;
}

int func_26(var uParam0) // Position - 0x160C
{
	int i;
	int num;
...
int func_28(int iParam0) // Position - 0x166E
{
...
void func_36() // Position - 0x19D9
{
	if (iLocal_112 == 0)
	{
		if (!func_57())
		{
			if (func_2(uLocal_45[0 /*20*/].f_1))
			{
				func_56(&uLocal_150, 5, uLocal_45[0 /*20*/].f_1, "YETARIAN_GOON", 0, 1);
			}
			else if (func_2(uLocal_45[1 /*20*/].f_1))
			{
				func_56(&uLocal_150, 5, uLocal_45[1 /*20*/].f_1, "YETARIAN_GOON", 0, 1);
			}
			else
			{
				iLocal_112 = 1;
			...
			if (iLocal_112 == 0)
				if (func_55() == 0)
					if (func_39(&uLocal_150, sLocal_149, "RE_YETA_MIKE", 7, 0, 0, 0))
						iLocal_112 = 1;
				else if (func_39(&uLocal_150, sLocal_149, "RE_YETA_FRAN", 7, 0, 0, 0))
					iLocal_112 = 1;
		}
	}
...
void func_56(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x243E
{
...
void func_61() // Position - 0x265F
{
	switch (iLocal_87)
	{
		...
		case 1:
			...
			if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
			{
				if (func_2(uLocal_89) || func_2(uLocal_90))
				{
					if (func_65())
					{
						if (iLocal_117 == 0)
...
{
	if (func_55() == 1)
		func_56(&uLocal_150, 1, unk_0x4A8C381C258A124D(), "FRANKLIN", 0, 1);
	else
		func_56(&uLocal_150, 0, unk_0x4A8C381C258A124D(), "MICHAEL", 0, 1);

	func_56(&uLocal_150, 4, uLocal_88, "SIMEON", 0, 1);

	if (bLocal_109)
		func_39(&uLocal_150, sLocal_149, "RE_YETA_SNIP", 7, 0, 0, 0);
	else if (bLocal_107)
		func_39(&uLocal_150, sLocal_149, "RE_YETA_EXT", 7, 1, 0, 0);
	else if (func_63())
		if (func_55() == 0)
			func_39(&uLocal_150, sLocal_149, "RE_YETAM", 7, 0, 0, 0);
		else if (func_55() == 1)
			func_39(&uLocal_150, sLocal_149, "RE_YETAF", 7, 0, 0, 0);
	else
		func_39(&uLocal_150, sLocal_149, "RE_YETA_SNIP", 7, 0, 0, 0);
...
{
	switch (func_72(&Global_32343, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
void func_79() // Position - 0x31F5
{
	switch (iLocal_87)
	{
		...
		case 1:
			if (!func_2(uLocal_89) || !func_2(uLocal_90))
			{
				func_81(&uLocal_89, 18, uLocal_97, fLocal_100, true);
				...
				func_81(&uLocal_90, 18, uLocal_101, fLocal_104, true);
...
int func_81(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x3618
{
	int num;
...
int func_82(var uParam0, int iParam1) // Position - 0x36A6
{
	int num;
...
int func_83(int iParam0) // Position - 0x36EC
{
	if (!func_25(iParam0))
		return func_28(iParam0);
	else
...
void func_97(int iParam0) // Position - 0x539A
{
	switch (uLocal_45[iParam0 /*20*/].f_18)
	{
		...
		case 1:
			...
			{
				if (!func_2(uLocal_45[iParam0 /*20*/].f_1))
				{
...
void func_101(int iParam0) // Position - 0x5B9A
{
	...
	if (func_129())
	{
		...
		func_104(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_103(Global_113799, true), 64);
...
{
	if (Global_113799 == func_32() && unk_0x9FA91AA1AC724CD0() && Global_113800)
		return true;
...
void func_130() // Position - 0x673C
{
	...
	uLocal_140 = unk_0xA7B0B03284E7503C(-79.95f, -1126.33f, 20.65f, -3.5f, -1081.6f, 30.67f, 0, 1, 1, 1);
...
void func_138(int iParam0, var uParam1) // Position - 0x72EE
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_139(iParam0) && unk_0x486FF5D06E9659F1(Global_91601[26 /*34*/].f_6) == 0)
			{
				Global_113810.f_7264[iParam0] = 1;
				unk_0xEBB2809684978887(uParam1->f_5, Global_113810.f_7264[iParam0], 1, 1);
			}
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_164() || Global_112857 || Global_32286 || func_163() || func_52(8, -1) || func_162() || func_161() || func_160() || func_159() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_164() || Global_32286 || func_163() || func_52(8, -1) || func_160() || func_162() || func_161() || func_159() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_164() || Global_112857 || Global_32286 || func_163() || func_52(8, -1) || func_160() || func_162() || func_161() || func_159() || Global_113810.f_7691.f_919[num] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_164() || Global_112857 || Global_32286 || func_163() || func_52(8, -1) || func_162() || func_161() || func_159() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
				
					case 4:
						if (func_164() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_52(8, -1) || func_159() || func_158() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
...
BOOL func_167(int iParam0, int iParam1, int iParam2) // Position - 0xBA59
{
	BOOL num;
	int num2;

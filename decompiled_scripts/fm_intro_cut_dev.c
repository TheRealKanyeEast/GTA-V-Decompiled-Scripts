...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (Global_1936381)
		{
			if (!Global_1936383)
			{
				Global_1936380 = unk_0x8DE4F68A9728925E("OPENING_CREDITS");
				Global_1936383 = true;
			}
			else if (unk_0xA0C7B98BCF1EEF9E(Global_1936380))
			{
				if (!Global_1936382)
...
BOOL func_1(var uParam0, var uParam1) // Position - 0xD8
{
	...
	func_219(uParam0);
	func_218(unk_0x259BE71D8A81D4FA());
	...
	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		switch (uParam0->f_6)
		{
			case 0:
				...
				else if (unk_0x486FF5D06E9659F1(func_217()) > 0)
				{
					uParam0->f_295 = 1;
				}
				...
				if (!func_214(&(uParam0->f_15)))
					func_213(&(uParam0->f_15), false, false);
				...
				if (unk_0x15CCE8886267624F())
				{
					*uParam0 = 0;
					uParam0->f_4 = 0;
					uParam0->f_5 = 0;
					func_202(false, false, false, true, true, true, 0);
					...
					if (unk_0x486FF5D06E9659F1(joaat("fm_intro")) < 1 || !func_161())
					{
						if (uParam0->f_292)
						{
							if (func_160() == 0)
				...
				if (!unk_0x3555462DB47B7AB1())
				{
					if (!IS_BIT_SET(*uParam0, 4))
					{
						if (func_138() == 65 || func_138() == 66)
						{
							...
							func_213(&(uParam0->f_17), false, false);
							unk_0x0B0C9A0F9AAEB7F0(uParam0, 4);
						}
					}
					else if (unk_0x16088CC55E7F218A("FM_INTRO_START") && unk_0x9E2D35FA908F57B4() || func_135(&(uParam0->f_17), 5000, false))
					{
			...
			case 7:
				...
				{
					unk_0x428C32CC68809A35(1);
					func_130("FMIC_INTRO2" /*In GTA Online, you can carry out Jobs with, or compete against, players around the world.*/, -1);
			...
			case 14:
				...
				{
					func_130("FMIC_RACE1" /*Take part in Jobs, including Races, with your friends, Crew members or others and check your position on the global leaderboards in-game or on the Rockstar Social Club.*/, -1);
			...
			case 17:
				...
				if (!IS_BIT_SET(*uParam0, 6))
				{
					...
					func_130("FMIC_RACE2" /*You can challenge others with Jobs you have created yourself or bet on players to win and earn cash.*/, -1);
				}
			...
			case 22:
				...
				if (IS_BIT_SET(uParam0->f_3, 0))
				{
					...
					func_95(uParam0);
					func_94();
					func_130("FMIC_GAR" /*You can store your own collection of cars and motorcycles in Garages that you can purchase around the Map.*/, -1);
					uParam0->f_6 = 23;
				}
				break;
			...
			case 29:
				...
				unk_0x216049890A2D1EC6(9, 9, 9, 9);
				func_130("FMIC_TENN" /*~s~Challenge others to Tennis, Golf and many other Activities.*/, -1);
			...
			case 55:
				...
				else if (func_135(&(uParam0->f_17), 10000, false))
				{
					if (func_32(uParam0))
					{
						func_125(uParam0);
...
void func_2(var uParam0) // Position - 0x37E7
{
	int num;
...
void func_5(var uParam0) // Position - 0x38D9
{
	var unk;
...
void func_6(var uParam0, int iParam1) // Position - 0x3946
{
	var unk;
	var unk4;
...
float func_8(var uParam0) // Position - 0x3C31
{
	float num;
	float num2;
...
void func_9(var uParam0) // Position - 0x3CAE
{
	if (IS_BIT_SET(*uParam0, 29))
	{
...
void func_10(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3D2D
{
	int num;
...
int func_11(int iParam0, int iParam1) // Position - 0x3D50
{
...
void func_14(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3DA5
{
...
void func_27(var uParam0) // Position - 0x427A
{
	int i;
...
int func_29(var uParam0, int iParam1, BOOL bParam2) // Position - 0x42F5
{
	int i;
	int num;
	int num2;
...
BOOL func_32(var uParam0) // Position - 0x4736
{
	int num;
	int num2;
...
void func_33(var uParam0, int iParam1) // Position - 0x485C
{
	if (unk_0xFC8BFE4B41177C22(uParam0->f_58[iParam1]))
...
int func_37(var uParam0) // Position - 0x491A
{
	if (uParam0->f_6 < 31)
...
void func_38(var uParam0, float fParam1) // Position - 0x4956
{
	func_39(uParam0->f_34, 7, "FMINTRO", fParam1, true);
	return;
}

void func_39(var uParam0, int iParam1, char* sParam2, float fParam3, BOOL bParam4) // Position - 0x496E
{
	var unk;
...
void func_40(var uParam0, float fParam1) // Position - 0x49EE
{
	func_39(uParam0->f_34, 6, "FMINTRO", fParam1, true);
	return;
}

void func_41(var uParam0) // Position - 0x4A06
{
	int num;
	int num2;
...
int func_42(int iParam0) // Position - 0x4A3B
{
	if (iParam0 == 0)
		return 1;
...
void func_43(var uParam0) // Position - 0x4A59
{
	int i;
...
BOOL func_44(var uParam0) // Position - 0x4AA8
{
	int i;
...
BOOL func_50(int iParam0, int iParam1) // Position - 0x5249
{
...
void func_57() // Position - 0x5485
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_60(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_58(num) && !func_62(14) || Global_112760)
			{
...
int func_59(var uParam0) // Position - 0x558E
{
	int i;
	int num;
...
int func_61(int iParam0) // Position - 0x55F0
{
...
void func_67(var uParam0) // Position - 0x574A
{
	int i;
	var unk;
...
BOOL func_68(var uParam0) // Position - 0x5825
{
	int i;
	var unk;
	float num;
...
var func_69() // Position - 0x59D1
{
	return unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D());
}

void func_70(var uParam0) // Position - 0x59E1
{
	int i;
...
void func_71(var uParam0) // Position - 0x5A42
{
	int i;
...
int func_72(var uParam0) // Position - 0x5AE0
{
	if (func_88(uParam0))
	{
...
int func_73(var uParam0) // Position - 0x5B4D
{
	int num;
...
void func_74(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x5C14
{
...
void func_75(var uParam0, float fParam1) // Position - 0x5CAF
{
	func_39(uParam0->f_34, 5, "FMINTRO", fParam1, false);
	return;
}

void func_76(var uParam0) // Position - 0x5CC7
{
	int i;
...
void func_77(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5D05
{
	if (bParam0)
	{
...
BOOL func_81(int iParam0) // Position - 0x5F06
{
	int num;
...
BOOL func_82(int iParam0) // Position - 0x5F28
{
...
int func_84(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x5F75
{
	int num;
...
void func_86(var uParam0) // Position - 0x5FCB
{
	int i;
...
BOOL func_88(var uParam0) // Position - 0x609B
{
	if (uParam0->f_295)
		return func_89();
	else
...
BOOL func_90(var uParam0) // Position - 0x60CA
{
...
void func_92(var uParam0, int iParam1) // Position - 0x60F6
{
...
void func_95(var uParam0) // Position - 0x6216
{
	var unk;
	int i;
...
void func_96(var uParam0) // Position - 0x62C1
{
...
void func_97(var uParam0) // Position - 0x6319
{
	if (unk_0xFC8BFE4B41177C22(uParam0->f_49[2]))
		if (unk_0xD9F5E1FEFD1329E4(uParam0->f_49[2], 0))
...
void func_99(var uParam0, char* sParam1, char* sParam2, var uParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9) // Position - 0x637C
{
...
void func_100(var uParam0) // Position - 0x63F7
{
...
BOOL func_102(var uParam0) // Position - 0x649C
{
	int i;
	var unk;
...
BOOL func_104(var uParam0, int iParam1) // Position - 0x6FD6
{
	if (uParam0->f_295 && uParam0->f_112[iParam1] != -1 && func_105(unk_0xB23E0F9B63D009A8(uParam0->f_112[iParam1]), false, true))
		return true;

	return false;
}

BOOL func_105(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7011
{
	int num;
...
BOOL func_106(var uParam0, int iParam1) // Position - 0x7071
{
...
BOOL func_109(var uParam0) // Position - 0x719E
{
	int num;
	int num2;
...
void func_110(var uParam0) // Position - 0x7368
{
	int i;
...
BOOL func_111(var uParam0) // Position - 0x7409
{
	int num;
...
BOOL func_112(var uParam0) // Position - 0x75F7
{
	int num;
	var unk;
	var unk4;
...
BOOL func_113(var uParam0, int iParam1) // Position - 0x775A
{
	switch (iParam1)
	{
		case 0:
...
void func_121(var uParam0, float fParam1, int iParam2) // Position - 0x8137
{
...
void func_122(var uParam0, int iParam1) // Position - 0x819C
{
	int i;
	int num;
...
void func_123(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, var uParam6, BOOL bParam7) // Position - 0x8B68
{
...
void func_124(var uParam0, char* sParam1, char* sParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, int iParam10) // Position - 0x8C8C
{
	if (!unk_0x78411E34CF90EA8C(uParam0->f_8))
		uParam0->f_8 = unk_0x69D23632E4288DBD("DEFAULT_ANIMATED_CAMERA", 0);
...
void func_125(var uParam0) // Position - 0x8CFD
{
...
BOOL func_126(var uParam0) // Position - 0x8D2B
{
	BOOL flag;
	int i;
...
BOOL func_129(var uParam0) // Position - 0x91EC
{
	int i;
	int num;
	var unk;
...
BOOL func_131(var uParam0, int iParam1, int iParam2) // Position - 0x939B
{
	int num;
...
BOOL func_132(var uParam0) // Position - 0x93E1
{
	int num;
...
void func_133(var uParam0, int iParam1) // Position - 0x949D
{
...
void func_134(var uParam0) // Position - 0x94D4
{
	uParam0->f_13 = unk_0x1DD05E817C89C737();
	return;
}

BOOL func_135(var uParam0, int iParam1, BOOL bParam2) // Position - 0x94E4
{
	if (iParam1 == -1)
		return true;

	func_213(uParam0, bParam2, false);
...
void func_144(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x961F
{
	func_149();
	func_147(1);
	unk_0x428C32CC68809A35(1);
...
void func_147(int iParam0) // Position - 0x973A
{
	int i;
...
void func_163(int iParam0) // Position - 0xCF80
{
	...
	if (Global_1575063)
	{
		...
		unk3 = func_183(&Global_2697014, true, false);
		func_182(&Global_2697012, true, false);
		unk_0x350F7DB8B2765EC2(unk2, 1, unk, iParam0, 0);
	}
...
BOOL func_166() // Position - 0xD023
{
	...
	if (Global_2684820.f_6635 && Global_2694496)
	{
		if (func_171(0))
		{
			if (func_169() && !unk_0x15CCE8886267624F())
			{
...
{
	if (func_181(unk_0x259BE71D8A81D4FA()) && IS_BIT_SET(Global_1950844.f_4, 22))
		return false;
...
BOOL func_173(int iParam0) // Position - 0xD799
{
...
BOOL func_175(int iParam0) // Position - 0xD7C0
{
	...
	unk = { func_176(unk_0x259BE71D8A81D4FA()) };
...
Vector3 func_176(var uParam0) // Position - 0xD80F
{
...
{
	return func_178(unk_0x259BE71D8A81D4FA());
}
...
BOOL func_181(int iParam0) // Position - 0xD875
{
	if (iParam0 != func_51())
		if (func_105(iParam0, true, true))
...
var func_183(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD8F9
{
	if (unk_0x76CD105BCAC6EB9F() && !bParam1)
		if (!bParam2)
...
void func_192(int iParam0) // Position - 0xDE23
{
	...
	if (func_194() == 0 || unk_0x4D9174D8796EA622())
	{
		func_193(1);
...
void func_196(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDE9A
{
	...
	if (func_194() == 1 || unk_0x4D9174D8796EA622() || bParam0)
	{
		func_193(0);
...
void func_202(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, int iParam6) // Position - 0xDFD8
{
	int num;
	...
	func_203(unk_0x259BE71D8A81D4FA(), false, num, 0);
	...
	else
	{
		...
		if (unk_0x762604C40829DB72(iParam0) && unk_0x75EAB09F5E974116(iParam0) || iParam3 == 1)
		{
			...
			if (bParam1)
			{
				...
				if (!func_207(unk) && !unk_0xB431D60610E7F85F(unk))
					if (!flag22)
...
BOOL func_207(var uParam0) // Position - 0xE59B
{
	int num;
...
void func_208(int iParam0, int iParam1, int iParam2) // Position - 0xE5CC
{
	int num;
	int i;
...
void func_209(int iParam0, int iParam1) // Position - 0xE69C
{
	int num;
...
void func_218(var uParam0) // Position - 0xE839
{
	unk_0x0FB8E752BCC547A9(unk_0x56E414973C2A8C0E(uParam0), 346, 1);
	return;
}

void func_219(var uParam0) // Position - 0xE84F
{
...
void func_222(char* sParam0, char* sParam1, float fParam2, char* sParam3, int iParam4) // Position - 0xFCC3
{
...
void func_223(char* sParam0, char* sParam1, float fParam2, char* sParam3, int iParam4) // Position - 0xFD1E
{
...
void func_225(var uParam0) // Position - 0xFDCE
{

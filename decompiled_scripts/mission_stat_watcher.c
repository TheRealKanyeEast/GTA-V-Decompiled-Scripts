...
void main() // Position - 0x0
{
	...
	while (!Global_63479)
	{
		if (Global_75580 > 0)
		{
			...
			else if (unk_0x1DD05E817C89C737() - Global_63513 > 1000)
				func_106();
		}
					...
					if (Global_63488)
					{
						...
						for (j = 0; j < Global_97043[Global_63489 /*38*/].f_37; j = j + 1)
						{
							if (Global_97043[Global_63489 /*38*/].f_31[j] > 0)
								func_96(&uLocal_43, 3, func_95(Global_97043[Global_63489 /*38*/].f_25[j]), "", -1 * Global_97043[Global_63489 /*38*/].f_31[j], 0, 0, 0);
						}
						...
						for (j = 0; j < Global_96842[num2 /*19*/]; j = j + 1)
						{
							if (!func_92(Global_113810.f_1.f_12[num2 /*6*/][j]))
								...
								num4 = num4 + Global_113810.f_1.f_126[Global_63489 /*23*/].f_17[j];
						}
...
void func_1(var uParam0, int iParam1) // Position - 0x8BE
{
	...
	if (!Global_78958)
		if (!unk_0xD5FF242D0AFC5855(unk_0xB6B621402486C3E4()))
			if (!Global_78960)
				if (unk_0x15CCE8886267624F() && !func_101(false))
...
int func_51(var uParam0) // Position - 0x3478
{
	int i;
	int num;
...
int func_53(int iParam0) // Position - 0x34DA
{
...
void func_65() // Position - 0x3791
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_52(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_54(num) && !func_66(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != num && func_54(Global_113810.f_2366.f_539.f_4321))
		...
		if (Global_75730 == false)
		{
			...
			if (num6 == 90)
			{
				if (Global_113810.f_9088.f_99.f_205[func_75(0)] == 2)
				{
					...
					unk_0x3573EC2255786C32(131, Global_75726, 0f);
					unk_0x3573EC2255786C32(162, Global_75727, 0f);
					unk_0x3573EC2255786C32(126, 1, 0f);
					unk_0x3573EC2255786C32(161, Global_75729, 0f);
...
void func_77(var uParam0) // Position - 0xBAA3
{
	...
	if (func_101(false))
	{
		unk_0x9012CD429E55212A(Global_75731);
...
BOOL func_88(var uParam0, int iParam1) // Position - 0xBF5B
{
	...
	str = func_89(Global_75581[iParam1 /*9*/]);
...
void func_90(int iParam0, int iParam1) // Position - 0xD60D
{
	...
	num = Global_63710[iParam1 /*13*/].f_4;
	...
	if (func_101(false) && Global_63477)
	{
...
void func_98(int iParam0) // Position - 0xD824
{
	...
	{
		case 0:
			unk_0x1164A75E490C27B6(joaat("JEWEL_HEIST_RAW_TAKE"), Global_113810.f_1.f_126[iParam0 /*23*/], 1);
			break;
	}
...
BOOL func_101(BOOL bParam0) // Position - 0xE387
{
...
void func_107() // Position - 0xE5B1
{
	...
	if (Global_63491 && unk_0x75EAB09F5E974116(unk_0xB6B621402486C3E4()) && !unk_0x0CB7695268A7F50F() && !unk_0x4D9174D8796EA622())
		Global_63491 = false;
	...
	for (i = 0; i < Global_75580; i = i + 1)
	{
		if (Global_75581[i /*9*/] >= 0)
		{
			num2 = Global_63710[Global_75581[i /*9*/] /*13*/];
			...
			switch (num2)
			{
				case 6:
					if (Global_75581[i /*9*/].f_6 != 0)
					{
						...
						else if (unk_0xFC8BFE4B41177C22(Global_75581[i /*9*/].f_6))
						{
							if (!unk_0x1C2F771CDC87A3A5(Global_75581[i /*9*/].f_6, 0))
							{
								iLocal_628 = Global_75581[i /*9*/].f_8;
								uLocal_627 = unk_0x8D91ADE44AC79BC9(Global_75581[i /*9*/].f_6);
								...
								Global_75581[i /*9*/].f_8 = uLocal_627;
							}
						}
						else
						{
					...
					if (Global_63493)
						if (Global_63495 == -1 || Global_75581[i /*9*/] == Global_63495)
							if (Global_75581[i /*9*/] == 339 || Global_75581[i /*9*/] == 179 || Global_75581[i /*9*/] == 342 || Global_75581[i /*9*/] == 234)
								Global_75581[i /*9*/].f_1 = Global_75581[i /*9*/].f_1 + SYSTEM::ROUND(unk_0x0B852B0BF94A8DC1() * 1000f);
							else
								Global_75581[i /*9*/].f_1 = Global_75581[i /*9*/].f_1 + iLocal_624;
					break;
				...
				case 5:
					if (flag2)
					{
						if (Global_63497 == -1 || Global_63497 == Global_75581[i /*9*/])
						{
							if (!(Global_63496 == 0))
							{
								if (unk_0xFC8BFE4B41177C22(Global_63496))
								{
									if (!unk_0x1C2F771CDC87A3A5(Global_63496, 0))
									{
										if (unk_0x55B80B6E7AB61270(Global_63496))
										{
											num = unk_0xDF93B3CFAC96698F(Global_63496);
										
											if (num > Global_75581[i /*9*/].f_2)
												Global_75581[i /*9*/].f_2 = num;
										}
									}
								}
							}
...
void func_108() // Position - 0xE98C
{
	...
	if (Global_63514 > 0)
	{
		...
		for (i = 0; i < 64; i = i + 1)
		{
			...
			{
				if (!unk_0xFC8BFE4B41177C22(Global_63515[i /*2*/]))
				{
					Global_63515[i /*2*/] = 0;
			...
			case 142:
				...
				if (unk_0xFC8BFE4B41177C22(num3))
				{
					...
					if (Global_63644 > 0)
					{
						...
						{
							if (Global_63645[j /*2*/] == unk2)
								num6 = num6 + Global_63645[j /*2*/].f_1;
						}
					}
						...
						if (unk_0x0101C509A6E67F99(unk) && unk_0x56E414973C2A8C0E(unk_0xB6B621402486C3E4()) == unk_0xBD545F8729E9F413(unk) || flag2)
						{
							if (unk_0x0101C509A6E67F99(unk))
							{
								...
								if (Global_63514 > 0)
								{
									...
									if (num7 != -1)
									{
										unk_0xB76C3F86B744BBA5(unk_0xBD545F8729E9F413(Global_63515[num7 /*2*/]), &iLocal_631);
							...
							if (Global_75766 > 0)
							{
								...
								while (!flag)
								{
									...
									{
										if (unk_0xFC8BFE4B41177C22(Global_75733[j /*2*/]))
										{
											if (unk_0x1C2F771CDC87A3A5(Global_75733[j /*2*/], 0))
											{
												if (Global_75733[j /*2*/] == num3)
												{
		...
		if (unk_0x81D4D874CB1DFBE4() == 13)
		{
			if (unk_0x16C990F0AEBBC7A3() == 37)
			{
				...
				if (num5 == 3)
				{
					...
					Global_113810.f_2355[num6 /*2*/] = unk2;
					Global_113810.f_2355[num6 /*2*/].f_1 = unk3;
					func_114();
				}
			}
		}

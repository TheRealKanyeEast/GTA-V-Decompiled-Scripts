...
void main() // Position - 0x0
{
	...
	func_69(&uLocal_106, 2, unk_0x4A8C381C258A124D(), "TREVOR", 0, 1);
...
int func_18(var uParam0) // Position - 0xC30
{
	int i;
	int num;
...
BOOL func_45(int iParam0) // Position - 0x190B
{
	int num;
...
BOOL func_46(int iParam0) // Position - 0x192D
{
...
int func_48(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x197A
{
	int num;
...
BOOL func_53(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x1BA6
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
BOOL func_63(int iParam0) // Position - 0x20A7
{
	if (Global_78689)
		return true;
...
void func_69(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x250E
{
...
BOOL func_73(int iParam0) // Position - 0x260B
{

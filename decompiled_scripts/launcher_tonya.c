...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (!func_225(&num, 1) || func_266(num))
			func_278(&num, true);
...
BOOL func_2(Any* panParam0) // Position - 0x2E0
{
	...
	if (!func_178())
	{
		while (!func_169(*panParam0))
		{
			...
			if (!func_225(panParam0, *panParam0 != 2))
			{
...
int func_32(var uParam0) // Position - 0x2AE4
{
	int i;
...
int func_33(var uParam0, int iParam1, int iParam2) // Position - 0x2B47
{
	int i;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D72
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A0A
{
	int i;
	float num;
	float num2;
...
BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x7521
{
...
BOOL func_85(int iParam0) // Position - 0x7577
{
	if (iParam0 != func_94())
...
BOOL func_93(int iParam0) // Position - 0x842F
{
	if (iParam0 != func_94())
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8E07
{
...
BOOL func_117(BOOL bParam0) // Position - 0x8E49
{
...
BOOL func_135(var uParam0) // Position - 0xACFF
{
	if (func_136(uParam0))
...
BOOL func_136(int iParam0) // Position - 0xAD1F
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAE63
{
	int i;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB002
{
	if (bParam0)
	{
...
BOOL func_147(int iParam0) // Position - 0xB203
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB225
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB272
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB2EF
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB422
{
...
void func_160(var uParam0) // Position - 0xB5BA
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_177(var uParam0, int iParam1) // Position - 0xBC3F
{
	int num;
	var unk;
	var unk33;
...
BOOL func_184(var uParam0) // Position - 0xC635
{
	if (func_136(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_194(var uParam0) // Position - 0xCE62
{
	...
	if (func_188() || unk_0x3555462DB47B7AB1())
	{
		unk_0x0F15249D24BC5ADA(0);
		return;
	}
		...
		if (num < 20f * 20f && bLocal_96)
		{
			switch (iLocal_97)
			{
				...
				case 2:
					if (func_201(&uLocal_263))
					{
						if (func_195(&uLocal_263) > unk_0xD2AA6F822D3A55D2(9f, 15f))
						{
...
float func_195(var uParam0) // Position - 0xDC13
{
	if (func_201(uParam0))
		if (func_197(uParam0))
			return uParam0->f_2;
		else
			return func_196(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1;
...
BOOL func_197(var uParam0) // Position - 0xDCA7
{
	return IS_BIT_SET(*uParam0, 2);
}

void func_198(var uParam0) // Position - 0xDCB4
{
	func_199(uParam0, 0f);
	return;
}

void func_199(var uParam0, float fParam1) // Position - 0xDCC3
{
	uParam0->f_1 = func_196(IS_BIT_SET(*uParam0, 4)) - fParam1;
...
void func_200(var uParam0) // Position - 0xDCEE
{
	if (!func_201(uParam0))
		func_198(uParam0);
...
BOOL func_201(var uParam0) // Position - 0xDD06
{
...
BOOL func_207(int iParam0, int iParam1) // Position - 0xE0DF
{
...
void func_215(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xE3F5
{
...
void func_216(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE490
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_220(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_219(uParam0, 1);
			}
			else
			{
				...
				if (func_220(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_222(uParam0);
			}
		}
	}
...
float func_220(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xE694
{
	var unk;
...
BOOL func_225(Any* panParam0, BOOL bParam1) // Position - 0xE801
{
	var unk;
	...
	{
		if (!func_233(panParam0, true, true))
		{
			if (*panParam0 == 16)
				func_232(panParam0);
			else
	...
	{
		if (!func_233(panParam0, false, true))
		{
			func_230(panParam0);
			return false;
		}
	...
	{
		if (!func_233(panParam0, true, false))
		{
			func_230(panParam0);
			return false;
		}
	...
	{
		if (!func_233(panParam0, false, false))
		{
			func_230(panParam0);
			return false;
		}
...
void func_226(int iParam0, var uParam1, int iParam2) // Position - 0xEA71
{
	...
	if (func_136(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_228(uParam1) || !unk_0x13CCB1AD131C1082(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_227(iParam2) && !unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 25f))
					{
						unk_0x0E95B96CFEFE7B61(iParam0, unk_0x4A8C381C258A124D(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_228(uParam1) && uParam1->f_4 == 0 && unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_227(iParam2) || unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						unk_0x10425721983AE158(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					else
...
void func_231(var uParam0) // Position - 0xF12A
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_233(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF1D5
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_234(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_234(var uParam0, var uParam1) // Position - 0xF393
{
	var unk;
...
BOOL func_237(var uParam0, int iParam1) // Position - 0xF6B3
{
	float num;
...
BOOL func_238(var uParam0, int iParam1) // Position - 0xF729
{
	return func_239(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_239(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF741
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_240(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF802
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_241(var uParam0, int iParam1) // Position - 0xF92E
{
	int num;
...
BOOL func_243(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xFA3D
{
	var unk;
	var unk4;
	float num;
...
int func_247(var uParam0, var uParam1) // Position - 0xFB49
{
	int i;
...
int func_248(var uParam0) // Position - 0xFB88
{
...
BOOL func_249(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xFBB0
{
	float num;
	float num2;
	int num3;
...
BOOL func_250(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFCAB
{
	float num;
	float num2;
...
BOOL func_251(var uParam0, float fParam1) // Position - 0xFDB7
{
	var unk;
	var unk2;
...
BOOL func_252(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFE4C
{
	var unk;
	var unk4;
	float num;
...
BOOL func_253(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xFEDA
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_255(var uParam0) // Position - 0xFF6C
{
	var unk;
...
BOOL func_263(var uParam0) // Position - 0x101BB
{
	...
	uLocal_93 = unk_0xA7B0B03284E7503C(uLocal_90 - { 10f, 10f, 10f }, uLocal_90 + { 10f, 10f, 10f }, 0, 1, 1, 1);
	bLocal_95 = true;
...
BOOL func_264(var uParam0) // Position - 0x1020F
{
	...
	switch (iLocal_89)
	{
		...
		case 3:
			if (func_136(uParam0->f_28[0]) && unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
			{
				unk_0xD0557B139A542F12(&unk);
				unk_0xB5396F1FB088FE38(&unk);
...
void func_282(var uParam0, BOOL bParam1) // Position - 0x10BB1
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_285(var uParam0) // Position - 0x10C3B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_286(var uParam0) // Position - 0x10C73
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_288(var uParam0, int iParam1) // Position - 0x10D21
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_289(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_289(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10D62
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_290(var uParam0) // Position - 0x10DB2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))

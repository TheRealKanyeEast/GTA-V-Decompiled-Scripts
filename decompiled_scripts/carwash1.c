...
BOOL func_11(int iParam0) // Position - 0x5C8
{
	int num;
...
BOOL func_12(int iParam0) // Position - 0x5EA
{
	if (func_8(iParam0, 0))
		return true;
...
int func_14(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x637
{
	int num;
...
BOOL func_17(var uParam0, int iParam1) // Position - 0x6B4
{
	var unk;
	float num;
	int num2;
...
BOOL func_21(BOOL bParam0) // Position - 0x14C1
{
...
void func_24(int iParam0, int iParam1, int iParam2) // Position - 0x1545
{
	if (iParam2 == -1)
		iParam2 = func_10();
...
void func_25(var uParam0) // Position - 0x1563
{
	int num;
...
void func_27(var uParam0, BOOL bParam1) // Position - 0x1594
{
	int num;
...
BOOL func_28(int iParam0, BOOL bParam1) // Position - 0x15FC
{
	if (Global_78689)
...
void func_29(var uParam0, int iParam1) // Position - 0x163A
{
	if (unk_0x78411E34CF90EA8C(*uParam0))
	{
...
BOOL func_33(int iParam0, BOOL bParam1) // Position - 0x172F
{
	if (Global_78689)
		if (unk_0xFC8BFE4B41177C22(iParam0) && !bParam1 || unk_0xD9F5E1FEFD1329E4(iParam0, 0))
...
Vector3 func_34(var uParam0) // Position - 0x1780
{
...
BOOL func_36(float fParam0, var uParam1, var uParam2) // Position - 0x18AD
{
...
void func_37(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x18D7
{
	float num;
	var unk;
	var unk4;
...
BOOL func_67(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x63CA
{
	int num;
	...
	else
	{
		...
		if (func_329(num))
		{
			if (unk_0xFD5C5BBD1FE92BB7(num, -1, 0) == unk_0x4A8C381C258A124D())
			{
				...
				if (func_128())
				{
					func_116(joaat("SERVICE_SPEND_CARWASH"), num3, &num2, false, false, true);
...
int func_124(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x9C05
{
	int i;
...
int func_127(int iParam0) // Position - 0x9DE4
{
	var unk;
...
int func_130(int iParam0, int iParam1, int iParam2) // Position - 0x9E63
{
	...
	return func_131(func_162(iParam0), 0, iParam1, iParam2, false);
}
...
void func_134(int iParam0) // Position - 0xA772
{
	...
	if (flag)
	{
		...
		unk_0xACF853FB3F6EA7D4(func_135(iParam0));
...
char* func_135(int iParam0) // Position - 0xA8EC
{
	switch (iParam0)
	{
		case 0:
...
void func_137(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA9FC
{
	int num;
...
int func_138(int iParam0, int iParam1) // Position - 0xAA1F
{
...
void func_164() // Position - 0xB156
{
	...
	{
		if (func_167(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_166(unk_0x4A8C381C258A124D());
		
			if (func_165(num) && !func_158(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != num && func_165(Global_113810.f_2366.f_539.f_4321))
...
int func_166(var uParam0) // Position - 0xB25F
{
	int i;
	int num;
...
int func_168(int iParam0) // Position - 0xB2C1
{
...
int func_171(int iParam0) // Position - 0xB364
{
	int num;
...
BOOL func_173(int iParam0) // Position - 0xB3B9
{
	if (!func_11(iParam0))
		return false;
...
Vector3 func_179(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xB69A
{
	var unk;
...
int func_196(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4) // Position - 0xC774
{
	if (IS_BIT_SET(uParam0->f_113, iParam1) || IS_BIT_SET(uParam0->f_114, iParam1))
		return 1;
...
void func_198(var uParam0, var uParam1) // Position - 0xC88F
{
	func_197(uParam0, 0, joaat("prop_carwash_roller_horz"));
	func_197(uParam0, 1, joaat("prop_carwash_roller_vert"));
	func_197(uParam0, 2, joaat("prop_ld_test_01"));
...
void func_211(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11) // Position - 0xCB5E
{
	float num;
	float num2;
	var unk;
...
var func_212(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0xCC0A
{
...
int func_215(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xCE1E
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_78472[1 /*14*/] = { func_263(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78472[1 /*14*/] = { func_263(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78472[1 /*14*/] = { func_263(num8, 14, unk18[j], -1) };
							func_235(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
							func_258(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_225(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_225(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_225(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
			...
			{
				Global_78472[1 /*14*/] = { func_263(num8, i, func_224(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78472[1 /*14*/] = { func_263(num8, 14, unk59[j], -1) };
			func_235(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
			func_258(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_225(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_225(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_225(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
...
BOOL func_216(var uParam0, int iParam1, var uParam2) // Position - 0xD62F
{
	int num;
	...
	{
		if (!func_327(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_64, Global_113810.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_219(int iParam0, int iParam1, int iParam2) // Position - 0xD780
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_221(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0xD886
{
	var unk;
	int i;
...
BOOL func_222(int iParam0, int iParam1, int iParam2) // Position - 0xDE8A
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_223(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0xDF23
{
	int num;
	...
	{
		if (!func_327(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_61, Global_113810.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
int func_224(var uParam0, int iParam1, int iParam2) // Position - 0xDFCE
{
	int i;
	int j;
...
int func_226(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xE11F
{
	int num;
...
int func_227(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE426
{
	int num;
	int num2;
	int num3;
...
BOOL func_231(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF5BB
{
	int num;
...
BOOL func_232(int iParam0, int iParam1, var uParam2) // Position - 0xF5E4
{
	*uParam2 = -99;
...
int func_233(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xF8AE
{
	int num;
...
void func_235(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFC8F
{
	int num;
...
BOOL func_236(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFD29
{
	switch (iParam0)
	{
...
int func_240(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1033A
{
	int num;
	int num2;
	int num3;
...
int func_241(var uParam0, int iParam1) // Position - 0x10436
{
	int num;
...
void func_246(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x11043
{
	int num;
	var unk;
	int num2;
...
BOOL func_252(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13308
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_253(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13585
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_254(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x139AA
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_255(var uParam0, int iParam1) // Position - 0x13C9D
{
	int num;
	var unk;
...
int func_256(var uParam0, int iParam1) // Position - 0x13CE4
{
	int num;
	var unk;
	var unk2;
...
int func_257(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x13D44
{
	int num;
	int num2;
	int num3;
...
BOOL func_270(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x19AD1
{
	int num;
	int num2;
	int num3;
...
void func_272(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x19BE3
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_266(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_266(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78670)
		{
			...
			func_266(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_327(var uParam0, int iParam1, int iParam2) // Position - 0x2B07F
{
	int num;
	int num2;
	int i;
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_78472[1 /*14*/] = { func_263(num, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_327(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_327(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78472[2 /*14*/] = { func_263(num, 14, k, -1) };
								
									if (Global_78472[2 /*14*/].f_12 == j)
										if (func_327(uParam0, 14, k))
											if (!func_221(num, iParam2, 14, k, &unk, &Global_78472[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_78472[2 /*14*/] = { func_263(num, i, num2, -1) };
					
						if (!func_221(num, iParam2, i, num2, &unk, &Global_78472[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_78472[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_225(iParam1)) && Global_78472[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_225(iParam1)))
	{
		return true;
	}
...
void func_330() // Position - 0x2B335
{
	...
	while (unk_0x15CCE8886267624F() || func_388())
	{
		SYSTEM::WAIT(0);
	}
	...
	while (true)
	{
			...
			if (func_375())
			{
				if (func_66(unk_0x4A8C381C258A124D()))
				{
					if (func_329(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)))
					{
						...
						{
							if (func_374(unk_0x4A8C381C258A124D(), 0) == -1)
							{
		...
		if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
		{
			...
			flag = func_371(num2) || func_370(num2);
...
BOOL func_333(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, eStackSize essParam5) // Position - 0x2B812
{
	...
	switch (uParam1->f_13)
	{
		...
		case 8:
			...
			if (func_344(&uParam0->[uParam1->f_12 /*24*/]) || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) == 0)
			{
				func_354(uParam1, 0);
				return false;
			}
		...
		case 4:
			...
			{
				if (!unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) || func_374(unk_0x4A8C381C258A124D(), 0) != -1)
				{
					func_354(uParam1, 0);
					return false;
				}
...
int func_334(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2BF98
{
...
void func_335(var uParam0) // Position - 0x2C134
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_336(var uParam0) // Position - 0x2C160
{
	...
	if (func_337(uParam0->f_12, unk) > SYSTEM::COS(uParam0->f_15))
		return 1;
...
int func_339(var uParam0, var uParam1, var uParam2) // Position - 0x2C25A
{
	if (unk_0xD6F9DEE4765092A9(uParam1))
		return 0;

	if (func_341(uParam0) || !unk_0x4C705AAF75363287())
	{
		unk_0x428C32CC68809A35(1);
...
void func_340(var uParam0, var uParam1) // Position - 0x2C2A6
{
...
BOOL func_342(var uParam0) // Position - 0x2C31C
{
	unk_0x39DCBE5519BD783A(uParam0);
	return unk_0x7EBCD400E7DE179C(0);
}

BOOL func_343(var uParam0, var uParam1) // Position - 0x2C32F
{
	unk_0x39DCBE5519BD783A(uParam0);
	unk_0x511D14ED2DA887E1(uParam1);
	return unk_0x7EBCD400E7DE179C(0);
...
int func_346(var uParam0, var uParam1) // Position - 0x2C44E
{
	if (unk_0xD6F9DEE4765092A9(uParam1))
		return 0;
...
void func_347(var uParam0) // Position - 0x2C497
{
	unk_0xAC98CA65AD9A3215(uParam0);
	unk_0x5E01B6B1F460FE3F(0, 1, 1, -1);
	return;
...
BOOL func_351(int iParam0) // Position - 0x2C5E3
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
		if (unk_0x1C2F771CDC87A3A5(iParam0, 0))
			return true;
...
BOOL func_356(var uParam0) // Position - 0x2C722
{
	if (func_359(uParam0))
		return true;
...
BOOL func_357(int iParam0) // Position - 0x2C745
{
	int num;
...
BOOL func_358(int iParam0, int iParam1) // Position - 0x2C763
{
	return IS_BIT_SET(Global_1895156[iParam0 /*609*/].f_10.f_4, iParam1);
}

BOOL func_359(int iParam0) // Position - 0x2C77B
{
	int num;
...
BOOL func_372(int iParam0) // Position - 0x2CE10
{
	int num;
...
BOOL func_373(int iParam0) // Position - 0x2D037
{
...
int func_374(var uParam0, int iParam1) // Position - 0x2D260
{
	var unk;
	int num;
	int i;
...
BOOL func_375() // Position - 0x2D2E5
{
	if (Global_1575038 == 0)
		if (!unk_0x76CD105BCAC6EB9F())
			return true;
	...
	if (func_376() != 0)
		if (unk_0x486FF5D06E9659F1(func_376()) == 0)
			return true;
...
BOOL func_379(int iParam0) // Position - 0x2D3CF
{
...
void func_382(var uParam0, int iParam1) // Position - 0x2D401
{
	*uParam0 = "CWASH_RIDEHLP" /*Press ~INPUT_CONTEXT~ to use the Car Wash. The cost is $~1~.*/;
	...
	if (unk_0x0BA1A956D36B210F() || func_384())
	...
	else if (unk_0x1226C55CA7D2269A() || func_383())

	...
	switch (iLocal_83)
	{
		...
		case 3:
			if (!func_76(iLocal_83))
				if (func_73() && !func_72() && func_71() && !func_70(false))
					if (iLocal_85 != 0)
		...
		case 4:
			if (func_67(uLocal_76))
				unk_0x04FC75A7251431C6(uLocal_76, 0.75f);
		
			if (!func_76(4))
				if (func_73() && func_71() && !func_70(false))
		...
		case 5:
			...
			if (!func_76(5) && iLocal_71 == 4 && func_71() && !func_70(false))
		...
		case 6:
			...
			if (func_73() && !func_72())
			{
				...
				if (func_22(6))
				{
					if (!func_76(6) && func_71() && !func_70(false))
					{
						func_7(134, 4, true);
				...
				if (func_6())
				{
					if (!func_5(0))
					{
						...
						func_2("MM_TOGGLE" /*Press ~INPUT_CONTEXT~ to cycle Vintage filters.*/, 10);
					}
				}
			}
			...
			if (func_34(1))
			{
				...
				{
					func_2("MM_HELP" /*Return to Isaac's corpse or call him on your cellphone to cycle Vintage filters.*/, 10000);
					func_33(1, false);
				}
			}
			break;
...
void func_7(int iParam0, int iParam1, BOOL bParam2) // Position - 0x55F
{
	...
	if (Global_117[iParam0 /*10*/].f_8 != 172)
	{
		...
		else
		{
			...
			num = iParam1;
			func_13(iParam0, num, 1);
			func_12(iParam0, num, 1);
...
BOOL func_22(int iParam0) // Position - 0xA8A
{
	...
	num2 = unk_0x8B5B2BE72A7C0CF6(Global_113810.f_10052.f_133, 0, num - 1);
...
BOOL func_27(var uParam0, int iParam1, BOOL bParam2) // Position - 0xF2F
{
	...
	for (i = 0; func_28(iParam1, i, &unk, &num); i = i + 1)
	{
...
void func_35() // Position - 0x14E9
{
	...
	switch (iLocal_70)
	{
		...
		case 2:
			...
			{
				func_45(24, false);
				func_44(unk_0x4A8C381C258A124D(), uLocal_59, fLocal_62);
				...
				if (iLocal_84 <= unk_0x1DD05E817C89C737())
				{
					...
					func_44(unk_0x4A8C381C258A124D(), uLocal_55, fLocal_58);
					func_61(true, 800);
					iLocal_70 = 0;
				}
				else
...
void func_44(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x4DD7
{
...
BOOL func_52(var uParam0, int iParam1) // Position - 0x516D
{
	int num;
...
BOOL func_62() // Position - 0x534A
{
	...
	func_2("MM_SOLBUSY" /*Solomon's office is busy. Come back later.*/, 5000);
	return false;
}
...
BOOL func_67(var uParam0) // Position - 0x54B0
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
void func_68(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x54D1
{
	if (bParam1)
	{
		unk_0x0B0C9A0F9AAEB7F0(&(Global_113810.f_10052.f_133), iParam0);
	...
	{
		unk_0x8744D2E3FC95740E(&(Global_113810.f_10052.f_133), iParam0);
	}
...
BOOL func_70(BOOL bParam0) // Position - 0x5560
{
...
BOOL func_78(var uParam0, var uParam1, var uParam2) // Position - 0x57D2
{
	var unk;
	var unk2;
...
void func_84() // Position - 0x59C7
{
	switch (iLocal_83)
	{
		...
		case 4:
			...
			func_85(sLocal_86);
			uLocal_76 = unk_0xB1DBFEB95C0EFB88(26, joaat("U_F_M_Drowned_01"), func_75(4), 184.5548f, 1, 1);
			...
			unk_0x935364B4448CD584(uLocal_76, 1);
			unk_0x3CEA1FD137ACE2D9(uLocal_76, joaat("PLAYER"));
			break;
	
		case 5:
			iLocal_73 = 731806707;
			unk_0xB80B2E08713B8BC6(iLocal_73, joaat("v_ilev_sol_off_door01"), -1002.147f, -478.064f, 50.117f, 1, 1, 0);
		...
		case 6:
			...
			uLocal_74 = unk_0xB1DBFEB95C0EFB88(26, joaat("U_M_O_FilmNoir"), func_75(6), 22.9631f, 1, 1);
			...
			uLocal_75 = unk_0x43AFC452F25F3A2F(joaat("prop_vintage_filmcan"), -543.71f, 1986.2f, 126.05f, 1, 1, 0);
			break;
	}
...
void func_87(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x5BC0
{

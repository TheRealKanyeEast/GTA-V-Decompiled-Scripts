...
BOOL func_2() // Position - 0x12B
{
	...
	if (!unk_0x4FAFF4BCB7633475(Global_100554))
	{
		...
		{
			if (unk_0x13CCB1AD131C1082(Global_100554, &uLocal_244, &uLocal_276, 3))
			{
				if (unk_0x5B702A5D1F2635BE(Global_100554))
				{
					unk_0xE1C7B23ECC5080B5(Global_100554, 0, 0);
					unk_0x974022927CB47E68(Global_100554);
					return false;
				}
...
int func_18(var uParam0) // Position - 0x9C6
{
	int i;
	int num;
...
int func_20(int iParam0) // Position - 0xA28
{
...
BOOL func_26() // Position - 0xB81
{
	...
	if (!unk_0x4FAFF4BCB7633475(Global_100554))
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_238))
		{
			if (unk_0x13CCB1AD131C1082(Global_100554, &uLocal_244, &uLocal_260, 3))
			{
				if (unk_0x5B702A5D1F2635BE(Global_100554))
				{
					unk_0xE1C7B23ECC5080B5(Global_100554, 0, 0);
				...
				else
				{
					...
					unk_0x3DA436E63AB0F541(Global_100554, iLocal_292, &uLocal_244, &uLocal_276, 8f, -8f, 257, 0, 8f, 0);
					return true;
				}
			}
			else
			{
				...
				{
					unk_0x974022927CB47E68(Global_100554);
					unk_0xBCB78CFBB026B0DF(Global_100554, 16);
...
void func_37() // Position - 0xFB7
{
	...
	while (!unk_0xFC8BFE4B41177C22(Global_100554) || !unk_0x6252BC0DD8A320DB(iLocal_239))
	{
		SYSTEM::WAIT(0);
	}
	...
	{
		if (!unk_0x4FAFF4BCB7633475(Global_100554))
			unk_0x0FD8B5F4BB15CD71(Global_100554, -1);
	
		unk_0x3CEA1FD137ACE2D9(Global_100554, joaat("PLAYER"));
	}

	unk_0xEE0BCDB1B5E36BCB(Global_100554, 1, 1);
	unk_0x0428AFDCAA63B06E(Global_100554, 132, 1);
	unk_0x72B18C9612CF3DA0(Global_100554, 16);
	func_39(&Global_100554, Global_95817);
	func_38(&uLocal_71, 1, unk_0x4A8C381C258A124D(), "FRANKLIN", 0, 1);
	uLocal_238 = unk_0x4E55EAB577C13329(iLocal_239, unk_0xD1A6A821F5AC81DB(Global_100554, 1), 1, 1, 0);
	unk_0x4D306DD94DD6FDBA(uLocal_238, Global_100554, unk_0x72F7E39FB49FC0BA(Global_100554, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
	return;
}

void func_38(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1092
{

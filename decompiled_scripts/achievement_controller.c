		...
		if (Global_32534 != iLocal_65)
		{
			if (iLocal_65 == 0 && Global_32534 != 0)
				if (unk_0x0BA1A956D36B210F() || func_179())
					func_178("CHEAT_TROPHIE" /*Cheats have been activated. Trophies will not be awarded for the duration of this session.*/, -1);
				else
					func_178("CHEAT_ACHIEVE" /*Cheats have been activated. Achievements will not be awarded for the duration of this session.*/, -1);
...
BOOL func_25(var uParam0) // Position - 0x10B3
{
...
float func_28(int iParam0, var uParam1, float fParam2) // Position - 0xA229
{
	float num;
	float num2;
	int num3;
...
int func_58(int iParam0, int iParam1) // Position - 0xB022
{
	...
	num5 = func_59(num, iParam1);

	if (func_59(num2, iParam1) < num5)
		num5 = func_59(num2, iParam1);

	if (func_59(num3, iParam1) < num5)
		num5 = func_59(num3, iParam1);

	if (num4 != -1)
		if (func_59(num4, iParam1) < num5)
			num5 = func_59(num4, iParam1);
...
void func_62() // Position - 0xB167
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_64(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_63(unk_0x4A8C381C258A124D());
		
			if (func_60(num) && !func_177(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != num && func_60(Global_113810.f_2366.f_539.f_4321))
...
int func_63(var uParam0) // Position - 0xB264
{
	int i;
	int num;
...
int func_65(int iParam0) // Position - 0xB2C6
{
...
void func_67(char* sParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, BOOL bParam12, int iParam13) // Position - 0xB2E4
{
...
{
	if (unk_0x76CD105BCAC6EB9F() && func_79())
		return 1;
...
int func_86(int iParam0, var uParam1) // Position - 0xCE8B
{
	int num;
	int num2;
	var unk;
...
int func_87(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0xD207
{
	...
	*uParam3 = 0;
	...
	{
		case joaat("WEAPON_BAT"):
			if (!*Global_262145.f_34131 && func_98(iLocal_54, false) || func_88(iParam0, iParam1, -1))
			{
				*uParam2 = 1;
				*uParam3 = 0;
				return 1;
...
BOOL func_88(int iParam0, int iParam1, int iParam2) // Position - 0xD2E3
{
	int num;
	int num2;
...
int func_92(int iParam0, int iParam1, int iParam2) // Position - 0xF88B
{
	int num;
...
void func_105(var uParam0, var uParam1) // Position - 0xFCF0
{
	int i;
	int j;
	int k;
...
float func_109(var uParam0) // Position - 0x110F4
{
	if (func_112(uParam0))
		if (func_111(uParam0))
			return uParam0->f_2;
...
BOOL func_111(var uParam0) // Position - 0x11188
{
	return IS_BIT_SET(*uParam0, 2);
}

BOOL func_112(var uParam0) // Position - 0x11195
{
...
int func_131() // Position - 0x1151C
{
	...
	if (unk_0x76CD105BCAC6EB9F() || Global_78689)
		return 0;
...
BOOL func_167(var uParam0) // Position - 0x12DEA
{
	if (!unk_0xFC8BFE4B41177C22(uParam0))
		return false;
...
void func_169(var uParam0) // Position - 0x12F18
{
	if (func_112(uParam0))
	{
		if (!func_111(uParam0))
...
int func_173() // Position - 0x12FBA
{
	...
	if (func_174(num2, 0) || IS_BIT_SET(Global_96664, 2))
		num = num + 1;

	num2 = func_175(1);

	if (func_174(num2, 0) || IS_BIT_SET(Global_96664, 1))
		num = num + 1;

	num2 = func_175(0);

	if (func_174(num2, 0) || IS_BIT_SET(Global_96664, 0))
		num = num + 1;

	return num;
}

BOOL func_174(int iParam0, int iParam1) // Position - 0x13030
{
	return false;
}
...
void func_180(var uParam0) // Position - 0x13130
{
	func_181(uParam0, 0f);
	return;
}

void func_181(var uParam0, float fParam1) // Position - 0x1313F
{

...
void main() // Position - 0x0
{
	...
	func_77();
	Global_4543160 = 0;
	unk_0x0B0C9A0F9AAEB7F0(&Global_4543160, 0);
	unk_0x0B0C9A0F9AAEB7F0(&Global_4543160, 1);
	...
	switch (iLocal_54)
	{
		case 0:
			...
			unk_0xA2CDB686AB549D8A(&Global_113810, 1, 1);
			unk_0x3C17D57F8A1F4336(&Global_113810, "fSaveVersion");
...
void func_23() // Position - 0x2C1B
{
	...
	if (num >= 0 && num2 >= 0 && num3 >= 0)
		Global_113810.f_668.f_1315 = Global_113810.f_668.f_1315 - num;
...
void func_24() // Position - 0x2C7A
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		for (j = 171; j <= 198; j = j + 1)
		{
			...
			{
				unk_0x8744D2E3FC95740E(&Global_113810.f_25185[j], i);
				num = j + (198 - 171) + 1;
				unk_0x0B0C9A0F9AAEB7F0(&Global_113810.f_25185[num], i);
			}
		}
	}

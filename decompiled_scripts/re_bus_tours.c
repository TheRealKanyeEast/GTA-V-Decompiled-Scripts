...
int func_18(var uParam0) // Position - 0xAEF
{
	int i;
	int num;
			...
			case 1:
				...
				if (unk_0xD9F5E1FEFD1329E4(uLocal_304, 0))
				{
					...
					if (unk_0xFFEB5F24B372DFF6(uLocal_318, uLocal_318.f_1, uLocal_321, uLocal_321.f_1))
					{
						...
						{
							if (func_85(&uLocal_341, "BUSTOAU", uLocal_50[iLocal_276 /*15*/], 4, 0, 0, 0))
							{
								if (num <= 13)
								{
									if (num == 11)
...
BOOL func_53(BOOL bParam0) // Position - 0x2052
{
...
void func_60(int iParam0, int iParam1, int iParam2) // Position - 0x278B
{
	if (iParam2 == -1)
		iParam2 = func_61();
...
BOOL func_78(int iParam0) // Position - 0x33EF
{
	int num;
...
BOOL func_79(int iParam0) // Position - 0x3411
{
...
int func_81(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x345E
{
	int num;
...
BOOL func_88(var uParam0) // Position - 0x3909
{
...
int func_94(int iParam0, int iParam1, int iParam2) // Position - 0x3E5E
{
	...
	return func_95(func_125(iParam0), 0, iParam1, iParam2, false);
}
...
void func_98(int iParam0) // Position - 0x476F
{
	...
	else if (IS_BIT_SET(Global_113810.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_100() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113810.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_100() /*5568*/].f_681.f_10), iParam0);
	}
...
char* func_99(int iParam0) // Position - 0x48E8
{
	switch (iParam0)
	{
		case 0:
...
int func_102(int iParam0, int iParam1) // Position - 0x4A1A
{
...
void func_127() // Position - 0x513D
{
	if (!unk_0x4FAFF4BCB7633475(uLocal_284))
	{
		...
		unk_0xEBA229B2E0BB05E0(uLocal_284, uLocal_304, 10000, 0, 2f, 262144, 0);
...
void func_128() // Position - 0x5177
{
	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		...
		{
			if (unk_0xFAA48325A90263BE(unk_0x4A8C381C258A124D(), uLocal_304, 5f, 5f, 5f, 0, 1, 0) && !unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) && !func_126("TX_H02" /*Press ~INPUT_ENTER~ to enter a taxi as a passenger. Hold ~INPUT_ENTER~ to jack a taxi.*/))
			{
				if (func_157())
				{
					if (!bLocal_511)
					...
					if (unk_0x6D05C5731A838CB3(2, 23))
						unk_0xEBA229B2E0BB05E0(unk_0x4A8C381C258A124D(), uLocal_304, -1, 2, 1f, 8, 0);
					...
					if (!unk_0xC450B06E5AAA0985(uLocal_308))
					{
						...
						unk_0x5D3946F818C6B331(uLocal_308, Global_32330);
...
BOOL func_129(var uParam0) // Position - 0x52D9
{
	char* str;
...
char* func_130(int iParam0) // Position - 0x5432
{
	int num;
...
BOOL func_131(var uParam0) // Position - 0x576F
{
	BOOL num;
...
{
	switch (func_139(&Global_32343, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
{
	if (Global_113799 == func_72() && unk_0x9FA91AA1AC724CD0() && Global_113800)
		return true;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_167() || Global_112857 || Global_32286 || func_166() || func_23(8, -1) || func_165() || func_164() || func_162() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
				
					case 4:
						if (func_167() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_23(8, -1) || func_162() || func_161() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
...
void func_169(var uParam0) // Position - 0x8306
{
	if (func_181(uLocal_284))
	{
		if (!unk_0x4FAFF4BCB7633475(uLocal_284))
...
void func_171(var uParam0, char* sParam1, int iParam2) // Position - 0x83A7
{
	unk_0x04C016145CE6A18B(uParam0, sParam1, func_172(iParam2), 1);
	return;
}

char* func_172(int iParam0) // Position - 0x83BE
{
	char* str;
...
BOOL func_173(var uParam0) // Position - 0x85B3
{
...
int func_174(var uParam0, var uParam1, var uParam2, int iParam3, BOOL bParam4, int iParam5, int iParam6) // Position - 0x85ED
{
	float num;
	int num2;
	BOOL flag;
...
void func_178(var uParam0) // Position - 0x8874
{
...
BOOL func_180(var uParam0, int iParam1) // Position - 0x8890
{
...
BOOL func_181(var uParam0) // Position - 0x88DD
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
			return true;
...
void func_186() // Position - 0x89CC
{
	...
	else
	{
		...
		if (unk_0x6252BC0DD8A320DB(num) && unk_0x6252BC0DD8A320DB(num2) && unk_0xE100DD4F82A51BDE(sLocal_507) && unk_0x6252BC0DD8A320DB(joaat("tourbus")) && unk_0xDCB78A15E5F495DC(2))
		{
			...
			func_188(&uLocal_341, 3, uLocal_284, "TOURGUIDE", 0, 1);
...
void func_188(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x8C8D
{
...
BOOL func_225(int iParam0, int iParam1, int iParam2) // Position - 0xA065
{
	BOOL num;
	int num2;
...
void func_232(int iParam0) // Position - 0xA475
{
	...
	if (func_156())
	{
		...
		func_234(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_233(Global_113799, true), 64);
...
void func_243() // Position - 0xAC48
{
	func_234(30000);
	func_242(&Global_32343);
	Global_32331 = unk_0x1DD05E817C89C737();
	return;
}

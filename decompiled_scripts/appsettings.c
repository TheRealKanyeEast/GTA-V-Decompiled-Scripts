...
void main() // Position - 0x0
{
	...
	for (i = 0; i < 9; i = i + 1)
	{
		...
		else if (unk_0x1B79E937E91F40C3(&(Global_113810.f_14054[Global_20500 /*20*/].f_11), &Global_9175[Global_20500 /*2811*/][1 /*281*/].f_144[i /*6*/]))
		{
...
void func_12() // Position - 0x890
{
	...
	if (iLocal_41 == 1)
	{
		...
		if (func_10(2, Global_20476, 0) || func_10(2, Global_20477, 0) || bLocal_49 || iLocal_63 == 1 || iLocal_64 == 1)
		{
			iLocal_63 = 0;
			iLocal_64 = 0;
			bLocal_49 = false;
			...
			if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
			{
				...
				if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
				{
					...
					{
						if (unk_0x1B79E937E91F40C3(&Global_9175[Global_20500 /*2811*/][1 /*281*/].f_144[iLocal_45 /*6*/], "Silent Ringtone Dummy"))
						{
						}
						else
						{
							unk_0x1BC60757AC20ACCF(&Global_9175[Global_20500 /*2811*/][1 /*281*/].f_144[iLocal_45 /*6*/], unk_0x4A8C381C258A124D(), 1);
						}
					}
				}
			}
					...
					if (Global_9175[Global_20500 /*2811*/][0 /*281*/].f_259 == 2)
					{
						if (Global_43377 == 15)
						{
							...
							else
							{
								...
								{
									unk_0x428C32CC68809A35(1);
									func_15("CELL_7051" /*When Sleep Mode is active, the Sleep symbol will be displayed near the Radar.*/, -1);
...
int func_21(int iParam0, int iParam1) // Position - 0x1546
{
...
void func_28() // Position - 0x16ED
{
	...
	while (value < 19)
	{
		...
		if (unk_0x1B79E937E91F40C3(&Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_7[Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_259 /*4*/], &Global_9175[Global_20500 /*2811*/][iLocal_41 /*281*/].f_7[num2 /*4*/]))
		{
			iLocal_46 = value;
...
void func_37() // Position - 0x1EBA
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_41(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_39(num) && !func_38(14) || Global_112760)
			{
...
int func_40(var uParam0) // Position - 0x1FD1
{
	int i;
	int num;
...
int func_42(int iParam0) // Position - 0x2033
{
...
void func_47(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x21BC
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	unk_0x330108B080A2132F(SYSTEM::ROUND(fParam2));

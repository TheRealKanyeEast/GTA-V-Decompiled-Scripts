...
void func_1() // Position - 0xA5
{
	...
	Global_55736 = num3;
	Global_55736.f_12 = num4;
	Global_55736.f_24 = num5;
	Global_55736.f_36 = num6;
	return;
}
...
BOOL func_14(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13) // Position - 0xA96
{
	if (!func_15(iParam0))
	{
		if (func_16())
...
BOOL func_15(int iParam0) // Position - 0xAD3
{
	switch (iParam0)
	{
		case 63:
...
void func_17(BOOL bParam0) // Position - 0xB15
{
	...
	if (bParam0)
		...
		func_18("INV_RESTRICT" /*You have received an Invite to user-generated content which is currently restricted by your control settings.*/, -1);
...
BOOL func_19(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13) // Position - 0xB8C
{
	if (!func_15(uParam0))
	{
		if (func_16())
...
BOOL func_35(var uParam0, var uParam1, BOOL bParam2) // Position - 0x161E
{
	int i;
	int num;
	int num2;
...
BOOL func_37(var uParam0, var uParam1, var uParam2) // Position - 0x1DA1
{
	int num;
	var unk;
	var unk3;
...
BOOL func_44(BOOL bParam0) // Position - 0x2199
{
...
void func_47(var uParam0) // Position - 0x21F5
{
	int num;
...
var func_53(int iParam0, int iParam1) // Position - 0x22C3
{
...
void func_64(int iParam0, BOOL bParam1) // Position - 0x23F7
{
	...
	if (!unk_0x834C960822A4683F())
	{
		...
		{
			func_92();
			func_76(unk_0x259BE71D8A81D4FA(), false, 81920, 0);
...
BOOL func_80(var uParam0) // Position - 0x2A72
{
	int num;
...
void func_81(int iParam0, int iParam1, int iParam2) // Position - 0x2AA3
{
	int num;
	int i;
...
void func_82(int iParam0, int iParam1) // Position - 0x2B73
{
	int num;
...
BOOL func_84(int iParam0) // Position - 0x2BE7
{
...
BOOL func_88(int iParam0) // Position - 0x2CCE
{
	int num;
...
{
	unk_0x0B0C9A0F9AAEB7F0(&(Global_2683883.f_2), 15);
	return;
}
...
var func_103(int iParam0, int iParam1) // Position - 0x3458
{
...
int func_112(var uParam0) // Position - 0x354A
{
	if (func_113())
	{
		*uParam0 = 11;
...
void func_138(int iParam0) // Position - 0x3C0B
{
	...
	{
		Global_2801145.f_33 = unk.f_1;
		Global_2801145.f_34 = unk;
	}
	...
	if (unk_0xFCEF367B86651ED3(1, iParam0, &unk, 21))
	{
		if (Global_2801145.f_3 == 0)
		{
			...
			else
			{
				...
				TEXT_LABEL_COPY(&(Global_2801145.f_4), { unk }, 16);
				Global_2801145.f_20 = { unk.f_8 };
				TEXT_LABEL_ASSIGN_STRING(&Global_2801145.f_39[0 /*16*/], "", 64);
				Global_2801145.f_58 = -2;
				Global_2801145.f_56 = 0;
				Global_2801145.f_57 = 0;
...
BOOL func_140(var uParam0) // Position - 0x3D1A
{
	if (Global_78689)
	{
		if (func_50() == false)
		...
		if (func_144(unk_0x259BE71D8A81D4FA(), true, true))
...
BOOL func_141(int iParam0) // Position - 0x3E9E
{
	int num;
	var unk;
...
BOOL func_144(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3F9A
{
	int num;
...
void func_146() // Position - 0x4007
{
	...
	if (unk_0xA0C7B98BCF1EEF9E(Global_20481) == 1)
	{
		if (Global_20488)
		{
...
void func_147(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11) // Position - 0x4080
{

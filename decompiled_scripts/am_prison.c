...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_35() || unk_0xF859473E4AD09F30())
			func_43();
		...
		if (unk_0x76CD105BCAC6EB9F())
		{
			...
			if (!func_28() || func_25(unk_0x259BE71D8A81D4FA(), 0))
				if (!Global_1836158 && !func_24(3) && !func_21(unk_0x259BE71D8A81D4FA(), 0) && !unk_0x3555462DB47B7AB1() && unk_0xE916D57851F785AB(unk_0x259BE71D8A81D4FA()) && !func_19(unk_0x259BE71D8A81D4FA()) && !func_17(func_18(unk_0x259BE71D8A81D4FA())) && !func_15(unk_0x259BE71D8A81D4FA(), 146) && !func_10(unk_0x259BE71D8A81D4FA()))
...
BOOL func_13(int iParam0, BOOL bParam1) // Position - 0x1111
{
	if (func_14(iParam0))
...
BOOL func_14(int iParam0) // Position - 0x1155
{
	int num;
...
BOOL func_15(int iParam0, int iParam1) // Position - 0x1177
{
...
BOOL func_16(int iParam0) // Position - 0x1197
{
	int num;
...
BOOL func_19(int iParam0) // Position - 0x1217
{
...
BOOL func_25(int iParam0, int iParam1) // Position - 0x1319
{
	int num;
...
BOOL func_26(int iParam0) // Position - 0x1352
{
	if (!func_14(iParam0))
		return false;
...
BOOL func_28() // Position - 0x137C
{
	...
	if (Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/] == -1)
		return false;
	...
	switch (iLocal_131)
	{
		case 0:
			if (Global_1836158 || func_24(3))
				iLocal_131.f_4 = unk_0xA7B0B03284E7503C(1413.7028f, 2341.5168f, -232.3945f, 2016.2095f, 2998.893f, 161.0299f, 0, 1, 1, 1);
		
			func_31(&uLocal_98[unk_0xAE032CEDCF23C6D5()], 1);
			iLocal_131 = 1;
			break;
		...
		case 2:
			if (Global_1836158 || func_24(3))
				unk_0xD7B6A43ACC36D868(iLocal_131.f_4, 0);
...
BOOL func_39(int iParam0) // Position - 0x1622
{
...
void func_45(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x1679
{
	...
	func_47(0, -1, false);
	unk_0x6F4A865F87C7A3AD(&iLocal_96, 2, 0);
	unk_0x7B13DC83218D9AF5(&uLocal_98, 33, 0);

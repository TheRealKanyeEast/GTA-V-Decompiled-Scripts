			...
			while (num == 0)
			{
				...
				if (unk_0x0A5BC2689B1DF62B())
				{
					...
					if (num3 >= 0)
					{
						...
						Global_1652106.f_1 = num3 % 3;
						Global_1652106.f_3 = num3 / 3;
						func_154(num3, &Global_1652404);
						func_159(&Global_1652404);
					}
				}
...
void func_1(var uParam0, var uParam1, var uParam2) // Position - 0x30C
{
	...
	if (!func_8(uParam2) || func_8(uParam2) && func_7(uParam2, 250, false))
		flag = true;

	if (unk_0x6D05C5731A838CB3(2, 187) || func_6(187, &(Global_1654054.f_1060), 1) && flag)
	{
		func_5(uParam2);
	...
	if (unk_0x6D05C5731A838CB3(2, 188) || func_6(188, &(Global_1654054.f_1060), 1) && flag)
	{
		func_5(uParam2);
		func_4(uParam2, false, false);
	...
	if (unk_0x6D05C5731A838CB3(2, 189) || unk_0x6D05C5731A838CB3(2, 241) || func_6(189, &(Global_1654054.f_1060), 1) && flag)
	{
		func_5(uParam2);
		func_4(uParam2, false, false);
	...
	if (unk_0x6D05C5731A838CB3(2, 190) || unk_0x6D05C5731A838CB3(2, 242) || func_6(190, &(Global_1654054.f_1060), 1) && flag)
	{
...
BOOL func_7(var uParam0, int iParam1, BOOL bParam2) // Position - 0x948
{
	if (iParam1 == -1)
		return 1;
...
int func_33(int iParam0, int iParam1) // Position - 0x2CC2
{
...
var func_39(int iParam0, int iParam1) // Position - 0x2DD8
{
...
int func_46(int iParam0) // Position - 0x347F
{
	return Global_1853988[iParam0 /*867*/].f_205.f_6;
}

int func_47(int iParam0, var uParam1, int iParam2) // Position - 0x3494
{
	int num;
...
int func_49(int iParam0, var uParam1, int iParam2) // Position - 0x36ED
{
	int num;
...
int func_51(int iParam0, var uParam1, int iParam2) // Position - 0x3954
{
	int num;
...
BOOL func_53(int iParam0, int iParam1, int iParam2) // Position - 0x4725
{
	int num;
	int num2;
...
int func_56(int iParam0, int iParam1, int iParam2) // Position - 0x6CC0
{
	int num;
...
void func_61(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x78D5
{
	int num;
...
int func_63(int iParam0, int iParam1, int iParam2) // Position - 0x7A7B
{
	int num;
...
BOOL func_64(int iParam0, int iParam1, int iParam2) // Position - 0x7A95
{
	int num;
	int num2;
...
int func_69(int iParam0, int iParam1, int iParam2) // Position - 0x7CEA
{
	int num;
...
int func_74(int iParam0, int iParam1, int iParam2) // Position - 0x7FA1
{
	int num;
...
BOOL func_75(int iParam0, int iParam1, int iParam2) // Position - 0x7FBB
{
	int num;
	int num2;
...
void func_76(int iParam0, int iParam1, BOOL bParam2) // Position - 0x7FED
{
	...
	if (num > -1)
		if (bParam2)
			unk_0x0B0C9A0F9AAEB7F0(&Global_2804776.f_991[func_77(iParam0, iParam1)], func_28(num));
		else
			unk_0x8744D2E3FC95740E(&Global_2804776.f_991[func_77(iParam0, iParam1)], func_28(num));
...
BOOL func_83(int iParam0, int iParam1) // Position - 0x8DF2
{
	int num;
	int num2;
...
int func_84(int iParam0, int iParam1) // Position - 0x8E17
{
	var unk;

	unk = Global_2804776.f_991[func_77(iParam0, iParam1)];
	return unk;
}
...
BOOL func_91(int iParam0, int iParam1, int iParam2) // Position - 0x9CD4
{
	int num;
	int num2;
...
BOOL func_95(int iParam0, int iParam1, int iParam2) // Position - 0xA3BB
{
	int num;
	int num2;
...
BOOL func_97(int iParam0) // Position - 0xA4A5
{
	switch (iParam0)
	{
		case joaat("WEAPON_PISTOL_MK2"):
...
void func_99(var uParam0, var uParam1) // Position - 0xA511
{
	...
	if (Global_262145.f_12224 && unk_0x2A9ED010C087BF2B(joaat("WEAPON_FLASHLIGHT")) && uLocal_65[25] == uParam1->f_5)
	...
	if (unk_0x2A9ED010C087BF2B(joaat("WEAPON_RAYCARBINE")) && uLocal_65[51] == uParam1->f_5 && Global_262145.f_26948)
		func_111(joaat("WEAPON_RAYCARBINE"), uParam0, *uParam1, 0);

	if (unk_0x2A9ED010C087BF2B(joaat("WEAPON_RAYMINIGUN")) && uLocal_65[52] == uParam1->f_5 && Global_262145.f_26947)
		func_111(joaat("WEAPON_RAYMINIGUN"), uParam0, *uParam1, 0);

	if (unk_0x2A9ED010C087BF2B(joaat("WEAPON_RAYPISTOL")) && func_17(25007, -1) || func_17(25002, -1) || func_91(joaat("WEAPON_RAYPISTOL"), -1, 0) || Global_262145.f_25956 && uLocal_65[53] == uParam1->f_5)
	...
	if (*Global_262145.f_34053 && unk_0x2A9ED010C087BF2B(-22923932) && uLocal_65[67] == uParam1->f_5)
...
BOOL func_100(int iParam0) // Position - 0xB1E9
{
...
var func_103(int iParam0, int iParam1) // Position - 0xB2E8
{
...
BOOL func_131(int iParam0) // Position - 0xBA69
{
	switch (iParam0)
	{
		case joaat("COMPONENT_PISTOL_CLIP_02"):
...
BOOL func_133(int iParam0) // Position - 0xBCC0
{
	switch (iParam0)
	{
		case joaat("COMPONENT_ASSAULTRIFLE_CLIP_03"):
...
BOOL func_142(int iParam0) // Position - 0xE993
{
	int num;
	BOOL num2;
...
BOOL func_143(int iParam0) // Position - 0xE9B1
{
	if (unk_0x76CD105BCAC6EB9F())
		if (func_144())
...
void func_150(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4) // Position - 0xEABA
{
...
BOOL func_152(int iParam0) // Position - 0xEB6E
{
	int num;
	int num2;
	int num3;
	...
	if (unk_0x2645430E708CBFAC(2, iParam0) || unk_0x61C3701AD6D746B2(2, iParam0) || func_6(iParam0, &(Global_1654054.f_1060), 1))
	{
		if (!IS_BIT_SET(Global_1654054.f_1049[num2], num3))
		{
			unk_0x0B0C9A0F9AAEB7F0(&Global_1654054.f_1049[num2], num3);
			return true;
		}
	}
	else if (IS_BIT_SET(Global_1654054.f_1049[num2], num3))
	{
		unk_0x8744D2E3FC95740E(&Global_1654054.f_1049[num2], num3);
	}
...
void func_153() // Position - 0xEC02
{
	...
	if (Global_262145.f_12224 && unk_0x2A9ED010C087BF2B(joaat("WEAPON_FLASHLIGHT")))
	{
	...
	if (Global_262145.f_23625 && unk_0x2A9ED010C087BF2B(joaat("WEAPON_DOUBLEACTION")) && func_107() || Global_1969115)
	{
	...
	if (Global_262145.f_24325 && unk_0x2A9ED010C087BF2B(joaat("WEAPON_STONE_HATCHET")) && func_105())
	{
	...
	if (unk_0x2A9ED010C087BF2B(joaat("WEAPON_RAYCARBINE")) && Global_262145.f_26948)
	{
	...
	if (unk_0x2A9ED010C087BF2B(joaat("WEAPON_RAYMINIGUN")) && Global_262145.f_26947)
	{
	...
	if (unk_0x2A9ED010C087BF2B(joaat("WEAPON_RAYPISTOL")) && func_17(25007, -1) || func_17(25002, -1) || func_91(joaat("WEAPON_RAYPISTOL"), -1, 0) || Global_262145.f_25956)
	{
	...
	if (Global_262145.f_28591 && unk_0x2A9ED010C087BF2B(joaat("WEAPON_NAVYREVOLVER")) && func_104() || Global_1969121)
	{
	...
	if (unk_0x2A9ED010C087BF2B(joaat("WEAPON_TACTICALRIFLE")) && *Global_262145.f_33084 || func_91(joaat("WEAPON_TACTICALRIFLE"), -1, 0) || func_38(func_94(joaat("WEAPON_TACTICALRIFLE")), -1) || func_100(joaat("WEAPON_TACTICALRIFLE")))
	{
	...
	if (*Global_262145.f_34053 && unk_0x2A9ED010C087BF2B(-22923932))
	{
...
void func_158(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF97F
{

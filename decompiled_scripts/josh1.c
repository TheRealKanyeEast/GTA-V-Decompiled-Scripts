...
void func_1() // Position - 0x17C
{
	switch (iLocal_143)
	{
		...
		case 1:
			...
			if (!bLocal_158)
			{
				if (func_299(uLocal_81.f_28[0]) && unk_0xFC8BFE4B41177C22(uLocal_145))
				{
			...
			else if (unk_0x5266F1D2AEF6F73A(uLocal_147))
			{
				if (unk_0xBD3B265153D3BA2D(uLocal_147) > 0.29f)
				{
					if (!bLocal_159)
					{
						func_235(&uLocal_161, 2, unk_0x4A8C381C258A124D(), "Trevor", 0, 1);
						func_235(&uLocal_161, 5, uLocal_81.f_28[0], "Josh", 0, 1);
...
void func_10(int iParam0, int iParam1, int iParam2) // Position - 0xE25
{
	if (iParam2 == -1)
		iParam2 = func_11();
...
void func_69(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5DB5
{
	int num;
...
int func_70(int iParam0, int iParam1) // Position - 0x5DD8
{
...
BOOL func_76(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x973A
{
	int num;
...
void func_79(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA1C4
{
	int num;
	var unk;
	int num2;
...
BOOL func_92(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE7E2
{
	int num;
	int num2;
	int num3;
...
int func_151(var uParam0) // Position - 0x200E6
{
	int i;
	int num;
...
int func_206(var uParam0, int iParam1) // Position - 0x274FA
{
	int num;
	var unk;
	var unk33;
...
void func_208(int iParam0) // Position - 0x2765B
{
	int i;
	int num;
	int j;
...
float func_219(var uParam0, var uParam1, int iParam2) // Position - 0x27B2A
{
	var unk;
	var unk4;
...
BOOL func_225(int iParam0, int iParam1) // Position - 0x27F4E
{
...
void func_235(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x28236
{
...
void func_238(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x28341
{
	var unk;
	...
	if (iParam1 == 1)
		if (iLocal_34 != 0 && iLocal_34 != joaat("OBJECT") && iLocal_34 != joaat("GADGET_PARACHUTE"))
			if (func_298(unk_0x4A8C381C258A124D()))
...
void func_239(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x283EB
{
	if (bParam0)
	{
...
BOOL func_243(int iParam0) // Position - 0x285EC
{
	int num;
...
BOOL func_244(int iParam0) // Position - 0x2860E
{
...
int func_246(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x2865B
{
	int num;
...
BOOL func_250(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, int iParam6) // Position - 0x28D44
{
	BOOL flag;
	float num;
...
Vector3 func_252(var uParam0) // Position - 0x28F5E
{
...
void func_255(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x28FDA
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
BOOL func_256(float fParam0, var uParam1, var uParam2) // Position - 0x293D0
{
...
BOOL func_257(var uParam0, int iParam1, BOOL bParam2) // Position - 0x293FA
{
	int i;
	var unk;
	int num;
	...
	for (i = 0; func_258(iParam1, i, &unk, &num); i = i + 1)
	{
...
BOOL func_258(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x29468
{
...
BOOL func_259(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x29541
{
	float num;
	var unk3;
	var unk6;
...
void func_262(var uParam0) // Position - 0x2992A
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_264(var uParam0) // Position - 0x299AF
{
	if (func_298(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_268() // Position - 0x29AE0
{
...
BOOL func_270(var uParam0, int iParam1) // Position - 0x29B53
{
	if (func_299(uParam0))
...
BOOL func_271(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x29B86
{
...
void func_272(var uParam0) // Position - 0x29D1E
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_273() // Position - 0x29D4A
{
	...
	{
		case 0:
			if (!func_5(false) && unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), -1115.0707f, 279.6581f, 62.421844f, -1092.4285f, 284.13983f, 67.31652f, 15.75f, 0, 1, 0))
			{
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_284(Global_78945, Global_78947, iParam10) };
				num4 == -0.014f;
...
float func_283(var uParam0) // Position - 0x2A5D1
{
...
{
	if (!func_295(0) || Global_78960 || Global_78948 == 1 || !unk_0x9390801B06EE998F())
		return false;
	...
	switch (Global_78944)
	{
		...
		case 5:
			if (unk_0xFD216000DC314A92() || func_280(0) || func_294(true))
			{
			}
			else
			{
...
BOOL func_298(var uParam0) // Position - 0x2AD0E
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
			return true;
...
BOOL func_299(var uParam0) // Position - 0x2AD2F
{
	if (func_298(uParam0))
		if (!unk_0x4FAFF4BCB7633475(uParam0))
			return true;
...
void func_303(var uParam0, BOOL bParam1) // Position - 0x2B01F
{
	var unk;
	float num;
	...
	func_304(uParam0, iLocal_79, unk, num);
...
void func_304(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x2B093
{
	func_305(uParam0);
...
void func_305(var uParam0) // Position - 0x2B0D5
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_306(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2B171
{
	if (func_307(uParam0, iParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_307(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x2B1CD
{
	int num;
...
BOOL func_313() // Position - 0x2B35D
{
...
void func_314() // Position - 0x2B381
{
	...
	func_326(&uLocal_81.f_28[0], 1, 1, 1);
...
void func_318(var uParam0, BOOL bParam1) // Position - 0x2B47B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_319(var uParam0) // Position - 0x2B4B6
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_322(var uParam0) // Position - 0x2B530
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_324(var uParam0, int iParam1) // Position - 0x2B57A
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_326(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_325(var uParam0) // Position - 0x2B5BB
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_326(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2B5FC
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_328(BOOL bParam0) // Position - 0x2B6ED
{
	...
	if (!func_345())
	{
		...
		{
			func_162(num, 1, 0);
			func_329(unk_0x1AF90EB93E0012D6(), num);
		}
		else
		{
			if (Global_112897[num /*10*/].f_9 == -1)
...
BOOL func_330(char* sParam0, int iParam1, int iParam2) // Position - 0x2B7E5
{
	var unk;
	var unk2;
	int num;
...
int func_334(var uParam0, BOOL bParam1) // Position - 0x2BA18
{
	int i;
...
void func_337(int iParam0) // Position - 0x2BB0A
{

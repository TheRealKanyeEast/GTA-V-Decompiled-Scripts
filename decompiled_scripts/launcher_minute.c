...
void main() // Position - 0x0
{
	...
	if (!func_280(&unk64, &num, unk61, 1f))
	{
		func_279();
	...
	while (true)
	{
		...
		if (num == 32)
		{
			...
			{
				if (!func_217(329.513f, 3402.691f, 36.258f, unk_0xD1A6A821F5AC81DB(num.f_35[1], 1), 1056964608))
				{
		...
		func_213(num);
		func_206(&iLocal_94, &(num.f_9), unk61);
	
		if (num == 32)
			func_202(&num, unk61, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_97);
		else if (num == 34)
			func_197(&num, unk61, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
...
int func_32(var uParam0) // Position - 0x2B9B
{
	int i;
...
int func_33(var uParam0, int iParam1, int iParam2) // Position - 0x2BFE
{
	int i;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E2A
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6AC2
{
	int i;
	float num;
	float num2;
...
BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x75D9
{
...
BOOL func_85(int iParam0) // Position - 0x762F
{
	if (iParam0 != func_94())
...
BOOL func_93(int iParam0) // Position - 0x84E9
{
	if (iParam0 != func_94())
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8EC1
{
...
BOOL func_117(BOOL bParam0) // Position - 0x8F03
{
...
BOOL func_135(var uParam0) // Position - 0xADB9
{
	if (func_136(uParam0))
...
BOOL func_136(int iParam0) // Position - 0xADD9
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAF1D
{
	int i;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB0BC
{
	if (bParam0)
	{
...
BOOL func_147(int iParam0) // Position - 0xB2BD
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB2DF
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB32C
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB3A9
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4DC
{
...
void func_160(var uParam0) // Position - 0xB674
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_177(var uParam0, int iParam1) // Position - 0xBCF9
{
	int num;
	var unk;
	var unk33;
...
var func_180(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC1D9
{
	var unk;
...
int func_197(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD435
{
	...
	if (func_136(unk_0x4A8C381C258A124D()) && func_136(uParam0->f_28[0]) && !func_156() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_201(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
		func_200(&unk, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		func_198(&unk, sParam4, sParam5, 7, 0, 0);
...
void func_200(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD54E
{
...
float func_201(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD5E9
{
	var unk;
...
int func_202(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10) // Position - 0xD623
{
	...
	if (!(*uParam10 == 3))
	{
		if (func_188(2))
		{
			if (!func_156())
			{
				if (func_136(unk_0x4A8C381C258A124D()) && func_136(uParam0->f_28[0]) && func_136(uParam0->f_28[1]) && func_201(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
				{
					...
					{
						func_200(&unk, iParam6, uParam0->f_28[0], sParam7, 0, 1);
						func_200(&unk, iParam8, uParam0->f_28[1], sParam9, 0, 1);
						func_198(&unk, sParam4, sParam5, 7, 0, 0);
						*uParam10 = 2;
					}
					else if (*uParam10 == 2)
			...
			else if (func_204(sParam5) && !(*uParam10 == 1) && func_136(unk_0x4A8C381C258A124D()) && func_201(unk_0x4A8C381C258A124D(), uParam1, 1) >= 20f)
			{
			...
			if (func_201(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f && *uParam10 == 1)
			{
...
void func_206(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD7BF
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_201(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_209(uParam0, 1);
			}
			else
			{
				...
				if (func_201(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_211(uParam0);
			}
		}
	}
...
void func_215(var uParam0) // Position - 0xDDFA
{
	var unk;
...
void func_216(var uParam0) // Position - 0xDE97
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_218(var uParam0) // Position - 0xDEFB
{
	if (func_136(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_220(Any* panParam0, BOOL bParam1) // Position - 0xDF58
{
	var unk;
	...
	{
		if (!func_226(panParam0, true, true))
		{
			if (*panParam0 == 16)
				func_225(panParam0);
			else
	...
	{
		if (!func_226(panParam0, false, true))
		{
			func_214(panParam0);
			return false;
		}
	...
	{
		if (!func_226(panParam0, true, false))
		{
			func_214(panParam0);
			return false;
		}
	...
	{
		if (!func_226(panParam0, false, false))
		{
			func_214(panParam0);
			return false;
		}
...
BOOL func_226(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE5FD
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_227(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_227(var uParam0, var uParam1) // Position - 0xE7BB
{
	var unk;
...
BOOL func_230(var uParam0, int iParam1) // Position - 0xEADB
{
	float num;

	if (func_136(unk_0x4A8C381C258A124D()) && func_136(uParam0))
	{
		if (func_241(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
BOOL func_231(var uParam0, int iParam1) // Position - 0xEB51
{
	return func_232(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_232(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEB69
{
	BOOL flag;
	var unk;
	int num;

	num = func_240(uParam0, uParam1);
	...
	flag = func_233(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_233(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xEC2A
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_234(var uParam0, int iParam1) // Position - 0xED56
{
	int num;
...
BOOL func_236(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xEE65
{
	var unk;
	var unk4;
	float num;

	unk = { func_238(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_238(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_237(unk4, unk);
...
int func_240(var uParam0, var uParam1) // Position - 0xEF71
{
	int i;
...
int func_241(var uParam0) // Position - 0xEFB0
{
...
BOOL func_242(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEFD8
{
	float num;
	float num2;
	int num3;
	...
	if (func_136(unk_0x4A8C381C258A124D()) && func_136(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_246(uParam0, bParam1, num, num2))
				return true;
		
			if (func_243(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_243(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF0D3
{
	float num;
	float num2;
...
BOOL func_244(var uParam0, float fParam1) // Position - 0xF1DF
{
	var unk;
	var unk2;
	...
	if (unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_245(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_245(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF274
{
	var unk;
	var unk4;
	float num;

	unk = { func_238(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
BOOL func_246(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF302
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_258(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF8F1
{
	func_259(uParam0);
...
void func_259(var uParam0) // Position - 0xF933
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_260(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF9CF
{
...
BOOL func_261(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFA2B
{
	int num;
...
void func_263(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFAFF
{
	func_216(uParam0);
...
BOOL func_268(var uParam0) // Position - 0xFCD0
{
	...
	switch (iLocal_89)
	{
		...
		case 1:
			...
			if (!func_265(&num) || !unk_0xE100DD4F82A51BDE("rcmminute1"))
				return false;
...
void func_269(var uParam0, var uParam1) // Position - 0xFFF4
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
...
void func_291(var uParam0, BOOL bParam1) // Position - 0x10768
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_294(var uParam0) // Position - 0x107F2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_297(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1087D
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_298(var uParam0) // Position - 0x108CD
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))

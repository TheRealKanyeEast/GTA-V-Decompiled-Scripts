...
void func_2(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x19A
{
	...
	*uParam3 = 500;
	...
	if (!unk_0x1C2F771CDC87A3A5(uParam1, 0))
	{
		...
		func_156(Global_113810.f_19976.f_3, &unk4, &unk8, &unk, &unk7);
	
		if (Global_113810.f_19976.f_3 >= 5 || bLocal_261)
		{
			func_155(uParam1, unk4, unk8, uParam0);
...
void func_25(char* sParam0, int iParam1, int iParam2) // Position - 0x1056
{
	if (Global_100833 != 10 && Global_100833 != 9)
	{
		...
		func_27(&Global_104373, sParam0, 0, "Start", iParam1, iParam2);
		func_26();
		Global_94991 = 0;
	}
...
void func_32(var uParam0, var uParam1, int iParam2) // Position - 0x2CCF
{
	...
	uParam0->f_7 = func_35(uParam1, 145, 0);
...
int func_34(var uParam0) // Position - 0x2DED
{
	int i;
...
int func_35(var uParam0, int iParam1, int iParam2) // Position - 0x2E50
{
	int i;
		...
		if (unk_0xFC8BFE4B41177C22(Global_98144[i]))
			if (Global_98144[i] == uParam0)
				if (iParam1 == 145 || iParam1 == Global_98154[i])
					if (iParam2 == 0 || unk_0x4B423FAA24E8ABF0(uParam0) == func_36(iParam1, iParam2))
						return 1;
	}
			...
			if (unk_0xFC8BFE4B41177C22(*uParam1))
			{
				if (unk_0xD9F5E1FEFD1329E4(*uParam1, 0))
				{
					if (iParam2 == 0 || unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(*uParam1, 1), unk_0xD1A6A821F5AC81DB(iParam0, 1), 1) < 100f)
					{
						...
						if (func_44(*uParam1, func_113(), true))
						{
...
BOOL func_44(var uParam0, int iParam1, BOOL bParam2) // Position - 0x381B
{
	int i;
	var unk;
	int num;
	...
	for (i = 0; func_45(iParam1, i, &unk, &num); i = i + 1)
	{
...
BOOL func_45(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x3889
{
...
int func_48(int iParam0) // Position - 0x39BC
{
...
void func_59() // Position - 0x43C7
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_47(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_38(num) && !func_60(14) || Global_112760)
			{
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x44D2
{
	...
	if (func_38(num) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		...
		{
			func_62(uParam0, &Global_113810.f_2366.f_539.f_298[num /*477*/]);
...
int func_65(int iParam0, int iParam1) // Position - 0x4ACE
{
	int num;
	int num2;
	int i;
...
int func_66(int iParam0, var uParam1) // Position - 0x577F
{
	int i;
	int num;
...
int func_67(int iParam0) // Position - 0x57BA
{
	int num;
...
void func_68(var uParam0) // Position - 0x5A2E
{
	int num;
...
BOOL func_70(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5FB9
{
	var unk;
	var unk2;
...
int func_79(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6C51
{
	int i;
	float num;
	float num2;
...
BOOL func_83(float fParam0, var uParam1, var uParam2) // Position - 0x7768
{
...
BOOL func_86(int iParam0) // Position - 0x77BE
{
	if (iParam0 != func_95())
...
BOOL func_94(int iParam0) // Position - 0x8675
{
	if (iParam0 != func_95())
...
int func_98(int iParam0) // Position - 0x8952
{
...
int func_114() // Position - 0x8FC8
{
	...
	if (unk_0xA6E4F7A73ABC4A76("Towing"))
	{
		...
		if (num == 1)
		{
			...
			iLocal_51.f_2 = 1;
			iLocal_247 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Towing", &iLocal_51, 9, 57500);
			unk_0xFD49725F3FE7EE13("Towing");
...
BOOL func_119(int iParam0) // Position - 0x920C
{
...
void func_125() // Position - 0x9463
{
	switch (iLocal_72)
	{
		case 1:
			if (!func_149())
			{
				if (!unk_0x4C705AAF75363287() && !func_148(&uLocal_60))
				{
					unk_0x51E3279E9437131C(0);
					func_146(&uLocal_60);
				}
				else if (!unk_0x4C705AAF75363287() && func_148(&uLocal_60))
				{
		...
		case 3:
			...
			{
				unk_0x51E3279E9437131C(1);
				func_126("TOW_JOBOFFRD" /*~s~To accept towing jobs press ~INPUT_VEH_HORN~~s~*/, -1);
				iLocal_72 = 4;
			}
			break;
		...
		case 4:
			if (func_143(&uLocal_60) > 30f)
			{
				...
				{
					func_126("TOW_MISSEDJOB" /*~s~The towing job has expired. There is only a short time to accept before dispatch takes silence as a no. However, more jobs can be accessed by pressing ~INPUT_VEH_HORN~~s~*/, -1);
...
void func_126(char* sParam0, int iParam1) // Position - 0x95B2
{
...
BOOL func_127(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x95C9
{
...
BOOL func_131(int iParam0) // Position - 0x997F
{
	return func_132(iParam0, 20);
}

BOOL func_132(int iParam0, int iParam1) // Position - 0x998F
{
...
void func_142(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x9D0B
{
...
float func_143(var uParam0) // Position - 0x9DA6
{
	if (func_148(uParam0))
		if (func_145(uParam0))
			return uParam0->f_2;
		else
			return func_144(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1;
...
BOOL func_145(var uParam0) // Position - 0x9E3A
{
	return IS_BIT_SET(*uParam0, 2);
}

void func_146(var uParam0) // Position - 0x9E47
{
	func_147(uParam0, 0f);
	return;
}

void func_147(var uParam0, float fParam1) // Position - 0x9E56
{
	uParam0->f_1 = func_144(IS_BIT_SET(*uParam0, 4)) - fParam1;
...
BOOL func_148(var uParam0) // Position - 0x9E81
{
	return IS_BIT_SET(*uParam0, 1);
}

BOOL func_149() // Position - 0x9E8E
{
...
BOOL func_150(var uParam0) // Position - 0x9EB0
{
	var unk;
	int num;
...
void func_153(var uParam0, var uParam1) // Position - 0x9F55
{
	if (!func_157(uParam0, false, true))
	{
		if (func_150(uParam1))
		{
			if (unk_0x875A214D5EBCA509(0, 86) || unk_0x4465D55576678706(0, 86))
			{
				if (!func_149() && !unk_0x4C705AAF75363287() && !func_121(0) && !func_60(6) && !func_60(7) && !(unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0) && func_113() == 1)
				{
					func_142(&uLocal_82, 1, unk_0x4A8C381C258A124D(), "FRANKLIN", 0, 1);
					func_142(&uLocal_82, 4, 0, "TOWDISPATCH", 0, 1);
...
void func_154(var uParam0) // Position - 0xA05B
{
	if (!func_148(uParam0))
		func_146(uParam0);
...
void func_155(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xA073
{
	float num;
	var unk;
	int num2;
	...
	switch (iLocal_73)
	{
		...
		case 2:
			...
			{
				if (!unk_0x7B780C491DEC834E(uLocal_256, fLocal_259) || func_22(Global_113810.f_19976.f_1, 1073741824))
				{
					if (!unk_0xFC8BFE4B41177C22(iLocal_273))
					{
...
BOOL func_157(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA2D9
{
	...
	if (unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0)
	{
		if (*uParam0 >= 16)
			if (Global_113810.f_19976.f_3 >= 5)
				func_126("TOW_WANTED" /*~s~Towing jobs unavailable when Wanted. The towing job has ended.~s~*/, -1);

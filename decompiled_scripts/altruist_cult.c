		...
		if (unk_0x173751E886F8E9AB() || bLocal_171)
		{
			...
			switch (iLocal_48)
			{
				...
				case 2:
					...
					unk_0xEBB2809684978887(Global_42073[9 /*31*/], 0, 0, 1);
					unk_0xEBB2809684978887(Global_42073[10 /*31*/], 0, 0, 1);
					break;
							...
							else if (unk_0xFAA48325A90263BE(iLocal_194[i], unk_0x4A8C381C258A124D(), 30f, 30f, 30f, 0, 1, 0))
							{
								if (!func_116())
								{
									if (iLocal_189 < unk_0x1DD05E817C89C737())
									{
										...
										{
											func_100(&uLocal_409, 1, iLocal_194[i], "ACULTMember1", 0, 1);
											func_101(&uLocal_409, "ACULTAU", "ACULT_FIGHT1", 4, 0, 0, 0);
										}
										else if (num == 2)
										{
											func_100(&uLocal_409, 2, iLocal_194[i], "ACULTMember2", 0, 1);
...
int func_19(var uParam0) // Position - 0xAA4
{
	int i;
	int num;
...
int func_21(int iParam0) // Position - 0xB06
{
...
BOOL func_28(int iParam0) // Position - 0xD40
{
	int num;
...
BOOL func_29(int iParam0) // Position - 0xD62
{
...
int func_31(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xDAF
{
	int num;
...
void func_36(var uParam0, float fParam1) // Position - 0x13AC
{
...
void func_38(var uParam0) // Position - 0x142F
{
	if (*uParam0 != 0)
	{
...
void func_43(var uParam0) // Position - 0x1749
{
...
void func_49(var uParam0) // Position - 0x186F
{
	if (!func_50(uParam0))
		func_35(uParam0);
...
void func_61(var uParam0) // Position - 0x1BF7
{
	if (!func_50(uParam0))
		func_49(uParam0);
	else
...
void func_64() // Position - 0x1C49
{
	...
	if (SYSTEM::TIMERA() > 10000)
	{
		...
		while (unk_0xED977E2AE2CB16EE(func_96(unk_0x259BE71D8A81D4FA()), uLocal_115, 1) < 209f && !unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
		{
			SYSTEM::WAIT(0);
		}
...
void func_65(int iParam0) // Position - 0x1D7D
{
	...
	if (func_93())
	{
		...
		func_70(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_69(Global_113799, true), 64);
...
{
	if (Global_113799 == func_94() && unk_0x9FA91AA1AC724CD0() && Global_113800)
		return true;
...
Vector3 func_96(var uParam0) // Position - 0x2B66
{
...
BOOL func_106(int iParam0, int iParam1) // Position - 0x3013
{
...
void func_117() // Position - 0x3395
{
	...
	switch (iLocal_188)
	{
		case 0:
			...
			unk_0xA7B0B03284E7503C(uLocal_115 - { 100f, 60f, 80f }, uLocal_115 + { 100f, 60f, 80f }, 0, 1, 1, 1);
			unk_0x425BBE19F25A57AB(0f);
			...
			if (unk_0x2B60F53D06BC6971(0))
			{
				...
				for (i = 0; i < iLocal_194; i = i + 1)
				{
					if (i == 0 || i == 5 || i == 6 || i == 10)
					{
						...
						unk_0xD25E9BDC14A0B649(iLocal_194[i], 150, 0);
					...
					unk_0x5C96CEA06531AB03(iLocal_194[i], func_135(unk_0xD1A6A821F5AC81DB(iLocal_194[i], 1), func_96(unk_0x259BE71D8A81D4FA())));
					unk_0xAAA71DD7E9059338(iLocal_194[i], 1);
					unk_0x0428AFDCAA63B06E(iLocal_194[i], 42, 1);
					uLocal_227[i] = func_133(iLocal_194[i], true, 145);
				}
			
				func_100(&uLocal_409, 0, unk_0x4A8C381C258A124D(), "TREVOR", 0, 1);
...
int func_133(var uParam0, BOOL bParam1, int iParam2) // Position - 0x49B3
{
	int num;
...
int func_134(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x49FD
{
	int num;
...
var func_135(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4AA1
{
...
int func_137(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x4AC7
{
	int num;
	int num2;
	int num3;
...
void func_138(var uParam0, int iParam1) // Position - 0x4C3B
{
	int num;
...
BOOL func_140(int iParam0) // Position - 0x4DF0
{
...
void func_158() // Position - 0x60AF
{
	...
	if (fLocal_181 >= 0f)
	{
		unk_0x3A15B21067339E98(Global_42073[10 /*31*/], fLocal_181, 0, 1);
		unk_0xEBB2809684978887(Global_42073[10 /*31*/], 4, 0, 1);
	}
	...
	if (fLocal_180 <= 0f)
	{
		unk_0x3A15B21067339E98(Global_42073[9 /*31*/], fLocal_180, 0, 1);
		unk_0xEBB2809684978887(Global_42073[9 /*31*/], 4, 0, 1);
	}
	...
	switch (iLocal_187)
	{
		...
		case 4:
			if (Global_113810.f_24998.f_5 < 2)
			{
				...
				func_161(func_15(), 1, 2000, false, false);
			}
...
void func_161(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6A01
{
	...
	func_162(func_181(iParam0), 1, iParam1, iParam2, false);
...
void func_165(int iParam0) // Position - 0x73AE
{
	...
	else if (IS_BIT_SET(Global_113810.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_167() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113810.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_167() /*5568*/].f_681.f_10), iParam0);
	}
	...
	if (flag)
	{
		...
		unk_0xACF853FB3F6EA7D4(func_166(iParam0));
...
char* func_166(int iParam0) // Position - 0x7528
{
	switch (iParam0)
	{
		case 0:
...
void func_168(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7638
{
	int num;
...
int func_169(int iParam0, int iParam1) // Position - 0x765B
{
...
void func_171(int iParam0, int iParam1, int iParam2) // Position - 0x76A4
{
	if (iParam2 == -1)
		iParam2 = func_27();
...
void func_182(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x7ADB
{
	unk_0x4CAD907F190E6F10(uParam0, sParam1, sParam2, func_183(iParam3), 0);
	return;
}

char* func_183(int iParam0) // Position - 0x7AF4
{
	char* str;
	...
	switch (iLocal_187)
	{
		...
		case 4:
			if (Global_113810.f_24998.f_5 < 3)
			{
				...
				unk_0x4A46DAA87A4C235E(unk_0x4A8C381C258A124D(), 0);
				unk_0x64BB72494B9DF6DC(0);
				func_161(func_15(), 1, 1000, false, false);
			}
...
void func_192() // Position - 0x8837
{
	...
	{
		if (iLocal_398 == 0)
			iLocal_398 = unk_0xA7B0B03284E7503C(uLocal_115 - { 100f, 60f, 80f }, uLocal_115 + { 100f, 60f, 80f }, 0, 1, 1, 1);
	
		while (unk_0xED977E2AE2CB16EE(func_96(unk_0x259BE71D8A81D4FA()), uLocal_115, 1) < 209f)
		{
			SYSTEM::WAIT(0);
		}
	}
	...
	if (func_194())
	{
		if (bLocal_177)
		{
			...
			if (unk_0xE10356B235A70E70(Global_42073[9 /*31*/].f_2, 6f, Global_42073[9 /*31*/].f_5, 0))
				unk_0x1F3E4227575DF103(Global_42073[9 /*31*/].f_5, Global_42073[9 /*31*/].f_2, 0, 0f, 0);
		
			if (unk_0xE10356B235A70E70(Global_42073[10 /*31*/].f_2, 6f, Global_42073[10 /*31*/].f_5, 0))
				unk_0x1F3E4227575DF103(Global_42073[10 /*31*/].f_5, Global_42073[10 /*31*/].f_2, 0, 0f, 0);
...
void func_197(var uParam0) // Position - 0x8D14
{
	if (unk_0xA0C7B98BCF1EEF9E(*uParam0))
	{
		unk_0xD314260005F064BF(uParam0);

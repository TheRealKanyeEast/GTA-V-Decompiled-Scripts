	...
	while (true)
	{
		...
		switch (num)
		{
			case 0:
				...
				{
					num2 = func_86(unk_0x4A8C381C258A124D());
					...
					if (num != 2)
					{
						if (!unk_0x94A7730DEC6E86C8() && !flag && !func_76(5))
						{
							...
							if (func_72())
							{
									...
									if (!bLocal_114)
									{
										switch (func_69("TC_HOWTOSTART" /*~s~While driving a taxi, become available for jobs by pressing ~INPUT_VEH_HORN~*/))
										{
											...
											case 1:
												...
												if (func_66("TC_HOWTOSTART" /*~s~While driving a taxi, become available for jobs by pressing ~INPUT_VEH_HORN~*/))
								...
								switch (iLocal_104)
								{
									...
									case 2:
										...
										if (func_61(&uLocal_116) > 15f)
										{
											...
											{
												func_57("TC_MISSEDJOB" /*~s~The taxi job you were offered has expired. There is only a short time to accept before another driver takes the job. However, more jobs can be accessed by pressing ~INPUT_VEH_HORN~~s~*/, -1);
								...
								if (unk_0x6D05C5731A838CB3(0, 86) && !unk_0xD1F1A906BA9226BE(unk_0x4A8C381C258A124D()) && !Global_32436 && unk_0x1DD05E817C89C737() - uLocal_107 > 3000)
								{
									num3 = func_70();
									...
									else if (num3 == 2)
									{
										if (!unk_0x4C705AAF75363287())
											func_57("TXC_HEALTH_GONE" /*Taxi has too much damage to start a Taxi job.*/, -1);
									}
									else if (num3 == 3)
									{
										if (!unk_0x4C705AAF75363287())
										{
											if (!func_66("TXC_WANTED_WARN" /*Taxi jobs are not available while wanted.*/))
											{
												if (!func_84(Global_113810.f_19100, 32768))
												{
													func_57("TXC_WANTED_WARN" /*Taxi jobs are not available while wanted.*/, -1);
							...
							else
							{
								...
								if (unk_0x1DD05E817C89C737() - uLocal_108 > 60000 && !func_66("TC_HOWTOSTART" /*~s~While driving a taxi, become available for jobs by pressing ~INPUT_VEH_HORN~*/) && bLocal_114)
									bLocal_114 = false;
			...
			case 4:
				...
				{
					num4 = func_26(&iLocal_106, 2, 9, false, 0);
			...
			case 5:
				...
				func_24(&unk, true);
				func_58(&uLocal_122, "OJTXAUD", &unk, 8, 0, 0, 0);
				num = 6;
				break;
			...
			case 7:
				if (!func_23())
				{
					...
					func_24(&unk7, true);
					func_81(&uLocal_122);
					func_58(&uLocal_122, "OJTXAUD", &unk7, 8, 0, 0, 0);
					num = 8;
				}
				break;
...
BOOL func_9(BOOL bParam0) // Position - 0xAFC
{
...
void func_17(int iParam0, int iParam1, int iParam2) // Position - 0x11B7
{
	if (iParam2 == -1)
		iParam2 = func_18();
...
void func_24(char* sParam0, BOOL bParam1) // Position - 0x130D
{
	...
	num = func_86(unk_0x4A8C381C258A124D());
...
void func_49() // Position - 0x21D5
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_51(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_50(num) && !func_76(14) || Global_112760)
			{
...
int func_52(int iParam0) // Position - 0x2303
{
...
int func_86(var uParam0) // Position - 0x2E4A
{
	int i;
	int num;

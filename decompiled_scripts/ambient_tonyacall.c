...
int func_20(var uParam0) // Position - 0xD1C
{
	int i;
	int num;
...
int func_22(int iParam0) // Position - 0xD7E
{
...
BOOL func_28() // Position - 0xED8
{
	...
	if (unk_0xFC8BFE4B41177C22(unk4) && !unk_0x1C2F771CDC87A3A5(unk4, 0))
	{
		...
		if (num == joaat("IG_Tonya"))
		{
			...
			func_31(&uLocal_61, 3, uLocal_36, "TONYA", 1, 1);
			func_30();
...
BOOL func_29(float fParam0, var uParam1, var uParam2) // Position - 0xFB1
{
...
void func_31(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1094
{

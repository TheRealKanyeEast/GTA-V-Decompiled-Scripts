...
BOOL func_5(int iParam0) // Position - 0x3A0
{
...
BOOL func_11(int iParam0) // Position - 0x5CE
{
	int num;
...
BOOL func_12(int iParam0) // Position - 0x5F0
{
	if (func_8(iParam0, 0))
		return true;
...
int func_14(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x63D
{
	int num;
...
BOOL func_17(var uParam0, int iParam1) // Position - 0x6BA
{
	var unk;
	float num;
	int num2;
...
BOOL func_21(BOOL bParam0) // Position - 0x14C7
{
...
void func_24(int iParam0, int iParam1, int iParam2) // Position - 0x154B
{
	if (iParam2 == -1)
		iParam2 = func_10();
...
void func_25(var uParam0) // Position - 0x1569
{
	int num;

	num = unk_0x1C1C92A1CBAE364B(uParam0);

	if (num == func_26())
		return;

	Global_2657704[num /*463*/].f_244 = 0;
	return;
}
...
void func_27(var uParam0, BOOL bParam1) // Position - 0x159A
{
	int num;
...
BOOL func_28(int iParam0, BOOL bParam1) // Position - 0x1602
{
	if (Global_78689)
...
void func_30(var uParam0, int iParam1) // Position - 0x164D
{
	if (unk_0x78411E34CF90EA8C(*uParam0))
	{
...
BOOL func_34(int iParam0, BOOL bParam1) // Position - 0x1742
{
	if (Global_78689)
		if (unk_0xFC8BFE4B41177C22(iParam0) && !bParam1 || unk_0xD9F5E1FEFD1329E4(iParam0, 0))
...
Vector3 func_35(var uParam0) // Position - 0x1793
{
...
BOOL func_37(float fParam0, var uParam1, var uParam2) // Position - 0x18C0
{
...
void func_38(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x18EA
{
	float num;
	var unk;
	var unk4;
...
BOOL func_54(var uParam0, int iParam1) // Position - 0x5EB6
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_55(var uParam0) // Position - 0x5FDA
{
...
BOOL func_56(var uParam0) // Position - 0x602D
{
	var unk;
	float num;
	float num2;
...
BOOL func_57(var uParam0) // Position - 0x6096
{
...
BOOL func_58(var uParam0) // Position - 0x610B
{
...
BOOL func_63(int iParam0) // Position - 0x61F3
{
...
BOOL func_65(int iParam0, int iParam1) // Position - 0x6279
{
	int num;
...
BOOL func_66(int iParam0) // Position - 0x6315
{
	if (func_5(iParam0))
...
BOOL func_67(var uParam0) // Position - 0x633F
{
	int num;
	var unk;
	int num2;
	...
	if (Global_78689)
	{
		num2 = unk_0x1C1C92A1CBAE364B(unk);
	
		if (num2 == func_26())
			return false;
	
		if (!func_68(num2, true, false))
		{
			Global_2657704[num2 /*463*/].f_244 = 0;
			return false;
		}
	
		return Global_2657704[num2 /*463*/].f_244;
	}

	return true;
}

BOOL func_68(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x63DA
{
	int num;
...
BOOL func_71(var uParam0) // Position - 0x64FD
{
	if (!unk_0xFC8BFE4B41177C22(uParam0))
		return false;
...
void func_73(var uParam0, int iParam1) // Position - 0x6579
{
	...
	if (Global_78689)
	{
		num = unk_0x1C1C92A1CBAE364B(unk_0x4A8C381C258A124D());
	
		if (num != func_26())
			if (Global_2657704[num /*463*/].f_244 == true)
				Global_2657704[num /*463*/].f_244 = 0;
	}
...
void func_76(var uParam0) // Position - 0x669E
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_82(var uParam0, int iParam1) // Position - 0x6788
{
	int num;
	...
	Global_2657704[num /*463*/].f_244 = iParam1;
	return;
}
...
float func_89(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x6A72
{
	var unk;
...
BOOL func_94(var uParam0, var uParam1, int iParam2) // Position - 0x6FC4
{
...
void func_95(var uParam0, int iParam1) // Position - 0x7015
{
	if (!func_96(iParam1))
...
BOOL func_96(int iParam0) // Position - 0x718F
{
...
BOOL func_97(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4) // Position - 0x71C9
{
...
BOOL func_98(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x7226
{
	return SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(uParam0, iParam5), vParam1) <= fParam4 * fParam4;
}

BOOL func_99(int iParam0, BOOL bParam1) // Position - 0x7244
{
	int num;
	...
	else
	{
		...
		if (func_336(num))
		{
			if (unk_0xFD5C5BBD1FE92BB7(num, -1, 0) == unk_0x4A8C381C258A124D())
			{
				...
				if (func_129())
				{
					func_117(joaat("SERVICE_SPEND_CARWASH"), num3, &num2, false, false, true);
...
int func_125(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x9C15
{
	int i;
...
int func_128(int iParam0) // Position - 0x9DF4
{
	var unk;
...
int func_131(int iParam0, int iParam1, int iParam2) // Position - 0x9E73
{
	...
	return func_132(func_163(iParam0), 0, iParam1, iParam2, false);
}
...
void func_135(int iParam0) // Position - 0xA782
{
	...
	else if (IS_BIT_SET(Global_113810.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_137() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113810.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_137() /*5568*/].f_681.f_10), iParam0);
	}
	...
	if (flag)
	{
		...
		unk_0xACF853FB3F6EA7D4(func_136(iParam0));
...
char* func_136(int iParam0) // Position - 0xA8FC
{
	switch (iParam0)
	{
		case 0:
...
void func_138(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xAA0C
{
	int num;
...
int func_139(int iParam0, int iParam1) // Position - 0xAA2F
{
...
void func_165() // Position - 0xB166
{
	...
	{
		if (func_168(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_167(unk_0x4A8C381C258A124D());
		
			if (func_166(num) && !func_159(14) || Global_112760)
			{
...
int func_167(var uParam0) // Position - 0xB26F
{
	int i;
	int num;
...
int func_169(int iParam0) // Position - 0xB2D1
{
...
BOOL func_174(int iParam0) // Position - 0xB3C9
{
	if (!func_11(iParam0))
		return false;
...
Vector3 func_179(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xB69D
{
	var unk;
...
int func_196(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4) // Position - 0xC593
{
	if (IS_BIT_SET(uParam0->f_113, iParam1) || IS_BIT_SET(uParam0->f_114, iParam1))
		return 1;
...
void func_198(var uParam0, var uParam1) // Position - 0xC6AE
{
	func_197(uParam0, 0, joaat("prop_carwash_roller_horz"));
	func_197(uParam0, 1, joaat("prop_carwash_roller_vert"));
	func_197(uParam0, 2, joaat("prop_ld_test_01"));
...
void func_212(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11) // Position - 0xCAA5
{
	float num;
	float num2;
	var unk;
...
var func_213(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0xCB51
{
...
int func_216(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xCD65
{
	int i;
	int j;
	int k;
...
BOOL func_217(var uParam0, int iParam1, var uParam2) // Position - 0xD576
{
	int num;
	...
	{
		if (!func_328(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_64, Global_113810.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_220(int iParam0, int iParam1, int iParam2) // Position - 0xD6C7
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_222(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0xD7CD
{
	var unk;
	int i;
...
BOOL func_223(int iParam0, int iParam1, int iParam2) // Position - 0xDDD1
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_224(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0xDE6A
{
	int num;
	...
	{
		if (!func_328(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_61, Global_113810.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
int func_225(var uParam0, int iParam1, int iParam2) // Position - 0xDF15
{
	int i;
	int j;
...
int func_227(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xE066
{
	int num;
...
int func_228(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE36D
{
	int num;
	int num2;
	int num3;
...
BOOL func_232(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF502
{
	int num;
...
BOOL func_233(int iParam0, int iParam1, var uParam2) // Position - 0xF52B
{
	*uParam2 = -99;
...
int func_234(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xF7F5
{
	int num;
...
void func_236(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFBD6
{
	int num;
...
BOOL func_237(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFC70
{
	switch (iParam0)
	{
...
int func_241(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1028A
{
	int num;
	int num2;
	int num3;
...
int func_242(var uParam0, int iParam1) // Position - 0x10386
{
	int num;
...
void func_247(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10F93
{
	int num;
	var unk;
	int num2;
...
BOOL func_253(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13258
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_254(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x134D5
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_255(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x138FA
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_256(var uParam0, int iParam1) // Position - 0x13BED
{
	int num;
	var unk;
...
int func_257(var uParam0, int iParam1) // Position - 0x13C34
{
	int num;
	var unk;
	var unk2;
...
int func_258(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x13C94
{
	int num;
	int num2;
	int num3;
...
BOOL func_271(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x19A21
{
	int num;
	int num2;
	int num3;
...
BOOL func_328(var uParam0, int iParam1, int iParam2) // Position - 0x2AFFF
{
	int num;
	int num2;
	int i;
...
void func_337() // Position - 0x2B696
{
	...
	while (unk_0x15CCE8886267624F() || func_394())
	{
		SYSTEM::WAIT(0);
	}
	...
	while (true)
	{
		...
		if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
		{
			...
			flag = func_378(num2) || func_377(num2);
...
BOOL func_340(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, eStackSize essParam5) // Position - 0x2BAF7
{
	...
	switch (uParam1->f_13)
	{
		...
		case 8:
			...
			if (func_352(&uParam0->[uParam1->f_12 /*24*/]) || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) == 0)
			{
				func_362(uParam1, 0);
				return false;
			}
		...
		case 4:
			...
			{
				if (!unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) || func_343(unk_0x4A8C381C258A124D(), 0) != -1)
				{
					func_362(uParam1, 0);
					return false;
				}
			...
			if (!unk_0xD6F9DEE4765092A9(uParam0->[uParam1->f_12 /*24*/].f_5))
			{
				...
				while (!unk_0xA6E4F7A73ABC4A76(uParam0->[uParam1->f_12 /*24*/].f_5))
				{
					...
					if (func_336(unk_0x4A8C381C258A124D()))
						if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) && !Global_78689)
...
int func_341(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2C27F
{
...
void func_342(var uParam0) // Position - 0x2C417
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_343(var uParam0, int iParam1) // Position - 0x2C443
{
	var unk;
	int num;
	int i;
...
BOOL func_344(var uParam0) // Position - 0x2C4C8
{
	...
	if (func_345(uParam0->f_12, unk) > SYSTEM::COS(uParam0->f_15))
		return 1;
...
int func_347(var uParam0, var uParam1, var uParam2) // Position - 0x2C5C2
{
	if (unk_0xD6F9DEE4765092A9(uParam1))
		return 0;

	if (func_349(uParam0) || !unk_0x4C705AAF75363287())
	{
		unk_0x428C32CC68809A35(1);
...
void func_348(var uParam0, var uParam1) // Position - 0x2C60E
{
...
BOOL func_350(var uParam0) // Position - 0x2C684
{
	unk_0x39DCBE5519BD783A(uParam0);
	return unk_0x7EBCD400E7DE179C(0);
}

BOOL func_351(var uParam0, var uParam1) // Position - 0x2C697
{
	unk_0x39DCBE5519BD783A(uParam0);
	unk_0x511D14ED2DA887E1(uParam1);
	return unk_0x7EBCD400E7DE179C(0);
...
BOOL func_352(var uParam0) // Position - 0x2C6B0
{
	...
	else if (uParam0->f_6 == 1)
	{
		...
		if (func_343(unk_0x4A8C381C258A124D(), 0) != -1)
			return true;
	}
...
int func_354(var uParam0, var uParam1) // Position - 0x2C7B6
{
	if (unk_0xD6F9DEE4765092A9(uParam1))
		return 0;
...
void func_355(var uParam0) // Position - 0x2C7FF
{
	unk_0xAC98CA65AD9A3215(uParam0);
	unk_0x5E01B6B1F460FE3F(0, 1, 1, -1);
	return;
...
BOOL func_359(int iParam0) // Position - 0x2C94B
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
		if (unk_0x1C2F771CDC87A3A5(iParam0, 0))
			return true;
...
BOOL func_364(var uParam0) // Position - 0x2CA8A
{
	if (func_367(uParam0))
		return true;
...
BOOL func_365(int iParam0) // Position - 0x2CAAD
{
	int num;
...
BOOL func_366(int iParam0, int iParam1) // Position - 0x2CACB
{
	return IS_BIT_SET(Global_1895156[iParam0 /*609*/].f_10.f_4, iParam1);
}

BOOL func_367(int iParam0) // Position - 0x2CAE3
{
	int num;
...
BOOL func_379(int iParam0) // Position - 0x2D117
{
	int num;
...
BOOL func_380(int iParam0) // Position - 0x2D33E
{
...
BOOL func_381() // Position - 0x2D567
{
	if (Global_1575038 == 0)
		if (!unk_0x76CD105BCAC6EB9F())
			return true;
	...
	if (func_382() != 0)
		if (unk_0x486FF5D06E9659F1(func_382()) == 0)
			return true;
...
BOOL func_385(int iParam0) // Position - 0x2D651
{
...
void func_388(var uParam0, int iParam1) // Position - 0x2D683
{
	*uParam0 = "CWASH_RIDEHLP" /*Press ~INPUT_CONTEXT~ to use the Car Wash. The cost is $~1~.*/;
	...
	if (unk_0x0BA1A956D36B210F() || func_390())
	...
	else if (unk_0x1226C55CA7D2269A() || func_389())
...
void func_399(var uParam0) // Position - 0x2D9D0
{
	...
	if (Global_78689)
	{
		num2 = unk_0x1C1C92A1CBAE364B(unk_0x4A8C381C258A124D());
	
		if (num2 != func_26())
			if (Global_2657704[num2 /*463*/].f_244 == true)
				Global_2657704[num2 /*463*/].f_244 = 0;
	}

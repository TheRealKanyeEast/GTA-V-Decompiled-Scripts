					...
					case 1:
						...
						if (!unk_0x4FAFF4BCB7633475(uLocal_55))
							if (unk_0x13CCB1AD131C1082(uLocal_55, "random@domestic", "f_attack_end", 3))
								func_50(uLocal_55, "WHIMPER", "WAVELOAD_PAIN_FEMALE", 24);
...
void func_6(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x77C
{
	int num;
...
int func_7(int iParam0, int iParam1) // Position - 0x79F
{
...
BOOL func_18(BOOL bParam0) // Position - 0xD42
{
...
void func_24(int iParam0, int iParam1, int iParam2) // Position - 0x1470
{
	if (iParam2 == -1)
		iParam2 = func_9();
...
void func_32() // Position - 0x1BC2
{
	...
	{
		if (func_36(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_35(unk_0x4A8C381C258A124D());
		
			if (func_34(num) && !func_33(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != num && func_34(Global_113810.f_2366.f_539.f_4321))
...
int func_35(var uParam0) // Position - 0x1CD9
{
	int i;
	int num;
...
int func_37(int iParam0) // Position - 0x1D3B
{
...
void func_50(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x20DF
{
	unk_0x4CAD907F190E6F10(uParam0, sParam1, sParam2, func_51(iParam3), 0);
	return;
}
...
BOOL func_70(int iParam0, int iParam1) // Position - 0x2960
{
	...
	switch (iLocal_68)
	{
		...
		case 2:
			...
			if (unk_0xFC8BFE4B41177C22(uLocal_56))
			{
				if (!unk_0x4FAFF4BCB7633475(uLocal_56))
				{
					if (unk_0x65FFA94B82A71741(uLocal_56, uLocal_110, Global_19, 1, 1, 0) && func_116(true, false, true))
					{
...
void func_83() // Position - 0x2F75
{
	switch (iLocal_141)
	{
		...
		case 4:
			if (!func_156())
			{
				func_114("DOM_GOLF" /*Castro will soon be available to play golf.*/, -1);
				...
				func_84(func_55(), 1, 80, false, true);
				SYSTEM::SETTIMERA(0);
				iLocal_141 = iLocal_141 + 1;
			}
			break;
...
void func_84(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3101
{
	...
	func_85(func_111(iParam0), 1, iParam1, iParam2, false);
...
char* func_89(int iParam0) // Position - 0x3C26
{
	switch (iParam0)
	{
		case 0:
...
void func_121() // Position - 0x4F5F
{
	if (func_55() == 2)
	{
		if (!Global_32524)
		{
			func_114("CULT_BLIP_HELP" /*Trevor can sometimes deliver Random Event passengers to the Altruist Cult, located at ~BLIP_ALTRUIST~*/, -1);
			Global_32524 = true;
		}
	}
...
var func_122(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x4F83
{
	var unk;
...
int func_124(var uParam0, BOOL bParam1, int iParam2) // Position - 0x4FC6
{
	int num;
...
int func_125(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5010
{
	int num;
...
var func_134(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x5951
{
...
{
	switch (func_145(&Global_32343, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
void func_151() // Position - 0x6969
{
	...
	unk_0xA7B0B03284E7503C(uLocal_61 - { 10f, 10f, 10f }, uLocal_61 + { 10f, 10f, 10f }, 0, 1, 1, 1);
	unk_0xA7B0B03284E7503C(uLocal_110 - { 3f, 2f, 2f }, uLocal_110 + { 3f, 2f, 2f }, 0, 1, 1, 1);
	...
	if (func_55() == 0)
		func_152(&uLocal_153, 0, unk_0x4A8C381C258A124D(), "MICHAEL", 0, 1);

	if (func_55() == 1)
		func_152(&uLocal_153, 1, unk_0x4A8C381C258A124D(), "FRANKLIN", 0, 1);

	if (func_55() == 2)
		func_152(&uLocal_153, 2, unk_0x4A8C381C258A124D(), "TREVOR", 0, 1);

	func_152(&uLocal_153, 3, uLocal_56, "REDOCastro", 0, 1);
	unk_0x397CF4F4C8B17365(uLocal_56, sLocal_151);
	func_152(&uLocal_153, 4, uLocal_55, "NATHALIA", 0, 1);
...
void func_152(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x6CC4
{
...
void func_154(var uParam0, char* sParam1, int iParam2) // Position - 0x7044
{
...
BOOL func_160(var uParam0) // Position - 0x7377
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
BOOL func_163(var uParam0) // Position - 0x745C
{
...
{
	if (Global_113799 == func_41() && unk_0x9FA91AA1AC724CD0() && Global_113800)
		return true;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_218() || Global_112857 || Global_32286 || func_217() || func_78(8, -1) || func_216() || func_215() || func_213() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
				
					case 4:
						if (func_218() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_78(8, -1) || func_213() || func_212() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
...
BOOL func_221(int iParam0, int iParam1, int iParam2) // Position - 0xA85D
{
	BOOL num;
	int num2;
...
void func_228(int iParam0) // Position - 0xAC49
{
	...
	if (func_180())
	{
		...
		func_231(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_230(Global_113799, true), 64);

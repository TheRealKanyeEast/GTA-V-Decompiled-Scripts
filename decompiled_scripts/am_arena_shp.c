...
void func_1() // Position - 0x78
{
	...
	if (uLocal_20.f_66.f_18 > 0 && !func_14())
	{
		...
		if (unk_0x8034325BF6D6E41F() - uLocal_20.f_66.f_18 > num2 * 10)
			uLocal_20.f_66.f_18 = -1;
	}

	if (func_13() && uLocal_20.f_66.f_2 == 1 && uLocal_20.f_66.f_13 && !uLocal_20.f_66.f_12)
	{
		if (unk_0x8034325BF6D6E41F() - uLocal_20.f_66.f_14 >= func_12(uLocal_20.f_66.f_5))
		{
			num = 0;
			...
			else if (uLocal_20.f_66.f_5 != 1 && !unk_0x54BC5E0B6A29AE8A(&(uLocal_20.f_66), uLocal_20.f_66.f_6, uLocal_20.f_66.f_4, uLocal_20.f_66.f_7, uLocal_20.f_66.f_1, uLocal_20.f_66.f_10))
			{
				num = 3;
			}
			else if (!unk_0x5F7C6361179DFFC4(uLocal_20.f_66))
			{
				num = 4;
			}
			else
	...
	if (num || unk_0xFCEF367B86651ED3(1, uParam0, &unk, 7))
	{
		...
		switch (unk.f_2)
		{
			case 0:
				if (num2 != -1)
				{
					Global_4540738[num2 /*12*/] = Global_4535172[num2 /*85*/].f_66.f_3;
					Global_4540738[num2 /*12*/].f_1 = Global_4535172[num2 /*85*/].f_66.f_7;
					Global_4540738[num2 /*12*/].f_2 = Global_4535172[num2 /*85*/].f_66.f_4;
					Global_4540738[num2 /*12*/].f_3 = Global_4535172[num2 /*85*/].f_66.f_1;
					Global_4540738[num2 /*12*/].f_5 = unk.f_1;
					Global_4540738[num2 /*12*/].f_6 = unk.f_3;
					Global_4540738[num2 /*12*/].f_7 = unk.f_4;
					Global_4540738[num2 /*12*/].f_8 = unk.f_5;
					Global_4540738[num2 /*12*/].f_9 = unk.f_6;
					Global_4540738[num2 /*12*/].f_11 = 1;
			...
			default:
				if (num2 != -1)
				{
					...
					if (Global_4535172[num2 /*85*/].f_66.f_11 & 1 != 0 && Global_4535172[num2 /*85*/].f_66.f_9 < 2 && func_32(unk.f_2))
					{
						if (func_10(num2))
						{
							if (func_24())
							...
							{
								Global_4536680 = Global_4535172[num2 /*85*/].f_66.f_4;
								Global_4536682 = Global_4535172[num2 /*85*/].f_66.f_6;
								Global_4536683 = unk.f_2;
								Global_4536681 = Global_4535172[num2 /*85*/].f_66.f_1;
					...
					else if (Global_4535172[num2 /*85*/].f_66.f_11 & 2 != 0)
					{
						...
						if (func_23(Global_4536680) && func_13() && func_32(unk.f_2))
						{
							if (!func_22(Global_4535172[num2 /*85*/].f_66))
							{
								num5 = func_21();
								Global_4536533[num5 /*7*/] = Global_4535172[num2 /*85*/].f_66;
								Global_4536533[num5 /*7*/].f_2 = Global_4536680;
								Global_4536533[num5 /*7*/].f_3 = Global_4536682;
								Global_4536533[num5 /*7*/].f_1 = Global_4536681;
...
int func_27(var uParam0) // Position - 0x1915
{
	var unk;
...
void func_33(int iParam0, BOOL bParam1) // Position - 0x2030
{
	...
	switch (Global_4535172[iParam0 /*85*/].f_66.f_4)
	{
		...
		case joaat("SERVICE_SPEND_RENAME_ORGANIZATION"):
			unk_0x1DC31E2CC59D9BB2(Global_4535172[iParam0 /*85*/].f_66.f_1, num2, num, &(Global_4535172[iParam0 /*85*/].f_14.f_26));
			break;
	
		case 2115896461:
			unk_0x14DF63D0BB614642(Global_4535172[iParam0 /*85*/].f_66.f_1, num2, num, func_35(&(Global_1914706[unk_0x259BE71D8A81D4FA() /*299*/].f_267)));
			break;
	
		case 797947947:
			unk_0x2416BBA9A9F18EAB(Global_4535172[iParam0 /*85*/].f_66.f_1, num2, num, func_35(&(Global_1914706[unk_0x259BE71D8A81D4FA() /*299*/].f_283)));
			break;
		...
		case joaat("SERVICE_SPEND_UTILITY_BILLS"):
			unk_0xD00BC7FDBE039771(Global_4535172[iParam0 /*85*/].f_66.f_1, num2, num, &Global_4540949);
			break;
		...
		case joaat("SERVICE_EARN_FROM_DESTROYING_CONTRABAND"):
			unk_0x95508E1DCDC31638(Global_4535172[iParam0 /*85*/].f_66.f_1, -1, Global_4535172[iParam0 /*85*/]);
			break;
		...
		case joaat("SERVICE_SPEND_NIGHTCLUB_ENTRY_FEE"):
			if (func_34(unk_0xB23E0F9B63D009A8(Global_4535172[iParam0 /*85*/]), false, false))
		...
		case joaat("SERVICE_EARN_AMBIENT_JOB_RC_TIME_TRIAL"):
			unk_0x237E99388DCA3CEF(Global_4535172[iParam0 /*85*/].f_66.f_1, "RC_TIME_TRIAL", &unk);
			break;
	...
	switch (Global_4535172[iParam0 /*85*/].f_66.f_4)
	{
		...
		case joaat("SERVICE_SPEND_BUSINESS_EXPENSES"):
			unk_0xCF0625D5D2A8F298(Global_4535172[iParam0 /*85*/].f_66.f_1, 0, 1, &Global_4540931);
			break;
...
BOOL func_34(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x454D
{
	int num;
...
int func_38(var uParam0, var uParam1) // Position - 0x4600
{
	int i;
...
void func_39(int iParam0) // Position - 0x4643
{
	...
	flag = flag || func_41();
	flag = flag + Global_4538687;
	func_40(&flag2);
	flag = flag || flag2;
	unk_0x8744D2E3FC95740E(&flag, 28);
	unk_0x8744D2E3FC95740E(&flag, 29);
	unk_0x8744D2E3FC95740E(&flag, 26);
	flag3 = Global_4540738[iParam0 /*12*/].f_9 && flag;
	flag4 = Global_4540738[iParam0 /*12*/].f_8 && flag;
	num = Global_4540738[iParam0 /*12*/].f_7;

	if (num == 0)
		num = -2085313189;

	if (Global_4540738[iParam0 /*12*/] != Global_4540738[iParam0 /*12*/].f_5 || Global_4540738[iParam0 /*12*/].f_1 != Global_4540738[iParam0 /*12*/].f_6 || Global_4540738[iParam0 /*12*/].f_2 != num || Global_4540738[iParam0 /*12*/].f_3 != flag4 + flag3)
		Global_110511 = 1;
...
BOOL func_41() // Position - 0x4784
{
	return SYSTEM::SHIFT_LEFT(1, 25);
}

BOOL func_42() // Position - 0x4793
{
	if (Global_1575038 == 0)
		if (!unk_0x76CD105BCAC6EB9F())
			return true;
	...
	if (func_43() != 0)
		if (unk_0x486FF5D06E9659F1(func_43()) == 0)
			return true;
...
BOOL func_47(int iParam0) // Position - 0x4888
{

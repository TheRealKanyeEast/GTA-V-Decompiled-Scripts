...
void main() // Position - 0x0
{
	...
	if (!func_253(&unk64, &num, unk61, 1f))
	{
		func_252();
	...
	func_241(&num);
	uLocal_90 = unk_0xA7B0B03284E7503C(unk61 - { 20f, 20f, 20f }, unk61 + { 20f, 20f, 20f }, 0, 1, 1, 1);
	...
	while (true)
	{
		...
		func_202(num);
		func_194(&iLocal_89, &(num.f_9), unk61);
...
int func_32(var uParam0) // Position - 0x2A77
{
	int i;
...
int func_33(var uParam0, int iParam1, int iParam2) // Position - 0x2ADA
{
	int i;
...
int func_34(int iParam0, int iParam1) // Position - 0x2B68
{
	int num;
...
void func_35(int iParam0, var uParam1, int iParam2) // Position - 0x2BAA
{
	int num;
...
BOOL func_43(var uParam0, int iParam1, BOOL bParam2) // Position - 0x355E
{
	int i;
	var unk;
	int num;
...
BOOL func_44(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x35CC
{
...
int func_47(int iParam0) // Position - 0x3706
{
...
var func_50(int iParam0, int iParam1) // Position - 0x38DE
{
...
var func_54(int iParam0, int iParam1) // Position - 0x3957
{
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D03
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x699B
{
	int i;
	float num;
	float num2;
...
BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x74B2
{
...
BOOL func_85(int iParam0) // Position - 0x7508
{
	if (iParam0 != func_94())
...
BOOL func_93(int iParam0) // Position - 0x83C0
{
	if (iParam0 != func_94())
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8D98
{
...
BOOL func_117(BOOL bParam0) // Position - 0x8DD9
{
...
BOOL func_135(var uParam0) // Position - 0xABFC
{
	if (func_136(uParam0))
...
BOOL func_136(int iParam0) // Position - 0xAC1C
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAD60
{
	int i;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAEFF
{
	if (bParam0)
	{
...
BOOL func_147(int iParam0) // Position - 0xB100
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB122
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB16F
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB1EC
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB31F
{
...
void func_160(var uParam0) // Position - 0xB4B7
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_177(var uParam0, int iParam1) // Position - 0xBB3C
{
	int num;
	var unk;
	var unk33;
...
BOOL func_184(var uParam0) // Position - 0xC531
{
	if (func_136(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_194(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCD5E
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
float func_198(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xCF62
{
	var unk;
...
BOOL func_203(Any* panParam0, BOOL bParam1) // Position - 0xD0CF
{
	var unk;
...
void func_209(var uParam0) // Position - 0xD9F8
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_211(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDAA3
{
	int i;
	int num;
	var unk;
...
BOOL func_212(var uParam0, var uParam1) // Position - 0xDC61
{
	var unk;
...
BOOL func_215(var uParam0, int iParam1) // Position - 0xDF81
{
	float num;
...
BOOL func_216(var uParam0, int iParam1) // Position - 0xDFF7
{
	return func_217(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_217(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE00F
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_218(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE0D0
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_219(var uParam0, int iParam1) // Position - 0xE1FC
{
	int num;
...
BOOL func_221(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE30B
{
	var unk;
	var unk4;
	float num;
...
int func_225(var uParam0, var uParam1) // Position - 0xE417
{
	int i;
...
int func_226(var uParam0) // Position - 0xE456
{
...
BOOL func_227(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE47E
{
	float num;
	float num2;
	int num3;
...
BOOL func_228(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE579
{
	float num;
	float num2;
...
BOOL func_229(var uParam0, float fParam1) // Position - 0xE685
{
	var unk;
	var unk2;
...
BOOL func_230(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE71A
{
	var unk;
	var unk4;
	float num;
...
BOOL func_231(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE7A8
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_233(var uParam0) // Position - 0xE83A
{
	var unk;
...
void func_260(var uParam0, BOOL bParam1) // Position - 0xF123
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_263(var uParam0) // Position - 0xF1AD
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_264(var uParam0) // Position - 0xF1E5
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_266(var uParam0, int iParam1) // Position - 0xF293
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_267(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_267(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF2D4
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_268(var uParam0) // Position - 0xF324
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))

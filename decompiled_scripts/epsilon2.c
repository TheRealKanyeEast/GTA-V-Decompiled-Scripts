...
void func_8() // Position - 0x970
{
	...
	{
		if (func_11(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_10(unk_0x4A8C381C258A124D());
		
			if (func_9(num) && !func_13(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != num && func_9(Global_113810.f_2366.f_539.f_4321))
...
BOOL func_9(int iParam0) // Position - 0xA6D
{
	return iParam0 < 3;
}

int func_10(var uParam0) // Position - 0xA79
{
	int i;
	int num;
...
int func_12(int iParam0) // Position - 0xADB
{
...
void func_17(int iParam0, var uParam1) // Position - 0xD96
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_18(iParam0) && unk_0x486FF5D06E9659F1(Global_91601[26 /*34*/].f_6) == 0)
			{
				Global_113810.f_7264[iParam0] = 1;
				unk_0xEBB2809684978887(uParam1->f_5, Global_113810.f_7264[iParam0], 1, 1);
			}
...
BOOL func_54(int iParam0) // Position - 0x4F85
{
	int num;
...
BOOL func_55(int iParam0) // Position - 0x4FA7
{
...
int func_57(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x4FF4
{
	int num;
...
Vector3 func_62(var uParam0) // Position - 0x526B
{
	return unk_0xD1A6A821F5AC81DB(unk_0x56E414973C2A8C0E(uParam0), 0);
}

int func_63(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x527E
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_78472[1 /*14*/] = { func_115(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78472[1 /*14*/] = { func_115(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78472[1 /*14*/] = { func_115(num8, 14, unk18[j], -1) };
							func_83(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
							func_106(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_73(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_73(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_73(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
			...
			{
				Global_78472[1 /*14*/] = { func_115(num8, i, func_72(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78472[1 /*14*/] = { func_115(num8, 14, unk59[j], -1) };
			func_83(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
			func_106(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_73(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_73(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_73(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
...
BOOL func_64(var uParam0, int iParam1, var uParam2) // Position - 0x5A8F
{
	int num;
	...
	{
		if (!func_179(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_64, Global_113810.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_67(int iParam0, int iParam1, int iParam2) // Position - 0x5BE0
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_69(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x5CE6
{
	var unk;
	int i;
...
BOOL func_70(int iParam0, int iParam1, int iParam2) // Position - 0x62EA
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_71(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x6383
{
	int num;
	...
	{
		if (!func_179(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_61, Global_113810.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
int func_72(var uParam0, int iParam1, int iParam2) // Position - 0x642E
{
	int i;
	int j;
...
int func_74(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x657F
{
	int num;
...
int func_75(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x6886
{
	int num;
	int num2;
	int num3;
...
BOOL func_79(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7A1B
{
	int num;
...
BOOL func_80(int iParam0, int iParam1, var uParam2) // Position - 0x7A44
{
	*uParam2 = -99;
...
int func_81(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x7D0E
{
	int num;
...
void func_83(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x80F1
{
	int num;
...
BOOL func_84(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x818B
{
	switch (iParam0)
	{
...
int func_88(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x877B
{
	int num;
	int num2;
	int num3;
...
int func_89(var uParam0, int iParam1) // Position - 0x8877
{
	int num;
...
void func_94(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9484
{
	int num;
	var unk;
	int num2;
...
BOOL func_100(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB749
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_101(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB9C6
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_102(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xBDEB
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_103(var uParam0, int iParam1) // Position - 0xC0DF
{
	int num;
	var unk;
...
int func_104(var uParam0, int iParam1) // Position - 0xC126
{
	int num;
	var unk;
	var unk2;
...
int func_105(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0xC186
{
	int num;
	int num2;
	int num3;
...
void func_108(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC2D1
{
	int num;
...
int func_109(int iParam0, int iParam1) // Position - 0xC2F4
{
...
BOOL func_122(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x121A3
{
	int num;
	int num2;
	int num3;
...
void func_124(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x122B5
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_118(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_118(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78670)
		{
			...
			func_118(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_179(var uParam0, int iParam1, int iParam2) // Position - 0x235E4
{
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_78472[1 /*14*/] = { func_115(num, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_179(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_179(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78472[2 /*14*/] = { func_115(num, 14, k, -1) };
								
									if (Global_78472[2 /*14*/].f_12 == j)
										if (func_179(uParam0, 14, k))
											if (!func_69(num, iParam2, 14, k, &unk, &Global_78472[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_78472[2 /*14*/] = { func_115(num, i, num2, -1) };
					
						if (!func_69(num, iParam2, i, num2, &unk, &Global_78472[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_78472[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_73(iParam1)) && Global_78472[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_73(iParam1)))
	{
		return true;
	}
...
BOOL func_184(var uParam0, int iParam1, BOOL bParam2) // Position - 0x23CC5
{
	...
	for (i = 0; func_185(iParam1, i, &unk, &num); i = i + 1)
	{
...
BOOL func_217() // Position - 0x262D2
{
...
BOOL func_219(var uParam0, int iParam1) // Position - 0x26345
{
	if (func_48(uParam0))
...
BOOL func_220(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x26378
{
...
void func_221(var uParam0) // Position - 0x26510
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_225(Global_78945, Global_78947, iParam10) };
				num4 == -0.014f;
...
float func_224(var uParam0) // Position - 0x26859
{
...
{
	if (!func_237(0) || Global_78960 || Global_78948 == 1 || !unk_0x9390801B06EE998F())
		return false;
	...
	switch (Global_78944)
	{
		...
		case 5:
			if (unk_0xFD216000DC314A92() || func_236(0) || func_235(true))
			{
			}
			else
			{
...
BOOL func_251() // Position - 0x2AAFC
{
...
void func_263(int iParam0, int iParam1, int iParam2) // Position - 0x2B7B6
{
	if (iParam2 == -1)
		iParam2 = func_53();
...
BOOL func_284(var uParam0, int iParam1, int iParam2) // Position - 0x2C27C
{
	int num;
	int i;
	var unk;
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			if (!func_284(uParam0, 14, unk18[j]))
				flag = 0;
		}
	...
	{
		unk28 = { func_96(num, 0) };
		Global_78472[1 /*14*/] = { func_115(num, iParam1, unk28[iParam1], -1) };
	
		if (unk_0x1A4EFE92822E3123(uParam0, func_73(iParam1)) > 0 && unk_0x8401C77F508D70FD(uParam0, func_73(iParam1), Global_78472[1 /*14*/].f_3) > 0)
			unk_0xD1C578C204015E1F(uParam0, func_73(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, 0);
	}
...
void func_285(var uParam0, int iParam1) // Position - 0x2C439
{
...
void func_288(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2C51A
{
	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
...
void func_289(int iParam0, int iParam1, int iParam2) // Position - 0x2C5B7
{
	var unk;
	var unk33;
	...
	if (iParam0 != -1)
	{
		...
		func_290(&unk33, unk.f_3, Global_100870, iParam1, iParam2);
	}

	return;
}

void func_290(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x2C5F6
{
...
void func_292() // Position - 0x2C64D
{
	...
	{
		func_8();
		unk_0xAFB25B9F2232474E(func_293(Global_113810.f_2366.f_539.f_4321));
	}
	else
	{
...
char* func_293(int iParam0) // Position - 0x2C680
{
	iParam0 = iParam0;
	return "";
}
...
void func_294() // Position - 0x2C690
{
	...
	if (unk_0x1226C55CA7D2269A() || func_296())
	{
		unk_0x012C74D626CB4559(StackVal, 0, 0, 0);
	}
	else if (unk_0x0BA1A956D36B210F() || func_295())
	{
...
BOOL func_336(char* sParam0, int iParam1, int iParam2) // Position - 0x320AC
{
	var unk;
	var unk2;
	int num;
...
int func_340(var uParam0, BOOL bParam1) // Position - 0x322E3
{
	int i;
...
void func_343(int iParam0) // Position - 0x323D5
{

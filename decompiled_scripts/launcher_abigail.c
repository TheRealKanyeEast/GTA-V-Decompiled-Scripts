...
void main() // Position - 0x0
{
	...
	if (!func_282(&unk230, &num, unk61, 1f))
	{
		func_281();
	...
	while (true)
	{
		...
		func_223(num);
		func_216(&iLocal_98, &(num.f_9), unk61);
		...
		switch (num)
		{
			...
			case 1:
				func_198(&num, unk61, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
...
BOOL func_2(Any* panParam0) // Position - 0x2BB
{
	var unk;
	var unk33;
...
int func_32(var uParam0) // Position - 0x2ABD
{
	int i;
...
int func_33(var uParam0, int iParam1, int iParam2) // Position - 0x2B20
{
	int i;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D4C
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x69E4
{
	int i;
	float num;
	float num2;
...
BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x74FB
{
...
BOOL func_85(int iParam0) // Position - 0x7551
{
	if (iParam0 != func_94())
...
BOOL func_93(int iParam0) // Position - 0x840C
{
	if (iParam0 != func_94())
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8DE4
{
...
BOOL func_117(BOOL bParam0) // Position - 0x8E26
{
...
BOOL func_135(var uParam0) // Position - 0xACDC
{
	if (func_136(uParam0))
...
BOOL func_136(int iParam0) // Position - 0xACFC
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAE40
{
	int i;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAFDF
{
	if (bParam0)
	{
...
BOOL func_147(int iParam0) // Position - 0xB1E0
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB202
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB24F
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB2CC
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB3FF
{
...
void func_160(var uParam0) // Position - 0xB597
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_177(var uParam0, int iParam1) // Position - 0xBC1C
{
	int num;
	var unk;
	var unk33;
...
var func_180(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC0F9
{
	var unk;
...
BOOL func_188(var uParam0) // Position - 0xCB52
{
	if (func_136(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
int func_198(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD37F
{
	...
	{
		unk = 16;
		func_201(&unk, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		func_199(&unk, sParam4, sParam5, 7, 0, 0);
...
void func_201(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD498
{
...
float func_202(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD533
{
	var unk;
...
{
	if (func_136(*uParam1) && func_136(unk_0x4A8C381C258A124D()))
	{
		switch (*uParam0)
		{
			case 0:
				uParam0->f_166 = unk_0x1DD05E817C89C737() + unk_0xC5935DFB3F39785A(1000, 2000);
				func_201(&(uParam0->f_1), 3, *uParam1, "ABIGAIL", 0, 1);
			...
			case 1:
				if (unk_0x1DD05E817C89C737() > uParam0->f_166)
				{
					...
					else if (func_215(unk_0x4A8C381C258A124D(), *uParam1, 1) < 15f)
					{
						*uParam0 = 4;
					}
				}
			...
			case 4:
				if (func_204(&(uParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), uLocal_90, uLocal_93, 8f, 0, 1, 0))
...
BOOL func_209(int iParam0, int iParam1) // Position - 0xDC2F
{
...
float func_215(var uParam0, var uParam1, int iParam2) // Position - 0xDEA1
{
	var unk;
	var unk4;
...
void func_216(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDEFF
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
BOOL func_224(Any* panParam0, BOOL bParam1) // Position - 0xE236
{
	var unk;
...
void func_230(var uParam0) // Position - 0xEB59
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_232(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEC04
{
	int i;
	int num;
	var unk;
...
BOOL func_233(var uParam0, var uParam1) // Position - 0xEDC2
{
	var unk;
...
BOOL func_236(var uParam0, int iParam1) // Position - 0xF0E2
{
	float num;
...
BOOL func_237(var uParam0, int iParam1) // Position - 0xF158
{
	return func_238(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_238(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF170
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_239(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF231
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_240(var uParam0, int iParam1) // Position - 0xF35D
{
	int num;
...
BOOL func_242(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF46C
{
	var unk;
	var unk4;
	float num;
...
int func_246(var uParam0, var uParam1) // Position - 0xF578
{
	int i;
...
int func_247(var uParam0) // Position - 0xF5B7
{
...
BOOL func_248(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF5DF
{
	float num;
	float num2;
	int num3;
...
BOOL func_249(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF6DA
{
	float num;
	float num2;
...
BOOL func_250(var uParam0, float fParam1) // Position - 0xF7E6
{
	var unk;
	var unk2;
...
BOOL func_251(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF87B
{
	var unk;
	var unk4;
	float num;
...
BOOL func_252(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF909
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_254(var uParam0) // Position - 0xF99B
{
	var unk;
...
BOOL func_263(var uParam0) // Position - 0xFC2D
{
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_269(&num) || !unk_0xE100DD4F82A51BDE(sLocal_97))
				return false;
...
void func_264(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFDDF
{
	func_265(uParam0);
...
void func_265(var uParam0) // Position - 0xFE21
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_266(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFEBD
{
	if (func_267(uParam0, iParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_267(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFF19
{
	int num;
...
void func_294(var uParam0, BOOL bParam1) // Position - 0x1084B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_297(var uParam0) // Position - 0x108D5
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_300(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10960
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_301(var uParam0) // Position - 0x109B0
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))

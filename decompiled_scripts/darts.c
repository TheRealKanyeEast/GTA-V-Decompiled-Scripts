...
void main() // Position - 0x0
{
	...
	func_475(true);
	iLocal_292 = func_472(func_508(uLocal_262[0]), 1);
			...
			switch (num)
			{
				...
				case 3:
					if (func_457(&unk476, &unk507))
					{
						...
						iLocal_355 = func_508(uLocal_262[0]);
				...
				case 4:
					if (!unk_0xB2A95909624C195B())
					{
						...
						func_445(&(num.f_257), 0, unk_0x4A8C381C258A124D(), sLocal_357, 0, 1);
					
						if (unk_0x1C2F771CDC87A3A5(func_506(), 0))
						{
							if (iLocal_301 == 2)
								func_445(&(num.f_257), 3, uLocal_262[1], "DartsBillLost1", 0, 1);
							else
								func_445(&(num.f_257), 3, uLocal_262[1], "DartsMelHick1", 0, 1);
						
							num4 = -1;
						}
						else
						{
							func_445(&(num.f_257), 3, func_506(), sLocal_358, 0, 1);
							func_443(&unk1792);
							num4 = 6;
						}
				...
				case 7:
					if (!IS_BIT_SET(Global_113771, 0))
					{
						...
						{
							unk_0x0B0C9A0F9AAEB7F0(&Global_113771, 0);
							num = 8;
						}
					}
					else
						...
						case 0:
							if (!unk_0xFC8BFE4B41177C22(func_506()))
							{
								if (!IS_BIT_SET(Global_113771, 10))
									unk_0x0B0C9A0F9AAEB7F0(&Global_113771, 10);
								else
									unk_0x8744D2E3FC95740E(&Global_113771, 10);
				...
				case 9:
					if (func_340(&num, &unk476, &unk507))
					{
						...
						if (func_339(Global_113810.f_18973.f_5, &uLocal_293))
...
void func_4(var uParam0, char* sParam1, BOOL bParam2, int iParam3) // Position - 0x1E7F
{
	if (!unk_0x1C2F771CDC87A3A5(func_506(), 0) || bParam2)
		...
		func_5(uParam0, sParam1, sLocal_100, iParam3);
...
char* func_6(int iParam0) // Position - 0x1ED8
{
	char* str;
	...
	if (bLocal_267)
	{
		...
		else if (num == 2)
		{
			...
			if (uParam0->f_446[0] * 10 > 0)
				func_56(func_92(), 21, uParam0->f_446[0] * 10, false, false);
...
void func_56(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x560A
{
	...
	func_57(func_91(iParam0), 1, iParam1, iParam2, false);
...
void func_60(int iParam0) // Position - 0x5FB7
{
	...
	if (flag)
	{
		...
		unk_0xACF853FB3F6EA7D4(func_61(iParam0));
...
char* func_61(int iParam0) // Position - 0x6131
{
	switch (iParam0)
	{
		case 0:
...
void func_63(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6241
{
	int num;
...
int func_64(int iParam0, int iParam1) // Position - 0x6264
{
...
void func_67(int iParam0, int iParam1, int iParam2) // Position - 0x62B9
{
	if (iParam2 == -1)
		iParam2 = func_66();
...
void func_93() // Position - 0x6A16
{
	...
	{
		if (func_95(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_508(unk_0x4A8C381C258A124D());
		
			if (func_94(num) && !func_86(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != num && func_94(Global_113810.f_2366.f_539.f_4321))
...
int func_96(int iParam0) // Position - 0x6B44
{
...
void func_114(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14) // Position - 0x743B
{
	int num;
	int i;
...
BOOL func_115(char* sParam0) // Position - 0x757D
{
				...
				if (!IS_BIT_SET(uParam1->f_42, 1))
				{
					...
					if (Global_2097536.f_2704[0] > 1 || Global_2097536.f_2704[0] > 0 && Global_2097536.f_2775[0] != -1 || Global_2097536.f_2704[0] > 0 && Global_2097536.f_2780.f_27 && func_199(uParam1->f_44) && Global_2097536.f_2775[0] != -1)
					{
						...
						for (i = 0; i < 12; i = i + 1)
						{
							...
							if (func_149(Global_2101867[i /*100*/].f_32))
							{
								if (func_199(uParam1->f_44))
								{
...
BOOL func_131(var uParam0, int iParam1) // Position - 0x8E1D
{
	var unk;
	int num;
	var unk2;
	...
	if (iParam1 == 188 || iParam1 == 187)
	{
		...
		if (!unk_0x6D05C5731A838CB3(2, iParam1) && !unk_0x4465D55576678706(2, iParam1) && num < 75 && num > -75 || func_155(&(uParam0->f_246.f_3), 250, false))
			return true;
	}
	else if (!unk_0x6D05C5731A838CB3(2, iParam1) && !unk_0x4465D55576678706(2, iParam1) || func_155(&(uParam0->f_246.f_3), 250, false))
	{
		return true;
	}
...
void func_133(var uParam0, int iParam1, int iParam2) // Position - 0x8F91
{
...
void func_138(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, int iParam43, int iParam44, BOOL bParam45, BOOL bParam46) // Position - 0x9102
{
	var unk;
...
void func_147(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5) // Position - 0xA70E
{
...
BOOL func_148(var uParam0, var uParam1) // Position - 0xA760
{
	if (!func_149(*uParam0))
		return false;
...
BOOL func_155(var uParam0, int iParam1, BOOL bParam2) // Position - 0xAEF4
{
	if (iParam1 == -1)
		return true;

	func_156(uParam0, bParam2, false);
...
void func_157(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0xAF97
{
...
void func_159(var uParam0) // Position - 0xB184
{
	...
	for (i = 0; i < 12; i = i + 1)
	{
		...
		if (uParam0->[i /*100*/].f_75 != 0)
		{
			...
			if (func_149(uParam0->[i /*100*/].f_45))
	...
	Global_2100721.f_87[num /*3*/] = { func_160(unk_0x259BE71D8A81D4FA()) };
	return;
}

Vector3 func_160(var uParam0) // Position - 0xB36B
{
...
BOOL func_163(var uParam0) // Position - 0xB48D
{
	...
	switch (uParam0->[0 /*100*/].f_76)
	{
		case 0:
			...
			for (i = 0; i < 12; i = i + 1)
			{
				if (func_149(uParam0->[i /*100*/].f_32))
				{
		...
		case 2:
			...
			for (i = 0; i < 12; i = i + 1)
			{
				...
				{
					if (func_149(uParam0->[i /*100*/].f_32) && func_149(Global_2103169[j /*13*/]))
...
BOOL func_164(var uParam0, int iParam1, var uParam2, var uParam3) // Position - 0xB63A
{
	var unk;
	int i;
...
void func_165(var uParam0, var uParam1) // Position - 0xB6F3
{
	unk_0x29B9959EF2236634(uParam0, 35, uParam1);
	return;
}

BOOL func_166(var uParam0, var uParam1) // Position - 0xB705
{
	int i;

	for (i = 0; i < 12; i = i + 1)
	{
		if (func_149(uParam1->[i /*13*/]))
...
BOOL func_171(var uParam0, var uParam1, char* sParam2) // Position - 0xB84F
{
	if (*uParam0 == 2)
		return true;
...
BOOL func_175(var uParam0, var uParam1, char* sParam2, var uParam3, var uParam4) // Position - 0xBCB5
{
	int num;
	var unk;
					...
					if (unk99.f_3 > 0)
					{
						...
						for (k = num3; k <= unk99.f_3 - 1; k = k + 1)
						{
							...
							if (Global_2097536.f_2704[num4] < 11 && unk.f_96 > 1)
							{
								...
								{
									if (func_149(unk) && !func_148(&unk, &(Global_2097536[num4 /*901*/][0 /*75*/].f_32)))
									{
										if (func_148(&unk, &unk107))
...
BOOL func_178(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0xCD06
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_187(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, BOOL bParam5, BOOL bParam6, int iParam7, int iParam8) // Position - 0xD093
{
	var unk;
	float unk2;
				...
				if (func_190(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), &(uParam0->f_113), uParam0->f_113[0 /*66*/], flag, 0, 100))
				{
					...
					if (uParam0->f_5 && unk_0xF685596DB2F81084(&unk99))
					{
						...
						if (unk99.f_3 > 0)
						{
							...
							else if (func_149(unk) && Global_2097536.f_2704[num5] < 11)
							{
								if (func_148(&unk, &unk107))
								{
									num2 = 0;
						...
						for (j = num3; j <= unk99.f_3 - 1; j = j + 1)
						{
							...
							if (Global_2097536.f_2704[num5] < 11 && unk.f_96 > 1)
							{
								...
								{
									if (func_149(unk) && !func_148(&unk, &(Global_2097536[num5 /*901*/][0 /*75*/].f_32)))
									{
										if (func_148(&unk, &unk107))
					...
					if (unk112.f_3 > 0)
					{
						...
						for (k = num3; k <= unk112.f_3 - 1; k = k + 1)
						{
							...
							if (Global_2097536.f_2704[num4] < 11 && unk14.f_96 > 1)
							{
								...
								{
									if (func_149(unk14) && !func_148(&(Global_2097536[num4 /*901*/][0 /*75*/].f_32), &unk14))
									{
										if (func_148(&unk14, &unk))
											if (Global_2097536.f_2775[num4] < 0)
												Global_2097536.f_2775[num4] = Global_2097536.f_2704[num4];
...
void func_195(var uParam0) // Position - 0xEBBB
{
	if (unk_0xA0C7B98BCF1EEF9E(uParam0))
		unk_0xA91A4C18A2DB01BD(uParam0, 255, 255, 255, 0, 0);
...
void func_196(var uParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEBDB
{
	char* str;
	var unk;
	var unk36;
...
void func_197(var uParam0, char* sParam1, var uParam2, int iParam3) // Position - 0xEEB3
{
	int i;
...
void func_198(var uParam0, char* sParam1, var uParam2, char* sParam3, BOOL bParam4, int iParam5) // Position - 0xEEF5
{
...
void func_200(var uParam0, var uParam1) // Position - 0xEFA7
{
...
BOOL func_203(int iParam0) // Position - 0xEFE4
{
...
int func_211(var uParam0, BOOL bParam1) // Position - 0xF14A
{
	...
	else
	{
		...
		if (func_194(&(Global_2103068.f_49)) && !func_155(&(Global_2103068.f_49), 2000, true) && !unk_0x261E3728EE56B3AC())
		{
...
BOOL func_228(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xFE72
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_231(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x10132
{
	int num;
	int i;
	var unk68;
...
var func_234(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, BOOL bParam12) // Position - 0x152F5
{
	var unk;
...
int func_251(var uParam0) // Position - 0x15A76
{
...
void func_252(var uParam0) // Position - 0x15AC6
{
...
void func_253(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x15B2A
{
	BOOL flag;
				...
				if (func_3(&(uParam3->f_666), 18))
				{
					if (!func_3(&(uParam3->f_666), 21))
					{
						if (!IS_BIT_SET(Global_113771, 3))
						{
							...
							unk_0x0B0C9A0F9AAEB7F0(&Global_113771, 3);
						}
					...
					else if (!func_3(&(uParam3->f_666), 20) && func_3(&(uParam3->f_666), 19))
					{
						if (!IS_BIT_SET(Global_113771, 4))
						{
							...
							unk_0x0B0C9A0F9AAEB7F0(&Global_113771, 4);
						}
			...
			if (iLocal_28 == 0)
			{
				...
				if (!func_310("DARTS_SHT_USE") && !func_310("DARTS_INSTR_W") && !func_310("DARTS_INSTR_B") && !func_310("DARTS_AIM_HLP") && !func_310("DARTS_STD_HLP") && !func_310("DARTS_FST_HLP"))
				{
					if (func_3(&(uParam3->f_666), 24))
					{
						...
						unk_0x0B0C9A0F9AAEB7F0(&(Global_113810.f_18973.f_6), uLocal_293);
...
void func_260(char* sParam0, var uParam1, int iParam2, int iParam3) // Position - 0x16CA1
{
	iParam3 = iParam3;
	unk_0x17EA339F685C42D2(sParam0);
	unk_0x511D14ED2DA887E1(uParam1);
...
void func_263(char* sParam0, int iParam1, var uParam2, int iParam3, int iParam4) // Position - 0x17273
{
	iParam4 = iParam4;
	unk_0x17EA339F685C42D2(sParam0);
...
void func_264(var uParam0) // Position - 0x17298
{
	if (!unk_0x4FAFF4BCB7633475(uParam0))
...
BOOL func_265(var uParam0, BOOL bParam1) // Position - 0x172B6
{
	int num;
...
BOOL func_266() // Position - 0x17335
{
...
BOOL func_267(var uParam0, BOOL bParam1) // Position - 0x17353
{
	int num;
...
int func_268(var uParam0) // Position - 0x173D2
{
	int num;
	BOOL flag;
...
BOOL func_269(var uParam0) // Position - 0x17415
{
	int num;
...
BOOL func_271(var uParam0) // Position - 0x17456
{
	BOOL flag;
...
void func_281(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x17D14
{
	var unk;
...
int func_297(var uParam0) // Position - 0x184C5
{
	int num;
...
void func_298(var uParam0) // Position - 0x184F1
{
	func_299(uParam0, 0f);
	return;
}

void func_299(var uParam0, float fParam1) // Position - 0x18500
{
...
void func_307() // Position - 0x18E4C
{
	...
	if (unk_0x6D05C5731A838CB3(2, 229))
	{
		...
		else if (!func_310("DARTS_FST_HLP") && !func_310("DARTS_AIM_HLP") && !func_310("DARTS_CLOCK") && !func_310("DARTS_STD_HLP") && !func_310("DARTS_INSTR_W") && !func_310("DARTS_INSTR_B") && !bLocal_93)
		{
			bLocal_93 = true;
			...
			if (!IS_BIT_SET(Global_113771, 1))
			{
				...
				unk_0x0B0C9A0F9AAEB7F0(&Global_113771, 1);
			}
		}
	}
	else if (bLocal_92)
	...
	if (iParam0 == 0)
	{
		if (!IS_BIT_SET(Global_113771, 9))
		{
			if (!func_310("DARTS_SHT_USE") && !func_310("DARTS_INSTR_W") && !func_310("DARTS_INSTR_B"))
			{
				...
				unk_0x0B0C9A0F9AAEB7F0(&Global_113771, 9);
			}
		}
		else if (bParam1 && !IS_BIT_SET(Global_113771, 7))
		{
			if (!func_310("DARTS_AIM_HLP") && !func_310("DARTS_INSTR_W") && !func_310("DARTS_INSTR_B"))
			{
				...
				unk_0x0B0C9A0F9AAEB7F0(&Global_113771, 7);
			}
		}
	}
	else if (iParam0 == 1)
	{
		if (!IS_BIT_SET(Global_113771, 8))
		{
			if (!func_310("DARTS_SHT_USE") && !func_310("DARTS_INSTR_W") && !func_310("DARTS_INSTR_B"))
			{
				...
				unk_0x0B0C9A0F9AAEB7F0(&Global_113771, 8);
			}
		}
	}
	else if (iParam0 == 2)
	{
		if (!bLocal_94 && !func_310("DARTS_SHT_USE") && !func_310("DARTS_INSTR_W") && !func_310("DARTS_INSTR_B"))
		{
			if (!IS_BIT_SET(Global_113771, 2))
			{
				func_426("DARTS_FST_HLP", -1);
				unk_0x0B0C9A0F9AAEB7F0(&Global_113771, 2);
			}
...
void func_314(var uParam0, var uParam1, var uParam2) // Position - 0x192CF
{
	var unk;
...
void func_335(var uParam0) // Position - 0x1A303
{
	if (!unk_0x4FAFF4BCB7633475(uParam0))
...
void func_338(var uParam0, int iParam1, BOOL bParam2) // Position - 0x1A3CB
{
	if (bParam2)
...
void func_348(var uParam0) // Position - 0x1A6EC
{
	if (uParam0->f_9 != 0)
	{
		if (unk_0xA0C7B98BCF1EEF9E(*uParam0))
...
BOOL func_351(var uParam0, var uParam1, var uParam2) // Position - 0x1A7E5
{
	...
	if (!func_3(&(uParam0->f_666), 7))
	{
		...
		if (func_407())
		{
			...
			Global_4541035 = unk_0x1DD05E817C89C737() + 300;
		}
		else if (func_404() && unk_0x1DD05E817C89C737() > Global_4541035)
		{
			if (Global_4541034 == uParam0->f_660)
			{
				num2 = func_403(0);
		...
		if (i == 1 && Global_23390.f_6171)
		{
			...
			else
			{
				if (Global_23390)
				{
					...
					{
						func_373(Global_23387, Global_23388, iParam5, num41, 0, 0, 0, 255);
				...
				func_373(Global_23387, Global_23388 + num41, iParam5, 0.034722f, num2, num3, num4, num5);
			...
			if (Global_23390.f_6174 > Global_23390.f_5668)
			{
				...
				func_373(Global_23387, num39 + 0f, iParam5, 0.034722f, num2, num3, num4, num5);
			...
			if (unk_0x70E57E9927B6BA58(&(Global_23390.f_5081)) != 0 && Global_23390.f_5163 != -1)
			{
				...
				{
					func_19(Global_23390.f_5165, true, true, &num31, &num32, bParam7);
				...
				func_373(Global_23387, num39 - 0.00277776f, iParam5, 0.00277776f, num2, num3, num4, num5);
				...
				if (Global_23390.f_5165 != 0)
				{
					...
					unk_0xFFA2B456A81EA1EB(func_26(Global_23390.f_5165), func_23(Global_23390.f_5165, true), Global_23387 + (num31 * 0.5f) + (0.00078125f * 2f), (num39 + (num32 * 0.5f)) - (0.00138888f * 4f), num31, num32, 0f, unk3, unk4, unk5, unk6, 0, 0);
				}
			...
			if (unk_0x70E57E9927B6BA58(&(Global_4540958.f_21)) != 0 && Global_4540958.f_65 != -1)
			{
				...
				{
					func_19(Global_4540958.f_67, true, true, &num31, &num32, bParam7);
					num34 = (Global_23387 + num31 + (0.00078125f * 4f)) - (0.00078125f * 1f);
				}
				...
				if (Global_4540958.f_67 != 0)
				{
					...
					unk_0xFFA2B456A81EA1EB(func_26(Global_4540958.f_67), func_23(Global_4540958.f_67, true), Global_23387 + (num31 * 0.5f) + (0.00078125f * 2f), (num39 + (num32 * 0.5f)) - (0.00138888f * 4f), num31, num32, 0f, unk3, unk4, unk5, unk6, 0, 0);
				}
						...
						switch (Global_23390.f_5499[k])
						{
								...
								if (flag2)
								{
									if (!Global_23390.f_6172)
									{
										...
										if (unk_0x70E57E9927B6BA58(&Global_23390.f_79[num21 /*6*/]) != 0)
										{
											...
											func_360(flag, Global_23390.f_1616[num21], Global_23390.f_1873[num21], flag7, num53, flag5, flag4);
										...
										if (num25 > 0)
										{
											...
											{
												if (func_19(Global_23390.f_4824[num19 + l], flag, false, &num31, &num32, bParam7))
												{
													num36 = num36 + num31;
									...
									if (unk_0x70E57E9927B6BA58(&Global_23390.f_79[num21 /*6*/]) != 0 && i == 1)
									{
										...
										func_360(flag, Global_23390.f_1616[num21], Global_23390.f_1873[num21], flag7, 0, flag5, flag4);
									...
									for (l = 0; l < 4; l = l + 1)
									{
										...
										else if (Global_23390.f_2387[num21 /*5*/][l] == 4)
										{
											...
											{
												if (func_19(Global_23390.f_4824[num19 + num25], flag, false, &num31, &num32, bParam7))
												{
													num34 = num34 + (num31 * 0.5f);
												
													if (func_19(Global_23390.f_4824[num19 + num25], flag, true, &num31, &num32, bParam7))
													{
														func_368(Global_23390.f_4824[num19 + num25], flag, &unk3, &unk4, &unk5, &unk6);
													
														if (i == 1)
															if (Global_23390.f_5526[k] == 2)
																unk_0xFFA2B456A81EA1EB(func_26(Global_23390.f_4824[num19 + num25]), func_23(Global_23390.f_4824[num19 + num25], flag), ((num29 + num34) - (0.00078125f * 8f)) + (0.00078125f * 4f), (num30 - 0.00277776f) + (num40 * 0.5f), num31, num32, 0f, unk3, unk4, unk5, unk6, 0, 0);
															else
																unk_0xFFA2B456A81EA1EB(func_26(Global_23390.f_4824[num19 + num25]), func_23(Global_23390.f_4824[num19 + num25], flag), (num29 + num34) - (0.00078125f * 8f), (num30 - 0.00277776f) + (num40 * 0.5f), num31, num32, 0f, unk3, unk4, unk5, unk6, 0, 0);
										...
										else
										{
											...
											if (func_358() && unk_0x486FF5D06E9659F1(joaat("fm_mission_creator")) > 0)
											{
												if (k == 0)
												{
													...
													func_360(false, Global_23390.f_1616[num21], Global_23390.f_1873[num21], flag7, 0, flag5, flag4);
										...
										for (l = 0; l < num25; l = l + 1)
										{
											if (Global_23390.f_4824[num19 + l] != 2 && Global_23390.f_4824[num19 + l] != 52 && Global_23390.f_4824[num19 + l] != 62)
											{
												if (func_19(Global_23390.f_4824[num19 + l], flag, false, &num31, &num32, bParam7))
												{
													...
													if (i == 1)
													{
														if (func_19(Global_23390.f_4824[num19 + l], flag, true, &num31, &num32, bParam7))
														{
															func_368(Global_23390.f_4824[num19 + l], flag, &unk3, &unk4, &unk5, &unk6);
														
															if (Global_23390.f_4824[num19 + l] == 30)
																unk_0xFFA2B456A81EA1EB(func_26(Global_23390.f_4824[num19 + l]), func_23(Global_23390.f_4824[num19 + l], flag), Global_23387 + (num31 * 0.5f), (num30 + 0.00277776f + (num32 * 0.5f)) - (0.00078125f * 11f), num31, num32, 0f, unk3, unk4, unk5, unk6, 0, 0);
															else if (Global_23390.f_5526[k] == 2)
																unk_0xFFA2B456A81EA1EB(func_26(Global_23390.f_4824[num19 + l]), func_23(Global_23390.f_4824[num19 + l], flag), ((num29 + num34 + num35) - (0.00078125f * 8f)) + (0.00078125f * 4f), (num30 - 0.00277776f) + (num40 * 0.5f), num31, num32, 0f, unk3, unk4, unk5, unk6, 0, 0);
															else
																unk_0xFFA2B456A81EA1EB(func_26(Global_23390.f_4824[num19 + l]), func_23(Global_23390.f_4824[num19 + l], flag), (num29 + num34 + num35) - (0.00078125f * 12f), (num30 - 0.00277776f) + (num40 * 0.5f), num31, num32, 0f, unk3, unk4, unk5, unk6, 0, 0);
														}
													}
							...
							case 2:
								if (flag2)
								{
									if (!Global_23390.f_6172)
									{
										func_360(flag, Global_23390.f_1616[num21], Global_23390.f_1873[num21], flag7, 0, false, false);
									...
									{
										func_360(flag, Global_23390.f_1616[num21], Global_23390.f_1873[num21], flag7, 0, false, false);
										func_357(num29 + num34, num30, "NUMBER" /*~1~*/, Global_23390.f_4309[num17], 0);
									}
								}
							...
							case 3:
								if (flag2)
								{
									...
									func_360(flag, Global_23390.f_1616[num21], Global_23390.f_1873[num21], flag7, 0, false, false);
									func_356(num29 + num34, num30, "NUMBER" /*~1~*/, Global_23390.f_4566[num18], Global_23390.f_4695[num18]);
								}
							...
							case 4:
								if (flag2)
								{
									if (func_19(Global_23390.f_4824[num19], flag, false, &num31, &num32, bParam7))
									{
										if (!Global_23390.f_6172)
										{
											num36 = num31;
										...
										if (i == 1)
										{
											if (func_19(Global_23390.f_4824[num19], flag, true, &num31, &num32, bParam7))
											{
												func_368(Global_23390.f_4824[num19], flag, &unk3, &unk4, &unk5, &unk6);
												unk_0xFFA2B456A81EA1EB(func_26(Global_23390.f_4824[num19]), func_23(Global_23390.f_4824[num19], flag), num29 + num34 + (num31 * 0.5f), (num30 - 0.00277776f) + (num40 * 0.5f), num31 * func_355(Global_23390.f_4824[num19]), num32 * func_355(Global_23390.f_4824[num19]), 0f, unk3, unk4, unk5, unk6, 0, 0);
											}
										}
									}
								}
...
void func_356(float fParam0, float fParam1, char* sParam2, float fParam3, var uParam4) // Position - 0x1E2D5
{
...
void func_360(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1E369
{
	...
	if (bParam2)
	{
		if (bParam3)
		{
			func_361(Global_23390.f_6454[iParam4], &num, &num2, &num3);
...
BOOL func_365(int iParam0) // Position - 0x1ED40
{
	int num;
...
void func_368(int iParam0, BOOL bParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x1EDEA
{
...
BOOL func_378(BOOL bParam0, BOOL bParam1) // Position - 0x1F349
{
	...
	if (!unk_0x9390801B06EE998F() || func_380(8, -1) && func_379() != 65 || unk_0x05AA183DA1344935() != 0 && !bParam1 || unk_0x3555462DB47B7AB1() && !bParam0 || unk_0x2B8BAF9BA2A3D36B() || Global_78950 || Global_23390.f_8891 || unk_0xB11671B812399BA2() || Global_100885.f_1482)
		return false;
...
int func_382(var uParam0, int iParam1, int iParam2) // Position - 0x1F4B1
{
	if (!unk_0xAE231F549813BBDF(2))
		return 0;
...
void func_383(var uParam0) // Position - 0x1F529
{
	if (!func_428(uParam0))
		func_443(uParam0);
...
int func_384(var uParam0) // Position - 0x1F541
{
	float num;
...
int func_399(var uParam0, int iParam1, int iParam2) // Position - 0x1FB64
{
	if (!unk_0xAE231F549813BBDF(2))
		return 0;
...
int func_400(var uParam0) // Position - 0x1FBDC
{
	float num;
...
BOOL func_401(var uParam0) // Position - 0x1FC54
{
	float num;
...
BOOL func_402(var uParam0) // Position - 0x1FCCC
{
	float num;
	...
	if (num8 >= num && num8 <= num3 && num9 >= num2 && num9 <= num4)
	{
		...
		if (bParam3)
		{
			if (!bParam1 || num14 != 0)
			{
				unk_0x9A122D542F2BB60E(76, 84);
				unk_0x9C066F8D86A1A438(-0.05f, -0.05f, 0f, 0f);
				func_373(num5, num6 + ((float)num14 * 0.034722f), Global_23389, 0.034722f - 0.0015f, 255, 255, 255, num11);
				unk_0x90B531766063C5CD();
			}
		}
...
BOOL func_415(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x205AC
{
	int i;
	int j;
	...
	switch (*uParam0)
	{
		...
		case 5:
			if (!unk_0x323C4A67159DAD02(uLocal_126) && !func_310("DARTS_DBL_WIN"))
...
void func_416(var uParam0) // Position - 0x209C8
{
	var unk;
...
void func_417(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10) // Position - 0x20A08
{
...
void func_419(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7) // Position - 0x20AE3
{
	char* str;

	str = func_420(iParam5);
	unk_0x88F483FBD433696A(*uParam0, "RESET_MOVIE");
	unk_0xE6B753D52F4CA222();
	unk_0x88F483FBD433696A(*uParam0, str);
	unk_0x882AEFD55B8D51FB("STRING");
...
void func_423(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10, BOOL bParam11) // Position - 0x20CFB
{
...
int func_427(var uParam0) // Position - 0x20E1D
{
	if (!unk_0x1C2F771CDC87A3A5(func_506(), 0))
...
BOOL func_428(var uParam0) // Position - 0x20E50
{
	return IS_BIT_SET(*uParam0, 1);
}

void func_429(var uParam0) // Position - 0x20E5D
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_430(var uParam0, char* sParam1, int iParam2) // Position - 0x20E73
{
	unk_0x04C016145CE6A18B(uParam0, sParam1, func_6(iParam2), 1);
	return;
}

float func_431(var uParam0) // Position - 0x20E8A
{
	if (func_428(uParam0))
		if (func_9(uParam0))
			return uParam0->f_2;
...
void func_432(var uParam0) // Position - 0x20EC3
{
	if (!func_428(uParam0))
		func_383(uParam0);
	else
...
BOOL func_441(var uParam0) // Position - 0x21123
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
void func_443(var uParam0) // Position - 0x2118A
{
	func_444(uParam0, 0f);
	return;
}

void func_444(var uParam0, float fParam1) // Position - 0x21199
{
	uParam0->f_1 = func_8(IS_BIT_SET(*uParam0, 4)) - fParam1;
	unk_0x0B0C9A0F9AAEB7F0(uParam0, 1);
	unk_0x8744D2E3FC95740E(uParam0, 2);
...
void func_445(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x211C4
{
...
void func_447(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x21283
{
	int num;
	var unk;
...
BOOL func_449(var uParam0) // Position - 0x2151B
{
	int i;
...
int func_450(var uParam0) // Position - 0x21604
{
	int i;
	int num;
	int num2;
...
var func_461() // Position - 0x21BAB
{
	return unk_0x8DE4F68A9728925E("MIDSIZED_MESSAGE");
}

var func_462() // Position - 0x21BBB
{
	return unk_0x8DE4F68A9728925E("MP_BIG_MESSAGE_FREEMODE");
}

void func_463(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x21BCB
{
	int i;
	int j;
	...
	if (!func_464(uParam2) && fParam5 != 0f)
	{
...
BOOL func_464(float fParam0, var uParam1, var uParam2) // Position - 0x21CE7
{
...
void func_468(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x21E34
{
	var unk;
	var unk4;
	var unk7;
...
int func_472(int iParam0, int iParam1) // Position - 0x22183
{
	var unk;
	var unk2;

	unk2 = func_473(iParam0, iParam1);
...
var func_473(int iParam0, int iParam1) // Position - 0x221A1
{
	...
	func_474(iParam0, iParam1, &unk, &unk2);
	return unk;
}
...
BOOL func_480(BOOL bParam0) // Position - 0x22641
{
...
void func_485(var uParam0, int iParam1) // Position - 0x22CC3
{
	...
	if (!Global_78958)
		if (!unk_0xD5FF242D0AFC5855(unk_0xB6B621402486C3E4()))
			if (!Global_78960)
				if (unk_0x15CCE8886267624F() && !func_480(false))
...
var func_489() // Position - 0x22EED
{
	return unk_0xD59511AF30BE1934(unk_0xB6B621402486C3E4());
}

void func_490(var uParam0) // Position - 0x22EFD
{
	if (unk_0xA0C7B98BCF1EEF9E(*uParam0))
	{
		unk_0xD314260005F064BF(uParam0);
...
void func_495() // Position - 0x22F96
{
	...
	if (Global_113810.f_9088 || func_480(false))
	{
		if (!func_503())
		{
			num = func_502();
...
int func_508(var uParam0) // Position - 0x23E97
{
	int i;
	int num;

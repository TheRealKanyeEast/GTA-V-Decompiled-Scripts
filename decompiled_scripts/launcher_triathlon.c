...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (unk_0xFC8BFE4B41177C22(uLocal_83) && !unk_0x1C2F771CDC87A3A5(uLocal_83, 0))
		{
			...
			{
				case 0:
					if (func_118(iLocal_98) || func_120(iLocal_92, 16) && !func_120(iLocal_92, 524288))
					{
						iLocal_96 = -1;
						func_111();
						func_113(1);
				...
				case 3:
					...
					else
					{
						...
						if (!func_102(3) && !Global_100867)
						{
							...
							{
								if (!func_120(iLocal_92, 1) || !unk_0xFC8BFE4B41177C22(func_101()) && !Global_100867)
								{
									func_113(10);
									break;
								}
						...
						if (flag3)
						{
							...
							if (fLocal_91 < (fLocal_115 * fLocal_115) + 4f)
							{
								if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
								{
									...
									{
										func_81("MG_GET_ON_FOOT" /*You cannot participate in this race with a vehicle.*/, -1);
				...
				case 6:
					...
					if (!unk_0xF40767E41852FB72(iLocal_50))
					{
						...
						if (iLocal_97 != -1)
						{
							if (func_120(Global_112460, 0))
							{
								unk_0x375B1B37EF136A49(func_41(iLocal_97), 0, Global_100870, 0);
...
void func_4() // Position - 0xB0D
{
	...
	uLocal_128 = unk_0xA7B0B03284E7503C(fLocal_119 - 3f, fLocal_119.f_1 - 3f, fLocal_119.f_2 - 3f, fLocal_119 + 3f, fLocal_119.f_1 + 3f, fLocal_119.f_2 + 3f, 0, 1, 1, 1);
	func_7();
	func_5();
	return;
}
...
void func_8(int iParam0, BOOL bParam1) // Position - 0xD3A
{
	...
	if (bParam1)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_32663[num /*23*/].f_11), 13);
	else
		unk_0x8744D2E3FC95740E(&(Global_32663[num /*23*/].f_11), 13);
...
void func_11(int iParam0, BOOL bParam1) // Position - 0xE52
{
	...
	if (bParam1)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_32663[num /*23*/].f_11), 4);
	else
		unk_0x8744D2E3FC95740E(&(Global_32663[num /*23*/].f_11), 4);
...
void func_12(int iParam0, BOOL bParam1) // Position - 0xED5
{
	...
	if (bParam1)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_32663[num /*23*/].f_11), 5);
	else
		unk_0x8744D2E3FC95740E(&(Global_32663[num /*23*/].f_11), 5);
...
void func_13(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF58
{
	...
	if (bParam1)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_32663[num /*23*/].f_11), 6);
	else
		unk_0x8744D2E3FC95740E(&(Global_32663[num /*23*/].f_11), 6);

	if (bParam2)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_32663[num /*23*/].f_11), 11);
	else
		unk_0x8744D2E3FC95740E(&(Global_32663[num /*23*/].f_11), 11);
...
void func_19(int iParam0) // Position - 0x136C
{
	...
	if (i < 3)
	{
		unk_0x8744D2E3FC95740E(&Global_113810.f_20413.f_150[i], num);
		unk_0x8744D2E3FC95740E(&Global_113810.f_20413.f_150[i], num);
	}
...
void func_40(char* sParam0, int iParam1, int iParam2) // Position - 0x581B
{
	...
	unk_0x048963DA591ECAAF(sParam0, iParam1, iParam2, func_6(false));
	return;
}
...
void func_62() // Position - 0x5FA9
{
	...
	{
		func_81("TRI_DEATH" /*Come back later for this race.*/, -1);
		num = iLocal_103;
		func_75(iLocal_103);
		iLocal_103 = num;
	}
...
void func_63() // Position - 0x60B5
{
	...
	if (unk_0x1DD05E817C89C737() > iLocal_132 && fLocal_91 < 30f * 30f)
	{
		...
		if (unk_0xD2AA6F822D3A55D2(0, 1065353216) <= 0.5f)
		{
			...
			num3 = unk_0xAA3F0A9E20917995(unk_0x4A8C381C258A124D(), &unk, num);
...
{
	unk_0x4CAD907F190E6F10(uParam0, sParam1, uParam2, func_65(iParam3), 0);
	return;
}

char* func_65(int iParam0) // Position - 0x61CA
{
	char* str;
...
void func_67() // Position - 0x63D8
{
	...
	{
		if (func_70(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_69(unk_0x4A8C381C258A124D());
		
			if (func_68(num) && !func_104(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != num && func_68(Global_113810.f_2366.f_539.f_4321))
...
int func_69(var uParam0) // Position - 0x64E1
{
	int i;
	int num;
...
int func_71(int iParam0) // Position - 0x6543
{
...
void func_78(var uParam0) // Position - 0x66E2
{
	int num;
...
void func_79(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x6739
{
	int i;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_99() || Global_112857 || Global_32286 || func_98() || func_84(8, -1) || func_97() || func_96() || func_95() || func_86() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_99() || Global_32286 || func_98() || func_84(8, -1) || func_95() || func_97() || func_96() || func_86() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_99() || Global_112857 || Global_32286 || func_98() || func_84(8, -1) || func_95() || func_97() || func_96() || func_86() || Global_113810.f_7691.f_919[num] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_99() || Global_112857 || Global_32286 || func_98() || func_84(8, -1) || func_97() || func_96() || func_86() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
				
					case 4:
						if (func_99() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_84(8, -1) || func_86() || func_94() || Global_113810.f_7691.f_919[num] == 5)
							return false;
						break;
...
BOOL func_106(float fParam0, var uParam1, var uParam2) // Position - 0x773E
{

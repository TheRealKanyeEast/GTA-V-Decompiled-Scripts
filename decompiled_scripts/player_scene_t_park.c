			...
			if (func_6(num, &unk31, &unk47, &unk63))
				if (func_4(num, &unk64, &unk80, &unk96, &unk112, &unk113))
					if (!unk_0x13CCB1AD131C1082(*uParam0, &unk64, &unk31, 2))
						unk_0x381D671BCFC294D9(*uParam0, Global_98143, &unk31, &unk64, 1000f, -8f, unk63, 1148846080);
...
void func_43() // Position - 0x301F
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_46(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_44(num) && !func_48(14) || Global_112760)
			{
...
int func_45(var uParam0) // Position - 0x3128
{
	int i;
	int num;
...
int func_47(int iParam0) // Position - 0x318A
{

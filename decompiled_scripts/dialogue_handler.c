	...
	while (true)
	{
		...
		if (IS_BIT_SET(Global_8371, 1))
		{
			if (!IS_BIT_SET(Global_8370, 20))
			{
				if (unk_0xE87F28FD4128D063())
				{
					...
					unk_0x8744D2E3FC95740E(&Global_8371, 1);
				}
			}
		}
		...
		if (IS_BIT_SET(Global_20711, 0))
		{
			if (!func_120())
			{
				...
				{
					unk_0x0B0C9A0F9AAEB7F0(&Global_20711, 1);
...
void func_2() // Position - 0x26D
{
	...
	unk_0x8744D2E3FC95740E(&Global_8370, 24);
	unk_0x8744D2E3FC95740E(&Global_8371, 23);
	unk_0x8744D2E3FC95740E(&Global_8372, 0);
	unk_0x8744D2E3FC95740E(&Global_8371, 9);
	unk_0x8744D2E3FC95740E(&Global_8371, 31);
	unk_0x8744D2E3FC95740E(&Global_8371, 17);
	unk_0x8744D2E3FC95740E(&Global_8372, 5);
	Global_22829 = 0;
	Global_22828 = 0;
	...
	else
	{
		Global_21845 = 0;
		Global_22856 = 0;
		Global_22867 = unk_0x1DD05E817C89C737();
	}
...
void func_5() // Position - 0x41B
{
	...
	else if (Global_22839 > 0)
	{
		...
		if (iLocal_35 - uLocal_34 > Global_22839)
		{
...
void func_7() // Position - 0x4D6
{
	...
	if (unk_0xE87F28FD4128D063() == 0 && Global_21858 == false)
	{
		if (Global_21898 == true)
			unk_0x0B0C9A0F9AAEB7F0(&Global_8371, 23);
		else
			unk_0x8744D2E3FC95740E(&Global_8371, 23);
		...
		if (!Global_21900)
		{
			while (Global_21898 == true)
			{
				...
				else
				{
					...
					if (func_49(2, Global_20470, 0) || IS_BIT_SET(Global_8370, 24))
					{
						func_47();
						Global_20426 = 0.19f;
						Global_21898 = false;
						...
						if (Global_8939[i] == 0)
						{
							...
							else if (num == 7)
							{
								if (Global_78689)
								{
									...
									func_121(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20500)
...
void func_16() // Position - 0x1CBA
{
	...
	if (bLocal_233 == false)
	{
		if (func_49(2, Global_20476, 0) || unk_0x875A214D5EBCA509(2, 181))
		{
			func_20();
			bLocal_233 = true;
			SYSTEM::SETTIMERA(0);
		...
		if (func_49(2, Global_20477, 0) || unk_0x875A214D5EBCA509(2, 180))
		{
			func_17();
			bLocal_233 = true;
			SYSTEM::SETTIMERA(0);
...
void func_32() // Position - 0x2601
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_35(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_33(num) && !func_14(14) || Global_112760)
			{
...
int func_34(var uParam0) // Position - 0x270A
{
	int i;
	int num;
...
int func_36(int iParam0) // Position - 0x276C
{
...
void func_64() // Position - 0x32E9
{
			...
			if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
			{
				if (unk_0xE916D57851F785AB(unk_0x259BE71D8A81D4FA()))
				{
					...
					else
					{
						...
						if (!Global_21856)
							unk_0x0B0C9A0F9AAEB7F0(&Global_8371, 5);
	...
	else
	{
		...
		if (!Global_21858)
		{
			...
			{
				unk_0xABC27367E50604B7(Global_21464.f_368, Global_21464.f_369);
			}
		}
...
void func_74() // Position - 0x38D8
{
	...
	while (iLocal_90 < Global_21841)
	{
		...
		while (num3 < 70 && iLocal_27 == 0)
		{
			...
			if (unk_0x6BA487C862DB8DDF(&uLocal_36))
			{
				...
				if (unk_0x6BA487C862DB8DDF(&Global_20713[num3 /*6*/]))
				{
					if (unk_0x1B79E937E91F40C3(&Global_20713[num3 /*6*/], &Global_21464.f_187[iLocal_90 /*6*/]))
					{
						num4 > 36 || num5 > 36;
						unk_0xC401B1960D35A6C4(num4, &uLocal_48, &Global_20713[num3 /*6*/], num5, num6, 0, num7, num8, num9, num13, num10, num11, num12);
					}
				}
			...
			else if (unk_0x6BA487C862DB8DDF(&uLocal_42))
			{
				...
				num11 = func_76(0);
				num12 = func_75(0);
				unk_0xC401B1960D35A6C4(num4, &uLocal_48, &Global_21464.f_6[iLocal_90 /*6*/], num5, num6, 1, num7, num8, num9, num13, num10, num11, num12);
	...
	if (Global_21851 == false)
	{
		...
		unk_0xA406335199BF1001(Global_21464.f_368, Global_21464.f_369, Global_21464.f_370, iLocal_80);
		Global_21845 = 4;
	}
...
void func_92() // Position - 0x4177
{
	...
	if (Global_22837)
	{
		unk_0x4082E7EF621D1686(Global_21464.f_368, Global_21464.f_369, Global_21464.f_370, iLocal_80);
...
void func_93() // Position - 0x41D2
{
	...
	if (unk_0x00F2D73E763510A4(&Global_21921))
	{
		if (unk_0x1B79E937E91F40C3(&Global_21921, "CT_AUD"))
			Global_2883586 = 1;
		...
		if (func_98(unk_0x70E57E9927B6BA58(&Global_21921)))
		{
			num15 = 0;
			Global_2883586 = 0;
			num14 = 1;
		...
		if (Global_21847 < 5 || Global_21847 == 10 || Global_21847 == 12 || Global_21847 == 13)
		{
			...
			{
				unk_0xF2CB0224D3BE0B42(&Global_21921, 7);
			...
			{
				unk_0x4AB15E3851FF326B(&Global_21921, 15);
		...
		{
			unk_0xF2CB0224D3BE0B42(&Global_21921, 6);
		...
		{
			unk_0x4AB15E3851FF326B(&Global_21921, 14);
	...
	while (num3 < 70 && iLocal_27 == 0)
	{
		...
		if (unk_0x6BA487C862DB8DDF(&uLocal_36))
		{
			...
			if (unk_0x6BA487C862DB8DDF(&Global_20713[num3 /*6*/]))
			{
				...
				else if (unk_0x1B79E937E91F40C3(&Global_20713[num3 /*6*/], &Global_22843))
				{
					num4 > 36 || num5 > 36;
					unk_0xC401B1960D35A6C4(num4, &uLocal_48, &Global_20713[num3 /*6*/], num5, num6, 0, num7, num8, num9, num13, num10, num11, num12);
					Global_22855 = num3;
		...
		else
		{
			if (unk_0x6BA487C862DB8DDF(&uLocal_42))
			{
				...
				num11 = func_76(num3);
				num12 = func_75(num3);
				unk_0xC401B1960D35A6C4(num4, &uLocal_48, &Global_21464, num5, num6, 1, num7, num8, num9, num13, num10, num11, num12);
			}
...
void func_94() // Position - 0x45EB
{
	...
	for (i = 0; i <= 15; i = i + 1)
	{
		...
		{
			if (unk_0xFC8BFE4B41177C22(Global_21134[i /*10*/]) || Global_21134[i /*10*/] == 0)
				unk_0x302B7D91564CDE7F(i, Global_21134[i /*10*/], &(Global_21134[i /*10*/].f_1));
			...
			if (Global_21134.f_161 == i)
			{
				...
				{
					SYSTEM::WAIT(0);
					unk_0x353876FDDC0D0E0E(Global_21134.f_161, Global_21134.f_162);
				}
			}
		}
	}
	...
	if (Global_4542490 == 1)
	{
		...
		for (i = 0; i <= 19; i = i + 1)
		{
			if (Global_4542309[i /*9*/].f_7 == 1)
				if (unk_0xFC8BFE4B41177C22(Global_4542309[i /*9*/]) || Global_4542309[i /*9*/] == 0)
					unk_0x302B7D91564CDE7F(Global_4542309[i /*9*/].f_8, Global_4542309[i /*9*/], &(Global_4542309[i /*9*/].f_1));
		}
	}
...
BOOL func_100(BOOL bParam0) // Position - 0x4C54
{
...
{
	while (Global_20483 == 1 && unk_0x486FF5D06E9659F1(joaat("cellphone_flashhand")) > 0)
	{
		SYSTEM::WAIT(0);
	}
	...
	if (IS_BIT_SET(Global_8370, 20))
		unk_0x0B0C9A0F9AAEB7F0(&Global_8371, 1);
	else
		unk_0x8744D2E3FC95740E(&Global_8371, 1);
	...
	if (Global_21855)
	{
		if (Global_22862 == 0)
		{
			...
			{
				iLocal_32 = 5000;
				unk_0x4FF8DE2B4C376BE4(Global_21464.f_368, Global_21464.f_369);
			}
			else
			{
				iLocal_32 = 0;
	...
	else
	{
		...
		if (Global_21855 == false)
		{
			...
			if (Global_22862 == 0)
			{
				...
				Global_20712 = 1;
				SYSTEM::SETTIMERB(0);
				unk_0x0B0C9A0F9AAEB7F0(&Global_8370, 27);
				SYSTEM::SETTIMERA(0);
			}
			else
			{
...
float func_108(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, float fParam12, BOOL bParam13) // Position - 0x5306
{
	...
	num = func_110(SYSTEM::TO_FLOAT(unk_0x1DD05E817C89C737() - iLocal_16) / fParam12, 0f, 1f);
...
BOOL func_118(int iParam0, int iParam1) // Position - 0x5888
{
...
void func_121(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11) // Position - 0x58CB
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	unk_0x330108B080A2132F(SYSTEM::ROUND(fParam2));

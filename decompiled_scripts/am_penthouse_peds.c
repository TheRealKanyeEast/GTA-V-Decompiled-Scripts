...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (!unk_0x76CD105BCAC6EB9F() || func_29() || Global_1579688 == 0 || func_28())
			func_25();
...
void func_1() // Position - 0xE4
{
	...
	if (iLocal_36 == 1)
	{
		...
		if (num > -1)
		{
			if (unk_0xFC8BFE4B41177C22(uLocal_40[num /*47*/]) && !unk_0x1C2F771CDC87A3A5(uLocal_40[num /*47*/], 0))
			{
				unk_0xF60A7646F4B460F7(uLocal_40[num /*47*/]);
				iLocal_36 = iLocal_36 + 1;
			}
		}
	}
...
void func_3() // Position - 0x1D4
{
	...
	for (i = 0; i < 50; i = i + 1)
	{
		...
		{
			if (!unk_0xFC8BFE4B41177C22(uLocal_40[i /*47*/]))
				func_12(&uLocal_40[i /*47*/]);
			else if (unk_0x1C2F771CDC87A3A5(uLocal_40[i /*47*/], 0))
...
BOOL func_24(float fParam0, var uParam1, var uParam2) // Position - 0x1357
{
...
{
	return !Global_1579684 && unk_0x834C960822A4683F();
}

BOOL func_29() // Position - 0x13E3
{
...
BOOL func_34(int iParam0) // Position - 0x14D8
{
...
{
	while (!unk_0x0384E096E4BE6261(32, 0, Global_1579703))
	{
		SYSTEM::WAIT(0);
	}
	...
	func_48(0, -1, false);
	unk_0x6F4A865F87C7A3AD(&iLocal_37, 3, 0);
	return;
}

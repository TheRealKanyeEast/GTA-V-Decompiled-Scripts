...
BOOL func_5(BOOL bParam0) // Position - 0x441
{
...
void func_10(int iParam0, int iParam1, int iParam2) // Position - 0xA69
{
	if (iParam2 == -1)
		iParam2 = func_11();
...
BOOL func_32(var uParam0, int iParam1, int iParam2) // Position - 0x1535
{
	int num;
	int i;
	var unk;
...
BOOL func_33(var uParam0, int iParam1, var uParam2) // Position - 0x16F2
{
	int num;
...
int func_35(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17B9
{
	int i;
	int j;
	int k;
...
BOOL func_37(int iParam0, int iParam1, int iParam2) // Position - 0x2054
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_39(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x215A
{
	var unk;
	int i;
...
BOOL func_40(int iParam0, int iParam1, int iParam2) // Position - 0x275E
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_41(var uParam0, int iParam1, int iParam2) // Position - 0x27F7
{
	int i;
	int j;
...
int func_42(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x2898
{
	int num;
...
int func_43(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2B9F
{
	int num;
	int num2;
	int num3;
...
BOOL func_47(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3D34
{
	int num;
...
BOOL func_48(int iParam0, int iParam1, var uParam2) // Position - 0x3D5D
{
	*uParam2 = -99;
...
int func_49(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x4028
{
	int num;
...
void func_51(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4409
{
	int num;
...
BOOL func_52(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x44A3
{
	switch (iParam0)
	{
...
int func_56(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4A93
{
	int num;
	int num2;
	int num3;
...
int func_57(var uParam0, int iParam1) // Position - 0x4B8F
{
	int num;
...
BOOL func_61(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4E6D
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_62(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x50EA
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_63(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x550F
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_64(var uParam0, int iParam1) // Position - 0x5802
{
	int num;
	var unk;
...
int func_65(var uParam0, int iParam1) // Position - 0x5849
{
	int num;
	var unk;
	var unk2;
...
int func_66(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x58A9
{
	int num;
	int num2;
	int num3;
...
void func_69(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x59F4
{
	int num;
...
int func_70(int iParam0, int iParam1) // Position - 0x5A17
{
...
BOOL func_76(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x937A
{
	int num;
...
void func_79(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9E04
{
	int num;
	var unk;
	int num2;
...
BOOL func_92(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE3D4
{
	int num;
	int num2;
	int num3;
...
BOOL func_150(var uParam0, int iParam1, int iParam2) // Position - 0x1F770
{
	int num;
	int num2;
	int i;
...
int func_151(var uParam0) // Position - 0x1F9C9
{
	int i;
	int num;
...
int func_153(int iParam0) // Position - 0x1FA2B
{
...
void func_155(var uParam0, int iParam1) // Position - 0x1FA46
{
...
void func_161(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x200A8
{
...
void func_162(int iParam0, int iParam1, int iParam2) // Position - 0x20145
{
	var unk;
	var unk33;
...
void func_163(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x20184
{
...
char* func_169(int iParam0) // Position - 0x21798
{
	iParam0 = iParam0;
	return "";
}
...
int func_206(var uParam0, int iParam1) // Position - 0x26C89
{
	int num;
	var unk;
	var unk33;
...
void func_207(var uParam0, int iParam1, BOOL bParam2) // Position - 0x26CD2
{
	int i;

	for (i = 0; i < 6; i = i + 1)
	{
		if (func_208(uParam0->f_28[i]))
...
BOOL func_208(var uParam0) // Position - 0x26DC7
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
void func_209(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x26DE8
{
	var unk;
...
BOOL func_210(var uParam0) // Position - 0x26E92
{
	if (func_208(uParam0))
		if (!unk_0x4FAFF4BCB7633475(uParam0))
			return true;
...
void func_211(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x26EB2
{
	if (bParam0)
	{
...
BOOL func_215(int iParam0) // Position - 0x270B3
{
	int num;
...
BOOL func_216(int iParam0) // Position - 0x270D5
{
...
int func_218(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x27122
{
	int num;
...
BOOL func_221(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, int iParam6) // Position - 0x2719F
{
	BOOL flag;
	float num;
...
Vector3 func_223(var uParam0) // Position - 0x273B9
{
...
BOOL func_232() // Position - 0x275DE
{
...
BOOL func_234(var uParam0, int iParam1) // Position - 0x27651
{
	if (func_210(uParam0))
...
BOOL func_235(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x27684
{
...
void func_236(var uParam0) // Position - 0x2781C
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_240(Global_78945, Global_78947, iParam10) };
				num4 == -0.014f;
...
float func_239(var uParam0) // Position - 0x27B43
{
...
{
	if (!func_252(0) || Global_78960 || Global_78948 == 1 || !unk_0x9390801B06EE998F())
		return false;
	...
	switch (Global_78944)
	{
		...
		case 5:
			if (unk_0xFD216000DC314A92() || func_251(0) || func_250(true))
			{
			}
			else
			{
...
void func_259(var uParam0, BOOL bParam1) // Position - 0x28360
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_260(var uParam0) // Position - 0x2839B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_263(var uParam0) // Position - 0x28415
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_264(var uParam0) // Position - 0x2844D
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_265(var uParam0) // Position - 0x284E9
{
	if (func_208(uParam0))
...
void func_267(var uParam0, int iParam1) // Position - 0x28525
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_268(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_268(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x28566
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_269(var uParam0) // Position - 0x285B6
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_271(BOOL bParam0) // Position - 0x28698
{
	...
	if (!func_292())
	{
		...
		{
			func_162(num, 1, 0);
			func_272(unk_0x1AF90EB93E0012D6(), num);
		}
		else
		{
			if (Global_112897[num /*10*/].f_9 == -1)
...
BOOL func_273(char* sParam0, int iParam1, int iParam2) // Position - 0x28790
{
	var unk;
	var unk2;
	int num;
...
int func_276(char* sParam0, BOOL bParam1) // Position - 0x28999
{
	...
	num = func_277(unk, true);
	num == -1 && !bParam1;
	return num;
}

int func_277(var uParam0, BOOL bParam1) // Position - 0x289C3
{
	int i;
...
void func_280(int iParam0) // Position - 0x28AB5
{

...
void main() // Position - 0x0
{
	...
	if (unk_0xFC8BFE4B41177C22(uScriptParam_0))
	{
		...
		uLocal_314 = Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_267.f_33;
		...
		uLocal_389 = Global_1567810.f_146.f_82[5 /*102*/].f_19.f_2;
	...
	switch (iLocal_310)
	{
		case 0:
			if (func_58(uLocal_376, unk) && !func_57() && unk_0xCFC0C995455A6204(unk_0x4A8C381C258A124D()) > fLocal_379 - 45f && unk_0xCFC0C995455A6204(unk_0x4A8C381C258A124D()) < fLocal_379 + 45f)
			{
				...
				if (!func_56("SA_STRIP_CALL" /*Press ~INPUT_CONTEXT~ to call stripper.~n~*/))
			...
			if (func_54(true, false, true))
			{
				if (func_58(uLocal_376, unk) && !func_57() && unk_0xCFC0C995455A6204(unk_0x4A8C381C258A124D()) > fLocal_379 - 45f && unk_0xCFC0C995455A6204(unk_0x4A8C381C258A124D()) < fLocal_379 + 45f)
				{
					if (!unk_0x1C751EF63BF4D501(unk_0x259BE71D8A81D4FA()) && !unk_0x4F035D45FC2856F8(unk_0x259BE71D8A81D4FA()) && unk_0x875A214D5EBCA509(2, 51))
					{
						...
						func_34(unk_0x259BE71D8A81D4FA(), false, 256, 0);
						bLocal_34 = true;
		...
		case 4:
			...
			if (!func_56("SA_STRIP_CAM" /*Press ~INPUT_CONTEXT~ to change view.~n~*/))
		...
		case 6:
			...
			if (!unk_0x5266F1D2AEF6F73A(uLocal_315))
			{
				...
				if (!func_56("SA_STRIP_MENU" /*Press ~INPUT_SCRIPT_RRIGHT~ for another dance.~n~Press ~INPUT_SCRIPT_RUP~ to quit.~n~*/))
		...
		case 11:
			...
			if (unk_0xBD3B265153D3BA2D(uLocal_316) > 0.5f)
			{
				...
				func_34(unk_0x259BE71D8A81D4FA(), true, 0, 0);
				bLocal_34 = false;
				iLocal_310 = 0;
			}
			break;
...
void func_2() // Position - 0xCE5
{
	...
	if (num > -1 && num != func_10())
	{
		for (i = 0; i < 30; i = i + 1)
		{
			if (Global_1853988[unk_0x259BE71D8A81D4FA() /*867*/].f_267.f_33 == Global_1853988[num /*867*/].f_267[i])
			{
				if (func_9(i) != -1)
				{
...
BOOL func_5(int iParam0) // Position - 0xDD7
{
	int num;
...
BOOL func_6(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDF9
{
	int num;
...
{
	return IS_BIT_SET(Global_1654054.f_241.f_136[func_15(9) /*33*/][iParam0], func_14(9));
}
...
BOOL func_16(var uParam0) // Position - 0x108A
{
...
void func_17(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10A9
{
	int num;
...
int func_18(int iParam0, int iParam1) // Position - 0x10CC
{
...
void func_25(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x11C6
{
	if (bParam0)
	{
...
BOOL func_29(int iParam0) // Position - 0x13C7
{
...
int func_31(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x1414
{
	int num;
...
BOOL func_38(var uParam0) // Position - 0x19C5
{
	int num;
...
void func_39(int iParam0, int iParam1, int iParam2) // Position - 0x19F6
{
	int num;
	int i;
...
void func_40(int iParam0, int iParam1) // Position - 0x1AC6
{
	int num;
...
int func_46(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x1BF9
{
	var unk;
...
BOOL func_58(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x1FDC
{
...
BOOL func_68(int iParam0) // Position - 0x232F
{
...
{
	if (func_56("SA_SHWR_OUT" /*Press ~INPUT_SCRIPT_RUP~ to stop showering.~n~*/) || func_56("SA_SHWR_IN" /*Press ~INPUT_CONTEXT~ to take a shower.~n~*/))
		unk_0x428C32CC68809A35(1);

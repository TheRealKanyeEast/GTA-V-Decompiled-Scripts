...
BOOL func_15(int iParam0) // Position - 0x5B9
{
	...
	if (!unk_0x1B79E937E91F40C3(&Global_112461[iParam0 /*28*/], "") && !unk_0xFF692AB7350A74D7(&Global_112461[iParam0 /*28*/]))
...
BOOL func_42(BOOL bParam0) // Position - 0x1282
{
...
void func_48(int iParam0, int iParam1, int iParam2) // Position - 0x1488
{
	if (iParam2 == -1)
		iParam2 = func_28();
...
BOOL func_54(var uParam0) // Position - 0x1711
{

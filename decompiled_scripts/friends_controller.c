	...
	while (bLocal_93)
	{
		...
		else
		{
			...
			else if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
			{
				...
				{
					if (!unk_0xF40767E41852FB72(Global_113810.f_18106.f_395))
					{
...
void func_2(var uParam0, var uParam1) // Position - 0x2CB
{
	...
	if (func_407() || unk_0x3555462DB47B7AB1())
	{
		if (uParam0->f_49 == 0)
		{
			if (func_406(Global_98291.f_45) && !unk_0x4FAFF4BCB7633475(uParam0->[Global_98291.f_45 /*15*/].f_2))
				unk_0x974022927CB47E68(uParam0->[Global_98291.f_45 /*15*/].f_2);
...
void func_6(var uParam0) // Position - 0x721
{
	...
	func_22(Global_96547, uParam0->f_74, &unk42, &unk58);
...
BOOL func_16(int iParam0) // Position - 0xB69
{
	int num;
...
BOOL func_17(int iParam0) // Position - 0xB8B
{
...
int func_19(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xBD8
{
	int num;
...
void func_25(var uParam0) // Position - 0xDED
{
	func_26(uParam0, 0f);
	return;
}

void func_26(var uParam0, float fParam1) // Position - 0xDFC
{
	...
	switch (uParam0->f_50)
	{
		...
		case 17:
			...
			if (!func_61(&(uParam0->f_54), 30f))
			{
				if (uParam0->f_53 == -1)
					if (uParam0->f_51 == 0)
						func_59(&(uParam0->f_53), 5, "FR_PK_AMB_M" /*Press ~INPUT_CONTEXT~ to hang out with Michael, or ~INPUT_CONTEXT_SECONDARY~ to decline.*/, 0, 0, 0, 0);
					else if (uParam0->f_51 == 1)
						func_59(&(uParam0->f_53), 5, "FR_PK_AMB_F" /*Press ~INPUT_CONTEXT~ to hang out with Franklin, or ~INPUT_CONTEXT_SECONDARY~ to decline.*/, 0, 0, 0, 0);
					else
						func_59(&(uParam0->f_53), 5, "FR_PK_AMB_T" /*Press ~INPUT_CONTEXT~ to hang out with Trevor, or ~INPUT_CONTEXT_SECONDARY~ to decline.*/, 0, 0, 0, 0);
		...
		case 21:
			...
			if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) || func_90(uParam0, uParam1, Global_96547, uParam0->f_51, 18, true))
				func_92(uParam0, 22);
			break;
...
BOOL func_49(int iParam0, int iParam1, int iParam2) // Position - 0x21AF
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0, int iParam1, var uParam2) // Position - 0x2283
{
	int num;
	int num2;
...
int func_56(int iParam0, int iParam1) // Position - 0x2334
{
	int num;
	int num2;
...
BOOL func_61(var uParam0, float fParam1) // Position - 0x265E
{
	if (func_63(uParam0))
...
BOOL func_70(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2896
{
	var unk;
	var unk5;
	...
	if (uParam0->f_52)
	{
		if (!func_87(iParam2, iParam3, iParam4, &unk, &unk5) || func_72(uParam1, &unk, &unk5, 4, 0, 0, 0))
		{
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113810.f_18106.f_410), iParam5);
			uParam0->f_52 = 0;
		}
	}
	else if (!func_71())
...
BOOL func_77(int iParam0, int iParam1) // Position - 0x2CD8
{
...
BOOL func_87(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4) // Position - 0x3038
{
	int num;
	int num2;
...
BOOL func_90(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x31FD
{
	var unk;
	var unk5;
	...
	if (uParam0->f_52)
		if (bParam5 || !func_71())
			if (!func_91(iParam2, iParam3, iParam4, &unk, &unk5) || func_72(uParam1, &unk, &unk5, 4, 0, 0, 0))
				uParam0->f_52 = 0;
	else if (!func_71())
		return true;
...
BOOL func_91(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4) // Position - 0x3257
{
	int num;
	int num2;
...
{
	if (unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || Global_112857 || func_99() || func_84(8, -1) || func_98() || func_97() || !unk_0xE916D57851F785AB(unk_0x259BE71D8A81D4FA()))
		return false;
	...
	else if (*uParam1 != 0 && *uParam1 != 1)
	{
		if (unk_0x4FAFF4BCB7633475(uParam1->f_2))
		{
			...
			if (!func_365(uParam1, false))
			{
				if (num6 != -1)
				{
					num7 = func_363(uParam1->f_2);
				
					if (num7 != 0)
						if (!func_362(num6) || func_350(num6) == 6)
							func_290(Global_96547, uParam1->f_1, 2, 0, num7, num6, -1);
				}
			}
...
BOOL func_103(var uParam0, var uParam1) // Position - 0x41E2
{
	...
	func_22(Global_96547, uParam1->f_1, &unk41, &unk57);
...
void func_104(var uParam0, var uParam1, int iParam2) // Position - 0x45B0
{
	iParam2 = iParam2;
...
var func_105(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x45C9
{
	var unk;
...
void func_106(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Position - 0x45FB
{
	var unk;
...
Vector3 func_108(var uParam0) // Position - 0x47F5
{
	return unk_0xD1A6A821F5AC81DB(unk_0x56E414973C2A8C0E(uParam0), 0);
}

int func_109(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x4808
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_78472[1 /*14*/] = { func_161(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78472[1 /*14*/] = { func_161(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78472[1 /*14*/] = { func_161(num8, 14, unk18[j], -1) };
							func_129(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
							func_152(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_119(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_119(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_119(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
			...
			{
				Global_78472[1 /*14*/] = { func_161(num8, i, func_118(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78472[1 /*14*/] = { func_161(num8, 14, unk59[j], -1) };
			func_129(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
			func_152(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_119(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_119(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_119(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
...
BOOL func_110(var uParam0, int iParam1, var uParam2) // Position - 0x5019
{
	int num;
	...
	{
		if (!func_225(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_64, Global_113810.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_113(int iParam0, int iParam1, int iParam2) // Position - 0x516A
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_115(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x5270
{
	var unk;
	int i;
...
BOOL func_116(int iParam0, int iParam1, int iParam2) // Position - 0x5874
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_117(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x590D
{
	int num;
	...
	{
		if (!func_225(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_61, Global_113810.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
int func_118(var uParam0, int iParam1, int iParam2) // Position - 0x59B8
{
	int i;
	int j;
...
int func_120(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x5B09
{
	int num;
...
int func_121(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x5E10
{
	int num;
	int num2;
	int num3;
...
BOOL func_125(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6FA5
{
	int num;
...
BOOL func_126(int iParam0, int iParam1, var uParam2) // Position - 0x6FCE
{
	*uParam2 = -99;
...
int func_127(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x7298
{
	int num;
...
void func_129(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7679
{
	int num;
...
BOOL func_130(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7713
{
	switch (iParam0)
	{
...
int func_134(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7D03
{
	int num;
	int num2;
	int num3;
...
int func_135(var uParam0, int iParam1) // Position - 0x7DFF
{
	int num;
...
void func_140(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8A0D
{
	int num;
	var unk;
	int num2;
...
BOOL func_146(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xACD2
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_147(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xAF4F
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_148(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB374
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_149(var uParam0, int iParam1) // Position - 0xB667
{
	int num;
	var unk;
...
int func_150(var uParam0, int iParam1) // Position - 0xB6AE
{
	int num;
	var unk;
	var unk2;
...
int func_151(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0xB70E
{
	int num;
	int num2;
	int num3;
...
void func_154(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB859
{
	int num;
...
int func_155(int iParam0, int iParam1) // Position - 0xB87C
{
...
BOOL func_168(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1165F
{
	int num;
	int num2;
	int num3;
...
void func_170(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x11771
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_164(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_164(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78670)
		{
			...
			func_164(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_225(var uParam0, int iParam1, int iParam2) // Position - 0x22E36
{
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_78472[1 /*14*/] = { func_161(num, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_225(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_225(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78472[2 /*14*/] = { func_161(num, 14, k, -1) };
								
									if (Global_78472[2 /*14*/].f_12 == j)
										if (func_225(uParam0, 14, k))
											if (!func_115(num, iParam2, 14, k, &unk, &Global_78472[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_78472[2 /*14*/] = { func_161(num, i, num2, -1) };
					
						if (!func_115(num, iParam2, i, num2, &unk, &Global_78472[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_78472[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_119(iParam1)) && Global_78472[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_119(iParam1)))
	{
		return true;
	}
					...
					if (func_241(uParam0))
					{
						if (func_94(Global_96547, uParam1->f_1) > 15f)
						{
							if (fParam3 < 8f * 8f)
							{
								...
								if (func_72(uParam2, &unk5, &unk, 4, 0, 0, 0))
								{
					...
					if (fParam3 < 8f * 8f)
					{
						if (func_94(Global_96547, uParam1->f_1) > 10f)
							if (unk_0x486FF5D06E9659F1(joaat("appinternet")) == 0)
								if (Global_96643 && uParam0->f_50 == 0 && !unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) || unk_0xFFEFA49356BD7CA2(unk_0x4A8C381C258A124D()) && unk_0x1D5CD3EAAA7422B0(unk_0xDF93B3CFAC96698F(unk_0x4A8C381C258A124D())) < 10f && !unk_0x7F420695E3F776FB(uParam1->f_2, 0) && !unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) && !unk_0x3F18810075C77D41(uParam1->f_2) && !unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) && !unk_0x8BF5256C439DF778(uParam1->f_2) && !func_407() && !unk_0x3555462DB47B7AB1() && func_235(uParam0, uParam1))
									return true;
...
void func_237(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x24440
{
	...
	TEXT_LABEL_ASSIGN_STRING(&unk, func_240(iParam1), 16);
	num = func_239(iParam1);
	bParam3;
	func_238(uParam0, num, iParam2, &unk, 0, 1);
	return;
}
...
void func_244(var uParam0) // Position - 0x24695
{
	...
	{
		num = func_245(unk_0x4A8C381C258A124D(), 0);
...
int func_245(var uParam0, int iParam1) // Position - 0x2472D
{
	var unk;
	int num;
	int i;
...
int func_249(var uParam0) // Position - 0x2482E
{
	int i;
...
BOOL func_252(var uParam0, var uParam1, int iParam2) // Position - 0x2495D
{
...
void func_253(var uParam0, char* sParam1, int iParam2) // Position - 0x249F3
{
	unk_0x04C016145CE6A18B(uParam0, sParam1, func_254(iParam2), 1);
	return;
}

char* func_254(int iParam0) // Position - 0x24A0A
{
	char* str;
...
BOOL func_255(var uParam0, int iParam1) // Position - 0x24BFF
{
	if (func_9(uParam0))
...
BOOL func_259(var uParam0, float fParam1) // Position - 0x24E64
{
	float num;

	if (func_10(unk_0x4A8C381C258A124D()) && func_10(uParam0))
	{
...
BOOL func_260(var uParam0, float fParam1) // Position - 0x24EDA
{
	return func_261(uParam0, unk_0x4A8C381C258A124D(), fParam1, 1, 250, 7);
}

BOOL func_261(var uParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5) // Position - 0x24EF2
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_262(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0x24FB3
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_263(var uParam0, int iParam1) // Position - 0x250DF
{
	int num;
...
BOOL func_265(var uParam0, var uParam1, float fParam2, int iParam3) // Position - 0x251EE
{
	var unk;
	var unk4;
	float num;
...
int func_269(var uParam0, var uParam1) // Position - 0x252FA
{
	int i;
...
int func_270(var uParam0) // Position - 0x25339
{
...
BOOL func_272(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x255A8
{
	float num;
...
BOOL func_275(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x257C4
{
	float num;
	float num2;
	int num3;
...
BOOL func_276(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x258BF
{
	float num;
	float num2;
...
BOOL func_277(var uParam0, float fParam1) // Position - 0x259CB
{
	var unk;
	var unk2;
...
BOOL func_278(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x25A60
{
	var unk;
	var unk4;
	float num;
...
BOOL func_279(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0x25AEE
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
var func_283(int iParam0) // Position - 0x25DC6
{
	return iParam0;
}
...
BOOL func_286(var uParam0) // Position - 0x25EB2
{
	int i;

	for (i = 0; i < Global_100758; i = i + 1)
	{
		if (Global_100758[i] == uParam0)
			return true;
	}
...
BOOL func_287(var uParam0, var uParam1, var uParam2) // Position - 0x25EE1
{
	...
	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		...
		else if (!unk_0x4FAFF4BCB7633475(Global_96651[uParam1->f_1]))
		{
...
void func_289(var uParam0, var uParam1, var uParam2) // Position - 0x2619F
{
	...
	if (!unk_0x4FAFF4BCB7633475(uParam1->f_2))
	{
		...
		func_237(uParam2, Global_96547, unk_0x4A8C381C258A124D(), false);
		func_237(uParam2, uParam1->f_1, uParam1->f_2, false);
...
int func_290(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x26299
{
	int num;
	int num2;
	int num3;
	...
	if (iParam3 == 0)
	{
		if (func_347(num2, iParam2, -1, &num5, &num6))
		{
			...
			if (func_343(iParam5, num5, num6, num, num3, iParam1, num4, 10000, iParam6, iParam4, num8, num7, 1))
				return 1;
			else
				return 0;
		}
	...
	{
		if (func_327(iParam1, &unk, 1, 0, 0, 0, 0, true, 0, 1))
		{
			if (iParam4 != 0)
			{
				switch (iParam4)
...
void func_291() // Position - 0x26443
{
	...
	if (num2 > 10000)
		func_292(num, 129, 5000);
	else if (num2 >= 10)
		func_292(num, 129, num2 / 10);
...
int func_292(int iParam0, int iParam1, int iParam2) // Position - 0x26485
{
	...
	return func_293(func_321(iParam0), 0, iParam1, iParam2, false);
}
...
void func_296(int iParam0) // Position - 0x26D94
{
	...
	else if (IS_BIT_SET(Global_113810.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_298() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113810.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_298() /*5568*/].f_681.f_10), iParam0);
	}
	...
	if (flag)
	{
		...
		unk_0xACF853FB3F6EA7D4(func_297(iParam0));
...
char* func_297(int iParam0) // Position - 0x26F0E
{
	switch (iParam0)
	{
		case 0:
...
void func_299(int iParam0, int iParam1, int iParam2) // Position - 0x2701E
{
	if (iParam2 == -1)
		iParam2 = func_15();
...
void func_323() // Position - 0x2777D
{
	...
	if (num2 > 10000)
		func_292(num, 128, 5000);
	else if (num2 >= 10)
		func_292(num, 128, num2 / 10);
...
void func_324() // Position - 0x277BF
{
	...
	if (num2 > 10000)
		func_292(num, 127, 5000);
	else if (num2 >= 10)
		func_292(num, 127, num2 / 10);
...
void func_325() // Position - 0x27801
{
	...
	if (num2 > 10000)
		func_292(num, 126, 5000);
	else if (num2 >= 10)
		func_292(num, 126, num2 / 10);
...
void func_326() // Position - 0x27843
{
	...
	if (num2 > 10000)
		func_292(num, 125, 5000);
	else if (num2 >= 10)
		func_292(num, 125, num2 / 10);

	return;
}

BOOL func_327(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x27885
{
	int num;
	char* str;
	int num2;
	...
	if (func_329(iParam0, sParam1, iParam2, num, str, str2, num2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, num3, str3, str4, num4) == 1)
	{
		if (bParam7 == true)
		{
			Global_9077 = iParam6;
			Global_8980[3 /*6*/] = { func_328(iParam0) };
			Global_9057 = iParam0;
...
int func_329(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x27927
{
	int num;
	int num2;
	...
	func_330(iParam0, sParam1, num2, func_331(unk_0x259BE71D8A81D4FA()));
	return 1;
}
						...
						if (Global_8939[i] == 0)
						{
							...
							else if (num == 7)
							{
								if (Global_78689)
								{
									...
									func_333(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20500)
...
void func_333(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x2844E
{
...
void func_334(int iParam0) // Position - 0x28501
{
...
void func_335(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x28513
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	unk_0x330108B080A2132F(SYSTEM::ROUND(fParam2));
...
BOOL func_341(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x28945
{
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			if (func_342(&unk5[0 /*4*/], num))
				iParam2 = 1;
			else if (func_342(&unk5[1 /*4*/], num))
				iParam2 = 0;
			else
...
BOOL func_342(var uParam0, int iParam1) // Position - 0x28A7D
{
	int num;
	int num2;
	...
	while (num < 35)
	{
		if (!unk_0xFF692AB7350A74D7(&Global_113810.f_14144[num /*104*/]))
			if (unk_0x1B79E937E91F40C3(&Global_113810.f_14144[num /*104*/], uParam0))
...
BOOL func_343(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12) // Position - 0x28AF1
{
	int num;
...
void func_344(int iParam0) // Position - 0x28C2C
{
	int i;
	int num;
	int j;
...
BOOL func_346(BOOL bParam0) // Position - 0x28D54
{
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			if (func_341(iParam0, iParam1, 0, &unk[0 /*4*/]) && func_341(iParam0, iParam1, 1, &unk[1 /*4*/]))
			{
				...
				if (func_342(&unk[0 /*4*/], num))
					iParam2 = 1;
				else if (func_342(&unk[1 /*4*/], num))
					iParam2 = 0;
				else
					iParam2 = unk_0xC5935DFB3F39785A(0, 2);
			}
...
int func_350(int iParam0) // Position - 0x28F63
{
	...
	for (i = 0; i < Global_113810.f_7691.f_866; i = i + 1)
	{
		if (Global_113810.f_7691.f_765[i /*10*/] == iParam0)
			return func_351(iParam0, unk);
	}

	return 6;
}

int func_351(int iParam0, var uParam1) // Position - 0x29019
{
	int num;
	BOOL flag;
	...
	if (IS_BIT_SET(num.f_2, func_352()))
		flag = true;
	...
	if (flag)
		if (num.f_3 < Global_113810.f_7691.f_919[func_352()])
			return 5;

	if (num.f_6 != 144)
		if (Global_43929[num.f_6] > uParam1)
			return 3;

	if (Global_43928 > uParam1)
		return 2;

	return 1;
}

int func_352() // Position - 0x290AE
{
	func_353();
...
void func_353() // Position - 0x290C7
{
	...
	{
		if (func_355(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_354(unk_0x4A8C381C258A124D());
		
			if (func_406(num) && !func_416(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != num && func_406(Global_113810.f_2366.f_539.f_4321))
...
int func_354(var uParam0) // Position - 0x291C4
{
	int i;
	int num;
...
int func_356(int iParam0) // Position - 0x29226
{
...
int func_358(int iParam0, var uParam1) // Position - 0x29284
{
	int num;
	BOOL flag;
...
int func_360(int iParam0, var uParam1) // Position - 0x2935F
{
	int num;
	BOOL flag;
...
int func_363(var uParam0) // Position - 0x2954B
{
	var unk;
...
int func_364(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x295DE
{
	int i;
	float num;
	float num2;
	...
	for (i = 0; i <= 5 - 1; i = i + 1)
	{
		if (Global_96016[i /*9*/].f_7 != 263)
		{
			...
			{
				num = unk_0xED977E2AE2CB16EE(uParam0, Global_96016[i /*9*/].f_3, 1);
...
void func_367(var uParam0) // Position - 0x2972D
{
	if (func_63(uParam0))
	{
		if (!func_412(uParam0))
...
void func_373(int iParam0) // Position - 0x29B96
{
	int num;
	int i;
	...
	{
		if (num < 0)
			if (!unk_0xFC8BFE4B41177C22(Global_100758[i]))
				num = i;
	}
...
var func_375() // Position - 0x29C29
{
	...
	func_385(&unk, unk_0x4BA5A16068183C5E());
	func_384(&unk, unk_0x18E502A71E28968C());
	func_383(&unk, unk_0x5295501D0862870D());
...
void func_386(var uParam0) // Position - 0x29F12
{
	int num;
	Vector3 vector;
	var unk3;
	...
	vector = { Global_113810.f_2366.f_539.f_2300[num /*3*/] };
	unk3 = Global_113810.f_2366.f_539.f_2310[num];
	unk4 = Global_113810.f_2366.f_539.f_2314[num];
	unk5 = { Global_113810.f_2366.f_539.f_2318[num /*3*/] };
	func_388(uParam0, false);

	if (!func_387(vector, 0f, 0f, 0f, false))
	{
		num2 = unk_0x1D5CD3EAAA7422B0(Global_113810.f_2366.f_539.f_2300[num /*3*/].f_2 - vector.f_2);
		num3 = SYSTEM::VDIST2(vector, Global_113810.f_2366.f_539.f_2300[num /*3*/]);
		num4 = SYSTEM::VMAG(Global_113810.f_2366.f_539.f_2318[num /*3*/]);
		flag = false;
		...
		if (flag)
		{
			Global_113810.f_2366.f_539.f_2300[num /*3*/] = { vector };
			Global_113810.f_2366.f_539.f_2310[num] = unk3;
			Global_113810.f_2366.f_539.f_2314[num] = unk4;
			Global_113810.f_2366.f_539.f_2318[num /*3*/] = { unk5 };
		}
	}
...
void func_388(var uParam0, BOOL bParam1) // Position - 0x2A0D8
{
	func_401(uParam0);
...
void func_389(var uParam0) // Position - 0x2A10C
{
	int num;

	num = func_354(uParam0);

	if (func_406(num) && !unk_0x4FAFF4BCB7633475(uParam0))
...
void func_390(var uParam0) // Position - 0x2A153
{
	int num;
...
void func_391(var uParam0) // Position - 0x2A191
{
	int num;
...
void func_392(var uParam0) // Position - 0x2A31E
{
	int num;
...
void func_393(var uParam0) // Position - 0x2A35A
{
	int num;
...
void func_394(var uParam0, BOOL bParam1) // Position - 0x2A3B7
{
	int num;
	var unk;
	int i;
	...
	if (func_406(num) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		if (uParam0 == unk_0x4A8C381C258A124D())
		{
			func_395(uParam0, &Global_113810.f_2366.f_539.f_298[num /*477*/]);
...
void func_395(var uParam0, var uParam1) // Position - 0x2A4AA
{
	int i;
	int j;
	int k;
	...
	if (!unk_0x4FAFF4BCB7633475(uParam0))
	{
		...
		for (i = 0; i <= 44 - 1; i = i + 1)
		{
			...
			if (num != 0)
			{
				num2 = unk_0xBCEDAE6CA2B2046E(uParam0, func_400(i));
				num2.f_1 = 0;
				num2.f_2 = 0;
				num2.f_3 = 0;
				num2.f_4 = 0;
				...
				if (num2 != 0 && num2 != joaat("WEAPON_UNARMED"))
				{
					...
					for (k = func_398(num2, j); k != 0; k = func_398(num2, j))
					{
		...
		{
			if (unk_0xA40B513DA7201333(l, &unk5) && !func_397(unk5.f_1) && num4 < 51)
			{
...
void func_401(var uParam0) // Position - 0x2B913
{
	int num;
	...
	if (func_406(num) && !unk_0x4FAFF4BCB7633475(uParam0))
		Global_113810.f_2366.f_539.f_2296[num] = func_375();
...
void func_404(var uParam0, int iParam1) // Position - 0x2BA17
{
	if (uParam0->f_50 != 0)
	{
...
void func_409(var uParam0) // Position - 0x2BB08
{
	if (func_63(uParam0))
	{
		if (func_412(uParam0))
...
void func_420(int iParam0, var uParam1) // Position - 0x2BD1E
{
	...
	if (num2 == 0)
	{
		if (!func_416(17))
		{
			if (func_468(num))
			{
				if (!func_233(6))
				{
					if (func_430(num, &flag, &flag2, &flag3))
					{
						if (flag)
						{
							if (flag3)
	...
	{
		if (func_428(iParam0, 3) && func_406(num))
		{
			if (!func_468(num))
			{
	...
	else if (num2 == 3)
	{
		...
		if (!unk_0xF40767E41852FB72(Global_113810.f_18106.f_395))
		{
			...
			{
				num3 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&scriptName, &iParam0, 1, FRIEND);
				Global_113810.f_18106.f_395 = num3;
...
void func_429(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2C196
{
	if (iParam0 < 9)
		if (bParam2)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113810.f_18106.f_175[iParam0 /*19*/].f_18), iParam1);
		else
			unk_0x8744D2E3FC95740E(&(Global_113810.f_18106.f_175[iParam0 /*19*/].f_18), iParam1);

	return;
}

BOOL func_430(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2C1DA
{
	int num;
	int num2;
	int num3;
	...
	func_237(&uLocal_179, num, unk_0x4A8C381C258A124D(), true);
	func_237(&uLocal_179, iParam0, 0, true);
	num4 = 0;

	if (!func_457(num2, num3))
	{
	...
	else if (func_451(num2, num3))
	{
		func_450(num2, &unk25, &num5);
		func_442(num2, num3, &num6, &num7, true);
		func_441(num, iParam0, unk25, &unk, &unk5);
		func_441(num, iParam0, num5, &unk, &unk9);
		func_441(num, iParam0, num6, &unk, &unk13);
		func_441(num, iParam0, num7, &unk, &unk21);
		unk17 = { unk13 };
	
		if (num6 == 9)
			TEXT_LABEL_APPEND_STRING(&unk17, "_1", 16);
	
		if (func_436(&uLocal_179, func_44(num3), &unk, &unk5, &unk5, &unk9, &unk9, &unk13, &unk17, &unk21, &unk21, 12, num4, 0, 0, false))
		{
			if (num6 == 12)
				*uParam3 = 1;
			else
	...
	else if (!func_435(num3))
	{
		num8 = unk_0xC5935DFB3F39785A(0, 3);
	
		if (num8 == 0)
			func_441(num, iParam0, 35, &unk, &unk5);
		else if (num8 == 1)
			func_441(num, iParam0, 36, &unk, &unk5);
		else
			func_441(num, iParam0, 37, &unk, &unk5);
	
		if (func_434(&uLocal_179, func_44(num3), &unk, &unk5, 12, num4, 0, 0, false))
		{
			*uParam1 = 0;
			*uParam2 = 0;
			return true;
	...
	{
		func_450(num2, &num9, &num10);
		func_431(num2, num3, &num11, &num12);
		func_441(num, iParam0, num9, &unk, &unk5);
		func_441(num, iParam0, num10, &unk, &unk9);
		func_441(num, iParam0, num11, &unk, &unk13);
		func_441(num, iParam0, num12, &unk, &unk21);
	
		if (func_436(&uLocal_179, func_44(num3), &unk, &unk5, &unk5, &unk9, &unk9, &unk13, &unk13, &unk21, &unk21, 12, num4, 0, 0, false))
		{
			*uParam1 = 0;
			*uParam2 = 0;
			return true;
...
BOOL func_433(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x2C498
{
	...
	num = func_44(iParam0);
	num2 = func_44(iParam1);
	*uParam2 = func_94(num, num2);
	*uParam3 = func_93(num, num2);
...
BOOL func_436(var uParam0, int iParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, BOOL bParam15) // Position - 0x2C57E
{
	var unk;
	var unk12;
...
int func_442(int iParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x2CD03
{
	...
	else if (bParam4 && unk_0xC5935DFB3F39785A(0, 100) < 15 && !(iParam0 == 2 && iParam1 == 0) && !(iParam0 == 0 && iParam1 == 5) && !unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && func_443(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1)))
	{
		*uParam2 = 12;
		*uParam3 = 14;
		return 1;
...
BOOL func_443(var uParam0, var uParam1, var uParam2) // Position - 0x2CE1F
{
	var unk;
	float num;
	var unk4;
	...
	if (func_447())
		if (unk_0xED977E2AE2CB16EE(uParam0, Global_96114[0 /*18*/], 1) < 10f)
			return true;
		else
			func_446();
	...
	if (!func_445())
	{
		if (Global_97741 == 0)
		{
			if (unk_0x6009FBA2EAAA60BE(uParam0, 1, &unk, &num, &unk4, 4, 1077936128, 0))
			{
				...
				Global_96114[0 /*18*/] = { unk5 };
				Global_96114[0 /*18*/].f_3 = { unk26 - unk5 };
				Global_96114[0 /*18*/].f_6 = { unk29 - unk5 };
				Global_96114[0 /*18*/].f_9 = { 0f, 0f, 0f };
				Global_96114[0 /*18*/].f_12 = 0f;
				Global_96114[0 /*18*/].f_13 = { unk23 };
...
BOOL func_448(var uParam0) // Position - 0x2D12F
{
...
BOOL func_449(var uParam0) // Position - 0x2D150
{
...
BOOL func_452(int iParam0, int iParam1) // Position - 0x2D27A
{
	...
	if (func_54(num, num2, &num3))
		if (num6 == 0)
			return true;
		else if (num6 == 1)
			if (func_43(num4, num3, &num5))
				if (Global_113810.f_18106.f_175[num5 /*19*/].f_2 == 0)
					return true;
...
BOOL func_455(var uParam0, int iParam1) // Position - 0x2D328
{
	int num;
	var unk;
	var unk5;
	...
	num = 0;
	func_456(func_29(iParam1), &unk, &unk5);

	if (func_434(uParam0, iParam1, &unk, &unk5, 2, num, 0, 0, false))
		return 1;
...
BOOL func_460(int iParam0, int iParam1) // Position - 0x2D58E
{
	...
	if (func_54(num, num2, &num3) && func_53(num3) == 0)
		if (num6 == 0)
			return true;
		else if (num6 == 1)
			if (func_43(num4, num3, &num5) && func_53(num5) == 0)
				if (func_461(num3, 14) || func_461(num4, 14))
					return false;
				else
					return true;
...
BOOL func_466(int iParam0) // Position - 0x2D707
{
	...
	if (!func_467(num))
	{
		...
		else
		{
			...
			if (num3 < 3)
				if (unk_0xFC8BFE4B41177C22(Global_96647[num3]))
					return false;
		}
	}
...
BOOL func_468(int iParam0) // Position - 0x2D78E
{
	if (Global_22959 == 0)
		return false;
...
void func_481() // Position - 0x2E3BB
{
	...
	for (j = 0; j < 3; j = j + 1)
	{
		if (!unk_0x4FAFF4BCB7633475(Global_96651[j]))
		{

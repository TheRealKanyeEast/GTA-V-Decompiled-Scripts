					...
					else if (func_23(iLocal_94))
					{
						...
						for (i = 243; i <= 262; i = i + 1)
						{
							...
							if (func_16(unk.f_6, func_17(num, 0), false))
							{
								if (unk_0xC450B06E5AAA0985(Global_32663[num /*23*/].f_19))
								{
									unk_0x861AC9C2D48CEA7F(Global_32663[num /*23*/].f_19, 1);
									unk_0x8D777E1B885E428C(Global_32663[num /*23*/].f_19, 10000);
...
void func_76() // Position - 0x3997
{
	...
	if (!func_82(num) || num == 52)
	{
		if (!IS_BIT_SET(Global_113810.f_18577.f_390[iLocal_50], iLocal_49))
		{
			...
			if (num == 58)
				unk_0x0B0C9A0F9AAEB7F0(&Global_113810.f_18577.f_390[iLocal_50], iLocal_49);
...
void func_83(int iParam0) // Position - 0x3D0C
{
	...
	if (!IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 1))
		if (!unk.f_23)
			unk_0x0B0C9A0F9AAEB7F0(&Global_113810.f_18577[iParam0 /*6*/], 1);
		...
		if (IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 1))
		{
			if (!IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 2))
			{
				...
				if (unk.f_15 > 0 && flag)
				{
					...
					{
						func_122(Global_113810.f_18577[iParam0 /*6*/].f_2, &unk34, &unk35, &unk36, &num2, &num3, &num4);
				...
				if (flag)
				{
					unk_0x0B0C9A0F9AAEB7F0(&Global_113810.f_18577[iParam0 /*6*/], 2);
	...
	if (IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 2) && !IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 3))
	{
		...
		if (!flag2)
			unk_0x8744D2E3FC95740E(&Global_113810.f_18577[iParam0 /*6*/], 2);
	}
	...
	if (Global_112897[iParam0 /*10*/].f_7 != num6)
	{
		if (func_105(&(Global_112897[iParam0 /*10*/].f_8)))
		{
			...
			{
				num7 = uLocal_72[Global_112897[iParam0 /*10*/].f_8];
			...
			Global_112897[iParam0 /*10*/].f_7 = num6;
		}
	}
	...
	if (!IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 4))
	{
		...
		{
			unk_0x0B0C9A0F9AAEB7F0(&Global_113810.f_18577[iParam0 /*6*/], 4);
		}
		else if (num6 == 2)
		{
	...
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!func_45(35))
		{
			if (IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 2) && !IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 3))
			{
				if (!func_94(unk.f_26, func_9()) && !func_103(iParam0) && !func_82(iParam0) && !func_86(iParam0) && !func_85(iParam0) && !Global_112897[iParam0 /*10*/].f_3)
				{
...
void func_97(int iParam0, char* sParam1) // Position - 0x4C94
{
	...
	if (unk_0xC450B06E5AAA0985(Global_32663[num /*23*/].f_19))
		unk_0x594D5D0D7071B0DE(Global_32663[num /*23*/].f_19, sParam1);
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4E9E
{
	...
	if (bParam1)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_32663[num /*23*/].f_11), 28);
	else
		unk_0x8744D2E3FC95740E(&(Global_32663[num /*23*/].f_11), 28);
...
void func_114(int iParam0, var uParam1) // Position - 0x597B
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_115(iParam0) && unk_0x486FF5D06E9659F1(Global_91601[26 /*34*/].f_6) == 0)
			{
				Global_113810.f_7264[iParam0] = 1;
				unk_0xEBB2809684978887(uParam1->f_5, Global_113810.f_7264[iParam0], 1, 1);
			}
...
void func_135(int iParam0, int iParam1) // Position - 0x9724
{
	...
	unk_0x0B0C9A0F9AAEB7F0(&(Global_32663[num /*23*/].f_11), 16);

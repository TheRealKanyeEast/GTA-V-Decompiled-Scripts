	...
	while (bLocal_260 && func_138(2, 0))
	{
		...
		switch (iLocal_69)
		{
			...
			case 2:
				if (func_134())
				{
					func_133(&uLocal_71, 0, unk_0x4A8C381C258A124D(), "FRANKLIN", 0, 1);
...
void func_3(int iParam0) // Position - 0x1B0
{
	...
	if (unk_0x4FAFF4BCB7633475(iParam0))
	{
		if (!bLocal_516 && unk_0x9B3D4335E0EDB0BE(iParam0, unk_0x4A8C381C258A124D(), 1))
		{
			...
			if (num3 != -1)
			{
				num4 = func_119(iParam0);
			
				if (num4 != 0)
				{
					if (!func_118(num3) || func_110(num3) == 6)
					{
						func_109(75, unk_0xD1A6A821F5AC81DB(iParam0, 0), 250f, -1);
					
						if (func_41(Global_96547, num, 2, 0, num4, num3, 75))
							bLocal_516 = true;
					}
				}
			}
...
int func_6(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, var uParam5, int iParam6) // Position - 0x517
{
	...
	if (num3 || func_31(sParam3, &unk5, uParam4))
	{
		if (num2 == 5)
			if (num == 0)
				func_133(uParam2, 0, unk_0x4A8C381C258A124D(), "MICHAEL", 0, 1);
			else if (num == 1)
				func_133(uParam2, 0, unk_0x4A8C381C258A124D(), "FRANKLIN", 0, 1);
			else if (num == 2)
				func_133(uParam2, 0, unk_0x4A8C381C258A124D(), "TREVOR", 0, 1);
...
BOOL func_10(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, int iParam5) // Position - 0x94E
{
	...
	if (func_29(sParam0, 7))
	{
		...
		{
			func_133(uParam2, 0, unk_0x4A8C381C258A124D(), str, 0, 1);
...
int func_35(int iParam0) // Position - 0x1A40
{
...
void func_39() // Position - 0x1A9A
{
	...
	{
		if (func_34(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_40(unk_0x4A8C381C258A124D());
		
			if (func_36(num) && !func_24(14) || Global_112760)
			{
...
int func_40(var uParam0) // Position - 0x1B97
{
	int i;
	int num;
...
BOOL func_41(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1BD4
{
	int num;
	int num2;
	int num3;
	...
	if (iParam3 == 0)
	{
		if (func_106(num2, iParam2, -1, &num5, &num6))
		{
			...
			if (func_102(iParam5, num5, num6, num, num3, iParam1, num4, 10000, iParam6, iParam4, num8, num7, 1))
				return true;
			else
				return false;
		}
	...
	{
		if (func_83(iParam1, &unk, 1, 0, 0, 0, 0, true, 0, 1))
		{
			if (iParam4 != 0)
			{
				switch (iParam4)
...
int func_43(int iParam0, int iParam1, int iParam2) // Position - 0x1DC0
{
	...
	return func_44(func_77(iParam0), 0, iParam1, iParam2, false);
}
...
void func_47(int iParam0) // Position - 0x26CF
{
	...
	if (flag)
	{
		...
		unk_0xACF853FB3F6EA7D4(func_48(iParam0));
...
char* func_48(int iParam0) // Position - 0x2847
{
	switch (iParam0)
	{
		case 0:
...
int func_51(int iParam0, int iParam1) // Position - 0x2978
{
...
void func_54(int iParam0, int iParam1, int iParam2) // Position - 0x29CD
{
	if (iParam2 == -1)
		iParam2 = func_53();
...
BOOL func_83(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x3263
{
	int num;
	char* str;
	int num2;
	...
	if (func_85(iParam0, sParam1, iParam2, num, str, str2, num2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, num3, str3, str4, num4) == 1)
	{
		if (bParam7 == true)
		{
			Global_9077 = iParam6;
			Global_8980[3 /*6*/] = { func_84(iParam0) };
			Global_9057 = iParam0;
...
int func_85(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x3305
{
	int num;
	int num2;
	...
	func_86(iParam0, sParam1, num2, func_87(unk_0x259BE71D8A81D4FA()));
	return 1;
}
						...
						if (Global_8939[i] == 0)
						{
							...
							else if (num == 7)
							{
								if (Global_78689)
								{
									...
									func_89(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20500)
...
void func_89(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x3E2A
{
...
void func_90(int iParam0) // Position - 0x3EDD
{
...
void func_91(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3EEF
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	unk_0x330108B080A2132F(SYSTEM::ROUND(fParam2));
...
BOOL func_99(var uParam0, int iParam1) // Position - 0x4466
{
	int num;
	int num2;
...
BOOL func_102(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12) // Position - 0x45AF
{
	int num;
...
void func_103(int iParam0) // Position - 0x46EA
{
	int i;
	int num;
	int j;
...
BOOL func_105(BOOL bParam0) // Position - 0x4812
{
...
int func_110(int iParam0) // Position - 0x4A6A
{
	...
	for (i = 0; i < Global_113810.f_7691.f_764; i = i + 1)
	{
		if (Global_113810.f_7691.f_651[i /*14*/] == iParam0)
			return func_114(iParam0, unk);
	}

	for (i = 0; i < Global_113810.f_7691.f_866; i = i + 1)
	{
		if (Global_113810.f_7691.f_765[i /*10*/] == iParam0)
			return func_111(iParam0, unk);
	}

	return 6;
}

int func_111(int iParam0, var uParam1) // Position - 0x4B20
{
	int num;
	BOOL flag;
	...
	if (IS_BIT_SET(num.f_2, func_112()))
		flag = true;
	...
	if (flag)
		if (num.f_3 < Global_113810.f_7691.f_919[func_112()])
			return 5;
...
int func_114(int iParam0, var uParam1) // Position - 0x4C1D
{
	int num;
	BOOL flag;
...
int func_116(int iParam0, var uParam1) // Position - 0x4CF8
{
	int num;
	BOOL flag;
...
int func_120(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x4F77
{
	int i;
	float num;
	float num2;
...
int func_123(int iParam0) // Position - 0x50B5
{
		...
		switch (uLocal_269[iParam1])
		{
			case 0:
				if (unk_0x13CCB1AD131C1082(*iParam0, &uLocal_360, &uLocal_441[iParam1 /*16*/], 2))
				{
					...
					if (unk_0xBD3B265153D3BA2D(Global_98143) > num2)
					{
			...
			case 1:
				...
				{
					if (!func_131() && !unk_0xCB5CAFF0A4A8B74B(*iParam0))
					{
						unk_0xA966E518B752B92A(*iParam0, uLocal_276 + uLocal_290[iParam1 /*3*/], 1f, -1, 0.25f, num, 1193033728);
						uLocal_269[iParam1] = 2;
						return 1;
			...
			case 4:
				...
				else
				{
					...
					unk4 = { func_127(uLocal_276 + uLocal_290[iParam1 /*3*/], func_130(uLocal_307[iParam1] * 0.9f, 10f, 100f), 0f) };
			...
			case 10:
				...
				unk_0xD414C47AFF81382A(5, uLocal_274, Global_95817);
				unk_0xD414C47AFF81382A(5, Global_95817, uLocal_274);
...
Vector3 func_128(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0x57A1
{
	...
	num = fParam4 / 2f;
	unk = { func_129(unk, unk_0xD2AA6F822D3A55D2(0f, fParam3)) };
...
BOOL func_134() // Position - 0x5943
{
	...
	if (!func_135())
	{
		if (unk_0x5266F1D2AEF6F73A(Global_98143))
		{
			...
			if (!bLocal_511)
			{
				...
				else if (func_12(&uLocal_71, "PRSAUD", &uLocal_506, 3, 0, 0, 0))
				{
					bLocal_511 = true;
				}
			}
	...
	if (!func_135())
	{
		if (unk_0x5266F1D2AEF6F73A(Global_98143))
		{
			for (i = 0; i < iLocal_261; i = i + 1)
			{
				...
				{
					unk_0x3DA436E63AB0F541(iLocal_261[i], Global_98143, &uLocal_360, &uLocal_441[i /*16*/], 8f, -4f, 3, 0, 1148846080, 0);
					uLocal_269[i] = 0;
				}
				else
				{
...
BOOL func_137() // Position - 0x5AA7
{
	...
	if (unk_0x5266F1D2AEF6F73A(Global_98142))
	{
		...
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_261[i]))
				unk_0x3DA436E63AB0F541(iLocal_261[i], Global_98142, &uLocal_360, &uLocal_376[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
		}
	
		if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			func_133(&uLocal_71, 1, unk_0x4A8C381C258A124D(), "FRANKLIN", 0, 1);
	
		if (!unk_0x4FAFF4BCB7633475(Global_100554))
...
BOOL func_138(int iParam0, int iParam1) // Position - 0x5B87
{
	Vector3 vector;
	float num;
...
void func_146() // Position - 0x5D37
{
	...
	if (unk_0xFC8BFE4B41177C22(Global_100554))
	{
		if (func_37(19) == unk_0x4B423FAA24E8ABF0(Global_100554))
...
void func_147(int iParam0, int iParam1) // Position - 0x5F15
{

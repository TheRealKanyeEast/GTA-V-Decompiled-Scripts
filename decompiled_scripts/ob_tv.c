					...
					switch (iLocal_27)
					{
						case 0:
							...
							else
							{
								...
								Global_32344[iLocal_41 /*11*/] = unk_0xC5935DFB3F39785A(0, 2);
						...
						case 2:
							...
							if (!func_65(iLocal_41))
							{
								...
								if (func_43("TV_HLP1" /*Press ~INPUT_CONTEXT~ to turn on the TV.*/))
							...
							if (!func_65(iLocal_41))
							{
								...
								unk_0xECDF98280946398E(Global_32344[iLocal_41 /*11*/]);
							...
							else
							{
								...
								unk_0x7C7F282055FB517C(iLocal_42, func_42(iLocal_43), Global_32344[iLocal_41 /*11*/].f_9);
...
{
	if (iLocal_41 != -1)
		Global_32344[iLocal_41 /*11*/] = unk_0x6609A7E82612E0DF();
	...
	if (func_43("TV_HLP1" /*Press ~INPUT_CONTEXT~ to turn on the TV.*/) || func_43("TV_HLP2" /*Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change the channel.~n~Use ~INPUT_SCRIPT_LEFT_AXIS_Y~ to change the volume.~n~Press ~INPUT_NEXT_CAMERA~ to change view.~n~Press ~INPUT_CONTEXT~ to stop watching.~n~*/) || func_43("TV_HLP5" /*Press ~INPUT_SCRIPT_RUP~ to use the TV controls.~n~Press ~INPUT_CONTEXT~ to turn off the TV.~n~*/) || func_43("TV_HLP6" /*Press ~INPUT_SCRIPT_RUP~ to stop using the TV controls.~n~Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change the channel.~n~Use ~INPUT_SCRIPT_LEFT_AXIS_Y~ to change the volume.~n~Press ~INPUT_CONTEXT~ to turn off the TV.~n~*/))
		unk_0x428C32CC68809A35(1);
...
BOOL func_16() // Position - 0xA08
{
	if (!func_65(iLocal_41))
	{
		if (func_32(&uLocal_24) >= 1f && unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), uLocal_86, 1f, 1f, 1.5f, 0, 1, 0) && unk_0xF8F35890F43ED2AE(iLocal_35) == unk_0xF8F35890F43ED2AE(unk_0x4A8C381C258A124D()) && !func_31(8, -1) && !unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) && unk_0xA702E444F81F0A83(unk_0x4A8C381C258A124D(), uLocal_29, 90f) && !unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) && !unk_0x3555462DB47B7AB1())
		{
			...
			{
				func_30();
				func_29(&iLocal_40, 3, "TV_HLP5" /*Press ~INPUT_SCRIPT_RUP~ to use the TV controls.~n~Press ~INPUT_CONTEXT~ to turn off the TV.~n~*/, 0, 0, 0, 0);
			}
		...
		{
			if (func_43("TV_HLP5" /*Press ~INPUT_SCRIPT_RUP~ to use the TV controls.~n~Press ~INPUT_CONTEXT~ to turn off the TV.~n~*/))
				unk_0x428C32CC68809A35(1);
...
void func_17() // Position - 0xB14
{
	if (bLocal_83 == false)
	{
		...
		{
			func_44(&iLocal_40);
			func_29(&iLocal_40, 3, "TV_HLP6" /*Press ~INPUT_SCRIPT_RUP~ to stop using the TV controls.~n~Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change the channel.~n~Use ~INPUT_SCRIPT_LEFT_AXIS_Y~ to change the volume.~n~Press ~INPUT_CONTEXT~ to turn off the TV.~n~*/, 0, 0, 0, 0);
			func_26();
		}
	}
	else
...
void func_29(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x10D0
{
	int i;
...
Vector3 func_40(var uParam0) // Position - 0x1474
{
...
void func_44(var uParam0) // Position - 0x15D6
{
	int num;
...
BOOL func_45() // Position - 0x162D
{
	...
	if (iLocal_40 == -1)
	{
		func_29(&iLocal_40, 3, "TV_HLP1" /*Press ~INPUT_CONTEXT~ to turn on the TV.*/, 0, 0, 0, 0);
		return false;
	}
...
BOOL func_49(BOOL bParam0) // Position - 0x1D4B
{
...
void func_52(int iParam0, int iParam1, int iParam2) // Position - 0x1DCF
{
	if (iParam2 == -1)
		iParam2 = func_9();
...
void func_69() // Position - 0x2440
{
	...
	if (func_43("TV_HLP1" /*Press ~INPUT_CONTEXT~ to turn on the TV.*/) || func_43("TV_HLP5" /*Press ~INPUT_SCRIPT_RUP~ to use the TV controls.~n~Press ~INPUT_CONTEXT~ to turn off the TV.~n~*/) || func_43("TV_HLP6" /*Press ~INPUT_SCRIPT_RUP~ to stop using the TV controls.~n~Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change the channel.~n~Use ~INPUT_SCRIPT_LEFT_AXIS_Y~ to change the volume.~n~Press ~INPUT_CONTEXT~ to turn off the TV.~n~*/))
		unk_0x428C32CC68809A35(1);

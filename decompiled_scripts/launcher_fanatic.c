...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (num == 21)
			func_205(&num, unk61, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		else if (num == 22)
			func_200(&num, unk61, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		else if (num == 23)
			if (iLocal_94 == 0)
				if (func_205(&num, unk61, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
					iLocal_94 = 1;
			else
				func_197(&num);
...
int func_32(var uParam0) // Position - 0x2AFB
{
	int i;
...
int func_33(var uParam0, int iParam1, int iParam2) // Position - 0x2B5E
{
	int i;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D89
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A21
{
	int i;
	float num;
	float num2;
...
BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x7538
{
...
BOOL func_85(int iParam0) // Position - 0x758E
{
	if (iParam0 != func_94())
...
BOOL func_93(int iParam0) // Position - 0x8444
{
	if (iParam0 != func_94())
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8E1C
{
...
BOOL func_117(BOOL bParam0) // Position - 0x8E5E
{
...
BOOL func_135(var uParam0) // Position - 0xAD14
{
	if (func_208(uParam0))
...
void func_142(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAFF6
{
	if (bParam0)
	{
...
BOOL func_146(int iParam0) // Position - 0xB1F7
{
	int num;
...
BOOL func_147(int iParam0) // Position - 0xB219
{
...
int func_149(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB266
{
	int num;
...
BOOL func_152(var uParam0) // Position - 0xB2E3
{
...
BOOL func_158(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB416
{
...
void func_159(var uParam0) // Position - 0xB5AE
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_176(var uParam0, int iParam1) // Position - 0xBC33
{
	int num;
	var unk;
	var unk33;
...
var func_179(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC113
{
	var unk;
	...
	switch (uParam0->f_16)
	{
		case 0:
			if (*uParam0 == 12)
			{
				...
				else if (func_208(uParam0->f_28[0]))
				{
					if (func_184(uParam0))
					{
						if (func_188(2))
		...
		case 5:
			...
			{
				if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
					if (func_208(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)))
...
BOOL func_187(var uParam0) // Position - 0xCB6C
{
	if (func_208(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_198(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xD3E9
{
	unk_0x4CAD907F190E6F10(uParam0, sParam1, sParam2, func_199(iParam3), 0);
	return;
}

char* func_199(int iParam0) // Position - 0xD402
{
	char* str;
...
int func_200(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD5F7
{
	...
	if (func_208(unk_0x4A8C381C258A124D()) && func_208(uParam0->f_28[0]) && !func_155() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_204(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
		func_203(&unk, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		func_201(&unk, sParam4, sParam5, 7, 0, 0);
...
void func_203(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD710
{
...
float func_204(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD7AB
{
	var unk;
...
BOOL func_205(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xD7E5
{
	...
	if (func_188(2))
	{
		if (!func_155())
		{
			if (func_208(unk_0x4A8C381C258A124D()) && func_208(uParam0->f_28[0]) && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_204(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
			{
				unk = 16;
				func_203(&unk, iParam6, uParam0->f_28[0], sParam7, 0, 1);
				func_201(&unk, sParam4, sParam5, 7, 0, 0);
		...
		else if (func_206(sParam5))
		{
			if (func_208(unk_0x4A8C381C258A124D()))
				if (func_204(unk_0x4A8C381C258A124D(), uParam1, 1) >= 20f)
					func_153();
		}
	}
...
BOOL func_208(int iParam0) // Position - 0xD8EB
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_209(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD90C
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
BOOL func_217(Any* panParam0, BOOL bParam1) // Position - 0xDC43
{
	var unk;
	...
	{
		if (!func_225(panParam0, true, true))
		{
			if (*panParam0 == 16)
				func_224(panParam0);
			else
	...
	{
		if (!func_225(panParam0, false, true))
		{
			func_222(panParam0);
			return false;
		}
	...
	{
		if (!func_225(panParam0, true, false))
		{
			func_222(panParam0);
			return false;
		}
	...
	{
		if (!func_225(panParam0, false, false))
		{
			func_222(panParam0);
			return false;
		}
...
void func_223(var uParam0) // Position - 0xE56C
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_225(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE617
{
	int i;
	int num;
	var unk;
...
BOOL func_226(var uParam0, var uParam1) // Position - 0xE7D5
{
	var unk;
...
BOOL func_229(var uParam0, int iParam1) // Position - 0xEAF5
{
	float num;
...
BOOL func_230(var uParam0, int iParam1) // Position - 0xEB6B
{
	return func_231(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_231(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEB83
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_232(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xEC44
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_233(var uParam0, int iParam1) // Position - 0xED70
{
	int num;
...
BOOL func_235(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xEE7F
{
	var unk;
	var unk4;
	float num;
...
int func_239(var uParam0, var uParam1) // Position - 0xEF8B
{
	int i;
...
int func_240(var uParam0) // Position - 0xEFCA
{
...
BOOL func_241(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEFF2
{
	float num;
	float num2;
	int num3;
...
BOOL func_242(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF0ED
{
	float num;
	float num2;
...
BOOL func_243(var uParam0, float fParam1) // Position - 0xF1F9
{
	var unk;
	var unk2;
...
BOOL func_244(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF28E
{
	var unk;
	var unk4;
	float num;
...
BOOL func_245(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF31C
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_247(var uParam0) // Position - 0xF3AE
{
	var unk;
...
BOOL func_258(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFA6C
{
	if (func_259(uParam0, iParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_259(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFAC8
{
	int num;
...
BOOL func_264(var uParam0) // Position - 0xFC33
{
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_268(&uParam0->f_28[1], num[1], 808.43f, 1279.16f, 360.47f, -79.11f, 26);
...
void func_266(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFF78
{
	func_267(uParam0);
...
void func_267(var uParam0) // Position - 0xFFBA
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_268(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0x10058
{
	func_269(uParam0);
...
void func_269(var uParam0) // Position - 0x10079
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_292(var uParam0, BOOL bParam1) // Position - 0x10909
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_295(var uParam0) // Position - 0x10993
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_297(var uParam0, int iParam1) // Position - 0x109DD
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_298(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_298(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10A1E
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))

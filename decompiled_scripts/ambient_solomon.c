...
void main() // Position - 0x0
{
	...
	if (func_75(unk_0x4A8C381C258A124D()))
	{
		while (flag == false)
		{
			flag = unk_0x3D2EB53CF281A77E() == 0 && func_70() == 0 && func_69(unk_0x4A8C381C258A124D(), uLocal_63, fLocal_66, 1);
			func_67();
		}
	}
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
			{
				...
				unk = unk_0x42CDD13001C98400(func_56(uLocal_249, 0.73f, 0.683f, -0.013f));
		...
		case 2:
			...
			{
				func_51(&uLocal_73, 0, unk_0x4A8C381C258A124D(), "MICHAEL", 0, 1);
			
				if (func_50())
					flag = func_34(&uLocal_73, "AMSOLAU", "AMSOL_HERE", 8, 0, 0, 0);
				else
					flag = func_34(&uLocal_73, "AMSOLAU", "AMSOL_WORK", 8, 0, 0, 0);
...
BOOL func_13(int iParam0) // Position - 0x1BDD
{
	return iParam0 < 3;
}
...
void func_16(int iParam0, var uParam1) // Position - 0x1C5F
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_17(iParam0) && unk_0x486FF5D06E9659F1(Global_91601[26 /*34*/].f_6) == 0)
			{
				Global_113810.f_7264[iParam0] = 1;
				unk_0xEBB2809684978887(uParam1->f_5, Global_113810.f_7264[iParam0], 1, 1);
			}
...
BOOL func_34(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x5579
{
...
void func_51(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x5CE2
{
...
BOOL func_61(var uParam0) // Position - 0x6236
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
			return true;
...
void func_63(var uParam0) // Position - 0x6281
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			{
				unk2 = unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0);
				unk = unk_0x42CDD13001C98400(func_56(uLocal_249, -0.37f, -0.927f, -0.053f));
...
void func_67() // Position - 0x6662
{
	...
	if (!func_69(unk_0x4A8C381C258A124D(), uLocal_63, fLocal_66 + 30f, 1))
		func_77();
...
void func_71() // Position - 0x6753
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_73(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_13(num) && !func_11(14) || Global_112760)
			{
...
int func_72(var uParam0) // Position - 0x6850
{
	int i;
	int num;
...
int func_74(int iParam0) // Position - 0x68B2
{

...
void func_1() // Position - 0xD6
{
	...
	if (bLocal_40)
	{
		...
		{
			if (!func_49() && !unk_0xCA038E64C65D1F9D(uLocal_42) && !unk_0x8BF5256C439DF778(uLocal_42) && !unk_0x78174817EDF226B3(uLocal_42) && !unk_0x4FAFF4BCB7633475(uLocal_42))
	...
	for (i = 0; i < 15; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_208[i /*11*/]))
		{
			...
			{
				unk_0x0B0C9A0F9AAEB7F0(&(Global_113810.f_10052.f_108), i);
				func_19(i);
...
BOOL func_17(BOOL bParam0) // Position - 0x75E
{
...
void func_21(int iParam0, int iParam1, int iParam2) // Position - 0x7E9
{
	if (iParam2 == -1)
		iParam2 = func_7();
...
void func_38() // Position - 0xF11
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_41(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_39(num) && !func_43(14) || Global_112760)
			{
...
int func_40(var uParam0) // Position - 0x101A
{
	int i;
	int num;
...
int func_42(int iParam0) // Position - 0x107C
{
...
BOOL func_50(var uParam0) // Position - 0x1255
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
			return true;
...
BOOL func_52() // Position - 0x14B8
{
	...
	for (i = 0; i < num; i = i + 1)
	{
		if (func_50(unk[i]))
		{
			if (unk_0x4B423FAA24E8ABF0(unk[i]) == func_54(58))
			{
				uLocal_42 = unk[i];
...
void func_53(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1560
{
...
void func_59(int iParam0) // Position - 0x1864
{
	int i;
	int num;
	int j;

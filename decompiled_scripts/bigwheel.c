...
void func_31() // Position - 0x14FC
{
	...
	func_32("FGND_SWTCHCAM" /*Press ~INPUT_SCRIPT_SELECT~ to change view.~n~Press ~INPUT_CONTEXT~ or ~INPUT_SKIP_CUTSCENE~ to skip the ride.*/, -1);
...
BOOL func_54(var uParam0, int iParam1, BOOL bParam2) // Position - 0x6584
{
	...
	for (i = 0; func_55(iParam1, i, &unk, &num); i = i + 1)
	{
...
void func_57() // Position - 0x66E4
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_61(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_59(num) && !func_58(14) || Global_112760)
			{
...
int func_71(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x6F24
{
	...
	if (iParam5 == 0)
	{
		Global_78472[1 /*14*/] = { func_124(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78472[1 /*14*/] = { func_124(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78472[1 /*14*/] = { func_124(num8, 14, unk18[j], -1) };
							func_91(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
							func_114(14);
			...
			{
				Global_78472[1 /*14*/] = { func_124(num8, i, func_80(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78472[1 /*14*/] = { func_124(num8, 14, unk59[j], -1) };
			func_91(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
			func_114(14);
...
BOOL func_72(var uParam0, int iParam1, var uParam2) // Position - 0x7735
{
	...
	{
		if (!func_188(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_64, Global_113810.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_79(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x802A
{
	...
	{
		if (!func_188(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_61, Global_113810.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
void func_116(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xDF75
{
	int num;
...
int func_117(int iParam0, int iParam1) // Position - 0xDF98
{
...
BOOL func_131(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x13E61
{
	int num;
	int num2;
	int num3;
...
void func_133(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13F73
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_127(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_127(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78670)
		{
			...
			func_127(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_188(var uParam0, int iParam1, int iParam2) // Position - 0x25663
{
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_78472[1 /*14*/] = { func_124(num, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_188(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_188(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78472[2 /*14*/] = { func_124(num, 14, k, -1) };
								
									if (Global_78472[2 /*14*/].f_12 == j)
										if (func_188(uParam0, 14, k))
											if (!func_77(num, iParam2, 14, k, &unk, &Global_78472[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_78472[2 /*14*/] = { func_124(num, i, num2, -1) };
					
						if (!func_77(num, iParam2, i, num2, &unk, &Global_78472[2 /*14*/]))
							return false;
					}
				}
			}
...
BOOL func_194(int iParam0) // Position - 0x25AFC
{
	int num;
...
BOOL func_195(int iParam0) // Position - 0x25B1E
{
...
int func_197(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x25B6B
{
	int num;
...
int func_203(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4) // Position - 0x25FF3
{
	if (IS_BIT_SET(uParam0->f_113, iParam1) || IS_BIT_SET(uParam0->f_114, iParam1))
		return 1;
...
void func_213(BOOL bParam0) // Position - 0x26331
{
	if (bParam0)
	{
		unk_0x428C32CC68809A35(1);
		func_23(500, true);
		unk_0x8744D2E3FC95740E(&Global_78938, 6);
	}
...
BOOL func_217(BOOL bParam0) // Position - 0x26A42
{
...
void func_219(int iParam0, int iParam1, int iParam2) // Position - 0x26ABB
{
	if (iParam2 == -1)
		iParam2 = func_119();
...
int func_223(int iParam0, int iParam1, int iParam2) // Position - 0x26D3B
{
	...
	return func_224(func_250(iParam0), 0, iParam1, iParam2, false);
}
...
char* func_228(int iParam0) // Position - 0x277C4
{
	switch (iParam0)
	{
		case 0:
...
int func_253(int iParam0) // Position - 0x28000
{
	int num;
...
BOOL func_255(int iParam0) // Position - 0x28055
{
	if (!func_194(iParam0))
		return false;
...
void func_256(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x28074
{
	var unk;
...
BOOL func_257(var uParam0) // Position - 0x2811E
{
	if (func_26(uParam0))
		if (!unk_0x4FAFF4BCB7633475(uParam0))
			return true;

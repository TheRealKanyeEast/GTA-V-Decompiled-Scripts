...
void main() // Position - 0x0
{
	...
	if (!func_260(&unk64, &num, unk61, 1f))
	{
		func_259();
	...
	while (true)
	{
		...
		func_202(num);
		func_194(&iLocal_91, &(num.f_9), unk61);
...
BOOL func_2(Any* panParam0) // Position - 0x20D
{
	...
	if (!func_178())
	{
		while (!func_169(*panParam0))
		{
			...
			if (!func_203(panParam0, *panParam0 != 2))
			{
...
int func_32(var uParam0) // Position - 0x2A09
{
	int i;
...
int func_33(var uParam0, int iParam1, int iParam2) // Position - 0x2A6C
{
	int i;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5C98
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6930
{
	int i;
	float num;
	float num2;
...
BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x7447
{
...
BOOL func_85(int iParam0) // Position - 0x749D
{
	if (iParam0 != func_94())
...
BOOL func_93(int iParam0) // Position - 0x8354
{
	if (iParam0 != func_94())
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8D2C
{
...
BOOL func_117(BOOL bParam0) // Position - 0x8D6E
{
...
BOOL func_135(var uParam0) // Position - 0xAC24
{
	if (func_136(uParam0))
...
BOOL func_136(int iParam0) // Position - 0xAC44
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAD88
{
	int i;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF27
{
	if (bParam0)
	{
...
BOOL func_147(int iParam0) // Position - 0xB128
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB14A
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB197
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB214
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB347
{
...
void func_160(var uParam0) // Position - 0xB4DF
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_177(var uParam0, int iParam1) // Position - 0xBB64
{
	int num;
	var unk;
	var unk33;
...
BOOL func_184(var uParam0) // Position - 0xC558
{
	if (func_136(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_194(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCD85
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
float func_198(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xCF89
{
	var unk;
...
BOOL func_203(Any* panParam0, BOOL bParam1) // Position - 0xD0F6
{
	var unk;
	...
	{
		if (!func_211(panParam0, true, true))
		{
			if (*panParam0 == 16)
				func_210(panParam0);
			else
	...
	{
		if (!func_211(panParam0, false, true))
		{
			func_208(panParam0);
			return false;
		}
	...
	{
		if (!func_211(panParam0, true, false))
		{
			func_208(panParam0);
			return false;
		}
	...
	{
		if (!func_211(panParam0, false, false))
		{
			func_208(panParam0);
			return false;
		}
...
void func_204(int iParam0, var uParam1, int iParam2) // Position - 0xD366
{
	...
	if (func_136(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_206(uParam1) || !unk_0x13CCB1AD131C1082(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_205(iParam2) && !unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 25f))
					{
						unk_0x0E95B96CFEFE7B61(iParam0, unk_0x4A8C381C258A124D(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_206(uParam1) && uParam1->f_4 == 0 && unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_205(iParam2) || unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						unk_0x10425721983AE158(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					else
...
void func_209(var uParam0) // Position - 0xDA1F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_211(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDACA
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_212(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_212(var uParam0, var uParam1) // Position - 0xDC88
{
	var unk;
...
BOOL func_215(var uParam0, int iParam1) // Position - 0xDFA8
{
	float num;
...
BOOL func_216(var uParam0, int iParam1) // Position - 0xE01E
{
	return func_217(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_217(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE036
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_218(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE0F7
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_219(var uParam0, int iParam1) // Position - 0xE223
{
	int num;
...
BOOL func_221(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE332
{
	var unk;
	var unk4;
	float num;
...
int func_225(var uParam0, var uParam1) // Position - 0xE43E
{
	int i;
...
int func_226(var uParam0) // Position - 0xE47D
{
...
BOOL func_227(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE4A5
{
	float num;
	float num2;
	int num3;
...
BOOL func_228(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE5A0
{
	float num;
	float num2;
...
BOOL func_229(var uParam0, float fParam1) // Position - 0xE6AC
{
	var unk;
	var unk2;
...
BOOL func_230(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE741
{
	var unk;
	var unk4;
	float num;
...
BOOL func_231(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE7CF
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_233(var uParam0) // Position - 0xE861
{
	var unk;
...
BOOL func_242(var uParam0) // Position - 0xEACB
{
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_247(&num) || !unk_0xE100DD4F82A51BDE("special_ped@maude@base"))
				return false;
...
BOOL func_243(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xED63
{
	if (func_244(uParam0, iParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_244(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xEDBF
{
	int num;
...
void func_246(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xEE93
{
	func_209(uParam0);
...
void func_248(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEEEB
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_90 = unk_0xA7B0B03284E7503C(unk, unk4, 0, 1, 1, 1);
...
void func_268(var uParam0, BOOL bParam1) // Position - 0xF676
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_271(var uParam0) // Position - 0xF700
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_272(var uParam0) // Position - 0xF738
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_275(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF827
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_276(var uParam0) // Position - 0xF877
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_278(var uParam0, int iParam1) // Position - 0xF929
{
	if (func_135(uParam0))

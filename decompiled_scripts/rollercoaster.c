...
void main() // Position - 0x0
{
	...
	unk_0x0B0C9A0F9AAEB7F0(&Global_78938, 7);
	...
	func_8("FGND_SKIPRIDE" /*Press ~INPUT_CONTEXT~ or ~INPUT_SKIP_CUTSCENE~ to skip the ride.*/, -1);
...
void func_28(var uParam0, int iParam1, int iParam2) // Position - 0x174D
{
	...
	*uParam0 = { func_18(&uLocal_157[uParam0->f_4[0] /*3*/], &uLocal_157[uParam0->f_4[1] /*3*/], &uLocal_157[uParam0->f_4[2] /*3*/], &uLocal_157[uParam0->f_4[3] /*3*/], uParam0->f_3) };
	*uParam0 = { *uParam0 + uLocal_860 };
	uParam0->f_9 = unk_0x43AFC452F25F3A2F(iLocal_38, *uParam0, 1, 1, 0);
...
void func_29() // Position - 0x185B
{
	...
	for (i = 0; i < iLocal_923; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(iLocal_923[i]))
		{
			...
			unk_0x935364B4448CD584(iLocal_923[i], 1);
		}
	}
...
BOOL func_36(float fParam0, var uParam1, var uParam2) // Position - 0x2F92
{
...
BOOL func_37(var uParam0, int iParam1, BOOL bParam2) // Position - 0x2FBC
{
	int i;
	var unk;
	int num;
	...
	for (i = 0; func_38(iParam1, i, &unk, &num); i = i + 1)
	{
...
BOOL func_38(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x302A
{
...
void func_40() // Position - 0x3117
{
	...
	{
		if (func_44(Global_113810.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			num = func_43(unk_0x4A8C381C258A124D());
		
			if (func_42(num) && !func_41(14) || Global_112760)
			{
				if (Global_113810.f_2366.f_539.f_4321 != num && func_42(Global_113810.f_2366.f_539.f_4321))
...
int func_43(var uParam0) // Position - 0x322E
{
	int i;
	int num;
...
int func_45(int iParam0) // Position - 0x3290
{
...
BOOL func_59(var uParam0) // Position - 0x3DED
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
Vector3 func_60(var uParam0) // Position - 0x3E0E
{
...
int func_61(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3E21
{
	...
	if (iParam5 == 0)
	{
		Global_78472[1 /*14*/] = { func_114(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78472[1 /*14*/] = { func_114(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78472[1 /*14*/] = { func_114(num8, 14, unk18[j], -1) };
							func_81(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
							func_104(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_71(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_71(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_71(i), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
			...
			{
				Global_78472[1 /*14*/] = { func_114(num8, i, func_70(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78472[1 /*14*/] = { func_114(num8, 14, unk59[j], -1) };
			func_81(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
			func_104(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_71(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_71(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_71(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
...
BOOL func_62(var uParam0, int iParam1, var uParam2) // Position - 0x4633
{
	...
	{
		if (!func_178(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_64, Global_113810.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_69(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x4F27
{
	...
	{
		if (!func_178(uParam0, Global_113810.f_2366.f_539[num /*65*/].f_61, Global_113810.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
void func_106(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xAE73
{
	int num;
...
int func_107(int iParam0, int iParam1) // Position - 0xAE96
{
...
BOOL func_121(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x10B5B
{
	int num;
	int num2;
	int num3;
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10C6D
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_117(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_117(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78670)
		{
			...
			func_117(&Global_78472[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_178(var uParam0, int iParam1, int iParam2) // Position - 0x222E2
{
	int num;
	int num2;
	int i;
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_78472[1 /*14*/] = { func_114(num, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_178(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_178(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78472[2 /*14*/] = { func_114(num, 14, k, -1) };
								
									if (Global_78472[2 /*14*/].f_12 == j)
										if (func_178(uParam0, 14, k))
											if (!func_67(num, iParam2, 14, k, &unk, &Global_78472[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_78472[2 /*14*/] = { func_114(num, i, num2, -1) };
					
						if (!func_67(num, iParam2, i, num2, &unk, &Global_78472[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_78472[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_71(iParam1)) && Global_78472[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_71(iParam1)))
	{
		return true;
	}
...
void func_180(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2257A
{
	if (bParam0)
	{
...
BOOL func_184(int iParam0) // Position - 0x2277B
{
	int num;
...
BOOL func_185(int iParam0) // Position - 0x2279D
{
...
int func_187(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x227EA
{
	int num;
...
void func_189(BOOL bParam0) // Position - 0x22840
{
	...
	{
		unk_0x428C32CC68809A35(1);
		unk_0x8744D2E3FC95740E(&Global_78938, 7);
		func_1(500, true);
	}
...
int func_192(int iParam0, int iParam1, int iParam2) // Position - 0x22B8B
{
	...
	return func_193(func_221(iParam0), 0, iParam1, iParam2, false);
}
...
void func_196(int iParam0) // Position - 0x2349A
{
	...
	else if (IS_BIT_SET(Global_113810.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_198() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113810.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_198() /*5568*/].f_681.f_10), iParam0);
	}
	...
	if (flag)
	{
		...
		unk_0xACF853FB3F6EA7D4(func_197(iParam0));
...
char* func_197(int iParam0) // Position - 0x23613
{
	switch (iParam0)
	{
		case 0:
...
void func_199(int iParam0, int iParam1, int iParam2) // Position - 0x23722
{
	if (iParam2 == -1)
		iParam2 = func_109();
...
void func_222(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x23E29
{
	var unk;
...
BOOL func_223(var uParam0) // Position - 0x23ED3
{
	if (func_59(uParam0))
		if (!unk_0x4FAFF4BCB7633475(uParam0))
			return true;
...
Vector3 func_224(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x23EF3
{
	var unk;
...
void func_226(var uParam0, BOOL bParam1) // Position - 0x2406E
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_228(var uParam0, int iParam1, BOOL bParam2) // Position - 0x240CA
{
	if (unk_0x78411E34CF90EA8C(*uParam0))
	{
		if (bParam2)
...
BOOL func_232(BOOL bParam0) // Position - 0x24753
{
